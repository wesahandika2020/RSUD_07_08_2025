...
$.fn.signaturePad.defaults = {
  ...
  , errorMessage : 'Silahkan Masukkan Nama Anda' // The error message displayed on invalid submission
  , errorMessageDraw : 'Silahkan Tanda Tangan Terlebih Dahulu' // The error message displayed when drawOnly and no signature is drawn
