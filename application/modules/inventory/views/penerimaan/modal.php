		...
		<div class="modal-content">
			<div class="modal-header">
				<div class="title">
					...
					<h6 class="modal-title text-muted" id="modal-sub-penerimaan-title"><small>(Pembelian Ke PBF)</small></h6>
				</div>
			...
			<div class="modal-body">
				<?= form_open('', 'id=form-penerimaan class=form-horizontal role=form') ?>
										...
										<tr>
											...
											<td width="33%"> 
												...
												<table width="100%" cellspacing="0" class="table table-striped table-sm mb-0">
													<!-- <tr>
														<td width="25%">No. Penerimaan</td>
														<td width="1%">:</td>
														<td width="74%">
															<input type="text" name="no_penerimaan" id="no-penerimaan" class="custom-form" readonly style="width:300px">
														</td>
													</tr> -->
													<tr>
														<td>Tanggal</td>
													...
													<tr>
														...
														<td>:</td>
														<td>
															<input type="text" name="supplier" id="supplier-auto" class="select2c-input" placeholder="Pilih Supplier..." style="width:300px">
														</td>
													</tr>
												</table>
											</td>
											<td width="33%">
												<table width="100%" cellspacing="0" class="table table-striped table-sm mb-0">
													...
													<tr>
														...
														<td>:</td>
														<td>
															<input type="text" name="jatuh_tempo" id="jatuh-tempo" class="custom-form" style="width:300px" value="<?= date('d/m/Y') ?>">
														</td>
													</tr>
													<tr>
														<td>Jenis Barang</td>
								...
								<table class="table table-hover table-striped table-sm color-table info-table" id="table-penerimaan" cellspacing="0" cellpadding="0">
									<thead>
										<tr>
											...
											<th width="10%" class="left">Disc Rp.</th>
...
<?php $this->load->view('inventory/penerimaan/js') ?>