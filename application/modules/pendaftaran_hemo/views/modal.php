    ...
    <div class="modal-dialog" style="max-width: 650px">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group row tight">
                    <label for="user_search_hemo" class="col-3 col-form-label">Petugas</label>
                    <div class="col">
                        <input type="text" name="user" id="user_search_hemo" class="form-control">
                    </div>
                </div><div class="form-group row tight">
    ...
    <div class="modal-dialog modal-dialog-scrollable" style="max-width: 95%">
        <div class="modal-content">
            ...
            <div class="modal-body bg-default">
                ...
                <input type="hidden" name="jenis_pendaftaran" id="jenis-pendaftaran" value="Hemodialisa">
                <input type="hidden" name="layanan" value="59">
                <!-- End ID Hidden -->
                            ...
                            <li class="list-group-item border-theme">
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <div class="form-group row tight">
                                            <label for="no-rm" class="col-md-3 col-form-label">No RM</label>
                                            <div class="col-md-8">
...
<!-- Modal Cetak Berkas Pendaftaran Poliklinik -->
<div id="modal_cetak_pendaftaran" class="modal fade" role="dialog" aria-labelledby="modal_cetak_pendaftaran_label" aria-hidden="true">
    <div class="modal-dialog" style="max-width: 350px">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="modal_cetak_pendaftaran_label"></h4>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col">
                        <button type="button" class="btn btn-info btn-block" id="btn_cetak_kartu_pasien"><i class="fas fa-print m-r-5"></i>Cetak Kartu Pasien</button>
                        <!-- <button type="button" class="btn btn-info btn-block" id="btn_cetak_bukti_kunjungan"><i class="fas fa-print m-r-5"></i>Cetak Bukti Kunjungan</button> -->
                        <button type="button" class="btn btn-info btn-block" id="btn_cetak_label_berkas"><i class="fas fa-print m-r-5"></i>Cetak Label Berkas</button>
                        <button type="button" class="btn btn-info btn-block" id="btn_cetak_label_gelang"><i class="fas fa-print m-r-5"></i>Cetak Label Gelang</button>
                        <button type="button" class="btn btn-info btn-block" id="btn_cetak_label_ranap"><i class="fas fa-print m-r-5"></i>Cetak Label Ranap</button>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
...
<!-- End Modal Cetak Berkas Pendaftaran Poliklinik -->
