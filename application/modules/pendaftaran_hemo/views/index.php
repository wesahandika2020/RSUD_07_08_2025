    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-3">
                        <h6><i class="fas fa-hospital-alt m-t-10 m-r-10"></i>Data List Pendataran Hemodialisa</h6>
                    </div>
                ...
                <table id="table-data" class="table table-hover table-striped table-sm color-table info-table">
                    <thead>
                        <tr>
                            ...
                            <th width="7%" class="center">No Rujukan</th>
...
<?php 
    ...
    $this->load->view(DIR_VCLAIM.'modal_vclaim_form');
