...
<head>
	...
	<title>.:FORMULIR TATA TERTIB PASIEN INTENSIVE CARE:.</title>
	<style>
		* {
			...
			<center>
				<table width="1065" style="border:1px solid #000; border-collapse:collapse;">
					...
					<tr>
						...
						<th colspan="6" rowspan="3" scope="col" style="border:1px solid #000;">TATA TERTIB<br />PASIEN INTENSIVE CARE <BR />( REGULATION INPATIENT )</th>
						<th scope="col">&nbsp;</th>
					</tr>
					<tr>
						<th scope="col">&nbsp;</th>
					...
					<tr>
						...
						<td>:</td>
						<td>KELAS <?= $pendaftaran['layanan']->kelas_icare ?></td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
					...
					<tr>
						<td>&nbsp;</td>
						<td colspan="4">Tanggal Masuk Intensive Care</td>
						<td>:</td>
						<td><?= datetimefmysql($pendaftaran['layanan']->waktu_konfirmasi_icare, true) ?></td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
					...
					<tr>
						...
						<td>&nbsp;</td>
						<td>1.</td>
						<td colspan="10" rowspan="2"><div align="justify">Pasien tersebut diatas setuju untuk dilakukan perawatan intensive care di RSUD Tangerang / <em>Patieny is listed above to perform inpatient care at RSUD Tangerang.</em></div></td>
						<td>&nbsp;</td>
					</tr>
					<tr>
						<td>&nbsp;</td>
					...
					<tr>
						...
						<td>&nbsp;</td>
						<td>1.</td>
						<td colspan="10" rowspan="3"><div align="justify">Pasien diwajibkan membayar uang muka pada saat registrasi intensive care. Jumlah uang muka yang dibayar sesuai dengan kebijakan yang berlaku di RSUD Tangerang./<em> Patient is obligated to pay deposit admission. The deposite amount to be paid is in accordance with the regulations of RSUD Tangerang</em></div></td>
						<td>&nbsp;</td>
					</tr>
					<tr>
						<td>&nbsp;</td>
					...
					<tr>
						...
						<td>&nbsp;</td>
						<td>2.</td>
						<td colspan="10" rowspan="3"><div align="justify">Bila pasien belum dapat memenuhi kewajiban pembayaran deposit, maka rumah sakit memberikan tenggang waktu selama 1 x 24 jam terhitung setelah registrasi intensive care untuk menyelesaikan pembayaran uang muka./<em> If the patient could not settle the deposit upon admission, the deposit has to be settled within 24 hours after admission.</em></div></td>
						<td>&nbsp;</td>
					</tr>
					<tr>
						<td>&nbsp;</td>
