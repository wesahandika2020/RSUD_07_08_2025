		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="form-group row">
					...
					<div class="col-9">
						<input type="text" name="dokter" id="dokter-search-icare" class="select2-input" placeholder="Pilih Dokter...">
					</div>
				</div>
				<div class="form-group row tight">
						...
						<div class="widget-body">
							<div id="wizard-form">
								...
								<ol>
									...
									<li>SOAP</li>
									<li>Diagnosis</li>
									<?php if ($this->session->userdata('profesi_nadis') === 'Perawat') : ?>
										<li>Tind. Keperawatan</li>
									<?php else : ?>
										<li>Tindakan</li>
									<?php endif ?>
									<li>BHP</li>
								...
								<div class="form-info-pasien">
										...
										<div class="col-lg-6">
											<table class="table table-sm table-hover table-detail table-striped">
												...
												<tr>
													...
													<td>
														<button type="button" class="btn btn-secondary btn-xxs" id="btn-upload-file-icare"><i class="fas fa-upload m-r-5"></i>Upload File Rekam Medis</button>
													</td>
												</tr>
												<tr>
													<td></td>
									...
									<div class="row">
										<div class="col-lg-6">
											...
											<table class="table table-striped table-hover table-sm table-detail">
												<tr>
													...
													<td><span id="layanan-detail"></span> (Intensive Care)</td>
												</tr>
												<?php if ($this->session->userdata('account_group') === 'Admin' || $this->session->userdata('account_group') === 'Intensive Care') : ?>
													<tr>
														<td><b></b></td>
														<!-- <td>
												...
												<?php if ($this->session->userdata('account_group') === 'Admin') : ?>
													<tr class="tombol-waktu-rawap">
														<td><b></b></td>
														<td>
															<button type="button" class="btn btn-secondary btn-xs" title="Tombol edit waktu rawat digunakan untuk mengubah waktu masuk dan waktu keluar pasien di intensive care. Tombol ini berfungsi jika pasien masi dirawat / belum pulang" onclick="formWaktuIcare()"><i class="fa fa-edit mr-1"></i>Edit Waktu Rawat
															</button>
														</td>
													</tr>
												<?php endif ?>
												...
												<tr>
													...
													<td><b><span id="cara-bayar-detail"></span></b></td>
												</tr>
												<tr>
													<td><b>No. Polish</b></td>
										...
										<div class="col-lg-6">
											...
											<table class="table table-striped table-hover table-sm table-detail">
												<tr>
													<td width="85%">Formulir Tata Tertib Intensive Care</td>
													<td class="right">
														<button type="button" class="btn btn-secondary btn-xs" onclick="formTataTertibIntensiveCare()"><i class="fas fa-print m-r-5"></i>Print</button>
													</td>
												</tr>
											</table>
										</div>
										...
										<div class="col-lg-12">
											...
											<div class="row">
												...
												<div class="col-lg-6">
													...
													<div class="form-group tight">
														<label>Alergi</label>
														<textarea type="text" name="alergi" id="alergi" class="form-control" rows="4"></textarea>
													</div>
												</div>
											</div>
											<div class="row mt-3">
											...
											<div class="row">
												<div class="col-lg-12">
													...
													<div class="form-group row tight">
														...
														<div class="col-lg-9">
															<button type="button" class="btn btn-info" onclick="addSOAP()"><i class="fas fa-arrow-circle-down mr-1"></i>Tambah S.O.A.P</button>
														</div>
													</div>
												</div>
											</div>
									...
									<div class="row">
										<div class="col-lg-12">
											<div class="col-lg-6">
												...
												<div class="form-group row tight">
													<label for="jenis-kasus" class="col-lg-4 col-form-label-custom">Jenis Kasus</label>
													<div class="col-lg-4">
														<?= form_dropdown('jenis_kasus', array('' => 'Pilih', '1' => 'Baru', '0' => 'Lama'), array(), 'id=jenis-kasus class=custom-form') ?>
													</div>
												</div>
												...
												<div class="form-group row tight">
													<label class="col-lg-4 col-form-label-custom"></label>
													<div class="col-lg-8">
														<button type="button" title="tambah diagnosa" onclick="addDiagnosaIcare()" class="btn btn-info"><i class="fas fa-arrow-circle-down mr-2"></i>Tambah Diagnosis</button>
													</div>
												</div>
											</div>
									...
									<div class="row">
										...
										<div class="col-lg-6">
											<div class="form-group row tight">
												...
												<div class="col-lg-4">
													<?php echo form_dropdown('profesi', $profesi, array(), 'id=profesi class=custom-form') ?>
												</div>
								...
								<div class="form-laboratorium">
									<button type="button" title="order pemeriksaan lab" class="btn btn-info waves-effect" onclick="request_lab()"><i class="fas fa-plus-circle mr-1"></i>Order Pemeriksaan Laboratorium</button>
									<br /><br />
								...
								<div class="form-radiologi">
									<button type="button" title="order pemeriksaan rad" class="btn btn-info waves-effect" onclick="request_rad()"><i class="fas fa-plus-circle mr-1"></i>Order Pemeriksaan Radiologi</button>
									<br /><br />
								...
								<div class="form-hemodial-icare">
									<div class="row">
										<div class="col-md-12">
											...
											<button type="button" title="tambah order hd" class="btn btn-info waves-effect" onclick="addHemodialisisIcare()"><i class="fas fa-plus-circle mr-1"></i>Tambah Order Hemodialisis
											</button>
								...
								<!-- DPMP -->
								<div class="form-dpmp-icare">
									<div class="row">
										<div class="col-lg-12">
											<input type="hidden" name="id_dftr_dpmp" id="id-dftr-dpmp">
											<button type="button" class="btn btn-info waves-effect" onclick="addDPMPIcare()"><i class="fas fa-plus-circle mr-1"></i>Tambah Order DPMP</button>
										...
										<div class="col-md-12">
											<table class="table table-hover table-striped table-sm color-table info-table" id="table-order-operasi">
												<thead>
													<tr>
														<th width="5%" class="center">No.</th>
														<th width="50%" class="left">Tindakan Operasi</th>
...
<!-- Dialog Form Tata Tertib Intensive Care -->
<div id="modal-tata-tertib-icare" class="modal fade">
	<div class="modal-dialog" style="max-width: 50%; max-height: 100%;">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title">Cetak Form Tata Tertib Intensive Care</h4>
			...
			<div class="modal-footer">
				...
				<button type="button" class="btn btn-info" onclick="printTataTertibIntensiveCare()"><i class="fas fa-print mr-1"></i>Cetak Form Tata Tertib Intensive Care</button>
			</div>
		</div><!-- /.modal-content -->
	</div><!-- /.modal-dialog -->
</div><!-- /.modal -->