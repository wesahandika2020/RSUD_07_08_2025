					...
					<table id="table-data" class="table table-hover table-striped table-sm color-table info-table">
						<thead>
							<tr>
								...
								<th width="10%" class="wrapper left">Nama Supplier</th>
								<th width="35%" class="wrapper left">Barang</th>
								<th width="7%" class="wrapper center">Qty</th>
								<th width="7%" class="wrapper center">Unit</th>
								<th width="7%" class="wrapper center">ED</th>
								<th width="7%" class="wrapper right">Disc %</th>
								<th width="7%" class="wrapper right">Disc Rp</th>
