...
<body onload="cetak()">
	<div class="page">
		...
		<div class="center bold" style="font-size:16px">BUKTI RETUR PENERIMAAN BARANG</div>
		<br>
		<div style="width:100%; display:inline-block;">
			<div style="width:60%; float:left;">
				<table width="100%" style="white-space: nowrap;">
					<tr>
						<td width="33%">No. Faktur</td>
						<td width="2%">:</td>
		...
		<br><br>
		<table><tr><td colspan="4">Berikut daftar barang-barang yang diretur:</td></tr></table>
		<table width="100%" class="tabel-laporan">
			<thead>
				<tr>
					...
					<th width="10%" class="bold right">Disc Rp</th>
					<th width="10%" class="bold right">HPP</th>
				</tr>
			</thead>
			<tbody>
				...
				<tr>
					...
					<td class="right"><?= formatcurrency($data->diskon_rp, 'IDR') ?></td>
					<td class="right"><?= formatcurrency($data->hpp * $data->jumlah, 'IDR') ?></td>
				</tr>
				<?php $total += $data->hpp * $data->jumlah ?>
				<?php endforeach; ?>
				<tr>
		...
		<table width="100%" cellspacing="0" cellpadding="0">
			<tr valign="top">
				...
				<td width="50%" class="center">
					...
					Yang Mengembalikan<br/><br/><br/><br><br><br>...............................................<br>
				</td>
			</tr>
		</table>
	</div>
