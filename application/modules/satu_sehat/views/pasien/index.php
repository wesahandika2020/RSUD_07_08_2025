            ...
            <div class="card-body">
                <div id="wizard-pasien">
                    ...
                    <div class="status-bridging">
                        ...
                        <table id="table-satset-pasien" class="table table-hover table-striped table-sm color-table info-table m-t-5">
                            <h4 class="modal-title center"><b>INTEGRASI PASIEN</b></h4>
                            <thead>
                                <tr>
                                    <th class="center" width="5%">No.</th>
                                    <th class="left" width="20%">RM</th>
                                    <th class="left" width="25%">Nama</th>
                                    <th class="center" width="25%">NIK</th>
                        ...
                        <div class="row">
                            <div class="col">
                                <div id="pagination-pasien" class="float-left"></div>
                                <div id="summary-pasien" class="float-right text-sm"></div>
                            </div>
                        </div>
                    </div>
                    <div class="belum-bridging">
                        ...
                        <!-- <div class="table-responsive"> -->
                        <table id="table-satset-kirim-pasien" class="table table-hover table-striped table-sm color-table info-table m-t-5">
                            <h4 class="modal-title center"><b>KIRIM DATA</b></h4>
                            <thead>
                                <tr>
                                    <th class="center" width="5%">No.</th>
                                    <th class="left" width="15%">RM</th>
                                    <th class="left" width="20%">Nama</th>
                                    <th class="center" width="20%">NIK</th>
                                    <th class="center" width="20%">IHSN</th>
                        ...
                        <div class="row">
                            <div class="col">
                                <div id="kirim-pagination-pasien" class="float-left"></div>
                                <div id="kirim-summary-pasien" class="float-right text-sm"></div>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php $this->load->view('pasien/js'); ?>
<?php $this->load->view('pasien/modal_search'); ?>