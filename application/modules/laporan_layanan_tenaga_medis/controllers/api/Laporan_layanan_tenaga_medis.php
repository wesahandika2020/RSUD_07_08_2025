...
class Laporan_layanan_tenaga_medis extends REST_Controller
{
	function __construct()
	{
		...
		$this->load->model('Laporan_layanan_tenaga_medis_model', 'laporan');
	...
	function get_list_laporan_tenaga_medis_get()
	{
		if (!$this->get('page')) :
		...
		$data          = $this->laporan->getListLaporanLayananTenagaMedis($this->limit, $start, $search);
