<!-- Modal Permintaan Gizi -->
<div id="modal-permintaan-gizi" class="modal fade" style="padding: 0 10px">
    <div class="modal-dialog" style="max-width: 100%;">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="modal-permintaan-gizi-label">Form Permintaan Gizi</h4>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>
            <div class="modal-body">
            	<?php date_default_timezone_set('Asia/Jakarta'); ?>
				<?= form_open('', 'id=form-permintaan-gizi role=form class=form-horizontal') ?>
					...
					<div class="row">
						<div class="col-md-6">
							<table class="table table-striped table-sm">
								<tr>
									<td width="29%">Daftar Barang Gizi</td>
									<td width="1%">:</td>
								...
								<tr>
									...
									<td>:</td>
									<td><input type="text" class="custom-form" id="pencarian-gizi" placeholder="Ketikkan nama barang yang dicari..."></td>
								</tr>
							</table>
							<div class="table-responsive">
								<table id="table-gizi-unit" class="table table-hover table-striped table-sm color-table info-table">
									<thead>
										<tr>
						...
						<div class="col-md-6">
							<table class="table table-striped table-sm">
								<tr>
									<td width="29%">Permintaan Ke Gizi</td>
									<td width="1%">:</td>
									<td width="70%">
							...
							<div class="table-responsive">
								<table id="table-gizi-order" class="table table-hover table-striped table-sm color-table info-table">
									<thead>
										<tr>
											<th width="3%" class="center">No.</th>
											<th width="47%" class="left">Nama Barang</th>
											<th width="20%" class="left">Sisa Di <span id="unit-tujuan"></span></th>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-info waves-effect" onclick="konfirmasiSimpanPermintaanGizi()"><i class="fas fa-save mr-1"></i>Simpan</button>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
    ...
    <div class="modal-dialog" style="max-width: 550px">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-info waves-effect" onclick="getListPermintaanGizi(1)"><i class="fas fa-search mr-1"></i>Cari</button>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
