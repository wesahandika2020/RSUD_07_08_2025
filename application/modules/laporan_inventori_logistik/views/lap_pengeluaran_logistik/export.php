    ...
    <tbody>
      ...
      ?>
        <tr>
          ...
          <td class="align-left"><?= $val->logistik ?></td>
          <td class="align-left"><?= $val->satuan ?></td>
          <td class="align-center"><?= number_format($val->harga_satuan, 0, ',', '.') ?></td>
          <td class="align-left"><?= $val->pembayaran ?></td>
          <td class="align-center"><?= $val->kategori_barang ?></td>
          <td class="align-center"><?= number_format($val->qty, 0, ',', '.') ?></td>
          <td class="align-right" ><?= number_format($val->total, 0, ',', '.') ?></td>
        </tr>
      <?php endforeach ?>
    </tbody>
    <tfoot>
