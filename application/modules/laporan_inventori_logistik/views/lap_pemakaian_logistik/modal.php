	...
	<div class="modal-dialog" style="max-width:500px">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="form-group row tight">
					<label for="pembayaran_pemakaian" class="col-3 col-form-label">Pembayaran</label>
					<div class="col-md-9">
						<?= form_dropdown('pembayaran_pemakaian', $pembayaran, array(), 'id=pembayaran_pemakaian class=form-control') ?>
					</div>
				</div>
				<div class="form-group row tight">
...
<script>
	...
	function resetFormPemakaianlogistik() {
		...
		$('#kategori-pemakaian, #jenis-pasien, #pembayaran_pemakaian').val('')
