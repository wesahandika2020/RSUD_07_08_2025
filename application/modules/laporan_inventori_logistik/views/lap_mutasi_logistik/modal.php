	...
	<div class="modal-dialog" style="max-width:500px">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="form-group row tight">
					<label for="pembayaran" class="col-3 col-form-label">Pembayaran</label>
					<div class="col-md-9">
...
<script>
	...
	function getLaporanInventori(page) {
		...
		if ($('#jenis-laporan').val() == "1") {
			$('.lap-mutasi-logistik, #table-lap-mutasi-logistik tbody').show()

			$.ajax({
				type: 'GET',
				url: '<?= base_url('laporan_inventori_logistik/api/laporan_inventori_logistik/get_list_laporan_mutasi') ?>/page/' + page + '/jenis/',
				...
				success: function(data) {
					...
					$.each(data.data, function(i, v) {
						...
						$('#table-lap-mutasi-logistik tbody').append(html);
					})

					let html = /* html */ `
						<tr>
							<td colspan="3" class="right"><h6><b>Total Saldo Awal</b></h6></td>
							<td colspan="2" class="right"><h6><b>${number_format(TotalSaldoAwal, 0, ',', '.')} &ensp;</b></h6></td>
							<td colspan="6" class="right"><h6><b>Total Saldo Akhir</b></h6></td>
							<td colspan="2" class="right"><h6><b>${number_format(TotalSaldoAkhir, 0, ',', '.')} &ensp;</b></h6></td>
						</tr>
					`;

					$('#table-lap-mutasi-logistik tfoot').append(html);
				},
				complete: function() {
					hideLoader()
