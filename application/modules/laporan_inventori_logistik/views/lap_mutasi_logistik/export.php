...
<body>
  ...
  <div style="text-align: center;">
    <h4 style="text-transform: uppercase;">LAPORAN MUTASI LOGISTIK
  ...
  <table width="100%" border="1">
    <thead>
      <tr>
        ...
        <th rowspan="2" widht="20%" class="center">Nama Logistik</th>
        <th rowspan="2" widht="20%" class="center">Pembayaran</th>
        <th rowspan="2" widht="5%" class="center">Satuan</th>
        <th rowspan="2" widht="5%" class="center">Harga Satuan</th>
        <th rowspan="2" widht="5%" class="center">Kategori</th>
        <th colspan="2" class="center">Saldo Awal</th>
        <th colspan="2" class="center">Masuk</th>
        <th colspan="3" class="center">Keluar</th>
      ...
      <tr>
        ...
        <th widht="5%" class="center">Bag. Umum</th>
    ...
    <tbody>
      ...
      ?>
        ...
        <tr>
          ...
          <td valign="baseline" class="left"><?= $value->pembayaran ?></td>
          <td class="center"><?= $value->satuan ?></td>
          <td class="center"><?= number_format($value->harga_satuan, 0, ',', '.') ?></td>
    ...
    <tfoot>
      <tr>
        <td colspan="3" class="right"><b>Total Saldo Awal</b></td>
        <td colspan="2" class="right"><b><?= number_format($total_saldo_awal, 0, ',', '.') ?></b></td>
        <td colspan="6" class="right"><b>Total Saldo Akhir</b></td>
