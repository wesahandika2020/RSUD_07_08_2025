...
<div class="row">
	<div class="col-lg-12">
		<div class="card">
			...
			<?php $this->load->view('lap_mutasi_logistik/index.php') ?>
			<?php $this->load->view('lap_pengeluaran_logistik/index.php') ?>
			<?php $this->load->view('lap_pembelian_logistik/index.php') ?>
			<?php $this->load->view('lap_permintaan_logistik/index.php') ?>
			<?php $this->load->view('lap_pemakaian_logistik/index.php') ?>
...
<?php $this->load->view('lap_mutasi_logistik/modal') ?>
<?php $this->load->view('lap_pengeluaran_logistik/modal') ?>
<?php $this->load->view('lap_pembelian_logistik/modal') ?>
<?php $this->load->view('lap_permintaan_logistik/modal') ?>
<?php $this->load->view('lap_pemakaian_logistik/modal') ?>