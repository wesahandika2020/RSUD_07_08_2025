...
class Laporan_casemix extends SYAM_Controller
{
    public function __construct()
    {
        ...
        $this->load->model('Laporan_casemix_model', 'm_laporan');
        // $this->load->model('Keuangan_model', 'm_keuangan');
    }

    public function index()
    {
        $data['active']  = 'Laporan Casemix';
    ...
    public function page_laporan_casemix()
    {
    ...
    public function export_laporan_casemix()
    {
        $search = [
        ...
        $this->load->view('laporan_casemix/export.php', $data);
    }
}
