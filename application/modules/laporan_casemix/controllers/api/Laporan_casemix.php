 ...
 */
class Laporan_casemix extends REST_Controller
{
	function __construct()
	{
		...
		$this->load->model('laporan_casemix_model', 'm_lap_casemix');
	...
	function dokter_auto_get()
	{
		...
		$data = $this->m_lap_casemix->getDokter($q, $start, $this->limit);
	...
	function get_list_laporan_casemix_get()
	{
		if (!$this->get('page')) :
		...
		$data          = $this->m_lap_casemix->getListLaporanCodeBlue($this->limit, $start, $search);
	...
	function get_list_laporan_casemix_detail_get()
	{
		// var_dump($this->get('id'));die;
		if (!$this->get('id', true)) :
			$this->response(NULL, REST_Controller::HTTP_BAD_REQUEST);
		endif;
		$data = $this->m_lap_casemix->getPendaftaranDetail($this->get('id'));
		$data['diagnosa'] = $this->m_lap_casemix->getDiagnosa($this->get('id'));
		// var_dump($data);die;
