 ...
 */
class Distribusi_gizi extends REST_Controller
{
    ...
    function get_list_distribusi_gizi_get()
    {
        if (!$this->get('page')) :
	...
	function simpan_distribusi_gizi_post()
	{	
		$data = $this->distribusi->simpanDataDistribusi();
		$this->response($data, REST_Controller::HTTP_OK);
	}

	function get_data_distribusi_gizi_get()
	{
