<script>
	...
	function getListDistribusi(page) {
		...
		$.ajax({
			type: 'GET',
			url: '<?php echo base_url('distribusi_gizi/api/distribusi_gizi/get_list_distribusi_gizi') ?>/page/' + page,
	...
	function distribusiPermintaan(detail) {
		...
		$.ajax({
			type: 'GET',
			url: '<?php echo base_url('permintaan_gizi/api/permintaan_gizi/get_permintaan_gizi') ?>/id/' + data[0],
			cache: false,
			dataType: 'JSON',
			beforeSend: function() {
				showLoader()
	...
	function simpanDistribusi(page) {
		$.ajax({
			type: 'POST',
			url: '<?php echo base_url('distribusi_gizi/api/distribusi_gizi/simpan_distribusi_gizi') ?>',
	...
	function printDistribusi(id) {
		...
		window.open('<?= base_url() ?>distribusi_gizi/printing_bukti_distribusi_gizi?id=' + id,'Cetak Bukti Distribusi Barang','width='+dWidth+', height='+dHeight+', left='+x+',top='+y)
	}
</script>