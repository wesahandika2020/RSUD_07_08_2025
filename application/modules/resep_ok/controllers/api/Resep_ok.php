 ...
 */
class Resep_ok extends REST_Controller
{
    ...
    function __construct()
    {
        parent::__construct();
        $this->limit = 10;
        $this->load->model('Resep_ok_model', 'resep_ok');
    ...
    function get_list_resep_ok_get()
    {
        if (!$this->get('page')) :
        ...
        $data           = $this->resep_ok->getListDataResepOK($this->limit, $this->start($this->get('page')), $search);
