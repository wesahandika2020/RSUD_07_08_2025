<?php
	header_excel("Daftar Permintaan Makan Pasien (Order Diet) - ".$periode);
...
<body>
	...
	<div>
		<h4>
        DAFTAR PERMINTAAN MAKANAN PASIEN (ORDER DIET)
			<br>Periode : <?= $periode ?>
		...
		<tbody>
			...
			?>
				<tr>
                    ...
                    <td style="text-align: left"><?= ($v->ket_makan_pasien != null) ? $v->ket_makan_pasien : '' ?></td>
				</tr>
			<?php endforeach ?>
		</tbody>
	</table>
