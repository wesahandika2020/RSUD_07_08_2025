	...
	<div class="col-lg-12">
		<div class="card">
			...
			<div class="card-body lap-01">
				<div></div>
				<h5 style="text-transform: uppercase;" class="center"><b>DAFTAR PERMINTAAN MAKANAN PASIEN (DPMP) AHLI GIZI RUANGAN</b></h5>
			...
			<div class="card-body lap-02">
				<div></div>
				<h5 style="text-transform: uppercase;" class="center"><b>DAFTAR PERMINTAAN MAKANAN PASIEN (DPMP) DAPUR</b></h5>
			...
			<div class="card-body lap-03">
				<div></div>
				<h5 style="text-transform: uppercase;" class="center"><b>REKAPITULASI DIET</b></h5>
				<div id=label-lap-03 class="left"></div>
				<div class="row" id='table-data-03'></div>
			</div>
			<div class="card-body lap-04">
				<div></div>
				<h5 style="text-transform: uppercase;" class="center"><b>Check List Makanan Cair</b></h5>
			...
			<div class="card-body lap-05">
				<div></div>
				<h5 style="text-transform: uppercase;" class="center"><b>Daftar Diet Pasien untuk Pramusaji</b></h5>
				<div id=label-lap-05 class="left"></div>
				<div class="row" id='table-data-05'></div>
			</div>
			<div class="card-body lap-06">
				<div></div>
				<h5 style="text-transform: uppercase;" class="center"><b>DAFTAR PERMINTAAN MAKANAN PASIEN (Order Diet)</b></h5>
				<div id=label-lap-06 class="left"></div>
