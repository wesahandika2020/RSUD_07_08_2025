...
class Penerimaan_barang_gizi extends SYAM_Controller
{
    ...
    function page_penerimaan_barang_gizi()
    {
        $data['no_penerimaan'] = $this->inventori->generateNoUrutPenerimaan('Gizi');
        ...
        $data['jenis'] = 'Gizi';
        $this->load->view('penerimaan_barang_gizi/index', $data);
	}
}