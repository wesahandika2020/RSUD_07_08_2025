...
class Rekap_billing_kepeg extends SYAM_Controller 
{
    ...
    function printing_rincian_billing($id_pendaftaran = NULL, $type = NULL, $id_layanan_pendaftaran = NULL)
    {
        if ($id_pendaftaran !== NULL) :
            ...
            $view = 'rekap_billing/printing/cetak_rincian_billing';
            // if ($type === 'download') :
            //     $view = 'rekap_billing/printing/download_rincian_billing';
            // else :
            //     if ($type === 'json') :
