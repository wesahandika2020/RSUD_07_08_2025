...
<div class="tab-pane fade show active" id="monitor-antrian" role="tabpanel" aria-labelledby="monitor-antrian-tab">
    <div class="card-body" style="padding-top: 0px;">
        ...
        <div class="row" id="warp-monitor-antrian">
            <div class="col-12">
                <div class="card">
                    <div class="card-header text-center"><h3><b>ANTRIAN RAIOLOGI</b></h3></div>
        ...
        <div class="row">
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-header text-center"><h4><b>BERIKUTNYA</b></h4></div>
                    <div class="card-body bg-primary p-3 div-style-custom" id="ruang1-tunda"></div>
                </div>
            </div>
            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-header text-center"><h4><b>BERIKUTNYA</b></h4></div>
                    <div class="card-body bg-warning p-3 div-style-custom" id="ruang2a-tunda"></div>
                </div>
            </div>
            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-header text-center"><h4><b>BERIKUTNYA</b></h4></div>
                    <div class="card-body bg-primary p-3 div-style-custom" id="ruang2b-tunda"></div>
                </div>
            </div>
            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-header text-center"><h4><b>BERIKUTNYA</b></h4></div>
                    <div class="card-body bg-warning p-3 div-style-custom" id="ruang3-tunda"></div>
                </div>
            </div>
            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-header text-center"><h4><b>BERIKUTNYA</b></h4></div>
                    <div class="card-body bg-primary p-3 div-style-custom" id="ruang4-tunda"></div>
                </div>
            </div>
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-header text-center"><h4><b>BERIKUTNYA</b></h4></div>
                    <div class="card-body bg-warning p-3 div-style-custom" id="ruang5-tunda"></div>
                </div>
            </div>
        </div>
    </div>
