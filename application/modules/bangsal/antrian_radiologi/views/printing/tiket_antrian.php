        ...
        <table width="100%">
            ...
            <tr>
                <td class="center" style="padding-left: 2%;">
                    <b>Radiologi - <?= $admisi->ruang_radiologi ?></b><br />
                    <b><?= $admisi->id_pasien ?> -  <?= $admisi->nama_pasien ?></b><br />
                    Mohon menunjukan No. Antrian <br />
                    Anda kepada petugas

                    <p style="margin:0px; font-size:6pt; text-transform: capitalize">Tgl Antrian : <?= $admisi->created_date2 ?> <br />
                    Tgl Cetak : <?= date('d/m/Y H:i') ?> </p>
                </td>
            </tr>
        </table>
    </div>
