...
class Vclaim_bpjs_v2 extends SYAM_Controller
{
    ...
    {   
        ...
        if ($output !== '') :
            if (($decode !== null) && ($decode->metaData->code === '200')) :
                ...
                echo $decode->metaData->message ?? "Data tidak ditemukan, pastikan No SEP '$no_sep' sesuai. Silahkan hubungin bagian Pendaftaran untuk mengecek No SEP Pasien.";
            endif;
        else :
            echo "timeout";
        endif;
