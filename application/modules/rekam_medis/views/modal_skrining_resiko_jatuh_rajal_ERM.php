        ...
        success: function(data) {
            if (data.status) {
                ...
                window.open(
                    ...
                    id,
                    'Cetak Skrining Resiko Jatuh Rawat Jalan', 'width=' + dWidth +
                    ', height=' +
                    dHeight + ', left=' +
                    x + ', top=' + y);
            } else {
                                ...
                                <div class="form-modal-skrining-resiko-jatuh-rajal">
                                    <table class="table table-no-border table-sm table-striped">
                                        ...
                                        <tbody id="check">
                                            ...
                                            <tr>
                                                <td width="1%">6.</td>
                                                <td width="20%">Pasien Jadal Opeasi rawat Jalan <i>One day care</i>
                                                    (ODC)</td>
                                                <td width="10%" align="center">
                                            ...
                                            <tr>
                                                <td width="1%">12.</td>
                                                <td width="20%">Pasien ganggua penglihatan</td>
                                                <td width="10%" align="center">
