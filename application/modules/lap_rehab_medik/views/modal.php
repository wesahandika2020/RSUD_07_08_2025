<!-- Modal Search -->
<div id="rehab-medik-search" class="modal fade" data-backdrop="static" role="dialog" aria-labelledby="rehab-medik-search-label" aria-hidden="true">
	<div class="modal-dialog" style="max-width:500px">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title" id="rehab-medik-search-label">Form Pencarian Lap. Rehab Medik</h4>
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
			</div>
			<div class="modal-body">
				<?= form_open('', 'id=form-search-rehab-medik role=form class=form-horizontal') ?>
				...
				<div class="form-group row tight">
					<label for="dokter_search" class="col-md-3 col-form-label">Operator</label>
					<div class="col-md-9">
						<input type="text" name="id_dokter" id="dokter_search" class="select2-input" placeholder="Semua Dokter / Petugas">
					</div>
				</div>
			...
			<div class="modal-footer">
				...
				<button type="button" class="btn btn-info waves-effect" onclick="getLaporanRehabMedik(1)"><i class="fas fa-paper-plane mr-1"></i> Tampilkan</button>
			</div>
		</div>
		<!-- /.modal-content -->
	</div>
