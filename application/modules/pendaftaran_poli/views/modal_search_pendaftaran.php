        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
				...
				<!-- <div class="form-group row tight">
                    ...
                    <div class="col">
                        <input type="text" name="cara_bayar" id="carabayar_search" class="form-control">
                    </div>
                </div> -->
                <div class="form-group row tight">
                ...
                <div class="form-group row tight">
                    <label for="user_search_poli" class="col-3 col-form-label">Petugas</label>
                    <div class="col">
                        <input type="text" name="user" id="user_search_poli" class="form-control">
                    </div>
                </div>
                <?= form_close() ?>
            </div>
