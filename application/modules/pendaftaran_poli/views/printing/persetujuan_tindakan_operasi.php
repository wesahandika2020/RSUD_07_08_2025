            ...
            <div class="persetujuan__tindakan__anestesi__container container">
                <table class="big__line__spacing small__font">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="no__border" colspan="3">Tangerang, Tanggal <b><?= date("d/m/Y H:i", strtotime($persetujuan_tindakan_operasi->updated_on)); ?></b>, Pukul <b><?php echo @date('H:i'); ?></b></td>
                        </tr>
                        <tr>
