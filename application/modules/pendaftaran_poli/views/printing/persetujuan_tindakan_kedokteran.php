            ...
            <div class="persetujuan__tindakan__anestesi__container container">
                <table class="big__line__spacing small__font">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="no__border" colspan="3">Tangerang, Tanggal <b><?= date("d/m/Y H:i", strtotime($persetujuan_tindakan_kedokteran->updated_on)); ?></b>, Pukul <b><?php echo @date('H:i'); ?></b></td>
                        </tr>
                        <tr>
                            ...
                            <td class="no__border" width="25%" align="center">Saksi 1 <br> <br> <br>(<b><?= $persetujuan_tindakan_kedokteran->nama_saksi_1; ?></b>) <br> <font size="1rem">Nama jelas dan tanda tangan</font></td>
                            <td class="no__border" width="25%" align="center">Saksi 2 <br> <br> <br>(<b><?= $persetujuan_tindakan_kedokteran->nama_saksi_2; ?></b>) <br> <font size="1rem">Nama jelas dan tanda tangan</font></td>
                        </tr>
                    </tbody>
                </table>
            </div>
