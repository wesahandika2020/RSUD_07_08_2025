    ...
    <div class="modal-dialog" style="max-width: 500px">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-info waves-effect" onclick="getListPemakaianBarangGizi(1)"><i class="fas fa-search mr-1"></i>Cari</button>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
...
<!-- Modal Pemakaian Barang Gizi -->
<div id="modal-pemakaian-barang-gizi" class="modal fade" role="dialog">
    <div class="modal-dialog" style="max-width: 50%">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="modal-pemakaian-barang-gizi-label">Form Pemakaian Barang Gizi</h4>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>
            <div class="modal-body">
                <?= form_open('', 'id=form-pemakaian-barang-gizi role=form class=form-horizontal') ?>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary waves-effect" data-dismiss="modal"><i class="fas fa-times-circle mr-1"></i>Keluar</button>
                <button type="button" class="btn btn-info waves-effect" onclick="simpanPemakaianBarangGizi()"><i class="fas fa-save mr-1"></i>Simpan</button>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
...
<!-- End Modal Pemakaian Barang Gizi -->