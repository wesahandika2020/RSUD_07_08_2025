<script>
	...
	function addNewRows(id_barang, nama_barang, jumlah, id_kemasan, pembayaran, keterangan) {
		...
		$.ajax({
            url: '<?= base_url('inventori_rt/api/inventori_rt/get_detail_harga_barang_pemesanan') ?>?id=' + id_barang + '&id_kemasan=' + id_kemasan,
            dataType: 'JSON',
            cache: false,
	...
	function simpanPenerimaan() {
		...
		$.ajax({
			type: 'POST',
			url: '<?= base_url("inventori_rt/api/inventori_rt/simpan_penerimaan") ?>' + update,
	...
	function showDetailPenerimaan(id_penerimaan) {
		$.ajax({
			type: 'GET',
			url: '<?= base_url('inventori_rt/api/inventori_rt/get_detail_penerimaan') ?>/id/' + id_penerimaan,
			cache: false,
			dataType: 'JSON',
			beforeSend: function() {
				showLoader()
	...
	function deleteDetailPenerimaan(id, el) {
		swal.fire({
			...
			if (result.value) {
				$.ajax({
					type: 'DELETE',
					url: '<?= base_url("inventori_rt/api/inventori_rt/delete_detail_penerimaan") ?>' + '/id/' + id,
					cache: false,
					dataType: 'JSON',
					beforeSend: function() {
						showLoader()
