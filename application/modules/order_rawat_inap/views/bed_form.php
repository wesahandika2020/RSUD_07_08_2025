								...
								<table class="table	table-striped table-hover table-sm">
									<tbody>
										<tr>
											...
											<td width="1%">:</td>
											<td width="69%"><span class="nama-ranap-label"></span></td>
										</tr>
										<tr>
											<td><b>No. RM</b></td>
											<td>:</td>
											<td><span class="no-rm-ranap-label"></span></td>
										</tr>
										<tr>
											<td><b>Kelamin</b></td>
											<td>:</td>
											<td><span class="kelamin-ranap-label"></span></td>
										</tr>
									</tbody>
								</table>
							</div>
								...
								<table class="table	table-striped table-hover table-sm">
									<tbody>
										<tr>
											...
											<td width="1%">:</td>
											<td width="69%"><span class="layanan-ranap-label"></span></td>
										</tr>
										<tr>
											<td><b>Cara Bayar</b></td>
											<td>:</td>
											<td><span class="cara-bayar-ranap-label"></span></td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td>:</td>
											<td><span class="bangsal-tujuan-ranap-label"></span></td>
										</tr>
									</tbody>
								</table>
							</div>
		...
		$.each(data.kelas, function(i, value) {
			...
			$.each(value, function(j, value2) {
				...
				$.each(value2, function(k, value3) {
					...
					let keteranganRuang = value3.keterangan_ruang;
