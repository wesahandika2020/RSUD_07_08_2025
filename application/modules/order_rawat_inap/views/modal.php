    ...
    <div class="modal-dialog" style="max-width: 45%">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-info waves-effect" onclick="getListDataOrderRawatInap(1)"><i class="fas fa-search mr-1"></i>Cari</button>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
...
<!-- Modal Batal Order Rawat Inap -->
<div id="modal-batal-order-rawat-inap" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Pembatalan Order Rawat Inap</h4>
                <button type="button" class="close" data-dismiss="modal">×</button>
            </div>
            <div class="modal-body">
				<?= form_open('', 'role=form class=form-horizontal id=form-batal-order-rawat-inap'); ?>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-info waves-effect" onclick="simpanPembatalanOrderRawatInap()"><i class="fas fa-check-circle mr-1"></i>Batalkan Order</button>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
...
<!-- End Modal Batal Order Rawat Inap -->
...
<div id="modal-konfirmasi-bed" class="modal fade">
	<div class="modal-dialog" style="max-width: 45%;">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title" id="title-konfirmasi-bed">Konfirmasi Masuk Ruang Rawat Inap</h4>
				<button type="button" class="close" data-dismiss="modal">x</button>
			</div>
			<div class="modal-body">
				<?= form_open('', 'id=form-rawat-inap class=form-horizontal role=form') ?>
					<input type="hidden" name="id_order" id="id-order-ranap">
					<input type="hidden" name="kelamin" id="kelamin">
					<input type="hidden" name="id_pendaftaran" id="id-pendaftaran-ranap">
					...
					<p>Pasien dengan No. Rekam Medik <b class="no-rm-ranap-label"></b> atas nama <b class="nama-ranap-label"></b> akan masuk rawat inap <b class="bed-ranap-detail"></b></p>
				<?= form_close() ?>
			</div>
			<div class="modal-footer">
				<button type="button" class="btn btn-secondary" data-dismiss="modal"><i class="fas fa-times-circle mr-1"></i>Batal</button>
				<button type="button" class="btn btn-info" onclick="sendRawatInap()"><i class="fas fa-paper-plane mr-1"></i>Send</button>
			</div>
		</div>
	</div>
</div>
