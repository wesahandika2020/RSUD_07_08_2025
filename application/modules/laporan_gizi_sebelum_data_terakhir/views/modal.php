		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="form-group row tight">
					<label for="periode-laporan" class="col-md-3 col-form-label">Waktu DPMP</label>
					<div class="col-md-9">
                ...
                <div class="form-group row tight">
					<label for="jenis-diet" class="col-md-3 col-form-label">Jenis Diet</label>
					<div class="col-md-9">
						<?= form_dropdown('jenis_diet', $jenis_diet, array(), 'id=jenis-diet class=form-control') ?>
					</div>
				</div>
				<div class="form-group row tight">
				...
				<div class="form-group row tight">
					<label for="ruangan-ranap" class="col-md-3 col-form-label">Ruangan</label>
					<div class="col-md-9">
						<?= form_dropdown('ruangan_ranap', $ruangan_ranap, array(), 'id=ruangan-ranap class=form-control') ?>
					</div>
				</div>
					<div class="form-group row tight">
						<label for="ruangan-ic" class="col-md-3 col-form-label">Ruangan</label>
					<div class="col-md-9">
						<?= form_dropdown('ruangan_ic', $ruangan_ic, array(), 'id=ruangan-ic class=form-control') ?>
					</div>
				</div>
			...
			<div class="modal-footer">
				...
				<button type="button" class="btn btn-info waves-effect" onclick="getLaporanGizi(1)"><i class="fas fa-paper-plane mr-1"></i> Tampilkan</button>
			</div>
		</div>
		<!-- /.modal-content -->
	</div>
