...
<body onload="window.print()">
	...
	<!--=============== MAIN ===============-->
	<main class="main">
		<div class="formulir__bimroh__pasien__khusus container">
            <td><br><br><br></td>
			<h2 class="section__title">FORMULIR PENDAMPINGAN SPIRITUAL PASIEN KHUSUS</h2>
            <td><br></td>
			<table class="no__border big__line__spacing small__font">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="no__border" colspan="3">: <b><?= (date("d/m/Y H:i", strtotime($bimbingan_rohani_khusus->waktu_konfirmasi))); ?></b></td>
                    </tr>
                    <tr>
                        <td class="no__border" colspan="2" width="20%">Kondisi Pasien</td>
                        <td class="no__border" colspan="3">: <b><?= $bimbingan_rohani_khusus->kondisi_pasien; ?></b></td>
                    </tr>
                    <tr>
                        <td class="no__border" colspan="2" width="20%">Diagnosa Spiritual</td>
                        <td class="no__border" colspan="3">: <b><?= $bimbingan_rohani_khusus->diagnosa_spiritual; ?></b></td>
                    </tr>
                    <tr>
                        <td class="no__border" colspan="2" width="20%">Terapi/Tindak Lanjut</td>
                        <td class="no__border" colspan="3">: <b><?= $bimbingan_rohani_khusus->terapi_tindak_lanjut; ?></b></td>
                    </tr>
                    <tr>
            ...
            <tbody>
                <tr>
                    <td class="no__border" width="30%" align="center">Perawat Ruangan<br> <br> <br>(<b style="text-transform:uppercase"><?= $bimbingan_rohani_khusus->nama_perawat;?></b>) <br> <font size="1rem">Nama jelas dan tanda tangan</font></td>
