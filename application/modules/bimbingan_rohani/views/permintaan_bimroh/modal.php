<!-- Modal Tindak Lanjut -->
<div id="modal-konfirm-bimroh" class="modal fade" role="dialog">
    <div class="modal-dialog" style="max-width:80%">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Form Konfirmasi Bimbingan Rohani</h4>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>
            <div class="modal-body">
                <?= form_open('', 'id=form-konfirm-bimroh1 role=form class=form-horizontal') ?>
                <input type="hidden" name="id_layanan_pendaftaran" id="id-layanan-pendaftaran-kb">
                <div class="row">
                    <div class="col-md-6">
                        <table class="table table-no-border table-striped table-hover table-sm color-table info-table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td width="1%">:</td>
                                    <td width="69%"><span id="tanggal-detail"></span></td>
                                </tr>
                                <tr>
                                    <td width="30%"><strong>No. RM</strong></td>
                                    <td width="1%">:</td>
                                    <td width="69%"><span id="no-rm-bimroh-detail"></span></td>
                                </tr>
                                <tr>
                                    <td><strong>Nama</strong></td>
                                    <td>:</td>
                                    <td><span id="nama-bimroh-detail"></span></td>
                                </tr>
                                <tr>
                                    <td><strong>Kelamin</strong></td>
                                    <td>:</td>
                                    <td><span id="kelamin-bimroh-detail"></span></td>
                                </tr>
                                <tr>
                                    <td><strong>Umur / Tgl Lahir</strong></td>
                                    <td>:</td>
                                    <td><span id="umur-bimroh-detail"></span></td>
                                </tr>
                                <tr>
                                    <td><strong>Asal Kamar</strong></td>
                                    <td>:</td>
                                    <td><span id="kamar-bimroh-detail"></span></td>
                                </tr>
                                <tr>
                                    <td><strong>Kondisi Pasien</strong></td>
                                    <td>:</td>
                                    <td><span id="kondisi-pasien-detail"></span></td>
                                </tr>     
                                <tr>
                                    <td><strong>Diagnosa Spiritual</strong></td>
                                    <td>:</td>
                                    <td><span id="diagnosa-bimroh-detail"></span></td>
                                </tr>
                                <tr>
                                    <td><strong>Terapi/Tindak Lanjut</strong></td>
                                    <td>:</td>
                                    <td><span id="tindak-lanjut-detail"></span></td>
                                </tr>              
                            </tbody>
                        </table>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="form-group row tight">
                            <label for="alasan-dibatalkan-bimroh" class="col-md-3 col-form-label right">Alasan Dibatalkan Bimbingan Rohani:</label>
                            <div class="col-md-9">
                                <textarea name="alasan_pembatalan" id="alasan-dibatalkan-bimroh" rows="3" class="form-control" placeholder="Alasan Dibatalkan Bimbingan Rohani"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-info waves-effect" onclick="konfirmasiPermintaanBimroh()"><i class="fas fa-save mr-1"></i>Confirm</button>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group row tight">
                    ...
                    <div class="col">
                        <input type="text" name="no_rm" id="no-rm-search-pb" class="form-control">
                    </div>
                </div>
                <div class="form-group row tight">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-info waves-effect" onclick="getListPermintaanBimroh(1)"><i class="fas fa-search"></i> Cari</button>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
