 ...
 */
class Laporan_inventori_gizi extends REST_Controller
{
	...
	{ //laporan mutasi gizi
		...
		$data          = $this->laporan->getListDataMutasiGiziNEW((int)$this->limit, (int)$start, $search);
	...
	{ //laporan pembelian gizi
		...
		$data          = $this->laporan->getListLaporanPembelianGizi((int)$this->limit, (int)$start, $search);
		$data['page']  = (int) $this->get('page');
		$data['limit'] = (int)$this->limit;
	...
	{ //laporan permintaan gizi
		...
		$data          = $this->laporan->getListLaporanPermintaanGizi((int)$this->limit, (int)$start, $search);
		$data['page']  = (int) $this->get('page');
		$data['limit'] = (int)$this->limit;
	...
	{ //laporan pemakaian gizi
		...
		$data          = $this->laporan->getListLaporanPemakaianGizi((int)$this->limit, (int)$start, $search);
		$data['page']  = (int) $this->get('page');
		$data['limit'] = (int)$this->limit;
