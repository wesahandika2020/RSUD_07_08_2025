				...
				success: function(data) {
					...
					$.each(data.data, function (i, v) {
						let html = /* html */ `
							<tr>
								...
								<td class="right">${number_format(v.awal, 0, ',', '.')}</td>
								<td class="right saldo-awal-rp">${number_format(v.awal*v.harga_satuan, 0, ',', '.')}</td>
								<td class="right">${number_format(v.masuk, 0, ',', '.')}</td>
								<td class="right penerimaan-rp">${number_format(v.masuk*v.harga_satuan, 0, ',', '.')}</td>
								<td class="right">${number_format(v.keluar, 0, ',', '.')}</td>
								<td class="right pengeluaran-rp">${number_format(v.keluar*v.harga_satuan, 0, ',', '.')}</td>
								<td class="right">${number_format(v.sisa, 0, ',', '.')}</td>
								<td class="right saldo-akhir-rp">${number_format(v.sisa*v.harga_satuan, 0, ',', '.')}</td>
					...
					let html2 = /* html */ `
						<tr>
							...
							<th class="right" colspan="2">${number_format(TotalSaldoAwalRP, 0, ',', '.')}</th>
							<th class="right" colspan="2">${number_format(TotalPenerimaanRP, 0, ',', '.')}</th>
							<th class="right" colspan="2">${number_format(TotalPengeluaranRP, 0, ',', '.')}</th>
							<th class="right" colspan="2">${number_format(TotalSaldoAkhirRP, 0, ',', '.')}</th>
							<th></th>
						</tr>
					`;
