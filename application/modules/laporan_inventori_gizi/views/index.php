...
<div class="row">
	<div class="col-lg-12">
		<div class="card">
			...
			<?php $this->load->view('lap_mutasi_gizi/index.php') ?>
			<?php $this->load->view('lap_pengeluaran_gizi/index.php') ?>
			<?php $this->load->view('lap_pembelian_gizi/index.php') ?>
			<?php $this->load->view('lap_permintaan_gizi/index.php') ?>
			<?php $this->load->view('lap_pemakaian_gizi/index.php') ?>
...
<?php $this->load->view('lap_mutasi_gizi/modal') ?>
<?php $this->load->view('lap_pengeluaran_gizi/modal') ?>
<?php $this->load->view('lap_pembelian_gizi/modal') ?>
<?php $this->load->view('lap_permintaan_gizi/modal') ?>
<?php $this->load->view('lap_pemakaian_gizi/modal') ?>