            ...
            <div class="card-body">
                <div class="row">
                    <div class="col d-flex justify-content-start">
                        <?= form_button('filter', '<i class="fas fa-plus-circle mr-1"></i>Filter', 'id=cek-dashboard-tanggal class="btn btn-info waves-effect mr-1"') ?>
                        <?= form_button('reset', '<i class="fas fa-sync-alt mr-1"></i>Reload Data', 'id=btn-reload class="btn btn-secondary waves-effect"') ?>
                    </div>
                </div>

                <!-- <div class="table-responsive"> -->
                    <table id="table-dashboard-tanggal" class="table table-hover table-striped table-sm color-table info-table m-t-5">
                        <h4 class="modal-title float-right" id="tanggal-dashboard-label"></h4>
                        <h4 class="modal-title center"><b>DASHBOARD PER TANGGAL</b></h4>
                        <thead>
                            <tr>
