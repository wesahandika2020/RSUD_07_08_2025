        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table id="table_tindpk" class="table table-hover table-striped table-sm color-table info-table m-t-5">
                        <thead>
                            <tr>
...
<?php $this->load->view('pk/js.php'); ?>
<?php $this->load->view('pk/modal_labpk'); ?>
<?php $this->load->view('pk/modal_labpk_input'); ?>