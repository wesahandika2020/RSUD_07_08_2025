<script>
	$(function() {
		...
		$('#barang-auto').select2({
            ...
            formatSelection: function(data){
                $.getJSON('<?= base_url('inventori_gizi/api/inventori_gizi/get_ed_barang') ?>?id_barang='+data.id, function(data){
                	$('#ed').html('')
                    if (data === null) {
		...
		$('#ed').change(function() {
			...
			$.ajax({
				type: 'GET',
				url: '<?php echo base_url('inventori_gizi/api/inventori_gizi/sisa_barang_koreksi_stok') ?>',
	...
	function getListStokGizi(page, id_koreksi_stok) {
		var id = '';
		...
		$.ajax({
			type: 'GET',
			url: '<?php echo base_url('koreksi_stok_gizi/api/koreksi_stok_gizi/get_list_stok_gizi/page/') ?>' + page + '/id/' + id ,
	...
	function cekTanggalTerima(id_barang, ed){
		...
		$.ajax({
				type: 'GET',
				url: '<?php echo base_url('koreksi_stok_gizi/api/koreksi_stok_gizi/cek_stok_gizi') ?>',
				data: 'id_barang=' + id_barang + '&ed=' + ed,
				dataType: 'JSON',
				success: function(data) {
	...
	function cekExpired(id){
		...
		$.ajax({
				type: 'GET',
				url: '<?php echo base_url('koreksi_stok_gizi/api/koreksi_stok_gizi/cek_expired') ?>',
				data: 'id=' + id,
				dataType: 'JSON',
				success: function(data) {
            ...
            buttons: {
                ...
                konfirmasi: {
                    ...
                    callback: function() {
						...
						$.ajax({
							type: 'POST',
							url: '<?php echo base_url('koreksi_stok_gizi/api/koreksi_stok_gizi/simpan_koreksi_stok_gizi') ?>',
	...
	function cetakKoreksiStok() {
        ...
        window.open('<?php echo base_url() ?>koreksi_stok_gizi/printing_koreksi_stok_gizi/'+kategori,'Cetak Lembar Koreksi Stok','width='+dWidth+', height='+dHeight+', left='+x+',top='+y)
	}

	function cetakExcelKoreksiStok() {
		location.href = '<?php echo base_url('koreksi_stok_gizi/export_koreksi_stok_gizi') ?>?' + $('#form-search').serialize()
	}
</script>