            ...
            <div class="card-body">
                <div class="row">
                    <div class="col d-flex justify-content-start">
                        <?= form_button('tambah', '<i class="fas fa-plus-circle mr-1"></i>Tambah Kelas', 'id=btn-tambah class="btn btn-info waves-effect mr-1"') ?>
                    ...
                    <div class="col d-flex justify-content-end">
                        <div class="custom-search">
                            <input type="text" class="search-query-white" onkeyup="getListKelas(1)" id="keyword" placeholder="Pencarian ...">
