			...
			<div class="page page_break">
				...
				<table width="100%" class="td-top">
					...
					<?php
						...
						if(isset($diagnosa->diagnosis)){

		                    $sebab_sakit_lain = $diagnosa->diagnosis;

		                } else {

		                    $s_sebab = substr($diagnosa->sebab_sakit,0,100);
				...
				<table width="100%" cellspacing="0" cellpadding="0" class="tabel-hasil" id="tabel-cetak-lab" style="font-size: 12px; border: solid 1px;">
					<tr>
						<th width="25%" style="padding-bottom:10px;padding-left:20px;padding-top:10px;border: solid 1px;">JENIS PEMERIKSAAN</th>
					...
					<tr>
						<td style="padding-bottom:10px;border-left: solid 1px;"></td>
						<td></td>
						<td></td>
						<td></td>
						<td></td>
					...
					foreach ($byGroup as $key => $value) : ?>
						...
						<tr>
							<td style="padding-top:10px;padding-bottom:10px;padding-left:40px;font-weight: bold;border-left: solid 1px;"><?= $key ?></td>
							<td></td>
							<td></td>
							<td></td>
							<td></td>
								...
								<tr>		
									...
									<?php 	foreach ($f['nama'] as $g => $h){ 
											...
											?>
													...
													<td style="padding-bottom:10px;padding-top:10px;font-weight: bold;padding-left:80px;border: solid 1px;"><?= $h->nama ?></td>
									...
									<?php 	} 
										...
										if ($f['flag'] === 'N' | $f['flag'] === '') {
											...
											$flag = '<td align="center" style="border: solid 1px;"></td>';

										} else {
											
											$flag = '<td align="center" style="color:red;border: solid 1px;">' . $f['flag'] . '</td>';
										} 
