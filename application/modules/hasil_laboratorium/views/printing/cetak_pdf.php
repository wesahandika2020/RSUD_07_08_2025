...
<?php
    ...
    $ch = curl_init();
        curl_setopt_array($ch, array(
            CURLOPT_URL => 'https://10.10.10.11/'.$noRm->id_pasien.'_'.$ono.'.pdf',
            CURLOPT_RETURNTRANSFER => true,
            CURLOPT_USERAGENT => 'Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US; rv:1.8.1.13) Gecko/20080311 Firefox/2.0.0.13',
            CURLOPT_ENCODING => "",
            CURLOPT_MAXREDIRS => 10,
...
<embed type="application/pdf" src="https://10.10.10.11/rsud/<?php echo $noRm->id_pasien.'_'.$ono.'.pdf'; ?>" width="1000" height="2000"></embed>

<?php } else if($response_getinfo === 404) {

        $cekCh = curl_init();
        curl_setopt_array($cekCh, array(
            CURLOPT_URL => 'https://10.10.10.11/rsud/'.$ono.'.pdf',
            CURLOPT_RETURNTRANSFER => true,
            CURLOPT_USERAGENT => 'Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US; rv:1.8.1.13) Gecko/20080311 Firefox/2.0.0.13',
            CURLOPT_ENCODING => "",
            CURLOPT_MAXREDIRS => 10,
        ...
        ?>
            ...
            <embed type="application/pdf" src="https://10.10.10.11/rsud/<?php echo $ono.'.pdf'; ?>" width="1000" height="2000"></embed>
    ...
    echo "File format PDF belum Tersedia di server SIMRS, harap ulangi berkala!";
