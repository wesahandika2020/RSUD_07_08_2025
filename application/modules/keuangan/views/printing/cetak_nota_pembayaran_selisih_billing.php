  ...
  <div class="page">
      ...
      <div style="width:50%; float:right;">
        <table width="100%" style="white-space: nowrap;">
          ...
          <tr>
            ...
            <td>:</td>
            <td><?= $pembayaran_selisih_billing->metode_bayar ?></td>
          </tr>
        </table>
      </div>
    </div>
    ...
    <table width="100%" class="tabel-laporan">
      ...
      <tbody>
        ...
        <tr>
          <td style="padding-left:20px;">Pembayaran Selisih Billing Pasien</td>
          <td><?= $pembayaran_selisih_billing->petugas ?></td>
          <td class="right"><?= currency($pembayaran_selisih_billing->nominal) ?></td>
          <td class="right"><?= currency($pembayaran_selisih_billing->nominal) ?></td>
        </tr>
        <?php if (!empty($pembayaran_selisih_billing->keterangan)) : ?>
          <tr>
            <td colspan="4" style="padding-left:20px; font-style: italic; font-size: 8pt; font-weight: bold;">Keterangan: <?= $pembayaran_selisih_billing->keterangan ?></td>
          </tr>
        <?php endif; ?>
        <!-- ?php endforeach; ? -->
        ...
        <tr>
          ...
          <td align="right" colspan="2" class="topborder" style="font-weight:bold;"><?= currency($total_bayar) ?></td>
        </tr>
        <?php if (($history_pembayaran->id_penjamin !== null) & ($history_pembayaran->tunai > 0)) : ?>
          <tr>
            <!-- <td colspan="3"></td> -->
            <td colspan="2" align="right">Iur Bayar (Rp) : </td>
            <td colspan="2" align="right" style="font-weight:bold;"><?= currency($history_pembayaran->tunai) ?></td>
          </tr>
          <tr>
            <!-- <td></td> -->
            <td colspan="2" align="right">Ditanggung Asuransi (Rp) : </td>
            <td colspan="2" align="right" style="font-weight:bold;"><?= currency($history_pembayaran->non_tunai) ?></td>
          </tr>
        <?php endif; ?>
        ...
        <tr>
          ...
          <td align="right" colspan="2" class="topborder" style="font-weight:bold;">
