  ...
  <div class="page">
      ...
      <div style="width:50%; float:right;">
        <table width="100%" style="white-space: nowrap;">
          ...
          <tr>
						...
						<td>:</td>
						<td><?= $pembayaran_lain->metode_bayar ?></td>
					</tr>
        </table>
      </div>
    </div>
    ...
    <table width="100%" class="tabel-laporan">
      ...
      <tbody>
        ...
        <tr>
          <td style="padding-left:20px;"><?= $pembayaran_lain->tarif ?></td>
          <td><?= $pembayaran_lain->petugas ?></td>
          <td class="right"><?= currency($pembayaran_lain->total/$pembayaran_lain->jumlah) ?></td>
          <td class="center"><?= $pembayaran_lain->jumlah ?></td>
          <td class="right"><?= currency($pembayaran_lain->total) ?></td>
        </tr>
        <!-- ?php endforeach; ? -->
        ...
        <tr>
          ...
          <td align="right" colspan="3" class="topborder">Tagihan (Rp) : </td>
        ...
        <tr>
          <!-- <td colspan="3"></td> -->
          <td colspan="3" align="right">Iur Bayar (Rp) : </td>
          <td colspan="2" align="right" style="font-weight:bold;"><?= currency($history_pembayaran->tunai) ?></td>
        </tr>
        <tr>
          <!-- <td></td> -->
          <td colspan="3" align="right">Ditanggung Asuransi (Rp) : </td>
