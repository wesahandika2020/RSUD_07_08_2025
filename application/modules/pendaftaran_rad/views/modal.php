    ...
    <div class="modal-dialog" style="max-width: 650px">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group row tight">
                    <label for="user_search_rad" class="col-3 col-form-label">Petugas</label>
                    <div class="col">
                        <input type="text" name="user" id="user_search_rad" class="form-control">
                    </div>
                </div>
				<div class="form-group row tight">
    ...
    <div class="modal-dialog modal-dialog-scrollable" style="max-width: 95%">
        <div class="modal-content">
            ...
            <div class="modal-body bg-default">
                ...
                <input type="hidden" name="jenis_pendaftaran" id="jenis-pendaftaran" value="Radiologi">
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        ...
                        <table class="table-no-border">
                            <tr>
                                <td><button type="button" class="btn btn-info" onclick="orderRad()"><i class="fa fa-paper-plane mr-1"></i>Order Radiologi</button></td>
                            </tr>
                        </table>
                    </div>
                </div>
