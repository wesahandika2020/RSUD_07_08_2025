    ...
    <div class="modal-dialog modal-dialog-scrollable" style="max-width: 95%">
        <div class="modal-content">
            ...
            <div class="modal-body bg-default">
                ...
                <input type="hidden" name="jenis_pendaftaran" id="jenis-pendaftaran" value="Fisioterapi">
                <!-- End ID Hidden -->
                            ...
                            <li class="list-group-item border-theme">
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <div class="form-group row tight">
                                            <label for="no-rm" class="col-3 col-form-label">No RM</label>
                                            <div class="col">
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        ...
                        <table class="table-no-border">
                            <tr>
                                <td><button type="button" class="btn btn-info" onclick="requestFisioterapi()"><i class="fa fa-paper-plane mr-1"></i>Order Fisioterapi</button></td>
                            </tr>
                        </table>
                    </div>
                </div>
