...
?>
    <div class="page page_break">
        <table width="100%">
            <tr>
                <td width="12%" class="center"><img src="<?= resource_url() ?>images/logos/<?= $val['hospital']->logo ?>" width="80px" height="80px"></td>
                <td width="43%">
                    <b class="bold" style="font-size: 16pt;"><?= strtoupper($val['hospital']->nama) ?></b><br>
                    <b class="bold" style="font-size: 9pt;"><?= strtoupper($val['hospital']->alamat) ?></b><br>
                    <b class="bold" style="font-size: 10pt;">Telp. <?= $val['hospital']->telp ?>, FAX. <?= $val['hospital']->fax ?> Email : <?= $val['hospital']->email ?></b>
                </td>
                <td width="45%">
                    <div class="box-identitas">
                        <table width="100%">
                            <tr>
                                <td>Nama</td>
                                <td>:</td>
                                <td class="bold"><?= $val['pasien']->nama; ?></td>
                            </tr>
                            <tr>
                                <td>Tgl Lahir</td>
                                <td>:</td>
                                <td class="bold"><?= ($val['pasien']->tanggal_lahir !== '' ? datefmysql($val['pasien']->tanggal_lahir) : '-') ?> (<?= createUmur($val['pasien']->tanggal_lahir) ?> Tahun)</td>
                            </tr>
                            <tr>
                                <td>Agama</td>
                                <td>:</td>
                                <td class="bold"><?= $val['pasien']->agama; ?></td>
                            </tr>
                            <tr>
                                <td width="30%">No. RM</td>
                                <td width="1%">:</td>
                                <td width="69%" class="bold"><?= $val['pasien']->no_rm; ?></td>
                            </tr>
                            <tr>
                                <td>Ruang Rawat / Kelas</td>
                                <td>:</td>
                                <td class="bold"><?= ($val['layanan']->layanan !== null ? $val['layanan']->layanan : $val['layanan']->bangsal.$val['layanan']->bangsal_ic.'/'.$val['layanan']->kelas.$val['layanan']->kelas_icare) ?></td>
                            </tr>
                            <tr>
                                <td>Alamat</td>
                                <td>:</td>
                                <td class="bold"><?= $val['pasien']->alamat ?></td>
                            </tr>
                        </table>
                    </div>
                </td>
        ...
        <table width="100%">
                ...
                <td>
                    <table width="75%" class="table-no-border small__font">
                        <tr>
                            ...
                            <td width="35%" class="no__border bold"><input type="checkbox" <?php if(isset($val['pernah_alergi']->pernah_alergi)){if($val['pernah_alergi']->pernah_alergi === 'Pernah'){ echo 'checked'; }else{ echo '';}} ?>> Pernah</input></td>
                            <td width="35%" class="no__border bold"><input type="checkbox" <?php if(isset($val['pernah_alergi']->pernah_alergi)){if($val['pernah_alergi']->pernah_alergi === 'Tidak') { echo 'checked'; } else{ echo '';}} ?>> Tidak Pernah</input></td>
                        </tr>
                    </table>
                </td>
            </tr>
            <tr>
                <td>
                    <table width="75%" class="table-data small__font">
                        ...
                        <tbody>
                            <?php if(isset($val['riwayat_alergi'])){foreach ($val['riwayat_alergi'] as $tp) { ?>
                            <tr>
            ...
            <tr>
                <td>
                    <table width="100%" class="table-data small__font">
                        ...
                        <tbody>
                            <?php
                            if(isset($val['resep'])){foreach ($val['resep'] as $r) {
                                if($r->status_resep === '1'){
            ...
            <tr>
                <table width="100%" class="table-no-border center">
                    ...
                    <tr>
                        <td><?= (!empty($val['apoteker']->nama) ? '('.$val['apoteker']->nama.')' : '' ) ?></td>
                        <td>(<?= $val['pasien']->nama ?>)</td>
                    </tr>
                </table>    
            </tr>                
        </table>
