        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <select name="tgl_search" id="tgl-search" class="form-control"> </select>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-info waves-effect" onclick="cariRekon()"><i class="fas fa-search"></i> Cari</button>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
