 ...
 */
class Sep_poli extends REST_Controller
{
    ...
    function __construct()
    {
        parent::__construct();
        $this->limit = 10;
        $this->load->model('Sep_poli_model', 'sep_poli');
    ...
    function get_list_sep_poli_get()
    {
        if (!$this->get('page')) :
            $this->response(NULL, REST_Controller::HTTP_BAD_REQUEST); // (400)
        endif;
        ...
        $data           = $this->sep_poli->getListDataSepPoli($this->limit, $start, $search);
