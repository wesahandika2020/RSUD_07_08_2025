            ...
            <div class="card-header">
                <div class="row">
                    <div class="col-lg-4 d-flex justify-content-start">
                        <h6 class="m-t-10"><i class="fas fa-list m-r-5"></i>Daftar Surat Elegibilitas Pasien Poliklinik</h6>
                    </div>
                    <div class="col-lg-8 d-flex justify-content-end">
                        ...
                        <?= form_dropdown('layanan', $layanan, array(), 'class="form-control" style="width:30%" id=klinik') ?>
                    </div>
                </div>
