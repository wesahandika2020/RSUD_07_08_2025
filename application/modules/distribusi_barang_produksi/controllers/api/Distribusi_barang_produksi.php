...
class Distribusi_barang_produksi extends REST_Controller
{
	...
	function get_list_distribusi_get()
	{
		if (!$this->get('page')) :
		...
		$data            = $this->m_distribusi->getListDataDistribusi($limit, $start, $search);
	...
	function simpan_distribusi_post()
	{
		$data = $this->m_distribusi->simpanDataDistribusi();
		$this->response($data, REST_Controller::HTTP_OK);
	}

	function get_data_distribusi_get()
	{
		$data = $this->m_distribusi->getDataDistribusi($this->get('id', true));
		$this->response($data, REST_Controller::HTTP_OK);
	}
}
