					...
					<table id="table-data" class="table table-hover table-striped table-sm color-table info-table">
						<thead>
							<tr class="header">
								...
								<th width="27%" class="center">Nama Barang</th>
								<th width="10%" class="center">Awal</th>
								<th width="10%" class="center">Masuk</th>
								<th width="10%" class="center">Keluar</th>
								<th width="10%" class="center">Sisa</th>
								<th width="10%" class="center">HPP</th>
								<th width="10%" class="center">Asset</th>
