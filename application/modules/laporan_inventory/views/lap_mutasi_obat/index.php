<div class="card-body lap-mutasi-obat">
  <div id=jenis-periode></div>
  <div class="table-responsive  m-t-10" id="parent">
    <table id="table-lap-mutasi-obat" class="table table-hover table-striped table-bordered table-sm color-table info-table">
      <thead>
        <tr style="top: 0;">
          ...
          <th colspan="4" rowspan="2" class="center">
            <table>
              <thead>
                <tr>
    ...
    <div class="row lap-mutasi-obat m-t-10">
      <div class="col">
