	...
	<div class="modal-dialog" style="max-width:500px">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="unit_depo_class form-group row tight">
					<label id="unit-depo-label" for="unit-depo" class="col-3 col-form-label">Unit</label>
					<div class="col">
...
<script>
	...
	$('#jenis-pasien').change(function() {
		...
		$('#ruangan_rajal, .ruangan_rajal').toggle(jenisPasien === 'Rawat Jalan');
		$('#ruangan_ranap, .ruangan_ranap').toggle(jenisPasien === 'Rawat Inap');
		$('#unit-depo, .unit_depo_class').toggle(jenisPasien !== 'Hemodialisa').val('');
		
		if (jenisPasien === 'Hemodialisa') {
			$('#unit-depo, .unit_depo_class').val('259');
		}
	});
	...
	function resetForm_02() {
		...
		$('#ruangan_rajal, #ruangan_ranap, #unit-depo').val('');
	...
	function getLaporanBukuPenjualan(page) {
		...
		if ($('#jenis-laporan').val() == "2") {
			...
			$.ajax({
				type: 'GET',
				url: '<?= base_url('laporan_inventory/api/laporan_inventory/get_list_laporan_inventory_02') ?>/page/' + page + '/jenis/',
				...
				success: function(data) {
					...
					$.each(data.data, function(i, v) {
						if (v.jenis_layanan === 'Hemodialisa') {
							v.ruang = 'Hemodialisis (HD)';
						}
