...
<div class="modal fade" id="modal-selisih-billing">
	<div class="modal-dialog modal-dialog-scrollable" style="max-width:75%">
		<div class="modal-content">
			...
			<div class="modal-body">
				<?= form_open('', 'id=form-selisih-billing class=form-horizontal role=form') ?>
				...
				<div class="row">
					<div class="col-md-6">
						...
						<div class="form-group row tight">
							<label for="nama" class="col-form-label col-md-3 right">Tanggal Transaksi</label>
							<div class="col-md-9">
								<input type="text" name="waktu" id="waktu" value="<?= date('Y-m-d H:i') ?>" class="form-control validasi">
							</div>
						</div>
						<div class="form-group row tight metode-pembayaran">
							<label class="col-md-3 col-form-label right">Metode Pembayaran</label>
							<div class="col-md-9">
					...
					<div class="col-md-6">
						...
						<div class="form-group row tight">
							<label class="col-md-4 col-form-label right">Total Selisih Bayar</label>
						...
						<div class="form-group row tight">
							...
							<div class="input-group-mixing col-md-8">
								<div class="input-group-mixing-prepend">Rp.</div>
								<input type="text" name="pembulatan" class="form-control validasi" id="pembulatan" readonly>
							</div>
						</div>
						<div class="form-group row tight">
			...
			<div class="modal-footer">
				...
				<button type="button" class="btn btn-info" onclick="simpanSelisihBilling()"><i class="fas fa-paper-plane mr-1"></i>Konfirmasi Bayar</button>
			</div>
		</div>
	</div>
</div>
	...
	<div class="modal-dialog" style="max-width: 650px">
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<button type="button" class="btn btn-info waves-effect" onclick="getListSelisihBilling(1, '')"><i class="fas fa-search"></i> Cari</button>
			</div>
		</div>
		<!-- /.modal-content -->
	</div>
