      ...
      <section class="resume__medis">
        ...
        <div class="resume__medis__container container">
          <table class="small__font">
            <tbody>
              <tr>
                <td align="center" colspan="3"><b>RESUME MEDIS</b></td>
              ...
              <tr>
                <td width="18%" colspan="2">Tanggal Masuk : <b><?= $data['pasien']->tanggal_daftar == NULL ? '' : datetimefmysql($data['pasien']->tanggal_daftar); ?></b></td>
                <td width="43%" colspan="2">Tanggal Keluar / Meninggal : <b><?= $data['pasien']->tanggal_keluar == NULL ? '' : datetimefmysql($data['pasien']->tanggal_keluar); ?></b></td>
                <td width="39%" colspan="2">Ruang Rawat Terakhir : <b><?= $data['pasien']->ruang_asal; ?><?= $data['intensive_care'] == NULL ? '' : $data['intensive_care']->nama_bangsal; ?><?= $data['pasien']->jenis_layanan == 'IGD' ? 'IGD' : ''; ?></b></td>
              </tr>
              <tr>
