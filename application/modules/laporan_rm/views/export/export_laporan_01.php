		...
		<?php foreach ( $value->diagnosa_data as $key => $diagnosa_data ) : ?>
			<?php if($key <= 0): ?>
				<tr>
					...
					<td width="7%" class="center" style="vertical-align: top;"><?= $value->penjamin ?></td>
					<td class="center" style="vertical-align: top;"><?= $value->unit_pelayanan ?></td>
					...
					<td class="center" style="vertical-align: top;"><?= $value->status_kunjungan ?></td>
					...
					<td class="center" style="vertical-align: top;"><?= $value->tgl_selesai ?></td>
				</tr>
			<?php else : ?>
				<tr>
					<td colspan="6"></td>
