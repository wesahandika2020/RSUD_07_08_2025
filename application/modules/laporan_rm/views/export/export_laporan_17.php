...
<body>
	...
	<div style="text-align: center;">
		<h4 style="text-transform: uppercase;">Data Kompilasi Penyakit/Morbiditas Pasien Rawat Inap
			<br>Periode <?= $periode ?>
		</h4>
	</div>
		...
		<tbody>
			<?php foreach ($data as $i => $value) : ?>
				<tr>
					...
					<td class="center"><?= $value->total_l_hidup ?></td>
					<td class="center"><?= $value->total_p_hidup ?></td>
					<td class="center"><?= $value->total_l_hidup + $value->total_p_hidup ?></td>
					<td class="center"><?= $value->total_l_meninggal ?></td>
					<td class="center"><?= $value->total_p_meninggal ?></td>
					<td class="center"><?= $value->total_l_meninggal + $value->total_p_meninggal ?></td>
				</tr>
			<?php endforeach ?>
		</tbody>
	</table>
