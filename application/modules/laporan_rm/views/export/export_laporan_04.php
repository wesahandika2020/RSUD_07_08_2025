...
header_excel(
		"Rekapulasi Data Pasien MASIH DIRAWAT - " . $jenis_rawat . " ( " . $periode . " )"
);
...
<h4>RSUD KOTA TANGERANG
	...
	<br><br> Rekapulasi Data Pasien MASIH DIRAWAT - <b style="text-transform: uppercase;"><?= $jenis_rawat ?></b>
...
<table width="100%" border="1">
	...
	<tr height="50pt">
		...
		<th class="center">Asal Ruangan</th>
		...
		<?php foreach ( $value->diagnosa_data as $key => $diagnosa_data ) : ?>
			<?php if ( $key <= 0 ): ?>
				<tr>
					...
					<td class="left" style="vertical-align: top;"><?= $value->nama ?> </td>
					...
					<td class="center" style="vertical-align: top;"><?= datetimefmysql( $value->tgl_mrs ) ?></td>
					<td class="center" style="vertical-align: top;"><?= ( $value->penjamin !== null ? $value->penjamin : 'Tunai' ) ?></td>
					<td class="center" style="vertical-align: top;"><?= ( $value->kelas !== null ? $value->kelas : '-' ) ?></td>
					<td class="center" style="vertical-align: top;"><?= ( $value->asal_kunjungan !== null ? $value->asal_kunjungan : '-' ) ?></td>
					<td class="left" style="vertical-align: top;"><?= ( $value->dokter_dpjp !== null ? $value->dokter_dpjp : '-' ) ?></td>
					<td class="center" style="vertical-align: top;"><?= ( $value->bangsal !== null ? $value->bangsal : '-' ) ?></td>
				</tr>
			<?php else : ?>
				<tr>
					<td colspan="7"> </td>
