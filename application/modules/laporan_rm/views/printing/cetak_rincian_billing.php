	...
	<div class="page">
		...
		<?php foreach ($layanan as $key => $lay) : ?>
			...
			<table width="100%" class="tabel-laporan">
					...
					<?php foreach ($lay->tindakan as $key => $value) : ?>
						...
						<?php if ($print) : ?>
							<tr>
								...
								<td style="white-space:nowrap;"><?= ($value->profesi === 'Perawat' ? 'Perawat' : $value->operator) ?></td>
								<td class="center"><?= $value->frekuensi ?></td>
								<td class="right"><?= currency($value->harga_item) ?></td>
				...
				<?php if ($lay->status_rawat === 'Masih Dirawat') : ?>
					<tr>
						<td colspan="6"><b style="font-size:14px;font-weight:bold;">Administrasi Rawat Inap</b></td>
					</tr>
					<?php
					$subtotal = 0;
				...
				<?php else : ?>
					...
					<?php $SUBTOTAL += $ADM_RANAP_TEMP->total;
					endif; ?>
				<?php endif; ?>

				<?php if ($lay->status_rawat_icare === 'Masih Dirawat') : ?>
					<tr>
						<td colspan="6"><b style="font-size:14px;font-weight:bold;">Administrasi Pasien Intensive Care</b></td>
					</tr>
					<?php
					$subtotal = 0;
					$adm = ceil((5 / 100) * ($SUBTOTAL + $TOTAL));
		...
		<table width="100%">
			<tr>
				...
				<td width="40%" class="right">( Kasir : RSUD KOTA TANGERANG )</td>
			</tr>
			<tr>
