...
<body onload="cetak()">
	<div class="page">
		...
		<div class="center bold" style="font-size:16px">BUKTI PERMINTAAN BARANG UNIT</div>
		<br>
		<div style="width:100%; display:inline-block;">
			<div style="width:60%; float:left;">
				<table width="100%" style="white-space: nowrap;">
					...
					<tr>
						...
						<td>:</td>
						<td><?= datefmysql($row->tanggal_permintaan) ?></td>
					</tr>
					<tr>
						<td>Dari Unit</td>
						<td>:</td>
			...
			<div style="width:40%; float:right;">
				<table width="100%" style="white-space: nowrap;">
					...
					<tr>
						<td colspan="3">Kepala Unit <?= $row->unit_tujuan ?></td>
					</tr>
					<tr>
		...
		<br><br>
		<table><tr><td colspan="4">Berikut daftar barang-barang yang diminta oleh unit:</td></tr></table>
		<table width="100%" class="tabel-laporan">
			...
			<tbody>
				<?php foreach ($list_data['data'] as $i => $data) : ?>
					<tr>
