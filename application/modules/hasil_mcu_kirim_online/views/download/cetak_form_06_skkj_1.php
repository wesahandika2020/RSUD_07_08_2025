...
<body onload="window.print()">
    ...
    <main style="page-break-after: auto;">
        ...
        <h5 align="center" style="margin-top: 0px;">Nomor:445/<?=$data_form->no_surat_skkj_1;?>-IRJ/<?= date("Y"); ?></h5>
        ...
        <table style="font-size: 10pt;" width="100%" class="table-space">
            ...
            <?php if (!empty($data_form->valid_1)): ?>
                <tr>
                    <td colspan="3">Berdasarkan pemeriksaan wawancara klinis dan test MMPI pada nama tersebut diatas, saat ini tidak ditemukan adanya gejala gangguan jiwa (psikopatologi) yang bermakna yang dapat mengganggu fungsi intelektual dan aktivitas sehari-sehari.</td>
                </tr>        
                <tr>
            ...
            <?php if (!empty($data_form->valid_2)): ?>
                <tr>
                    <td colspan="3">Hasil test MMPI tidak dapat diinterprestasi. Berdasarkan pemeriksaan wawancara klinis pada nama tersebut diatas, saat ini tidak ditemukan adanya gejala gangguan jiwa (psikopatologi) yang bermakna yang dapat mengganggu fungsi intelektual dan aktivitas sehari-sehari.</td>
                </tr>        
                <tr>
                    <td colspan="3">Surat keterangan ini dibuat sebagai <b><?= $data_form->keterangan; ?></b> dan tidak dapat digunakan untuk kepentingan hukum lainnya. Demikian surat keterangan ini dibuat agar dapat dipergunakan sebagaimana mestinya.</td>
                </tr>     
        ...
        <table style="font-size: 10pt; border-collapse: collapse; page-break-inside: avoid;" width="100%">
            ...
            <tr>
                ...
                <td>:
                    <?php
                        $tanggal_mysql = $data_form->tanggal_skkj_1;
                        ...
                        $text_barcode .= "Nomor Surat : NO.445/" . $data_form->no_surat_skkj_1 . "-IRJ/" . date("Y") . "\n";
