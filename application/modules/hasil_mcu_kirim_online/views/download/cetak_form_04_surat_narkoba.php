...
<body onload="window.print()">
    ...
    <footer>
        ...
        <div class="footer-content">
            <table width="100%">
                <tr>
                    <td style="vertical-align: top; text-align: right; font-size:10pt;"><b>FORM-MCU-13-01</b></td>
                </tr>
                <tr>
    ...
    <main style="page-break-after: auto;">
        <h4 align="center" style="margin-bottom: 0px;">SURAT KETERANGAN BEBAS NARKOBA</h4>
        <h5 align="center" style="margin-top: 0px;">NO.<?= $data_form->no_surat;?>/MCU_SKBN_RSUDKT/<?= $data_form->tahun_surat; ?></h5>

        <table style="font-size: 10pt;" width="100%" class="table-space">
            <tr>
                <td colspan="3">Yang bertanda tangan dibawah ini, Dokter Rumah Sakit Umum Daerah Kota Tangerang, menerangkan bahwa :</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="bold">
                    ...
                    RT. <?= $pasien->rt; ?> / RW. <?= $pasien->rw; ?>, KEL.<?= $pasien->kel; ?>, KEC.<?= $pasien->kec; ?>, <?= $pasien->kab; ?>, <?= $pasien->prop; ?> </b></td>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="3">Menerangkan bahwa berdasarkan  pemeriksaan laboratorium (Hasil Terlampir), maka saat ini yang bersangkutan dinyatakan <b>TIDAK DITEMUKAN</b> zat yang terlampir dalam hasil pemeriksaan laboratorium.</td>
            </tr>
            <tr>
                <td colspan="3">Demikian Surat Keterangan ini untuk digunakan sesuai ketentuan yang berlaku.</td>
            </tr>
            <tr>
                <td width="19%">&nbsp;</td>
                <td width="1%">&nbsp;</td>
        ...
        <table style="font-size: 10pt; border-collapse: collapse; page-break-inside: avoid;" width="100%">
            ...
            <tr>
                ...
                <td>:
                    <?php
                        $tanggal_mysql = $data_form->tanggal_pemeriksaan;
                        ...
                        $text_barcode .= "Nomor Surat : NO." . $data_form->no_surat . "/MCU_SKBN_RSUDKT/" . $data_form->tahun_surat. "\n";
                        $text_barcode .= "Tanggal Surat : " . $tanggal . "\n";
                        $text_barcode .= "Perihal : Surat Keterangan Bebas Narkoba\n";
