<html>
<title><?= "Ket Tidak Disabilitas" ?></title>
...
<body onload="window.print()">
    ...
    <footer>
        ...
        <div class="footer-content">
            <table width="100%">
                <tr>
                    <td style="vertical-align: top; text-align: right; font-size:10pt;"><b>FORM-MCU-28-00</b></td>
                </tr>
                <tr>
    ...
    <main style="page-break-after: auto;">
        <h4 align="center" style="margin-bottom: 0px;">SURAT KETERANGAN TIDAK DISABILITAS</h4>
        <h5 align="center" style="margin-top: 0px;">NOMOR : <?=$data_form->nomorsktd;?>/MCU_RSUDKT/<?= date("Y"); ?></h5>
        ...
        <table style="font-size: 10pt;" width="100%" class="table-space">
            ...
            <tr>
                <td colspan="4">Surat keterangan ini untuk keperluan : <b><?= $data_form->keterangan; ?></b></td>
            </tr>
            <tr>
                <td colspan="4">&nbsp;</td>
            </tr>
            ...
            <tr>
                ...
                <td>Nama</td>
                <td style="text-align: right;">:</td>
                <td><b><?= $data_form->nama_dokter; ?></b></td>
            </tr>
            <tr>
                <td>&nbsp;</td>
                <td>NIP</td>
                <td style="text-align: right;">:</td>
                <td><b><?= $data_form->nip_dokter; ?></b></td>
            </tr>
            <tr>
                <td colspan="4">Setelah melakukan pemeriksaan kesehatan dan kemampuan fungsional bahwa yang bersangkutan benar-benar sebagai <b><u>bukan penyandang Disabilitas</u></b></td>
            </tr>            
            <tr>                
                <td width="3%">&nbsp;</td>
                <td width="22%">&nbsp;</td>
        ...
        <table style="font-size: 10pt; border-collapse: collapse; page-break-inside: avoid;" width="100%">
            ...
            <tr>
                ...
                <td>:
                    <?php
                        $tanggal_mysql = $data_form->tanggalsktd;
                        ...
                        $text_barcode .= "Nomor Surat : NO." . $data_form->nomorsktd . "/MCU_RSUDKT/" . date("Y") . "\n";
                        $text_barcode .= "Tanggal Surat : " . $tanggal . "\n";
                        $text_barcode .= "Perihal : Surat Keterangan Tidak Disabilitas\n";
