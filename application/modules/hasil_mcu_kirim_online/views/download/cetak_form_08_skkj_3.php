...
<body onload="window.print()">
    ...
    <footer>
        ...
        <div class="footer-content">
            <table width="100%">
                <tr>
                    <td style="vertical-align: top; text-align: right; font-size:10pt;"><b>FORM-KEP-94b-00</b></td>
                </tr>
                <tr>
    ...
    <main style="page-break-after: auto;">
        ...
        <h5 align="center" style="margin-top: 0px;">Nomor:445/<?=$data_form->no_surat_skkj_3;?>-IRJ/<?= date("Y"); ?></h5>
        ...
        <table style="font-size: 10pt;" width="100%" class="table-space">
            ...
            <?php if (!empty($data_form->valid_1)): ?>
                <tr>
                    <td colspan="3">Berdasarkan pemeriksaan klinis dan MMPI pada nama tersebut diatas, kondisi emosi terperiksa cenderung mudah terpengaruh dan memerlukan bantuan profesional untuk mengatasinya.</td>
                </tr>        
                <tr>
            ...
            <?php if (!empty($data_form->valid_2)): ?>
                <tr>
                    <td colspan="3">Hasil test MMPI tidak dapat di interprestasi. Berdasarkan wawancara klinis ditemukan alur pikir yang tidak mudah dipahami dan kondisi kesehatan mental yang memerlukan bantuan profesional.</td>
                </tr>        
                <tr>
                    <td colspan="3">Surat keterangan ini dibuat <b><?= $data_form->keterangan; ?> </b> dan tidak dapat digunakan untuk kepentingan hukum lainnya. Demikian surat keterangan ini dibuat agar dapat dipergunakan sebagaimana mestinya.</td>
                </tr>     
                <tr>
                    <td colspan="3" >Surat ini berlaku selama 3 bulan terhitung sejak tanggal dikeluarkan.</td>
                </tr>
        ...
        <table style="font-size: 10pt; border-collapse: collapse; page-break-inside: avoid;" width="100%">
            ...
            <tr>
                ...
                <td>:
                    <?php
                        $tanggal_mysql = $data_form->tanggal_skkj_3;
                        ...
                        $text_barcode .= "Nomor Surat : NO.445/" . $data_form->no_surat_skkj_3 . "-IRJ/" . date("Y") . "\n";
