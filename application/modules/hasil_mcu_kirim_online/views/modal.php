        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group row tight">
                    ...
                    <!-- 00304602 -->
                    <!-- 00370815  -->
                        <input class="form-control" type="text" name="no_rm" onkeypress="return hanyaAngka(event)" id="no-rm-search" placeholder="No. RM" value="">
                    </div>
                </div>
                <div class="form-group row tight">
                ...
                <div class="form-group row tight">
                    <label class="col col-form-label">Status Kirim</label>
                    <div class="col-9">
                        <select name="status_wa" id="status-kirim" class="form-control">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-info waves-effect" onclick="getListHasilMcu(1)"><i class="fas fa-search mr-1"></i>Cari</button>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
