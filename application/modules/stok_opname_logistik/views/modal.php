...
<div id="modal-stok-opname" class="modal fade" role="dialog">
	<div class="modal-dialog" style="max-width:70%">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title" id="modal-stok-opname-label">Form Stok Opname Logistik</h4>
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
			</div>
			<div class="modal-body">
				...
				<div class="row">
					<div class="col-md-6">
						...
						<div class="form-group row">
							<label class="col-form-label col-lg-3 right">Kategori Pembayaran</label>
							<div class="col-lg-9">
							...
							<table id="table-list" class="table table-hover table-striped table-sm color-table info-table">
								<thead>
									<tr>
										...
										<th width="10%" class="left">Pembayaran</th>
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-secondary waves-effect" data-dismiss="modal"><i class="fas fa-times-circle mr-1"></i>Keluar</button>
				<button type="button" class="btn btn-info waves-effect" onclick="konfirmasiSimpanStokLogistik('add')"><i class="fas fa-save mr-1"></i>Simpan</button>
			</div>
		</div>
		<!-- /.modal-content -->
	</div>
...
<div id="modal-stok-opname-edit" class="modal fade" role="dialog">
	<div class="modal-dialog" style="max-width:40%">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-secondary waves-effect" data-dismiss="modal"><i class="fas fa-times-circle mr-1"></i>Keluar</button>
				<button type="button" class="btn btn-info waves-effect" onclick="konfirmasiSimpanStokLogistik('edit')"><i class="fas fa-save mr-1"></i>Update</button>
			</div>
		</div>
		<!-- /.modal-content -->
	</div>
