					...
					<table class="small__font">
						...
						<tbody>
							...
							<tr>
								...
								<td style="vertical-align: top;" class="no__border">: </td>
								<td style="vertical-align: top;" colspan="4" class="no__border">
									<b><?= $pasien->hasil_konsultasi == NULL ? '' : $pasien->hasil_konsultasi . '. '; ?></b>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td style="vertical-align: top;" class="no__border">: </td>
								<td style="vertical-align: top;" colspan="4" class="no__border">
									<b><?= $pasien->pending_lab == NULL ? '' : $pasien->pending_lab . '. '; ?></b>
								</td>
							</tr>
							<tr>
																									...
																									<tr>
																										...
																										foreach ($status as $i => $j) {
																											...
																											';
																												...
																												<td align="center" style="border: solid 1px;"><?= $l['test_comment'] ?></td>
																									</tr>
																			...
																			<tbody>
																				...
																				<?php foreach ($cek_radiologi as $key => $cr) { ?>
																					...
																					<tr>
																						...
																						<td class="center"><?= (!empty($cr->code) ? $cr->code . ". " . $cr->layanan : $cr->layanan); ?></td>
																						<td class="center"><?= (!empty($cr->hasil) ? $cr->hasil : $cr->html); ?></td>
																					</tr>
