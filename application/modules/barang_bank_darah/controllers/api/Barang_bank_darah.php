 ...
 */
class Barang_bank_darah extends REST_Controller
{
    ...
    function get_list_barang_get()
    {
        ...
        $data          = $this->barang_bank_darah->getListData($start, $this->limit, $search);
    ...
    {
        $data = $this->barang_bank_darah->deleteDataKemasanBarang($this->get("id"));
        $this->set_response($data, REST_Controller::HTTP_OK);
    }

    function simpan_barang_post() {
        $data = $this->barang_bank_darah->simpanDataBarang();
