<!-- Modal Barang Bank Darah -->
<div id="modal-barang-bank-darah" class="modal fade" role="dialog">
    <div class="modal-dialog modal-dialog-scrollable" style="max-width: 820px">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="modal-barang-bank-darah-label"></h4>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>
            <div class="modal-body">
                <?= form_open('', 'role=form class=form-horizontal id=form-barang-bank-darah'); ?>
                <div class="row">
                    <div class="col-lg-12">
                        <div class="widget-body">
                            <div id="wizard-form">
                                ...
                                <div class="form-data-utama">
                                    ...
                                    <div class="form-group row thin">
                                        <label class="col-lg-3 col-form-label">Kode Barang :</label> <!--span class="text-red">*</span -->
                                        <div class="col-lg-9">
                                    ...
                                    <div class="form-group row thin">
                                        <label class="col-lg-3 col-form-label">Golongaan Darah Barang <span class="text-red">*</span>:</label>
                                        <div class="col-lg-9">
                                            <select name="golongan_darah_barang" id="golongan-darah-barang" class="form-control">
                                    ...
                                    <div class="form-group row thin">
                                        <label class="col-lg-3 col-form-label">Rhesus Barang <span class="text-red">*</span>:</label>
                                        <div class="col-lg-9">
                                            <select name="rhesus_barang" id="rhesus-barang" class="form-control">
                                    ...
                                    <div class="form-group row thin">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="input-group">
                                                ...
                                                <?= form_input('hpp', NULL, 'id=hpp onblur="FormNum(this)" class="form-control"') ?> 
                                            </div>
                                        </div>
                                    </div>
                                </div>
