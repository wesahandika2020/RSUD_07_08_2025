	...
	<div class="modal-dialog modal-dialog-scrollable" style="max-width: 500px">
		<div class="modal-content">
			...
			<div class="modal-body">
				<?= form_open('', 'role=form class=form-horizontal id=form-tambah-pkrt'); ?>
				<input type="hidden" id="id-pkrt" name="id_pkrt">
				<div class="row">
					<div class="col-md-12">
						...
						<div class="form-group row tight">
							<label class="col col-form-label">Nama Barang</label>
							<div class="col-9">
								<input name="nama" id="nama-pkrt" class="form-control input-pkrt" placeholder="Nama Barang">
							</div>
						</div>
						<div class="form-group row tight">
							<label class="col col-form-label">Is Active</label>
							<div class="col-9">
								<?= form_dropdown('status_active', ["1" => "Ya", "0" => "Tidak"], array(), 'id=status-active class=form-control') ?>
							</div>
						</div>
					</div>
				</div>
