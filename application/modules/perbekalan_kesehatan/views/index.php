            ...
            <div class="card-body">
                <div class="row">
                    <div class="col d-flex justify-content-start">
                        <?= form_button('tambah', '<i class="fas fa-plus-circle mr-1"></i>Tambah Data', 'id=btn-tambah class="btn btn-info waves-effect mr-1"') ?>
                ...
                <div class="table-responsive">
                    <table id="table-data-pkrt" class="table table-hover table-striped table-sm color-table info-table m-t-5">
                        <thead>
                            <tr>
                                <th class="center" width="5%">No.</th>
                                <th class="left" width="70%">Nama</th>
                                <th class="center" width="15%">Status Aktif</th>
