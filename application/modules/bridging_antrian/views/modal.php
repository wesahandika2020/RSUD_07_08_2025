        ...
        <div class="modal-content">
            ...
            <?= form_open('', 'id=form-integrasi role=form class=form-horizontal') ?>
                ...
                <div class="form-group row tight">
                    ...
                    <div class="col-9">
                        <?= form_dropdown('status_bridging', $status_bridging, array(), 'class="custom-select" id=status-bridging') ?>
                    </div>
                </div>
            <?= form_close() ?>
            </div>
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-info waves-effect" onclick="validIntegrasi()"><i class="fas fa-save"></i> Kirim</button>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
