...
<div class="row">
	<div class="col-lg-12">
		<div class="card mb-1">
			...
			<?php $this->load->view('lap_bulanan_ppi/index.php') ?>
			<?php $this->load->view('lap_kultur_ppi/index.php') ?>
			<?php $this->load->view('lap_antiobika_ppi/index.php') ?>

	</div>
</div>

<?php $this->load->view('js') ?>
<?php $this->load->view('lap_bulanan_ppi/modal') ?>
<?php $this->load->view('lap_kultur_ppi/modal') ?>
<?php $this->load->view('lap_antiobika_ppi/modal') ?>