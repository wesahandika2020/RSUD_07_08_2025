		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="form-group row tight">
					<label for="periode-laporan" class="col-md-3 col-form-label">Tanggal Layanan</label>
					<div class="col-md-9">
				...
				<div class="form-group row tight">
					<label for="dokter-mcu" class="col-md-3 col-form-label">Dokter MCU</label>
					<div class="col-md-9">
						<input type="text" name="dokter_mcu" id="dokter-mcu" class="select2-input" placeholder="Semua Dokter / Petugas">
					</div>
				</div>
				<div class="form-group row tight">
					<label for="poliklinik" class="col-md-3 col-form-label">Poliklinik Konsul</label>
					<div class="col-md-9">
			...
			<div class="modal-footer">
				...
				<button type="button" class="btn btn-info waves-effect" onclick="getLaporanMcu(1)"><i class="fas fa-paper-plane mr-1"></i> Tampilkan</button>
			</div>
		</div>
		<!-- /.modal-content -->
	</div>
