	...
	<div class="col-lg-12">
		<div class="card">
			...
			<div class="card-body lap-01">
				<div></div>
					<h5 style="text-transform: uppercase;" class="center"><b>LAPORAN KONSUL MEDICAL CHECK UP</b></h5>
			...
			<div class="card-body lap-02">
				<div></div>
					<h5 style="text-transform: uppercase;" class="center"><b>LAPORAN MEDICAL CHECK UP ORDER LABORATORIUM</b></h5>
			...
			<div class="card-body lap-03">
				<div></div>
					<h5 style="text-transform: uppercase;" class="center"><b>LAPORAN MEDICAL CHECK UP ORDER RADIOLOGI</b></h5>
			...
			<div class="card-body lap-04">
				<div></div>
					<h5 style="text-transform: uppercase;" class="center"><b>LAPORAN TINDAKAN DOKTER MEDICAL CHECK UP</b></h5>
