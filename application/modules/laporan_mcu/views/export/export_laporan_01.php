<?php
	header_excel("LAPORAN KONSUL MEDICAL CHECK UP _ ".$data['periode']);
...
<body>
	...
	<div>
		<h4 style="text-transform: uppercase;">
            ...
            <?= (!empty($data['poliklinik']) ? '<br>Poliklinik : ' .$data['poliklinik'] : '' ) ?>
	...
	<table border="1">
		...
		<tr height="50pt" >
			...
			<th style="text-align: center; background-color: #c3d4f9;"><b>KONSUL POLIKLINIK</b></th>
			<th style="text-align: center; background-color: #c3d4f9;"><b>DOKTER POLIKLINIK</b></th>
		...
		<tbody>
			...
			?>
				<tr>
					...
					<td style="text-align: left"><?= $value->konsul[0]->nama_poli ?></td>
					<td style="text-align: left"><?= $value->konsul[0]->nama_dokter ?></td>
					<td style="text-align: center"><?= $value->konsul[0]->nama_penjamin ?></td>
				</tr>
					...
					?>
						<tr>
							...
							<td></td>
							<td></td>
							<td style="text-align: left"><?= $val->nama_poli ?></td>
							<td style="text-align: left"><?= $val->nama_dokter ?></td>
							<td style="text-align: center"><?= $val->nama_penjamin ?></td>
						</tr>
					<?php endforeach ?>
