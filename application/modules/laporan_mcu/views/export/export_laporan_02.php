<?php
	header_excel("LAPORAN MCU ORDER LABORATORIUM _ ".$data['periode']);
...
<body>
	...
	<div>
		<h4 style="text-transform: uppercase;">
            LAPORAN MEDICAL CHECK UP ORDER LABORATORIUM 
	...
	<table border="1">
		...
		<tr height="50pt" >
			...
			<th style="text-align: center; background-color: #c3d4f9;"><b>TINDAKAN LABORATORIUM</b></th>
