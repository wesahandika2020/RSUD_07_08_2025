 ...
 */
class Sisa_stok_gizi extends REST_Controller
{
	...
	function __construct()
	{
		...
		$this->load->model('Sisa_stok_gizi_model', 'gizi');
	...
	function get_list_sisa_stok_get() {
		...
		$data          = $this->gizi->getListDataSisaStok( (int)$limit, (int)$start, $search );
		// var_dump($data);die;
	...
	{
		$data = $this->gizi->getDataSisaStok($this->get('id_unit'), $this->get('id_barang'));
