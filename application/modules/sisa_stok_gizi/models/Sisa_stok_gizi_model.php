...
class Sisa_stok_gizi_model extends CI_Model {
	...
	private function _listSisaStok($limit = 0, $start = 0, $search)
	{
		...
		foreach ($result as $i => $val) :
			...
			// Calculate the remaining stock for Non-Ed and Ed items
			...
			// Calculate the total remaining stock
	...
	{
		$this->db->select("COALESCE(sum(masuk) - sum(keluar), 0) as sisa")->from('sm_gizi_stok');
