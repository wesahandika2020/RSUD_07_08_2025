	...
	<div class="modal-dialog" style="max-width: 500px">
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<button type="button" class="btn btn-info waves-effect" onclick="getListKoreksiStok(1)"><i class="fas fa-filter mr-1"></i>Tampilkan</button>
			</div>
		</div>
		<!-- /.modal-content -->
	</div>
...
<div id="modal-print" class="modal fade" role="dialog">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-secondary waves-effect" data-dismiss="modal"><i class="fas fa-times-circle mr-1"></i>Keluar</button>
				<button type="button" class="btn btn-success waves-effect" onclick="cetakKoreksiStok()"><i class="fas fa-print mr-1"></i>Cetak</button>
			</div>
		</div>
		<!-- /.modal-content -->
	</div>
