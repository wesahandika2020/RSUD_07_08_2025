<script>
	...
	function getListKoreksiStok(page, id_koreksi_stok) {
		var id = '';
		...
		$.ajax({
			type: 'GET',
			url: '<?php echo base_url('koreksi_stok/api/koreksi_stok/get_list_koreksi_stok/page/') ?>' + page + '/id/' + id ,
            ...
            buttons: {
                ...
                konfirmasi: {
                    ...
                    callback: function() {
						...
						$.ajax({
							type: 'POST',
							url: '<?php echo base_url('koreksi_stok/api/koreksi_stok/simpan_koreksi_stok') ?>',
	...
	function cetakKoreksiStok() {
        ...
        window.open('<?php echo base_url() ?>koreksi_stok/printing_koreksi_stok/'+kategori,'Cetak Lembar Koreksi Stok','width='+dWidth+', height='+dHeight+', left='+x+',top='+y)
	}

	function cetakExcelKoreksiStok() {
		location.href = '<?php echo base_url('koreksi_stok/export_koreksi_stok') ?>?' + $('#form-search').serialize()
	}
</script>