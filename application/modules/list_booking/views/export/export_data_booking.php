...
<body>
	...
	<div style="text-align: left;">
		<h4><b>LIST BOOKING</b>
			...
			<?= (!empty($shift_poli) ? '<br>Shift Poli : ' .$shift_poli : '' ) ?>
		</h4>
	</div>				
	<table border="1">
		<thead border="2">
			<tr height="50pt">
				...
				<th style="background-color: #9cc8ff; text-align: center">ASAL LAYANAN</th>
				<th style="background-color: #9cc8ff; text-align: center">POLI</th>
				<th style="background-color: #9cc8ff; text-align: center">SHIFT POLI</th>
				...
				<th style="background-color: #9cc8ff; text-align: center">NO REFERENSI</th>
		...
		<tbody>
			<?php foreach ($data as $i => $value) : ?>
				<tr>
					...
					<td style="text-align: center"><?= $value->shift_poli?></td>
					...
					<td style="text-align: center" style="mso-number-format:'@'"><?=  $value->no_referensi?></td>
