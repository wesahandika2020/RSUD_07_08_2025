					...
					<table id="table-data" class="table table-hover table-striped table-sm color-table info-table">
						<thead>
							<tr>
								...
								<th width="9%" class="center">No. Rehab</th>
								<th wdith="12%">Waktu Konfirmasi</th>
								<th width="6%">No RM</th>
								<th width="20%">Nama Pasien</th>
								<th width="13%">Dokter P. Jawab</th>
								<th width="18%">Layanan</th>
								<th width="12%" class="center">Waktu Hasil</th>
								<th width="5%"></th>
							</tr>
						</thead>
						<tbody></tbody>
...
<?php $this->load->view('pelayanan/item_fisioterapi_form/modal_item_fisioterapi.php') ?>