...
<div id="modal-barang-gizi" class="modal fade" role="dialog">
    <div class="modal-dialog modal-dialog-scrollable" style="max-width: 820px">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="modal-barang-gizi-label"></h4>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>
            <div class="modal-body">
                <?= form_open('', 'role=form class=form-horizontal id=form-barang-gizi'); ?>
                <div class="row">
                    <div class="col-lg-12">
