...
<table border="1">
    ...
    <tbody>
        <?php foreach ($data as $key => $value) : ?>
            <tr>
                <td><?= ++$key ?></td>
                <td style="mso-number-format:\@;" align="left"><?= $value->code ?></td>
                <td><?= $value->bidang ?></td>
                <td><?= $value->nama ?></td>
                <td><?= $value->pabrik ?></td>
                <td style="mso-number-format:\@;" align="right"><?= formatcurrency($value->hpp) ?></td>
                <td style="mso-number-format:\@;" align="right"><?= formatcurrency($value->margin_non_resep) ?></td>
