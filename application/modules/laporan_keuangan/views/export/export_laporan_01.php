<?php
	header_excel("Laporan Pendapatan Berdasarkan Layanan Dokter DPJP - ".$periode);
...
<body>
	...
	<div>
		<h4>Laporan Pendapatan Berdasarkan Layanan Dokter DPJP
			<br>Periode : <?= $periode ?>
    ...
    <table border="1">
		<thead border="2">
            <tr height="30pt" style="text-transform: uppercase;">
                ...
                <th style="background-color: #9cc8ff; text-align: center;" rowspan="3">BHP</th>
            </tr>
            <tr height="30pt" style="text-transform: uppercase;">
		...
		<tbody>
                ...
                foreach ($data as $key_dokter => $penjamin_list) {
                    ...
                    foreach ($penjamin_list as $key_penjamin => $layanan_list) {
                        ...
                        foreach ($layanan_list as $key_layanan => $value_layanan) {
                            ...
                            if ($layanan === 'Bhp') {
                                $bhp = isset($value_layanan[0]->total) ? $value_layanan[0]->total : 0;
                            }
                        ...
                        $all_resep     += (int)$resep;    $all_bhp         += (int)$bhp;                         
						...
						<tr>
							...
							<td style="text-align: right;"><?= number_format($bhp, 0, ",", ".") ?></td>
			...
			?>
				<tr style="background-color: #45b1ff94;">
                    ...
                    <td style="text-align: right;" ><b><?= number_format($all_bhp, 0, ",", ".") ?></b></td>
                </tr>
		</tbody>
	</table>
</body>
