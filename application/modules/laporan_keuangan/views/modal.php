	...
	<div class="modal-dialog" style="max-width:500px">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="form-group row tight">
					<label for="kelas-rawat-search" class="col-md-3 col-form-label">Kelas Rawat</label>
					<div class="col-md-9">
						<?= form_dropdown('kelas_rawat', $kelas_rawat, array(), 'id=kelas-rawat-search class=form-control') ?>
						<!-- <select id="kelas-rawat-search" name="kelas_rawat" class="form-control">
							...
							<option value="5">Kelas VIP</option>
						</select> -->
					</div>
				</div>
				<div class="form-group row tight">
					<label for="jenis-rawat-search" class="col-md-3 col-form-label">Jenis Rawat</label>
					<div class="col-md-9">
						<select id="jenis-rawat-search" name="jenis_rawat" class="form-control">
				...
				<div class="form-group row tight">
					<label id="notif-modal-label" style="padding-left: 10px; padding-right: 10px; padding-top: 15px;"></label>
				</div>
				<?= form_close() ?>
			</div>
			<div class="modal-footer">
				<button type="button" class="btn btn-secondary waves-effect" data-dismiss="modal"><i class="fas fa-window-close mr-1"></i>Keluar</button>
				<button type="button" class="btn btn-info waves-effect" onclick="getLaporanKeuangan(1)"><i class="fas fa-paper-plane mr-1"></i> Tampilkan</button>
			</div>
		</div>
		<!-- /.modal-content -->
	</div>
