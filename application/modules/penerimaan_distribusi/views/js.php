<script>
    ...
    function getListPenerimaanDistribusi(page) {
		...
		$.ajax({
			type: 'GET',
			url: '<?php echo base_url('penerimaan_distribusi/api/penerimaan_distribusi/get_list_penerimaan_distribusi') ?>/page/' + page,
    ...
    function simpanPenerimaanDistribusi() {
        ...
        swal.fire({
			...
			if (result.value) {
				$.ajax({
                    type: 'POST',
                    url: '<?php echo base_url('penerimaan_distribusi/api/penerimaan_distribusi/simpan_penerimaan_distribusi') ?>',
    ...
    function  deletePenerimaanDistribusi(id) {
        swal.fire({
			...
			if (result.value) {
				$.ajax({
                    type: 'DELETE',
                    url: '<?php echo base_url('penerimaan_distribusi/api/penerimaan_distribusi/delete_penerimaan_distribusi') ?>/id/' + id,
                    dataType:'JSON',
                    beforeSend: function() {
                        showLoader()
                    },
