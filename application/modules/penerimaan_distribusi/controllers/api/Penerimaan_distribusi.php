 ...
 */
class Penerimaan_distribusi extends REST_Controller
{
	...
	function __construct()
	{
		...
		$this->load->model('Penerimaan_distribusi_model', 'm_penerimaan_distribusi');
    ...
    function get_list_penerimaan_distribusi_get()
    {
		...
		$data            = $this->m_penerimaan_distribusi->getListDataPenerimaanDistribusi($limit, $start, $search);
	...
	{	
		...
		$data = $this->m_penerimaan_distribusi->simpanDataPenerimaanDistribusi();
	...
	{
		$id = $this->get('id', true);
		$data = $this->m_penerimaan_distribusi->deleteDataPenerimaanDistribusi($id);
		$this->response($data, REST_Controller::HTTP_OK);
	}
}
