...
<!-- Modal Grouping (Set Claim Data) -->
<!-- <div id="modal-grouper-eklaim" class="modal fade"> -->
<div id="modal-grouper-eklaim" class="modal fade" role="dialog" data-backdrop="static" aria-hidden="true">
	<div class="modal-dialog modal-dialog-scrollable" style="max-width:95%">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title"><i class="fas fa-fw fa-info mr-1"></i>KLAIM</h4>
				<button type="button" class="close" data-dismiss="modal" onclick="closeTabEklaim()" aria-hidden="true">&times;</button>
			</div>
							...
							<div class="tab-content tabcontent-border coding-grouper">
								...
								<div class="tab-pane p-20" id="coding-ina-grouper" role="tabpanel">
									<div class="col-lg-12 d-flex justify-content-end">
										<p class="pointer" id="import-coding">[ import coding ]</p>
									</div>
									<div class="row p-20" style="padding-bottom: 0px;">
...
<?php $this->load->view('coding-grouping/js_eklaim') ?>
<?php $this->load->view('coding-grouping/js_eklaim_auto') ?>
<!-- End Modal Grouping (Set Claim Data) -->
