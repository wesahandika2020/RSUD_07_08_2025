 ...
 */
class Resep_ranap extends REST_Controller
{
    ...
    function __construct()
    {
        parent::__construct();
        $this->limit = 10;
        $this->load->model('Resep_ranap_model', 'resep_ranap');
    ...
    function get_list_resep_ranap_get()
    {
        if (!$this->get('page')) :
        ...
        $data           = $this->resep_ranap->getListDataResepRanap($this->limit, $this->start($this->get('page')), $search);
