...
<input type="hidden" id="jenis-barang" value="Rumah Tangga">
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                    ...
                    <table id="table-data" class="table table-hover table-striped table-sm color-table info-table m-t-5">
                        <thead>
                            <tr>
                                ...
                                <th class="left" width="10%">Brg Bidang</th>
                                <th class="left" width="20%">Nama</th>
                                <th class="left" width="10%">Pembayaran</th>
                                <th class="left" width="17%">Pabrik</th>
                                <th class="right" width="10%">HPP</th>
                                <th class="center" width="5%">Margin</th>
