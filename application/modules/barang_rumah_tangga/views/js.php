...
<script>
    $(function() {
        ...
        $('#btn-tambah').click(function() {
            $('#modal-barang-rumah-tangga').modal('show');
            $('#modal-barang-rumah-tangga-label').html('Tambah Barang');
            resetForm();
        ...
        $('#btn-excel').click(function() {
            location.href='<?= base_url('barang_rumah_tangga/export_data_barang') ?>?'+$('#form-search').serialize()+'&keyword='+$('#pencarian').val();
        });
            ...
            buttons: {
                ...
                hapus: {
                    ...
                    callback: function() {
                        ...
                        $.ajax({
                            type : 'DELETE',
                            url: '<?= base_url("barang_rumah_tangga/api/barang_rumah_tangga/kemasan_barang") ?>/id/'+id,
                            cache: false,
                            dataType : 'JSON',
    ...
    function simpanData() {
        ...
        $.ajax({
            type: 'POST',
            url: '<?= base_url("barang_rumah_tangga/api/barang_rumah_tangga/simpan_barang") ?>' + update,
            data: $('#form-barang-rumah-tangga').serialize(),
            cache: false,
            dataType: 'JSON',
            beforeSend: function() {
                showLoader();
            ...
            success: function(data) {
                ...
                $('#modal-barang-rumah-tangga').modal('hide');
    ...
    function getListBarang(p, id_barang) {
        ...
        $.ajax({
            type: 'GET',
            url: '<?= base_url("barang_rumah_tangga/api/barang_rumah_tangga/get_list_barang") ?>/page/' + p + '/id' + id,
    ...
    function editBarang(id) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $('#modal-barang-rumah-tangga').modal('show');
                $('#modal-barang-rumah-tangga-label').html('Edit Barang');
            },
            error: function(e) {
                accessFailed(e.status);
            }
