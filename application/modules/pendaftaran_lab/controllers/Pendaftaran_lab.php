...
class Pendaftaran_lab extends SYAM_Controller
{
    ...
    function cetak_bukti_kunjungan_lab($id_pendaftaran)
    {
        if ($id_pendaftaran !== null) :
            ...
            $this->load->view('pendaftaran_lab/printing/bukti_kunjungan_lab', $data);
        endif;
    }
    ...
    function cetak_kartu_pasien_lab($id_pendaftaran)
    {
        if ($id_pendaftaran !== null) :
            ...
            // echo json_encode($data); die;
            $this->load->view('pendaftaran_lab/printing/kartu_pasien_lab', $data);
        endif;
    }    
}