            ...
            <div class="card-body">
                <div class="row">
                    <div class="col d-flex justify-content-start">
                        <?= form_button('tambah', '<i class="fas fa-plus-circle mr-1"></i>Tambah Kamar', 'id=btn-tambah class="btn btn-info waves-effect mr-1"') ?>
                    ...
                    <div class="col d-flex justify-content-end">
                        <div class="custom-search">
                            <input type="text" class="search-query-white" onkeyup="getListKamar(1)" id="keyword" placeholder="Pencarian ...">
                    ...
                    <table id="table-data" class="table table-hover table-striped table-sm color-table info-table m-t-5">
                        <thead>
                            <tr>
                                ...
                                <th class="left" width="20%">Nama Bangsal</th>
                                <th class="center" width="15%">Kode Kelas BPJS</th>
                                <th class="center" width="10%">Kelas</th>
                                <th class="center" width="10%">No. Kamar</th>
                                <th class="left" width="20%">Keterangan</th>
                                <th class="left" width="10%">Dipakai</th>
