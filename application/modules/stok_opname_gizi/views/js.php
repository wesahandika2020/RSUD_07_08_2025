<script>
	...
	function getListStokGizi(page, id_stok_opname) {
		var id = '';
		...
		$.ajax({
			type: 'GET',
			url: '<?php echo base_url('stok_opname_gizi/api/stok_opname_gizi/get_list_stok_gizi/page/') ?>' + page + '/id/' + id ,
				...
				$.each(data.data, function(i, v) {
					let html = '<tr>'+
									...
									'<td class="right wrapper">'+
										'<button type="button" class="btn btn-secondary btn-xs mr-1" onclick="editStokGizi('+v.id+', \''+v.nama_barang+'\')"><i class="fas fa-edit"></i></button>'+
	...
	function simpanStokGizi() {
		$.ajax({
			type: 'POST',
			url: '<?php echo base_url('stok_opname_gizi/api/stok_opname_gizi/simpan_stok_gizi') ?>',
	...
	function editStokGizi(id, nama_barang) {
		$.ajax({
			type: 'GET',
			url: '<?php echo base_url('stok_opname_gizi/api/stok_opname_gizi/get_stok_gizi') ?>/id/' + id,
			success: function(data) {
				$('#id').val(data.id)
	...
	function updateStokLogistik() {
		$.ajax({
			type: 'PUT',
			url: '<?php echo base_url('stok_opname_gizi/api/stok_opname_gizi/update_stok_gizi') ?>',
	...
	function hapusStokLogistik(id, page) {
		swal.fire({
			...
			if (result.value) {
				$.ajax({
					type: 'DELETE',
					url: '<?php echo base_url('stok_opname_gizi/api/stok_opname_gizi/delete_stok_gizi') ?>/id/' + id,
					success: function(data) {
						let page = $('#page').val()
						if (data.status) {
