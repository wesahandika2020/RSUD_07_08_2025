    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-3">
                        <h6><i class="fas fa-hospital-alt m-t-10 m-r-10"></i>Data List Pendataran IGD</h6>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <h6 class="d-flex justify-content-end">
                            <span class="m-t-5 m-r-5">Filter Jenis IGD :</span>
                            <?= form_dropdown('jenis_igd_search', $jenis_igd, array(), 'class="custom-form" style="width:50%" id=jenis_igd_search') ?>
                        </h6>
                    </div>
                </div>
                ...
                <table id="table_data" class="table table-hover table-striped table-sm color-table info-table">
                    <thead>
                        <tr>
                            ...
                            <th width="7%" class="center">Jenis IGD</th>
                            <th width="7%" class="center">Tgl Keluar</th>
                            <th></th>
                            <th width="7%" class="center">No Polish</th>
                            <th width="7%" class="center">No SEP</th>
                            <th width="9%" class="center">Cara Bayar</th>
                            <th width="7%" class="center">Status</th>
                            <th width="7%" class="center">Status Layanan</th>
                            <th width="7%">Petugas</th>
                            <th width="7%" class="nowrap"></th>
                        </tr>
                    </thead>
                    <tbody></tbody>
                </table>
