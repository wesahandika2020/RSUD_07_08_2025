                    ...
                    <div class="col-6">
                        <table class="table table-sm table-striped table-hover table-detail">
                            ...
                            <tr>
                                ...
                                <td><span id="kelas_rawat"></span></td>
                            </tr>
                            <tr>
                                <td></td>
                                <td>&nbsp;</td>
...
<!-- End Modal Detail Pendaftaran IGD  -->

<!-- Modal Edit Jenis IGD Pendaftaran IGD -->
<div id="modal_edit_jenisigd" class="modal fade" role="dialog" aria-labelledby="modal_edit_jenisigd_label" aria-hidden="true">
    <div class="modal-dialog" style="max-width: 45%">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="modal_edit_jenisigd_label"></h4>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>
            <div class="modal-body">
                <?= form_open('', 'id=form_edit_jenisigd role=form class=form-horizontal') ?>
                <input type="hidden" name="id_pendaftaran_jenisigd" id="id_pendaftaran_jenisigd" />
                <div class="form-group row tight">
                    <label class="col-4 col-form-label">Jenis IGD Asal</label>
                    <div class="col-8">
                        <h5 id="jenis_igd_asal" class="m-t-10 bold"></h5>
                    </div>
                </div>
                <div class="form-group row tight">
                    <label for="jenis-igd-baru" class="col-4 col-form-label">Jenis IGD Tujuan<span class="text-red">*</span></label>
                    <div class="col-8">
                        <?= form_dropdown('jenis_igd_baru', $jenis_igd, array(), 'class="form-control" style="width:95%" id=jenis-igd-baru') ?>
                    </div>
                </div>
                <?= form_close() ?>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary waves-effect" data-dismiss="modal"><i class="fas fa-window-close"></i> Keluar</button>
                <button type="button" class="btn btn-info waves-effect" onclick="simpanEditJenisigd()"><i class="fas fa-save"></i> Update</button>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
...
<!-- End Modal Edit Jenis IGD Pendaftaran IGD -->

<!-- Modal Edit Dokter Pendaftaran IGD -->
<div id="modal_edit_dokterigd" class="modal fade" role="dialog" aria-labelledby="modal_edit_dokterigd_label" aria-hidden="true">
    <div class="modal-dialog" style="max-width: 45%">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="modal_edit_dokterigd_label"></h4>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>
            <div class="modal-body">
                <?= form_open('', 'id=form_edit_dokterigd role=form class=form-horizontal') ?>
                <input type="hidden" name="id_layanan_pendaftaran_dokterigd" id="id_layanan_pendaftaran_dokterigd" />
                <div class="form-group row tight">
                    <label class="col-4 col-form-label">Dokter IGD Asal</label>
                    <div class="col-8">
                        <h5 id="dokter_igd_asal" class="m-t-10 bold"></h5>
                    </div>
                </div>
                <div class="form-group row tight">
                    <label for="dokter-edit" class="col-4 col-form-label">Dokter IGD Tujuan<span class="text-red">*</span></label>
                    <div class="col-8">
                        <input type="text" name="dokter_edit" id="dokter-edit" class="select2-input">
                    </div>
                </div>
                <?= form_close() ?>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary waves-effect" data-dismiss="modal"><i class="fas fa-window-close"></i> Keluar</button>
                <button type="button" class="btn btn-info waves-effect" onclick="simpanEditDokterigd()"><i class="fas fa-save"></i> Update</button>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
...
<!-- End Modal Edit Dokter Pendaftaran IGD -->

<!-- Modal Edit Hak Kelas Pendaftaran IGD -->
...
<!-- End Modal Hak Kelas Pendaftaran IGD -->