...
<script>
	$(function () {
		...
		$('#btn-export').click(function() {
			window.open('<?= base_url('sisa_stok_logistik/export_sisa_stok_logistik?') ?>' + $('#form-search').serialize());
		});
	})
	...
	function getListSisaStok(page) {
		...
		$.ajax({
			type: 'GET',
			url: '<?= base_url("sisa_stok_logistik/api/sisa_stok_logistik/get_list_sisa_stok") ?>/page/' + page,
