...
class Sisa_stok_logistik extends SYAM_Controller
{
    ...
    function __construct()
    {
		...
		$this->load->model('Sisa_stok_logistik_model', 'stok');
    }
	...
	function page_sisa_stok_logistik() {
		...
		$this->load->view('sisa_stok_logistik/index', $data );
	}

	public function export_sisa_stok_logistik() {
		$search = [
		...
		$this->load->view('export/sisa_stok_logistik.php', $data );
	}
}
