<?php  
	...
	header_excel("Data Rawat Inap - " . $param_title);
?>

<body> 
	<h3>DATA RAWAT INAP (<?= $param_title ?>)</h3></td></tr>
		...
		<tbody>
			<?php foreach ($data as $i => $value) : ?>
				...
				<tr>
					...
					<td><?= $bed ?></td>
					<td><?= $value->dokter ?></td>
					<td align="center"><?= (($value->cara_bayar === 'Tunai') ? $value->cara_bayar : $value->penjamin) ?></td>
