        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group row tight">
                    ...
                    <div class="col-9">
                        <input name="dokter" id="dokter-icare" class="select2-input">
                    </div>
                </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-info waves-effect" onclick="getListDataOrderIntensiveCare(1)"><i class="fas fa-search mr-1"></i>Cari</button>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
...
<!-- Modal Batal Order Intensive Care -->
<div id="modal-batal-order-intensive-care" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Pembatalan Order Intensive Care</h4>
                <button type="button" class="close" data-dismiss="modal">×</button>
            </div>
            <div class="modal-body">
				<?= form_open('', 'role=form class=form-horizontal id=form-batal-order-intensive-care'); ?>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-info waves-effect" onclick="simpanPembatalanOrderIntensiveCare()"><i class="fas fa-check-circle mr-1"></i>Batalkan Order</button>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
...
<!-- End Modal Batal Order Intensive Care -->
...
<div id="modal-konfirmasi-bed" class="modal fade">
	<div class="modal-dialog" style="max-width: 45%;">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title" id="title-konfirmasi-bed">Konfirmasi Masuk Ruang Intensive Care</h4>
				<button type="button" class="close" data-dismiss="modal">x</button>
			</div>
			<div class="modal-body">
				<?= form_open('', 'id=form-intensive-care class=form-horizontal role=form') ?>
					<input type="hidden" name="id_order" id="id-order-icare">
					<input type="hidden" name="kelamin" id="kelamin">
					<input type="hidden" name="id_pendaftaran" id="id-pendaftaran-icare">
					...
					<p>Pasien dengan No. Rekam Medik <b class="no-rm-icare-label"></b> atas nama <b class="nama-icare-label"></b> akan masuk Intensive Care <b class="bed-icare-detail"></b></p>
				<?= form_close() ?>
			</div>
			<div class="modal-footer">
				<button type="button" class="btn btn-secondary" data-dismiss="modal"><i class="fas fa-times-circle mr-1"></i>Batal</button>
				<button type="button" class="btn btn-info" onclick="sendIntensiveCare()"><i class="fas fa-paper-plane mr-1"></i>Send</button>
			</div>
		</div>
	</div>
</div>
