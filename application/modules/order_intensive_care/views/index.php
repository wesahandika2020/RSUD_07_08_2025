    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-lg-6">
                        <?php if ($this->session->userdata('account_group') == 'Maternal dan Neotanal') : ?>
                            <h6><i class="fas fa-hospital-alt m-t-10 m-r-10"></i>List Data Permintaan Intensive Care (<?= $this->session->userdata('account_group') ?>)</h6>
                        <?php else : ?>
                            <h6><i class="fas fa-hospital-alt m-t-10 m-r-10"></i>List Data Permintaan Intensive Care (<?= $this->session->userdata('unit') ?>)</h6>
                        <?php endif; ?>
                    </div>
