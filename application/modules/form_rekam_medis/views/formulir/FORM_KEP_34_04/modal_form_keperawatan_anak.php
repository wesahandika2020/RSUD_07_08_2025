<!-- // PAKARJ -->
<div class="modal fade" id="modal_form_keperawatan_anak_rm" data-backdrop="static">
    <div class="modal-dialog modal-dialog-scrollable" style="max-width: 90%;">
        <div class="modal-content">
            <div class="modal-header">
                <div class="title">
                    <h5 class="modal-title bold" id="modal_form_keperawatan_anak_rm">FORM PENGKAJIAN KEPERAWATAN NEONATUS / PEDIATRIK RAWAT JALAN</h5>
            ...
            <div class="modal-body">
                ...
                <input type="hidden" name="id_pasien" id="id-pasien-pakarj">
            ...
            <div class="modal-footer">
                ...
                <button id="btn-simpan" type="button" class="btn btn-info" onclick="konfirmasiSimpanEntriFormKeperawatanAnak()"><i
