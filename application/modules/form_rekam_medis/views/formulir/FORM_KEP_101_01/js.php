<script>
	...
	function lihatFORM_KEP_101_01(data) {
		let pasien = data.pasien;
		let layanan = data.layanan;
		let action = 'lihat';

		entriLaporanHemodialisa(layanan.id_pendaftaran, layanan.id, action);
	}

	function editFORM_KEP_101_01(data) {
		let pasien = data.pasien;
		let layanan = data.layanan;
		let action = 'edit';
	...
	function tambahFORM_KEP_101_01(data) {
		let pasien = data.pasien;
		let layanan = data.layanan;
		let action = 'tambah';
	...
	function entriLaporanHemodialisa(id_pendaftaran, id_layanan_pendaftaran, action) {
		...
		$.ajax({
			...
			success: function(data) {
				...
				$('#id-pasien-laporan-hd').val(data.pasien.id_pasien);
	...
	function simpanLaporanHD() {
		...
		$.ajax({
			...
			success: function(data) {
				...
				showListForm($('#id-pendaftaran-laporan-hd').val(), $('#id-layanan-pendaftaran-laporan-hd').val(), $('#id-pasien-laporan-hd').val());
			},
			complete: function() {
				hideLoader()
			},
