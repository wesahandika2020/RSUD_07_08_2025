		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<?= form_open('', 'id=form-laporan-hd class=form-horizontal') ?>
					...
					<input type="hidden" name="id_pasien" id="id-pasien-laporan-hd">
						...
						<div class="row">
							<div class="col-lg-6">
								<div class="form-group row tight">
									...
									<div class="col-lg-8">
										<span class="bold" style="font-size: 12px">E</span> <input type="text" name="gcs_e" id="gcs-e" class="custom-form d-inline-block col-lg-2 clear-input"placeholder="" onkeypress="return hanyaAngka(event)">
										<span class="bold" style="font-size: 12px">M</span> <input type="text" name="gcs_m" id="gcs-m" class="custom-form d-inline-block col-lg-2 clear-input"placeholder="" onkeypress="return hanyaAngka(event)">
										<span class="bold" style="font-size: 12px">V</span> <input type="text" name="gcs_v" id="gcs-v" class="custom-form d-inline-block col-lg-2 clear-input"placeholder="" onkeypress="return hanyaAngka(event)">
									</div>
								</div>
								<div class="form-group row tight">
			...
			<div class="modal-footer">
				...
				<button type="button" class="btn btn-info" id="btn-simpan" onclick="konfirmasiSimpanLaporanHD()"><i class="fas fa-save mr-1"></i>Simpan</button>
			</div>
		</div>
	</div>
</div>