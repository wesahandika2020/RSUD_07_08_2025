  ...
  <div class="modal-dialog modal-dialog-scrollable" style="max-width: 90%;">
    <div class="modal-content">
      <div class="modal-header">
        <div class="title">
          <h5 class="modal-title bold" id="modal_entri_keperawatan_rm">PENGKAJIAN ULANG NYERI DAN PEMANTAUAN NYERI</h5>
        </div>
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card-body">
              ...
              <div class="form-pemantauan-nyeri">
                <!-- <h5 class="center"><b>PENGKAJIAN ULANG NYERI DAN PEMANTAUAN NYERI</b></h5> -->
                <table class="table table-no-border table-sm table-striped">
                  <tr>
                    <td colspan="3">
                      <button class="btn btn-info btn-xs mr-1 float-left" type="button" id="pun-btn-expand-all"><i class="fas fa-fw fa-expand mr-1"></i>Expand All</button>
                      <button class="btn btn-warning btn-xs mr-1 float-left" type="button" id="pun-btn-collapse-all"><i class="fas fa-fw fa-compress mr-1"></i>Collapse All</button>
                    </td>
                  </tr>
                </table>
                <table class="table table-no-border table-sm table-striped" style="margin-top:-15px">
                  <tr>
                    <td colspan="3" class="center bold td-dark">
                      <button class="btn btn-info btn-xs mr-1 float-left" type="button" data-toggle="collapse" data-target="#data-pengkajian-pemantauan-nyeri"><i class="fas fa-expand mr-1"></i>Expand</button>PENGKAJIAN DAN
                      PEMANTAUAN NYERI
                    </td>
                  </tr>
                </table>

                <div class="collapse multi-collapse mt-2" id="data-pengkajian-pemantauan-nyeri">
                  <div class="row">
                    <div class="col-lg-6">
                      <div id="buka-pengkajian-pemantauan">
                      </div>

                      <table class="table table-no-border table-sm table-striped" id="tabel-pengkajian-pemantauan">
                        <thead>
                          <tr>
                            <th class="center"><b>No</b></th>
                            <th class="center"><b>Tanggal</b></th>
                            <?php if ($this->session->userdata('account_group') === 'Admin') : ?>
                              <th class="center"><b>Waktu</b></th>
                              <th class="center"><b>Skor Nyeri</b></th>
                            <?php else : ?>
                              <th class="center"><b>Skor Nyeri</b></th>
                            <?php endif ?>
                            <th class="center"><b>Tindakan</b></th>
                            <?php if ($this->session->userdata('account_group') === 'Admin') : ?>
                    ...
                    <div class="col-lg-6">
                      <table class="table table-no-border table-sm table-striped">
                        <tr>
                          ...
                          <td><b>Skor Nyeri</b><br><br>0 : Tidak ada Nyeri<br>1 - 3 :
                            Nyeri Ringan<br>4 - 6 : Nyeri Sedang<br>7 - 10 : Nyeri
                            Berat<br><br><b>Pengkajian Ulang</b><br><br>1x/shift bila
                            skor nyeri 1-3<br>setiap 3 jam bila skor nyeri 4-6<br>setiap
                            1 jam bila skor nyeri 7-10<br>dihentikan bila skor nyeri 0
                          </td>
              ...
              <!-- End Pengkajian ulang nyeri dan pemantauan nyeri-->
