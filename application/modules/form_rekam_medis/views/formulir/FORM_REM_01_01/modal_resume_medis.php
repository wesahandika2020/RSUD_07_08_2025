<script>
	...
	function cetakResumeMedisRanap() {
		const id = $('#rm_id_layanan_pendaftaran').val();
		const id_daftar = $('#rm-id-pendaftaran').val();
		const id_pasien = $('#ek_id_pasien').val();
		...
		showListForm(id_daftar, id, id_pasien);
	...
	<div class="modal-dialog modal-dialog-scrollable" style="max-width: 90%;">
		<div class="modal-content">
						...
						<div class="widget-body">
							<div id="wizard_form_ranap">
								<div class="form-modal-resume-medis">
									<table class="table table-no-border table-sm table-striped">
										...
										<tr>
											...
											<td>
												...
												<button id="button-cppt" type="button" class="btn btn-outline-info btn-rounded">
													<i class="fas fa-file-alt mr-2"></i>HASIL CPPT
												</button>
												<button id="button-lab" type="button" class="btn btn-outline-info btn-rounded">
													<i class="fas fa-file-medical-alt mr-2"></i>HASIL LABORATORIUM
												</button>
												<button id="button-rad" type="button" class="btn btn-outline-info btn-rounded">
													<i class="fas fa-file mr-2"></i>HASIL RADIOLOGI
												</button>
											</td>
										</tr>
										<tr>
									...
									<table class="table table-no-border table-sm table-striped">
										<tr>
											<td width="25%"><b>Cara Pemberian Terapi / Pengobatan Selama di Rumah Sakit</b></td>
											<td width="1%"><b>:</b></td>
											<td>
												<textarea name="cara_terapi_pengobatan_rm" class="form-control" id="cara-terapi-pengobatan-rm" rows="3"></textarea>
											</td>
										</tr>
										<tr>
										...
										<tr>
											<td width="25%"><b class="mr-2">Diagnosis Utama</b> <span id="button-edit-diagnosa"></span></td>
											<td width="1%"><b>:</b></td>
											<td>
			...
			<div class="modal-footer">
				<button id="btn_keluar" type="button" class="btn btn-secondary" data-dismiss="modal"><i class="fas fa-fw fa-times-circle mr-1"></i>Keluar</button>
				<!-- <div id="btn_simpan"></div> -->
				<button type="button" class="btn btn-info" id="btn___simpan" onclick="simpanResumeMedisRanap()"></button>
