...
<script>
	$(function() {
		...
		$('#informasi_dari_lain_anak').click(function() {
			if ($(this).is(":checked")) {
				$('#informasi_dari_lain_anak_inputt').prop('disabled', false);
			} else {
				$('#informasi_dari_lain_anak_inputt').val('');
				$('#informasi_dari_lain_anak_inputt').prop('disabled', true);
			}
		});

		$('#faktor_pencetus_lain_anak').click(function() {
			if ($(this).is(":checked")) {
				$('#faktor_pencetus_lain_input_anak').prop('disabled', false);
			} else {
				$('#faktor_pencetus_lain_input_anak').val('');
				$('#faktor_pencetus_lain_input_anak').prop('disabled', true);
			}
		});

		$('#rpt_lain_anak').click(function() {
			if ($(this).is(":checked")) {
				$('#rpt_lain_anak_input').prop('disabled', false);
			} else {
				$('#rpt_lain_anak_input').val('');
				$('#rpt_lain_anak_input').prop('disabled', true);
			}
		});

		$('#rpk_lain_anak').click(function() {
			if ($(this).is(":checked")) {
				$('#rpk_lain_anak_input').prop('disabled', false);
			} else {
				$('#rpk_lain_anak_input').val('');
				$('#rpk_lain_anak_input').prop('disabled', true);
			}
		});
		...
		$('#riwayat_imunisasi_anak_tidak_lengkap').click(function() {
			if ($(this).is(":checked")) {
				$('#riwayat_imunisasi_anak_lain').prop('disabled', false);
			} else {
				$('#riwayat_imunisasi_anak_lain').val('');
				$('#riwayat_imunisasi_anak_lain').prop('disabled', true);
			}
		});
		...
		$('#sps_lain_anak').click(function() {
			if ($(this).is(":checked")) {
				$('#sps_lain_input_anak').prop('disabled', false);
			} else {
				$('#sps_lain_input_anak').val('');
				$('#sps_lain_input_anak').prop('disabled', true);
			}
		});
		...
		$('#pengeluaran_stomata').click(function() {
			if ($(this).is(":checked")) {
				$('#pengeluaran_stomata_lokasi').prop('disabled', false);
			} else {
				$('#pengeluaran_stomata_lokasi').val('');
				$('#pengeluaran_stomata_lokasi').prop('disabled', true);
			}
		});
		...
		$('#pk_pm_lain_anak').click(function() {
			if ($(this).is(":checked")) {
				$('#pk_pm_lain_anak_input').prop('disabled', false);
			} else {
				$('#pk_pm_lain_anak_input').val('');
				$('#pk_pm_lain_anak_input').prop('disabled', true);
			}
		});
		...
		$('#pk_pdtt_lain_anak').click(function() {
			if ($(this).is(":checked")) {
				$('#pk_pdtt_lain_anak_input').prop('disabled', false);
			} else {
				$('#pk_pdtt_lain_anak_input').val('');
				$('#pk_pdtt_lain_anak_input').prop('disabled', true);
			}
		});
		...
		$('#masalah_keperawatan_30_anak').click(function() {
			if ($(this).is(":checked")) {
				$('#masalah_keperawatan_lain_input_anak').prop('disabled', false);
			} else {
				$('#masalah_keperawatan_lain_input_anak').val('');
				$('#masalah_keperawatan_lain_input_anak').prop('disabled', true);
			}
		});
		...
		$('#kriteria_discharge_9_anak').click(function() {
			if ($(this).is(":checked")) {
				$('#kriteria_discharge_lain_input_anak').prop('disabled', false);
			} else {
				$('#kriteria_discharge_lain_input_anak').val('');
				$('#kriteria_discharge_lain_input_anak').prop('disabled', true);
			}
		});
		...
		function hitungSkalaEarly() {
			...
			for (let i = 1; i <= 17; i++) { // Loop untuk iterasi baris dari 1 hingga 17
				...
				for (let j = 1; j <= 7; j++) { // Loop untuk iterasi kolom dari 1 hingga 7
					...
					if ($('#skalapewsk_' + i + '_' + j).is(':checked')) { // Memeriksa apakah elemen dengan ID tertentu tercentang
						var getNilai = $('#skalapewsk_' + i + '_' + j).val(); // Mengambil nilai dari elemen yang tercentang
			...
			if (total >= 0 && total <= 2) {
				$('#sew_total_1').prop('checked', true); // Jika total antara 0 dan 2, centang elemen dengan ID 'sew_total_1'
			} else if (total >= 3 && total <= 4) {
				$('#sew_total_2').prop('checked', true); // Jika total antara 3 dan 4, centang elemen dengan ID 'sew_total_2'
			} else if (total >= 5) {
				$('#sew_total_3').prop('checked', true); // Jika total 5 atau lebih, centang elemen dengan ID 'sew_total_3'
			}
		}
	...
	function calcscoresna() {
		...
		$("input[name='skrining_jumlah_skor']").val(score);
		calcscoresna
	}
	...
	function calcscoreprja() {
		...
		$("input[name='prja_nilai_total']").val(score);
		calcscoreprja
	}
	...
	function lihatFORM_KEP_37_03(data) {
		let pasien = data.pasien;
		let layanan = data.layanan;
		let bed = layanan.bangsal + ' kelas ' + layanan.kelas + ' ruang ' + layanan.no_ruang + ' No. Bed ' + layanan.no_bed;
		let action = 'lihat';

		entriPengkajianAnak(layanan.id_pendaftaran, layanan.id, bed, action);
	}

	function editFORM_KEP_37_03(data) {
		let pasien = data.pasien;
		let layanan = data.layanan;
		let bed = layanan.bangsal + ' kelas ' + layanan.kelas + ' ruang ' + layanan.no_ruang + ' No. Bed ' + layanan.no_bed;
		let action = 'edit';
	...
	function tambahFORM_KEP_37_03(data) {
		let pasien = data.pasien;
		let layanan = data.layanan;
		let bed = layanan.bangsal + ' kelas ' + layanan.kelas + ' ruang ' + layanan.no_ruang + ' No. Bed ' + layanan.no_bed;
		let action = 'tambah';
	...
	function entriPengkajianAnak(id_pendaftaran, id_layanan_pendaftaran, bed, action) {
		...
		$.ajax({
			...
			success: function(data) {
				...
				$('#id_pendaftaran_anak').val(id_pendaftaran);
				...
				if (data.layanan !== null) {
					...
					if (data.layanan.before !== null) {
						if (data.layanan.before.jenis_layanan == 'Poliklinik') {
							$('#cara_masuk_irj_anak').prop('checked', true).attr('disabled', false)
						}
						if (data.layanan.before.jenis_layanan == 'IGD') {
							$('#cara_masuk_igd_anak').prop('checked', true).attr('disabled', false)
						}
						if (data.layanan.before.jenis_layanan == 'Hemodialisa') {
							$('#cara_masuk_lain_anak').prop('checked', true).attr('disabled', false)
						}
						if (data.layanan.before.jenis_layanan == 'Hemodialisa') {
							$('#cara_masuk_lain_input_anak').val(data.layanan.before.jenis_layanan)
						}
					}
				}
				...
				$('#modal_pengkajian_awal_pasien_anak').modal('show');
			},
			complete: function() {
				hideLoader()
			},
	...
	function showKajianPerawatAnak(data) {
		...
		// cara_tiba_diruangan
		if (data.cara_tiba_diruangan_anak === 'Jalan') {
			$('#cara_tiba_diruangan_anak_jalan').prop('checked', true).change()
		}
		if (data.cara_tiba_diruangan_anak === 'Brankar') {
			$('#cara_tiba_diruangan_anak_brankar').prop('checked', true).change()
		}
		if (data.cara_tiba_diruangan_anak === 'Kursi Roda') {
			$('#cara_tiba_diruangan_anak_kursi_roda').prop('checked', true).change()
		}
		...
		if (informasi.pasien !== '') {
			$('#informasi_dari_pasien_anak').prop('checked', true)
		}
		if (informasi.keluarga !== '') {
			$('#informasi_dari_keluarga_anak').prop('checked', true)
		}
		if (informasi.lain !== '') {
		...
		if (faktor_pencetus.infeksi !== '') {
			$('#faktor_pencetus_infeksi_anak').prop('checked', true)
		}
		...
		// sifat keluhan
		if (data.sifat_keluhan_anak === 'Akut') {
			$('#sifat_keluhan_anak_akut').prop('checked', true).change()
		}
		if (data.sifat_keluhan_anak === 'Kronik') {
			$('#sifat_keluhan_anak_kronik').prop('checked', true).change()
		}
		// end sifat keluhan
		...
		if (rpt.asma !== '') {
			$('#rpt_asma_anak').prop('checked', true)
		}
		if (rpt.hipertensi !== '') {
			$('#rpt_hipertensi_anak').prop('checked', true)
		}
		if (rpt.jantung !== '') {
			$('#rpt_jantung_anak').prop('checked', true)
		}
		if (rpt.diabetes !== '') {
			$('#rpt_diabetes_anak').prop('checked', true)
		}
		if (rpt.hepatitis !== '') {
			$('#rpt_hepatitis_anak').prop('checked', true)
		}
		if (rpt.lain !== '') {
		...
		if (rpk.asma !== '') {
			$('#rpk_asma_anak').prop('checked', true)
		}
		if (rpk.hipertensi !== '') {
			$('#rpk_hipertensi_anak').prop('checked', true)
		}
		if (rpk.jantung !== '') {
			$('#rpk_jantung_anak').prop('checked', true)
		}
		if (rpk.diabetes !== '') {
			$('#rpk_diabetes_anak').prop('checked', true)
		}
		if (rpk.hepatitis !== '') {
			$('#rpk_hepatitis_anak').prop('checked', true)
		}
		if (rpk.lain !== '') {
		...
		if (pernah_dirawat.dirawat === '0') {
			$('#pernah_dirawat_anak_tidak').prop('checked', true).change()
		}
		if (pernah_dirawat.dirawat === '1') {
			$('#pernah_dirawat_anak_ya').prop('checked', true).change()
		}
		...
		//Obat dari luar 
		if (data.obat_dari_luar_anak === '1') {
			$('#obat_luar_anak_ya').prop('checked', true).change()
		}
		if (data.obat_dari_luar_anak === '0') {
			$('#obat_luar_anak_tidak').prop('checked', true).change()
		}
		//end obat dari luar 

		// Riwayat Alergi Pasien
		// alergi
		if (data.alergi_anak === '0') {
			$('#alergi_anak_tidak').prop('checked', true).change()
		}
		if (data.alergi_anak === '1') {
			$('#alergi_anak_ya').prop('checked', true).change()
		}
		if (data.alergi_anak === '2') {
			$('#alergi_anak_tidak_tahu').prop('checked', true).change()
		}
		...
		if (data.riwayat_kelahiran_anak === 'Spontan') {
			$('#riwayat_kelahiran_anak_spontan').prop('checked', true).change()
		}
		if (data.riwayat_kelahiran_anak === 'Operasi') {
			$('#riwayat_kelahiran_anak_operasi').prop('checked', true).change()
		}
		if (data.riwayat_kelahiran_anak === 'Cukup Bulan') {
			$('#riwayat_kelahiran_anak_cukup_bulan').prop('checked', true).change()
		}
		if (data.riwayat_kelahiran_anak === 'Kurang Bulan') {
			$('#riwayat_kelahiran_anak_kurang_bulan').prop('checked', true).change()
		}

		if (data.menangis === '1') {
			$('#menangis_anak_ya').prop('checked', true).change()
		}
		if (data.menangis === '0') {
			$('#menangis_anak_tidak').prop('checked', true).change()
		}

		if (data.riwayat_kuning === '1') {
			$('#riwayat_kuning_anak_ya').prop('checked', true).change()
		}
		if (data.riwayat_kuning === '0') {
			$('#riwayat_kuning_anak_tidak').prop('checked', true).change()
		}

		// Riwayat Imunisasi Dasar
		var riwayat_imunisasi = JSON.parse(data.riwayat_imunisasi);
		if (riwayat_imunisasi.lengkap !== '') {
			$('#riwayat_imunisasi_anak_lengkap').prop('checked', true)
		}
		if (riwayat_imunisasi.tidak_pernah !== '') {
			$('#riwayat_imunisasi_anak_tidak_pernah').prop('checked', true)
		}
		...
		// Status Fungsional		
		if (data.stts_fungsional_mandiri === '1') {
			$('#status_fungsional_mandiri_anak_ya').prop('checked', true).change()
		}
		if (data.stts_fungsional_mandiri === '0') {
			$('#status_fungsional_mandiri_anak_tidak').prop('checked', true).change()
		}

		if (data.stts_fungsional_ketergantungan === '0') {
			$('#ketergantungan_total_anak_tidak').prop('checked', true).change()
		}
		if (data.stts_fungsional_ketergantungan === '1') {
			$('#ketergantungan_total_anak_ya').prop('checked', true).change()
		}
		...
		if (data.stts_fungsional_perlu_bantuan === '0') {
			$('#perlu_bantuan_anak_tidak').prop('checked', true).change()
		}
		if (data.stts_fungsional_perlu_bantuan === '1') {
			$('#perlu_bantuan_anak_ya').prop('checked', true).change()
		}
		...
		if (status_psikologi_anak.cemas !== '') {
			$('#sps_cemas_anak').prop('checked', true)
		}
		if (status_psikologi_anak.takut !== '') {
			$('#sps_takut_anak').prop('checked', true)
		}
		if (status_psikologi_anak.marah !== '') {
			$('#sps_marah_anak').prop('checked', true)
		}
		if (status_psikologi_anak.sedih !== '') {
			$('#sps_sedih_anak').prop('checked', true)
		}
		if (status_psikologi_anak.bunuh_diri !== '') {
			$('#sps_bunuh_diri_anak').prop('checked', true)
		}
		...
		if (data.hubungan_dengan_orang_tua === '1') {
			$('#hubungan_dengan_orang_tua_anak_baik').prop('checked', true).change()
		}
		if (data.hubungan_dengan_orang_tua === '0') {
			$('#hubungan_dengan_orang_tua_anak_tidak_baik').prop('checked', true).change()
		}

		if (data.tempat_tinggal_anak === 'Rumah') {
			$('#tempat_tinggal_anak_rumah').prop('checked', true).change()
		}
		if (data.tempat_tinggal_anak === 'Apartemen') {
			$('#tempat_tinggal_anak_apart').prop('checked', true).change()
		}
		if (data.tempat_tinggal_anak === 'Panti') {
			$('#tempat_tinggal_anak_panti').prop('checked', true).change()
		}

		if (data.tempat_tinggal_anak === 'Lain') {
			$('#tempat_tinggal_anak_lain').prop('checked', true).change()
		}
		...
		if (data.cara_bayar === 'Sendiri') {
			$('#cara_bayar_anak_biaya_sendiri').prop('checked', true).change()
		}
		if (data.cara_bayar === 'BPJS') {
			$('#cara_bayar_anak_bpjs').prop('checked', true).change()
		}
		if (data.cara_bayar === 'Asuransi') {
			$('#cara_bayar_anak_asuransi').prop('checked', true).change()
		}
		$('#cara_bayar_anak_asuransi_input').val(data.ket_cara_bayar_lain);
		if (data.cara_bayar_anak_t === 'Lain') {
			$('#cara_bayar_anak_lain').prop('checked', true).change()
		}
		...
		if (data.agama_anak === 'Islam') {
			$('#agama_anak_islam').prop('checked', true).change()
		}
		if (data.agama_anak === 'Kristen') {
			$('#agama_anak_kristen').prop('checked', true).change()
		}
		if (data.agama_anak === 'Hindu') {
			$('#agama_anak_hindu').prop('checked', true).change()
		}
		if (data.agama_anak === 'Katholik') {
			$('#agama_anak_katholik').prop('checked', true).change()
		}
		if (data.agama_anak === 'Budha') {
			$('#agama_anak_budha').prop('checked', true).change()
		}

		if (data.agama_anak === 'Lain') {
			$('#agama_anak_lain').prop('checked', true).change()
		}
		...
		if (data.wajib_ibadah_anak === 'Baligh') {
			$('#wajib_ibadah_anak_baligh').prop('checked', true).change()
		}
		if (data.wajib_ibadah_anak === 'Belum Baligh') {
			$('#wajib_ibadah_anak_belum').prop('checked', true).change()
		}
		if (data.wajib_ibadah_anak === 'Halangan') {
			$('#wajib_ibadah_anak_halangan').prop('checked', true).change()
		}
		$('#wajib_ibadah_anak_halangan_input').val(data.ket_wajib_ibadah_halangan_anak);

		if (data.thaharoh_anak === 'Berwudhu') {
			$('#thaharoh_anak_berwudhu').prop('checked', true).change()
		}
		if (data.thaharoh_anak === 'Tayamum') {
			$('#thaharoh_anak_tayamum').prop('checked', true).change()
		}

		if (data.sholat_anak === 'Berdiri') {
			$('#sholat_anak_berdiri').prop('checked', true).change()
		}
		if (data.sholat_anak === 'Duduk') {
			$('#sholat_anak_duduk').prop('checked', true).change()
		}
		if (data.sholat_anak === 'Berbaring') {
			$('#sholat_anak_berbaring').prop('checked', true).change()
		}

		// Identifikasi Kebutuhan Komunikasi
		if (data.kewarganegaraan_anak === 'WNI') {
			$('#kewarganegaraan_anak_wni').prop('checked', true).change()
		}
		if (data.kewarganegaraan_anak === 'WNA') {
			$('#kewarganegaraan_anak_wna').prop('checked', true).change()
		}

		if (data.pemahaman_penyakit === '1') {
			$('#pt_penyakit_perawatan_anak_ya').prop('checked', true).change()
		}
		if (data.pemahaman_penyakit === '0') {
			$('#pt_penyakit_perawatan_anak_tidak').prop('checked', true).change()
		}

		$('#suku_bangsa_anak').val(data.suku_bangsa);

		if (data.pemahaman_pengobatan === '1') {
			$('#pt_pengobatan_anak_ya').prop('checked', true).change()
		}
		if (data.pemahaman_pengobatan === '0') {
			$('#pt_pengobatan_anak_tidak').prop('checked', true).change()
		}

		if (data.bicara_anak === '1') {
			$('#bicara_anak_normal').prop('checked', true).change()
		}
		if (data.bicara_anak === '0') {
			$('#bicara_anak_gangguan').prop('checked', true).change()
		}
		// $('#bicara_anak_gangguan').val(data.bicara_anak);
		$('#bicara_input_anak').val(data.ket_bicara_anak);

		if (data.perlu_penterjemah === '1') {
			$('#perlu_penterjemah_anak_ya').prop('checked', true).change()
		}
		if (data.perlu_penterjemah === '0') {
			$('#perlu_penterjemah_anak_tidak').prop('checked', true).change()
		}
		...
		if (data.bahasa_isyarat === '1') {
			$('#bahasa_isyarat_anak_ya').prop('checked', true).change()
		}
		if (data.bahasa_isyarat === '0') {
			$('#bahasa_isyarat_anak_tidak').prop('checked', true).change()
		}


		if (data.hanbatan_belajar_w === '1') {
			$('#hanbatan-belajar-w-ya').prop('checked', true).change()
		}
		if (data.hanbatan_belajar_w === '0') {
			$('#hanbatan-belajar-w-tidak').prop('checked', true).change()
		}
		...
		if (data.pemahaman_nutrisi_diet === '1') {
			$('#pt_nutrisi_diet_anak_ya').prop('checked', true).change()
		}
		if (data.pemahaman_nutrisi_diet === '0') {
			$('#pt_nutrisi_diet_anak_tidak').prop('checked', true).change()
		}

		if (data.pemahaman_spiritual === '1') {
			$('#pt_spiritual_anak_ya').prop('checked', true).change()
		}
		if (data.pemahaman_spiritual === '0') {
			$('#pt_spiritual_anak_tidak').prop('checked', true).change()
		}

		if (data.pemahaman_peralatan_medis === '1') {
			$('#pt_peralatan_medis_anak_ya').prop('checked', true).change()
		}
		if (data.pemahaman_peralatan_medis === '0') {
			$('#pt_peralatan_medis_anak_tidak').prop('checked', true).change()
		}

		if (data.pemahaman_rehab_medik === '1') {
			$('#pt_rehab_medik_anak_ya').prop('checked', true).change()
		}
		if (data.pemahaman_rehab_medik === '0') {
			$('#pt_rehab_medik_anak_tidak').prop('checked', true).change()
		}

		if (data.pemahaman_manajemen_nyeri === '1') {
			$('#pt_manajemen_nyeri_anak_ya').prop('checked', true).change()
		}
		if (data.pemahaman_manajemen_nyeri === '0') {
			$('#pt_manajemen_nyeri_anak_tidak').prop('checked', true).change()
		}
		...
		if (kesadaran.composmentis !== '') {
			$('#composmentis_anak').prop('checked', true)
		}
		if (kesadaran.apatis !== '') {
			$('#apatis_anak').prop('checked', true)
		}
		if (kesadaran.samnolen !== '') {
			$('#samnolen_anak').prop('checked', true)
		}
		if (kesadaran.sopor !== '') {
			$('#sopor_anak').prop('checked', true)
		}
		if (kesadaran.koma !== '') {
			$('#koma_anak').prop('checked', true)
		}
		...
		if (data.gangguan_neurologis === '0') {
			$('#gangguan_neurologis_tidak').prop('checked', true).change()
		}
		if (data.gangguan_neurologis === '1') {
			$('#gangguan_neurologis_ya').prop('checked', true).change()
		}
		// $('#gangguan_neurologis_ya').val(data.gangguan_neurologis);
		$('#gangguan_neurologis_input').val(data.ket_gangguan_neurologis);

		//Sistem Pernafasan
		if (data.irama_nafas === 'Reguler') {
			$('#irama_nafas_anak_reguler').prop('checked', true).change()
		}
		if (data.irama_nafas === 'Irreguler') {
			$('#irama_nafas_anak_irreguler').prop('checked', true).change()
		}

		if (data.retraksi_dada === '1') {
			$('#retraksi_dada_anak_ya').prop('checked', true).change()
		}
		if (data.retraksi_dada === '0') {
			$('#retraksi_dada_anak_tidak').prop('checked', true).change()
		}

		if (data.bentuk_dada === '1') {
			$('#bentuk_dada_anak_normal').prop('checked', true).change()
		}
		if (data.bentuk_dada === '0') {
			$('#bentuk_dada_anak_tidak_normal').prop('checked', true).change()
		}
		// $('#bentuk_dada_anak_normal').val(data.bentuk_dada);
		$('#bentuk_dada_anak_input').val(data.ket_bentuk_dada);

		if (data.pola_nafas === '0') {
			$('#pola_nafas_anak_tidak_normal').prop('checked', true).change()
		}
		if (data.pola_nafas === '1') {
			$('#pola_nafas_anak_normal').prop('checked', true).change()
		}
		// $('#pola_nafas_anak_normal').val(data.pola_nafas);
		$('#pola_nafas_anak_input').val(data.ket_pola_nafas);

		if (data.suara_nafas === '0') {
			$('#suara_nafas_anak_tidak_normal').prop('checked', true).change()
		}
		if (data.suara_nafas === '1') {
			$('#suara_nafas_anak_normal').prop('checked', true).change()
		}
		// $('#suara_nafas_anak_normal').val(data.suara_nafas);
		$('#suara_nafas_anak_input').val(data.ket_suara_nafas);

		if (data.nafas_cuping_hidung === '1') {
			$('#nafas_cuping_hidung_ya').prop('checked', true).change()
		}
		if (data.nafas_cuping_hidung === '0') {
			$('#nafas_cuping_hidung_tidak').prop('checked', true).change()
		}

		if (data.sianosis_nafas === '1') {
			$('#sianosis_nafas_anak_ya').prop('checked', true).change()
		}
		if (data.sianosis_nafas === '0') {
			$('#sianosis_nafas_anak_tidak').prop('checked', true).change()
		}

		if (data.alat_bantu_nafas === 'Spontan') {
			$('#alat_bantu_nafas_anak_spontan').prop('checked', true).change()
		}
		if (data.alat_bantu_nafas === 'Kanul') {
			$('#alat_bantu_nafas_anak_kanul').prop('checked', true).change()
		}
		$('#alat_bantu_nafas_anak_kanul_input').val(data.ket_kanul);
		if (data.alat_bantu_nafas_anak_t === 'Ventilator') {
			$('#alat_bantu_nafas_anak_ventilator').prop('checked', true).change()
		}
		$('#alat_bantu_nafas_anak_ventilator_input').val(data.ket_ventilator);


		//Sirkulasi
		if (data.sirkulasi_sianosis === '1') {
			$('#sirkualsi_sianosis_ya').prop('checked', true).change()
		}
		if (data.sirkulasi_sianosis === '0') {
			$('#sirkualsi_sianosis_tidak').prop('checked', true).change()
		}

		if (data.sirkulasi_pucat === '1') {
			$('#pucat_anak_ya').prop('checked', true).change()
		}
		if (data.sirkulasi_pucat === '0') {
			$('#pucat_anak_tidak').prop('checked', true).change()
		}
		...
		if (intensitas_nadi.Kuat !== '') {
			$('#intensitas_nadi_anak_kuat').prop('checked', true)
		}
		if (intensitas_nadi.Lemah !== '') {
			$('#intensitas_nadi_anak_lemah').prop('checked', true)
		}
		if (intensitas_nadi.Bounding !== '') {
			$('#itensitas_nadi_anak_bounding').prop('checked', true)
		}
		...
		if (data.irama_nadi === 'Reguler') {
			$('#irama_nadi_anak_reguler').prop('checked', true).change()
		}
		if (data.irama_nadi === 'Irreguler') {
			$('#irama_nadi_anak_irreguler').prop('checked', true).change()
		}

		if (data.sirkulasi_edema === '1') {
			$('#edema_anak_ya').prop('checked', true).change()
		}
		if (data.sirkulasi_edema === '0') {
			$('#edema_anak_tidak').prop('checked', true).change()
		}

		if (data.sirkulasi_akral === 'Hangat') {
			$('#akral_anak_hangat').prop('checked', true).change()
		}
		if (data.sirkulasi_akral === 'Dingin') {
			$('#akral_anak_dingin').prop('checked', true).change()
		}

		if (data.sirkulasi_crt === 'Kurang dari 3') {
			$('#crt_anak_ya').prop('checked', true).change()
		}
		if (data.sirkulasi_crt === 'Lebih dari 3') {
			$('#crt_anak_tidak').prop('checked', true).change()
		}

		if (data.nafas_cuping_hidung === '1') {
			$('#clubing_finger_anak_ya').prop('checked', true).change()
		}
		if (data.nafas_cuping_hidung === '0') {
			$('#clubing_finger_anak_tidak').prop('checked', true).change()
		}

		//Gastrointestinal
		var gastro_mulut = JSON.parse(data.gastro_mulut);
		if (gastro_mulut.mukosa_lembab !== '') {
			$('#mukosa_lembab_anak').prop('checked', true)
		}
		if (gastro_mulut.mukosa_kering !== '') {
			$('#mukosa_kering_anak').prop('checked', true)
		}
		if (gastro_mulut.stomatitis !== '') {
			$('#stomatitis_anak').prop('checked', true)
		}
		if (gastro_mulut.labio !== '') {
			$('#labio_anak').prop('checked', true)
		}
		if (gastro_mulut.pendarahan_gusi !== '') {
			$('#pendarahan_gusi_anak').prop('checked', true)
		}
		if (gastro_mulut.mulut_lainnya !== '') {
			$('#mulut_lainnya').prop('checked', true);
		...
		if (data.gastro_muntah === '0') {
			$('#muntah_anak_tidak').prop('checked', true).change()
		}
		if (data.gastro_muntah === '1') {
			$('#muntah_anak_ya').prop('checked', true).change()
		}
		// $('#muntah_anak_ya').val(data.gastro_muntah);
		$('#muntah_anak_lainnya').val(data.ket_gastro_muntah);

		if (data.gastro_mual === '1') {
			$('#mual_anak_ya').prop('checked', true).change()
		}
		if (data.gastro_mual === '0') {
			$('#mual_anak_tidak').prop('checked', true).change()
		}

		if (data.gastro_ascites === '1') {
			$('#ascites_anak_ya').prop('checked', true).change()
		}
		if (data.gastro_ascites === '0') {
			$('#ascites_anak_tidak').prop('checked', true).change()
		}

		if (data.gastro_nyeri_ulu_hati === '1') {
			$('#nyeri_ulu_hati_anak_ya').prop('checked', true).change()
		}
		if (data.gastro_nyeri_ulu_hati === '0') {
			$('#nyeri_ulu_hati_anak_tidak').prop('checked', true).change()
		}

		$('#peristaltik_usus_anak').val(data.gastro_peristaltik);
		//Eliminasi - BAB
		var bab_pengeluaran = JSON.parse(data.bab_pengeluaran);
		if (bab_pengeluaran.anus !== '') {
			$('#pengeluaran_anus').prop('checked', true)
		}
		if (bab_pengeluaran.stomata !== '') {
			$('#pengeluaran_stomata').prop('checked', true)
		...
		if (bak_pengeluaran.spontan !== '') {
			$('#pengeluaran_spontan_bak').prop('checked', true)
		}
		if (bak_pengeluaran.kateter_urine !== '') {
			$('#krakter_urine_bak').prop('checked', true)
		}
		if (bak_pengeluaran.cystostomy !== '') {
			$('#pengeluaran_cystostomy').prop('checked', true)
		}

		if (data.bak_kelainan === '0') {
			$('#kelainan_bak_tidak').prop('checked', true).change()
		}
		if (data.bak_kelainan === '1') {
			$('#kelainan_bak_ada').prop('checked', true).change()
		}
		...
		if (integumen_warna_kulit.pucat !== '') {
			$('#si_warna_pucat_anak').prop('checked', true)
		}
		if (integumen_warna_kulit.kuning !== '') {
			$('#si_warna_kuniing_anak').prop('checked', true)
		}
		if (integumen_warna_kulit.normal !== '') {
			$('#si_warna_normal_anak').prop('checked', true)
		}
		if (integumen_warna_kulit.mootled !== '') {
			$('#si_warna_kulit_mootled').prop('checked', true)
		}

		if (data.integumen_kelainan === '1') {
			$('#kelainan_sistem_integumen_ya').prop('checked', true).change()
		}
		if (data.integumen_kelainan === '0') {
			$('#kelainan_sistem_integumen_tidak').prop('checked', true).change()
		}

		if (data.integumen_resiko_dubitus === '1') {
			$('#resiko_dekubitus_anak_ya').prop('checked', true).change()
		}
		if (data.integumen_resiko_dubitus === '0') {
			$('#resiko_dekubitus_anak_tidak').prop('checked', true).change()
		}

		if (data.integumen_luka === '1') {
			$('#luka_anak_ya').prop('checked', true).change()
		}
		if (data.integumen_luka === '0') {
			$('#luka_anak_tidak').prop('checked', true).change()
		}

		//Muskoskeletal
		if (data.kelainan_tulang === '0') {
			$('#kelainan_tulang_anak_tidak').prop('checked', true).change()
		}
		if (data.kelainan_tulang === '1') {
			$('#kelainan_tulang_anak_ya').prop('checked', true).change()
		}
		// $('#kelainan_tulang_anak_ya').val(data.kelainan_tulang);
		$('#kelainan_tulang_anak_lainnya').val(data.ket_kelainan_tulang);

		if (data.gerakan_anak === 'Bebas') {
			$('#gerakan_anak_beas').prop('checked', true).change()
		}
		if (data.gerakan_anak === 'Terbatas') {
			$('#gerakan_anak_terbatas').prop('checked', true).change()
		}

		if (data.gentalia_anak === '0') {
			$('#genetalia_anak_kelainan').prop('checked', true).change()
		}
		if (data.gentalia_anak === '1') {
			$('#genetalia_anak_normal').prop('checked', true).change()
		}
		...
		if (data.nilai_tingkat_nyeri === 'Tidak Nyeri') {
			$('#ptn_keterangan_anak_tidak_nyeri').prop('checked', true).change()
		}
		if (data.nilai_tingkat_nyeri === 'Ringan') {
			$('#ptn_keterangan_anak_ringan').prop('checked', true).change()
		}
		if (data.nilai_tingkat_nyeri === 'Sedang') {
			$('#ptn_keterangan_anak_sedang').prop('checked', true).change()
		}
		if (data.nilai_tingkat_nyeri === 'Berat') {
			$('#ptn_keterangan_anak_berat').prop('checked', true).change()
		}

		// nyeri hilang
		var nyeri_hilang = JSON.parse(data.nyeri_hilang);
		if (nyeri_hilang.minum_obat !== '') {
			$('#ptn_minum_obat_anak').prop('checked', true)
		}
		if (nyeri_hilang.mendengarkan_musik !== '') {
			$('#ptn_mendengarkan_musik_anak').prop('checked', true)
		}
		if (nyeri_hilang.istirahat !== '') {
			$('#ptn_istirahat_anak').prop('checked', true)
		}
		if (nyeri_hilang.berubah_posisi !== '') {
			$('#ptn_berubah_posisi_anak').prop('checked', true)
		}
		...
		//Skrining Gizi 
		if (data.sg_nilai_1 === '1') {
			$('#sgizi_gizi_buruk_ya').prop('checked', true).change()
		}
		if (data.sg_nilai_1 === '0') {
			$('#sgizi_gizi_buruk_tidak').prop('checked', true).change()
		}

		if (data.sg_nilai_2 === '1') {
			$('#sgizi_penurunan_bb_ya').prop('checked', true).change()
		}
		if (data.sg_nilai_2 === '0') {
			$('#sgizi_penurunan_bb_tidak').prop('checked', true).change()
		}

		if (data.sg_nilai_3 === '1') {
			$('#sgizi_dua_kondisi_ya').prop('checked', true).change()
		}
		if (data.sg_nilai_3 === '0') {
			$('#sgizi_dua_kondisi_tidak').prop('checked', true).change()
		}

		if (data.sg_nilai_4 === '1') {
			$('#sgizi_malnutrisi_ya').prop('checked', true).change()
		}
		if (data.sg_nilai_4 === '0') {
			$('#sgizi_malnutrisi_tidak').prop('checked', true).change()
		}
		...
		if (daftar_penyakit_malnutrisi.diare_persisten !== '') {
			$('#penyakit_diare').prop('checked', true)
		}
		if (daftar_penyakit_malnutrisi.prematuris !== '') {
			$('#penyakit_prematuris').prop('checked', true)
		}
		if (daftar_penyakit_malnutrisi.penyakit_jantung_bawaan !== '') {
			$('#penyakit_jantung_bawaan').prop('checked', true)
		}
		if (daftar_penyakit_malnutrisi.kelainan_bawaan !== '') {
			$('#penyakit_kelainan_bawaan').prop('checked', true)
		}
		if (daftar_penyakit_malnutrisi.wajah_dismorfik !== '') {
			$('#penyakit_wajah_aneh').prop('checked', true)
		}
		if (daftar_penyakit_malnutrisi.penyakit_akut_berat !== '') {
			$('#penyakit_akut_berat').prop('checked', true)
		}
		if (daftar_penyakit_malnutrisi.ginjal !== '') {
			$('#penyakit_ginjal_anak').prop('checked', true)
		}
		if (daftar_penyakit_malnutrisi.infeksi_hiv !== '') {
			$('#penyakit_hiv_anak').prop('checked', true)
		}
		if (daftar_penyakit_malnutrisi.kanker !== '') {
			$('#penyakit_kanker_anak').prop('checked', true)
		}
		if (daftar_penyakit_malnutrisi.penyakit_hati_kronik !== '') {
			$('#penyakit_hati_kronik_anak').prop('checked', true)
		}
		if (daftar_penyakit_malnutrisi.penyakit_ginjal_kronik !== '') {
			$('#penyakit_ginjal_kronik_anak').prop('checked', true)
		}
		if (daftar_penyakit_malnutrisi.terdapat_stoma !== '') {
			$('#penyakit_stoma_usus_halus').prop('checked', true)
		}
		if (daftar_penyakit_malnutrisi.trauma !== '') {
			$('#penyakit_trauma_anak').prop('checked', true)
		}
		if (daftar_penyakit_malnutrisi.kontipasi_berulang !== '') {
			$('#penyakit_kontipasi_berulang_anak').prop('checked', true)
		}
		if (daftar_penyakit_malnutrisi.gagal_tumbuh !== '') {
			$('#penyakit_gagal_tumbuh_anak').prop('checked', true)
		}
		if (daftar_penyakit_malnutrisi.penyakit_metabolik !== '') {
			$('#penyakit_metabolik_anak').prop('checked', true)
		}
		if (daftar_penyakit_malnutrisi.retardasi_metabolik !== '') {
			$('#penyakit_retardasi_anak').prop('checked', true)
		}
		if (daftar_penyakit_malnutrisi.keterlambatan_perkembangan !== '') {
			$('#penyakit_keterlambatan_kembang_anak').prop('checked', true)
		}
		if (daftar_penyakit_malnutrisi.luka_bakar !== '') {
			$('#penyakit_luka_bakar_anak').prop('checked', true)
		}
		if (daftar_penyakit_malnutrisi.rencana_operasi !== '') {
			$('#penyakit_obesitas_anak').prop('checked', true)
		}

		// Skririning Pasien Akhir
		if (data.integumen_luka === '1') {
			$('#spak_1_anak_ya').prop('checked', true).change()
		}
		if (data.integumen_luka === '0') {
			$('#spak_1_anak_tidak').prop('checked', true).change()
		}

		if (data.integumen_luka === '1') {
			$('#spak_2_anak_ya').prop('checked', true).change()
		}
		if (data.integumen_luka === '0') {
			$('#spak_2_anak_tidak').prop('checked', true).change()
		}

		if (data.integumen_luka === '1') {
			$('#spak_3_anak_ya').prop('checked', true).change()
		}
		if (data.integumen_luka === '0') {
			$('#spak_3_anak_tidak').prop('checked', true).change()
		}

		if (data.integumen_luka === '1') {
			$('#spak_4_anak_ya').prop('checked', true).change()
		}
		if (data.integumen_luka === '0') {
			$('#spak_4_anak_tidak').prop('checked', true).change()
		}

		if (data.integumen_luka === '1') {
			$('#spak_5_anak_ya').prop('checked', true).change()
		}
		if (data.integumen_luka === '0') {
			$('#spak_5_anak_tidak').prop('checked', true).change()
		}
		...
		if (penyakit_menular.penyakit_saat_ini === '0') {
			$('#pk_penyakit_menular_1_anak_tidak').prop('checked', true).change()
		}
		if (penyakit_menular.penyakit_saat_ini === '1') {
			$('#pk_penyakit_menular_1_anak_ya').prop('checked', true).change()
		}

		if (penyakit_menular.informasi_dari.dokter !== '') {
			$('#pk_pm_dokter_anak').prop('checked', true)
		}
		if (penyakit_menular.informasi_dari.perawat !== '') {
			$('#pk_pm_perawat_anak').prop('checked', true)
		}
		if (penyakit_menular.informasi_dari.keluarga !== '') {
			$('#pk_pm_keluarga_anak').prop('checked', true)
		}
		if (penyakit_menular.informasi_dari.lain !== '') {
			$('#pk_pm_lain_anak').prop('checked', true)
		}
		if (penyakit_menular.informasi_dari.ket_lain !== '') {
			$('#pk_pm_lain_anak_input').val(penyakit_menular.informasi_dari.ket_lain).attr('disabled', false)
		}

		if (penyakit_menular.informasi_jangka_waktu === '0') {
			$('#pk_penyakit_menular_3_anak_tidak').prop('checked', true).change()
		}
		if (penyakit_menular.informasi_jangka_waktu === '1') {
			$('#pk_penyakit_menular_3_anak_ya').prop('checked', true).change()
		}
		$('#pk_penyakit_menular_3_anak_input').val(penyakit_menular.ket_informasi_jangka_waktu);

		if (penyakit_menular.pemeriksaan_rutin === '0') {
			$('#pk_penyakit_menular_4_anak_tidak').prop('checked', true).change()
		}
		if (penyakit_menular.pemeriksaan_rutin === '1') {
			$('#pk_penyakit_menular_4_anak_ya').prop('checked', true).change()
		}
		$('#pk_penyakit_menular_4_anak_input').val(penyakit_menular.ket_pemeriksaan_rutin);

		if (penyakit_menular.cara_penularan.airbone !== '') {
			$('#pk_pm_airbone_anak').prop('checked', true)
		}
		if (penyakit_menular.cara_penularan.droplet !== '') {
			$('#pk_pm_droplet_anak').prop('checked', true)
		}
		if (penyakit_menular.cara_penularan.kontak_langsung !== '') {
			$('#pk_pm_kontak_langsung_anak').prop('checked', true)
		}
		if (penyakit_menular.cara_penularan.cairan_tubuh !== '') {
			$('#pk_pm_cairan_tubuh_anak').prop('checked', true)
		}

		if (penyakit_menular.penyakit_penyerta === '0') {
			$('#pk_penyakit_menular_6_anak_tidak').prop('checked', true).change()
		}
		if (penyakit_menular.penyakit_penyerta === '1') {
			$('#pk_penyakit_menular_6_anak_ya').prop('checked', true).change()
		}
		...
		if (pk_penurunan_daya_tahan.penyakit_saat_ini === '0') {
			$('#pk_penyakit_pdtt_1_anak_tidak').prop('checked', true).change()
		}
		if (pk_penurunan_daya_tahan.penyakit_saat_ini === '1') {
			$('#pk_penyakit_pdtt_1_anak_ya').prop('checked', true).change()
		}

		if (pk_penurunan_daya_tahan.informasi_dari.dokter !== '') {
			$('#pk_pdtt_dokter_anak').prop('checked', true)
		}
		if (pk_penurunan_daya_tahan.informasi_dari.perawat !== '') {
			$('#pk_pdtt_perawat_anak').prop('checked', true)
		}
		if (pk_penurunan_daya_tahan.informasi_dari.keluarga !== '') {
			$('#pk_pdtt_keluarga_anak').prop('checked', true)
		}
		if (pk_penurunan_daya_tahan.informasi_dari.lain !== '') {
			$('#pk_pdtt_lain_anak').prop('checked', true)
		}
		if (pk_penurunan_daya_tahan.informasi_dari.ket_lain !== '') {
			$('#pk_pdtt_lain_anak_input').val(pk_penurunan_daya_tahan.informasi_dari.ket_lain).attr('disabled', false)
		}

		if (pk_penurunan_daya_tahan.informasi_jangka_waktu === '0') {
			$('#pk_penyakit_pdtt_3_anak_tidak').prop('checked', true).change()
		}
		if (pk_penurunan_daya_tahan.informasi_jangka_waktu === '1') {
			$('#pk_penyakit_pdtt_3_anak_ya').prop('checked', true).change()
		}
		$('#pk_penyakit_pdtt_3_anak_input').val(pk_penurunan_daya_tahan.ket_informasi_jangka_waktu);

		if (pk_penurunan_daya_tahan.pemeriksaan_rutin === '0') {
			$('#pk_penyakit_pdtt_4_anak_tidak').prop('checked', true).change()
		}
		if (pk_penurunan_daya_tahan.pemeriksaan_rutin === '1') {
			$('#pk_penyakit_pdtt_4_anak_ya').prop('checked', true).change()
		}
		$('#pk_penyakit_pdtt_4_anak_input').val(pk_penurunan_daya_tahan.ket_pemeriksaan_rutin);

		if (pk_penurunan_daya_tahan.penyakit_penyerta === '0') {
			$('#pk_penyakit_pdtt_5_anak_tidak').prop('checked', true).change()
		}
		if (pk_penurunan_daya_tahan.penyakit_penyerta === '1') {
			$('#pk_penyakit_pdtt_5_anak_ya').prop('checked', true).change()
		}
		...
		if (pk_kesehatan_jiwa.ket_1 === '0') {
			$('#pk_kesehatan_jiwa_1_anak_tidak').prop('checked', true).change()
		}
		if (pk_kesehatan_jiwa.ket_1 === '1') {
			$('#pk_kesehatan_jiwa_1_anak_ya').prop('checked', true).change()
		}

		if (pk_kesehatan_jiwa.ket_2 === '0') {
			$('#pk_kesehatan_jiwa_2_anak_tidak').prop('checked', true).change()
		}
		if (pk_kesehatan_jiwa.ket_2 === '1') {
			$('#pk_kesehatan_jiwa_2_anak_ya').prop('checked', true).change()
		}

		if (pk_kesehatan_jiwa.ket_3 === '0') {
			$('#pk_kesehatan_jiwa_3_anak_tidak').prop('checked', true).change()
		}
		if (pk_kesehatan_jiwa.ket_3 === '1') {
			$('#pk_kesehatan_jiwa_3_anak_ya').prop('checked', true).change()
		}

		if (pk_kesehatan_jiwa.ket_4 === '0') {
			$('#pk_kesehatan_jiwa_4_anak_tidak').prop('checked', true).change()
		}
		if (pk_kesehatan_jiwa.ket_4 === '1') {
			$('#pk_kesehatan_jiwa_4_anak_ya').prop('checked', true).change()
		}

		if (pk_kesehatan_jiwa.ket_5 === '0') {
			$('#pk_kesehatan_jiwa_5_anak_tidak').prop('checked', true).change()
		}
		if (pk_kesehatan_jiwa.ket_5 === '1') {
			$('#pk_kesehatan_jiwa_5_anak_ya').prop('checked', true).change()
		}

		if (pk_kesehatan_jiwa.ket_6 === '0') {
			$('#pk_kesehatan_jiwa_6_anak_tidak').prop('checked', true).change()
		}
		if (pk_kesehatan_jiwa.ket_6 === '1') {
			$('#pk_kesehatan_jiwa_6_anak_ya').prop('checked', true).change()
		}

		if (pk_kesehatan_jiwa.ket_7 === '0') {
			$('#pk_kesehatan_jiwa_7_anak_tidak').prop('checked', true).change()
		}
		if (pk_kesehatan_jiwa.ket_7 === '1') {
			$('#pk_kesehatan_jiwa_7_anak_ya').prop('checked', true).change()
		}

		if (pk_kesehatan_jiwa.ket_8 === '0') {
			$('#pk_kesehatan_jiwa_8_anak_tidak').prop('checked', true).change()
		}
		if (pk_kesehatan_jiwa.ket_8 === '1') {
			$('#pk_kesehatan_jiwa_8_anak_ya').prop('checked', true).change()
		}

		if (pk_kesehatan_jiwa.ket_9 === '0') {
			$('#pk_kesehatan_jiwa_9_anak_tidak').prop('checked', true).change()
		}
		if (pk_kesehatan_jiwa.ket_9 === '1') {
			$('#pk_kesehatan_jiwa_9_anak_ya').prop('checked', true).change()
		}
		// end kesehatan jiwa

		//Pasien Kekerasan
		var pk_pasien_kekerasan = JSON.parse(data.pk_pasien_kekerasan);
		if (pk_pasien_kekerasan.ket_1 === '0') {
			$('#pk_pasien_kekerasan_1_anak_tidak').prop('checked', true).change()
		}
		if (pk_pasien_kekerasan.ket_1 === '1') {
			$('#pk_pasien_kekerasan_1_anak_ya').prop('checked', true).change()
		}
		...
		if (pk_pasien_kekerasan.ket_6 === '0') {
			$('#pk_pasien_kekerasan_6_anak_tidak').prop('checked', true).change()
		}
		if (pk_pasien_kekerasan.ket_6 === '1') {
			$('#pk_pasien_kekerasan_6_anak_ya').prop('checked', true).change()
		}
		//End pasien kekerasan

		//Pasien diduga menggunakan obat 
		var pk_pasien_ketergantungan = JSON.parse(data.pk_pasien_ketergantungan);
		if (pk_pasien_ketergantungan.obat === '0') {
			$('#pk_pasien_ketergantungan_obat_anak_tidak').prop('checked', true).change()
		}
		if (pk_pasien_ketergantungan.obat === '1') {
			$('#pk_pasien_ketergantungan_obat_anak_ya').prop('checked', true).change()
		}
		...
		for (let a = 1; a <= 17; a++) { // Iterasi dari 1 hingga 17 untuk variabel 'a', kemungkinan mewakili baris
            for (let b = 1; b <= 7; b++) { // Iterasi dari 1 hingga 7 untuk variabel 'b', kemungkinan mewakili kolom
                // Memeriksa dan memperbarui elemen berdasarkan data.sew_suhu
                if (data.sew_suhu === $('#skalapewsk_' + a + '_' + b).val() && 
                    data.sew_suhu === $('.pews_suhuk_' + a + '_' + b).val()) {
                    // Jika nilai data.sew_suhu sama dengan nilai dari elemen dengan ID dan kelas tertentu,
                    // setel elemen dengan ID tersebut menjadi checked dan trigger event change
                    $('#skalapewsk_' + a + '_' + b).prop('checked', true).change();
                }

                // Memeriksa dan memperbarui elemen berdasarkan data.sew_pernafasan
                if (data.sew_pernafasan === $('#skalapewsk_' + a + '_' + b).val() && 
                    data.sew_pernafasan === $('.pews_pernafasank_' + a + '_' + b).val()) {
                    // Jika nilai data.sew_pernafasan sama dengan nilai dari elemen dengan ID dan kelas tertentu,
                    // setel elemen dengan ID tersebut menjadi checked dan trigger event change
                    $('#skalapewsk_' + a + '_' + b).prop('checked', true).change();
                }

                // Memeriksa dan memperbarui elemen berdasarkan data.sew_kondisi_pernafasan
                if (data.sew_kondisi_pernafasan === $('#skalapewsk_' + a + '_' + b).val() && 
                    data.sew_kondisi_pernafasan === $('.pews_subpernafasank_' + a + '_' + b).val()) {
                    // Jika nilai data.sew_kondisi_pernafasan sama dengan nilai dari elemen dengan ID dan kelas tertentu,
                    // setel elemen dengan ID tersebut menjadi checked dan trigger event change
                    $('#skalapewsk_' + a + '_' + b).prop('checked', true).change();
                }

                // Memeriksa dan memperbarui elemen berdasarkan data.sew_alat_bantu
                if (data.sew_alat_bantu === $('#skalapewsk_' + a + '_' + b).val() && 
                    data.sew_alat_bantu === $('.pews_alat_bantuk_' + a + '_' + b).val()) {
                    // Jika nilai data.sew_alat_bantu sama dengan nilai dari elemen dengan ID dan kelas tertentu,
                    // setel elemen dengan ID tersebut menjadi checked dan trigger event change
                    $('#skalapewsk_' + a + '_' + b).prop('checked', true).change();
                }

                // Memeriksa dan memperbarui elemen berdasarkan data.sew_saturasi
                if (data.sew_saturasi === $('#skalapewsk_' + a + '_' + b).val() && 
                    data.sew_saturasi === $('.pews_saturasik_' + a + '_' + b).val()) {
                    // Jika nilai data.sew_saturasi sama dengan nilai dari elemen dengan ID dan kelas tertentu,
                    // setel elemen dengan ID tersebut menjadi checked dan trigger event change
                    $('#skalapewsk_' + a + '_' + b).prop('checked', true).change();
                }

                // Memeriksa dan memperbarui elemen berdasarkan data.sew_nadi
                if (data.sew_nadi === $('#skalapewsk_' + a + '_' + b).val() && 
                    data.sew_nadi === $('.pews_nadik_' + a + '_' + b).val()) {
                    // Jika nilai data.sew_nadi sama dengan nilai dari elemen dengan ID dan kelas tertentu,
                    // setel elemen dengan ID tersebut menjadi checked dan trigger event change
                    $('#skalapewsk_' + a + '_' + b).prop('checked', true).change();
                }

                // Memeriksa dan memperbarui elemen berdasarkan data.sew_warna_kulit
                if (data.sew_warna_kulit === $('#skalapewsk_' + a + '_' + b).val() && 
                    data.sew_warna_kulit === $('.pews_warna_kulitk_' + a + '_' + b).val()) {
                    // Jika nilai data.sew_warna_kulit sama dengan nilai dari elemen dengan ID dan kelas tertentu,
                    // setel elemen dengan ID tersebut menjadi checked dan trigger event change
                    $('#skalapewsk_' + a + '_' + b).prop('checked', true).change();
                }

                // Memeriksa dan memperbarui elemen berdasarkan data.sew_tds
                if (data.sew_tds === $('#skalapewsk_' + a + '_' + b).val() && 
                    data.sew_tds === $('.pews_tdsk_' + a + '_' + b).val()) {
                    // Jika nilai data.sew_tds sama dengan nilai dari elemen dengan ID dan kelas tertentu,
                    // setel elemen dengan ID tersebut menjadi checked dan trigger event change
                    $('#skalapewsk_' + a + '_' + b).prop('checked', true).change();
                }

                // Memeriksa dan memperbarui elemen berdasarkan data.sew_kesadaran
                if (data.sew_kesadaran === $('#skalapewsk_' + a + '_' + b).val() && 
                    data.sew_kesadaran === $('.pews_kesadarank_' + a + '_' + b).val()) {
                    // Jika nilai data.sew_kesadaran sama dengan nilai dari elemen dengan ID dan kelas tertentu,
                    // setel elemen dengan ID tersebut menjadi checked dan trigger event change
                    $('#skalapewsk_' + a + '_' + b).prop('checked', true).change();
                }
            }
		...
		if (masalah_keperawatan.ket_1 !== '') {
			$('#masalah_keperawatan_1_anak').prop('checked', true)
		}
		if (masalah_keperawatan.ket_2 !== '') {
			$('#masalah_keperawatan_2_anak').prop('checked', true)
		}
		if (masalah_keperawatan.ket_3 !== '') {
			$('#masalah_keperawatan_3_anak').prop('checked', true)
		}
		if (masalah_keperawatan.ket_4 !== '') {
			$('#masalah_keperawatan_4_anak').prop('checked', true)
		}
		if (masalah_keperawatan.ket_5 !== '') {
			$('#masalah_keperawatan_5_anak').prop('checked', true)
		}
		if (masalah_keperawatan.ket_6 !== '') {
			$('#masalah_keperawatan_6_anak').prop('checked', true)
		}
		if (masalah_keperawatan.ket_7 !== '') {
			$('#masalah_keperawatan_7_anak').prop('checked', true)
		}
		if (masalah_keperawatan.ket_8 !== '') {
			$('#masalah_keperawatan_8_anak').prop('checked', true)
		}
		if (masalah_keperawatan.ket_9 !== '') {
			$('#masalah_keperawatan_9_anak').prop('checked', true)
		}
		if (masalah_keperawatan.ket_10 !== '') {
			$('#masalah_keperawatan_10_anak').prop('checked', true)
		}
		if (masalah_keperawatan.ket_11 !== '') {
			$('#masalah_keperawatan_11_anak').prop('checked', true)
		}
		if (masalah_keperawatan.ket_12 !== '') {
			$('#masalah_keperawatan_12_anak').prop('checked', true)
		}
		if (masalah_keperawatan.ket_13 !== '') {
			$('#masalah_keperawatan_13_anak').prop('checked', true)
		}
		if (masalah_keperawatan.ket_14 !== '') {
			$('#masalah_keperawatan_14_anak').prop('checked', true)
		}
		if (masalah_keperawatan.ket_15 !== '') {
			$('#masalah_keperawatan_15_anak').prop('checked', true)
		}
		if (masalah_keperawatan.ket_16 !== '') {
			$('#masalah_keperawatan_16_anak').prop('checked', true)
		}
		if (masalah_keperawatan.ket_17 !== '') {
			$('#masalah_keperawatan_17_anak').prop('checked', true)
		}
		if (masalah_keperawatan.ket_18 !== '') {
			$('#masalah_keperawatan_18_anak').prop('checked', true)
		}
		if (masalah_keperawatan.ket_19 !== '') {
			$('#masalah_keperawatan_19_anak').prop('checked', true)
		}
		if (masalah_keperawatan.ket_20 !== '') {
			$('#masalah_keperawatan_20_anak').prop('checked', true)
		}
		if (masalah_keperawatan.ket_21 !== '') {
			$('#masalah_keperawatan_21_anak').prop('checked', true)
		}
		if (masalah_keperawatan.ket_22 !== '') {
			$('#masalah_keperawatan_22_anak').prop('checked', true)
		}
		if (masalah_keperawatan.ket_23 !== '') {
			$('#masalah_keperawatan_23_anak').prop('checked', true)
		}
		if (masalah_keperawatan.ket_24 !== '') {
			$('#masalah_keperawatan_24_anak').prop('checked', true)
		}
		if (masalah_keperawatan.ket_25 !== '') {
			$('#masalah_keperawatan_25_anak').prop('checked', true)
		}
		if (masalah_keperawatan.ket_26 !== '') {
			$('#masalah_keperawatan_26_anak').prop('checked', true)
		}
		if (masalah_keperawatan.ket_27 !== '') {
			$('#masalah_keperawatan_27_anak').prop('checked', true)
		}
		if (masalah_keperawatan.ket_28 !== '') {
			$('#masalah_keperawatan_28_anak').prop('checked', true)
		}
		if (masalah_keperawatan.ket_29 !== '') {
			$('#masalah_keperawatan_29_anak').prop('checked', true)
		}
		// if (masalah_keperawatan.ket_30 !== '') { $('#masalah_keperawatan_30_anak').prop('checked', true) }
		if (masalah_keperawatan.ket_31 !== '') {
			$('#masalah_keperawatan_31_anak').prop('checked', true)
		}
		if (masalah_keperawatan.ket_32 !== '') {
			$('#masalah_keperawatan_32_anak').prop('checked', true)
		}
		if (masalah_keperawatan.ket_33 !== '') {
			$('#masalah_keperawatan_33_anak').prop('checked', true)
		}
		if (masalah_keperawatan.ket_34 !== '') {
			$('#masalah_keperawatan_34_anak').prop('checked', true)
		}
		if (masalah_keperawatan.ket_30 !== '') {
			$('#masalah_keperawatan_30_anak').prop('checked', true)
		}
		if (masalah_keperawatan.ket_lain !== '') {
			$('#masalah_keperawatan_lain_input_anak').val(masalah_keperawatan.ket_lain).attr('disabled', false)
		}

		// perencanaan pulang
		var perencanaan_pulang = JSON.parse(data.perencanaan_pulang);
		if (perencanaan_pulang.planning_1 === '0') {
			$('#discharge_planning_1_anak_tidak').prop('checked', true).change()
		}
		if (perencanaan_pulang.planning_1 === '1') {
			$('#discharge_planning_1_anak_ya').prop('checked', true).change()
		}

		if (perencanaan_pulang.planning_2 === '0') {
			$('#discharge_planning_2_anak_tidak').prop('checked', true).change()
		}
		if (perencanaan_pulang.planning_2 === '1') {
			$('#discharge_planning_2_anak_ya').prop('checked', true).change()
		}

		if (perencanaan_pulang.planning_3 === '0') {
			$('#discharge_planning_3_anak_tidak').prop('checked', true).change()
		}
		if (perencanaan_pulang.planning_3 === '1') {
			$('#discharge_planning_3_anak_ya').prop('checked', true).change()
		}

		if (perencanaan_pulang.planning_4 === '0') {
			$('#discharge_planning_4_anak_tidak').prop('checked', true).change()
		}
		if (perencanaan_pulang.planning_4 === '1') {
			$('#discharge_planning_4_anak_ya').prop('checked', true).change()
		}


		if (perencanaan_pulang.kriteria.kriteria_1 !== '') {
			$('#kriteria_discharge_1_anak').prop('checked', true)
		}
		if (perencanaan_pulang.kriteria.kriteria_2 !== '') {
			$('#kriteria_discharge_2_anak').prop('checked', true)
		}
		if (perencanaan_pulang.kriteria.kriteria_3 !== '') {
			$('#kriteria_discharge_3_anak').prop('checked', true)
		}
		if (perencanaan_pulang.kriteria.kriteria_4 !== '') {
			$('#kriteria_discharge_4_anak').prop('checked', true)
		}
		if (perencanaan_pulang.kriteria.kriteria_5 !== '') {
			$('#kriteria_discharge_5_anak').prop('checked', true)
		}
		if (perencanaan_pulang.kriteria.kriteria_6 !== '') {
			$('#kriteria_discharge_6_anak').prop('checked', true)
		}
		if (perencanaan_pulang.kriteria.kriteria_7 !== '') {
			$('#kriteria_discharge_7_anak').prop('checked', true)
		}
		if (perencanaan_pulang.kriteria.kriteria_8 !== '') {
			$('#kriteria_discharge_8_anak').prop('checked', true)
		}
		if (perencanaan_pulang.kriteria.kriteria_9 !== '') {
			$('#kriteria_discharge_9_anak').prop('checked', true)
		}
		if (perencanaan_pulang.kriteria.kriteria_lain !== '') {
			$('#kriteria_discharge_lain_input_anak').val(perencanaan_pulang.kriteria.kriteria_lain).attr('disabled', false)
		}
		...
		if (data.id_perawat !== null) {
			$('#perawat_anak').select2c('readonly', true)
		}
		...
		if (data.id_verifikasi_dokter_dpjp !== null) {
			$('#verifikasi_dokter_dpjp_anak').select2c('readonly', true)
		}
	...
	function showKajianMedisAnak(data) {
		...
		var rpk = JSON.parse(data.riwayat_penyakit_keluarga);
		if (rpk.hasil === '1') {
			$('#rpk_medis_anak_ya').prop('checked', true).change()
		}
		if (rpk.asma !== '') {
			$('#rpk_medis_anak_asma').prop('checked', true)
		}
		if (rpk.dm !== '') {
			$('#rpk_medis_anak_dm').prop('checked', true)
		}
		if (rpk.cardiovascular !== '') {
			$('#rpk_medis_anak_cardiovascular').prop('checked', true)
		}
		if (rpk.kanker !== '') {
			$('#rpk_medis_anak_kanker').prop('checked', true)
		}
		if (rpk.thalasemia !== '') {
			$('#rpk_medis_anak_thalasemia').prop('checked', true)
		}
		if (rpk.lain !== '') {
			$('#rpk_medis_anak_lain').prop('checked', true)
		}
		if (rpk.ket_lain !== '') {
			$('#rpk_medis_anak_lain_input').val(rpk.ket_lain).attr('disabled', false)
		}
		...
		if (sadar.composmentis !== '') {
			$('#composmentis_medis_anak').prop('checked', true)
		}
		if (sadar.apatis !== '') {
			$('#apatis_medis_anak').prop('checked', true)
		}
		if (sadar.samnolen !== '') {
			$('#samnolen_medis_anak').prop('checked', true)
		}
		if (sadar.sopor !== '') {
			$('#sopor_medis_anak').prop('checked', true)
		}
		if (sadar.koma !== '') {
			$('#koma_medis_anak').prop('checked', true)
		}

		if (data.pf_kepala === 'Normal') {
			$('#pf_kepala_anak_tidak').prop('checked', true)
		}
		if (data.pf_kepala === 'Abnormal') {
			$('#pf_kepala_anak_ya').prop('checked', true)
		}
		if (data.ket_pf_kepala !== null) {
			$('#ket_pf_kepala_anak').val(data.ket_pf_kepala)
		}

		if (data.pf_mata === 'Normal') {
			$('#pf_mata_anak_tidak').prop('checked', true)
		}
		if (data.pf_mata === 'Abnormal') {
			$('#pf_mata_anak_ya').prop('checked', true)
		}
		if (data.ket_pf_mata !== null) {
			$('#ket_pf_mata_anak').val(data.ket_pf_mata)
		}

		if (data.pf_hidung === 'Normal') {
			$('#pf_hidung_anak_tidak').prop('checked', true)
		}
		if (data.pf_hidung === 'Abnormal') {
			$('#pf_hidung_anak_ya').prop('checked', true)
		}
		if (data.ket_pf_hidung !== null) {
			$('#ket_pf_hidung_anak').val(data.ket_pf_hidung)
		}

		if (data.pf_gigi_mulut === 'Normal') {
			$('#pf_gigi_mulut_anak_tidak').prop('checked', true)
		}
		if (data.pf_gigi_mulut === 'Abnormal') {
			$('#pf_gigi_mulut_anak_ya').prop('checked', true)
		}
		if (data.ket_pf_gigi_mulut !== null) {
			$('#ket_pf_gigi_mulut_anak').val(data.ket_pf_gigi_mulut)
		}

		if (data.pf_tenggorokan === 'Normal') {
			$('#pf_tenggorokan_anak_tidak').prop('checked', true)
		}
		if (data.pf_tenggorokan === 'Abnormal') {
			$('#pf_tenggorokan_anak_ya').prop('checked', true)
		}
		if (data.ket_pf_tenggorokan !== null) {
			$('#ket_pf_tenggorokan_anak').val(data.ket_pf_tenggorokan)
		}

		if (data.pf_telinga === 'Normal') {
			$('#pf_telinga_anak_tidak').prop('checked', true)
		}
		if (data.pf_telinga === 'Abnormal') {
			$('#pf_telinga_anak_ya').prop('checked', true)
		}
		if (data.ket_pf_telinga !== null) {
			$('#ket_pf_telinga_anak').val(data.ket_pf_telinga)
		}

		if (data.pf_leher === 'Normal') {
			$('#pf_leher_anak_tidak').prop('checked', true)
		}
		if (data.pf_leher === 'Abnormal') {
			$('#pf_leher_anak_ya').prop('checked', true)
		}
		if (data.ket_pf_leher !== null) {
			$('#ket_pf_leher_anak').val(data.ket_pf_leher)
		}

		if (data.pf_thorax === 'Normal') {
			$('#pf_thorax_anak_tidak').prop('checked', true)
		}
		if (data.pf_thorax === 'Abnormal') {
			$('#pf_thorax_anak_ya').prop('checked', true)
		}
		if (data.ket_pf_thorax !== null) {
			$('#ket_pf_thorax_anak').val(data.ket_pf_thorax)
		}

		if (data.pf_jantung === 'Normal') {
			$('#pf_jantung_anak_tidak').prop('checked', true)
		}
		if (data.pf_jantung === 'Abnormal') {
			$('#pf_jantung_anak_ya').prop('checked', true)
		}
		if (data.ket_pf_jantung !== null) {
			$('#ket_pf_jantung_anak').val(data.ket_pf_jantung)
		}

		if (data.pf_paru === 'Normal') {
			$('#pf_paru_anak_tidak').prop('checked', true)
		}
		if (data.pf_paru === 'Abnormal') {
			$('#pf_paru_anak_ya').prop('checked', true)
		}
		if (data.ket_pf_paru !== null) {
			$('#ket_pf_paru_anak').val(data.ket_pf_paru)
		}

		if (data.pf_abdomen === 'Normal') {
			$('#pf_abdomen_anak_tidak').prop('checked', true)
		}
		if (data.pf_abdomen === 'Abnormal') {
			$('#pf_abdomen_anak_ya').prop('checked', true)
		}
		if (data.ket_pf_abdomen !== null) {
			$('#ket_pf_abdomen_anak').val(data.ket_pf_abdomen)
		}

		if (data.pf_genitalia_anus === 'Normal') {
			$('#pf_genitalia_anak_tidak').prop('checked', true)
		}
		if (data.pf_genitalia_anus === 'Abnormal') {
			$('#pf_genitalia_anak_ya').prop('checked', true)
		}
		if (data.anak_ket_pf_genitalia_anus !== null) {
			$('#ket_pf_genitalia_anak').val(data.ket_pf_genitalia_anus)
		}

		if (data.pf_ekstermitas === 'Normal') {
			$('#pf_ekstermitas_anak_tidak').prop('checked', true)
		}
		if (data.pf_ekstermitas === 'Abnormal') {
			$('#pf_ekstermitas_anak_ya').prop('checked', true)
		}
		if (data.ket_pf_ekstermitas !== null) {
			$('#ket_pf_ekstermitas_anak').val(data.ket_pf_ekstermitas)
		}

		if (data.pf_kulit === 'Normal') {
			$('#pf_kulit_anak_tidak').prop('checked', true)
		}
		if (data.pf_kulit === 'Abnormal') {
			$('#pf_kulit_anak_ya').prop('checked', true)
		}
		if (data.ket_pf_kulit !== null) {
			$('#ket_pf_kulit_anak').val(data.ket_pf_kulit)
		}
		...
		if (data.sbd_anak !== null) {
			$('#sbd-anak ').prop('checked', true)
		}
		...
		if (data.id_dokter_dpjp !== null) {
			$('#dokter_dpjp_anak').select2c('readonly', true)
		}
		...
		if (data.id_dokter_pengkajian !== null) {
			$('#dokter_pengkajian_anak').select2c('readonly', true)
		}
	...
	function simpanPengkajianAwalAnak() {
		...
		$.ajax({
			...
			success: function(data) {
				...
				$('#modal_pengkajian_awal_pasien_anak').modal('hide');
				showListForm($('#id_pendaftaran_anak').val(), $('#id_layanan_pendaftaran_anak').val(), $('#id_pasien_anak').val());
			},
...
<!-- Modal -->
<!-- Rawat Inap -->
<div class="modal fade" id="modal_pengkajian_awal_pasien_anak" data-backdrop="static">
	<div class="modal-dialog modal-dialog-scrollable" style="max-width: 90%;">
		<div class="modal-content">
			<div class="modal-header">
				<div class="title">
					<h5 class="modal-title bold" id="modal_pengkajian_awal_pasien_anak">FORM PENGKAJIAN AWAL PASIEN ANAK</h5>
			...
			<div class="modal-body">
				...
				<input type="hidden" name="id_pendaftaran" id="id_pendaftaran_anak">
							...
							<div id="wizard_form_ranap_anak">
								...
								<div class="form-data-pengkajian-perawat-anak">
									...
									<div class="collapse multi-collapse mt-2" id="data-skrining-gizi">
										<table class="table table-sm table-striped table-bordered" style="margin-top: -15px">
											...
											<tbody>
												...
												<tr>
													<th rowspan="2" class="center v-center">2.</th>
													<td rowspan="2" class="v-center">Apakah terdapat penurunan berat badan selama 1 bulan terakhir? atau untuk bayi < dari 1 tahun berat badan tidak naik selama 3 bulan terakhir ? <br><i> Jika pasien menjawab tidak tahu, dianggap jawaban "Ya" </i></td>
													<td class="center">
									...
									<table class="table table-no-border table-sm table-striped" style="margin-top:-15px">
										<tr>
											<td colspan="3" class="center bold td-dark">
												<button class="btn btn-info btn-xs mr-1 float-left" type="button" data-toggle="collapse" data-target="#data-skala-early-warning-system-anak"><i class="fas fa-expand mr-1"></i>Expand</button>PEWS (ANAK)
											</td>
										</tr>
									</table>
									<div class="collapse multi-collapse mt-2" id="data-skala-early-warning-system-anak">
										...
										<table class="table table-sm table-striped table-bordered">
											<thead>
												...
												<tr>
													<th width="15%" class="center" style="background-color: #5F9EA0; color: white;"><b>Parameter</b></th>
											...
											<tbody>
												<tr>
													<td>Suhu</td>
													<td></td>
													<td class="center"><input type="radio" name="suhupewsk" id="skalapewsk_1_1" value="2_1" class="mr-1 skalapewsk pews_suhuk_1_1"> ≤ 35</td>
													<td class="center"><input type="radio" name="suhupewsk" id="skalapewsk_1_2" value="1_2" class="mr-1 skalapewsk pews_suhuk_1_2">35.1-36</td>
													<td class="center"><input type="radio" name="suhupewsk" id="skalapewsk_1_3" value="0_3" class="mr-1 skalapewsk pews_suhuk_1_3">36.1-38</td>
													<td class="center"><input type="radio" name="suhupewsk" id="skalapewsk_1_4" value="1_4" class="mr-1 skalapewsk pews_suhuk_1_4">38.1-38.5</td>
													<td class="center"><input type="radio" name="suhupewsk" id="skalapewsk_1_5" value="2_5" class="mr-1 skalapewsk pews_suhuk_1_5">> 38.5</td>
													<td></td>
												</tr>
												<tr>
												...
												<tr>
													...
													<td class="center"><input type="radio" name="pernafasanpewsk" id="skalapewsk_2_1" value="3_1" class="mr-1 skalapewsk pews_pernafasank_2_1"> ≤20</td>
													<td></td>
													<td class="center"><input type="radio" name="pernafasanpewsk" id="skalapewsk_2_2" value="1_2" class="mr-1 skalapewsk pews_pernafasank_2_2">20-29</td>
													<td class="center"><input type="radio" name="pernafasanpewsk" id="skalapewsk_2_3" value="0_3" class="mr-1 skalapewsk pews_pernafasank_2_3">30-40</td>
													<td class="center"><input type="radio" name="pernafasanpewsk" id="skalapewsk_2_4" value="1_4" class="mr-1 skalapewsk pews_pernafasank_2_4">41-50</td>
													<td class="center"><input type="radio" name="pernafasanpewsk" id="skalapewsk_2_5" value="2_5" class="mr-1 skalapewsk pews_pernafasank_2_5">51-60</td>
													<td class="center"><input type="radio" name="pernafasanpewsk" id="skalapewsk_2_6" value="3_6" class="mr-1 skalapewsk pews_pernafasank_2_6"> ≥60</td>
												</tr>
												<tr>
													<td><span class="ml-3">13-36 Bulan</span></td>
													<td class="center"><input type="radio" name="pernafasanpewsk" id="skalapewsk_3_1" value="3_7" class="mr-1 skalapewsk pews_pernafasank_3_1">≤20</td>
													<td></td>
													<td></td>
													<td class="center"><input type="radio" name="pernafasanpewsk" id="skalapewsk_3_2" value="0_8" class="mr-1 skalapewsk pews_pernafasank_3_2">20-30</td>
													<td class="center"><input type="radio" name="pernafasanpewsk" id="skalapewsk_3_3" value="1_9" class="mr-1 skalapewsk pews_pernafasank_3_3">31-50</td>
													<td class="center"><input type="radio" name="pernafasanpewsk" id="skalapewsk_3_4" value="2_10" class="mr-1 skalapewsk pews_pernafasank_3_4">51-60</td>
													<td class="center"><input type="radio" name="pernafasanpewsk" id="skalapewsk_3_5" value="3_11" class="mr-1 skalapewsk pews_pernafasank_3_5"> ≥60</td>
												</tr>
												<tr>
													<td><span class="ml-3">4-6 Tahun</span></td>
													<td class="center"><input type="radio" name="pernafasanpewsk" id="skalapewsk_4_1" value="3_12" class="mr-1 skalapewsk pews_pernafasank_4_1"> ≤20</td>
													<td></td>
													<td></td>
													<td class="center"><input type="radio" name="pernafasanpewsk" id="skalapewsk_4_2" value="0_13" class="mr-1 skalapewsk pews_pernafasank_4_2">20-30</td>
													<td class="center"><input type="radio" name="pernafasanpewsk" id="skalapewsk_4_3" value="1_14" class="mr-1 skalapewsk pews_pernafasank_4_3">31-50</td>
													<td class="center"><input type="radio" name="pernafasanpewsk" id="skalapewsk_4_4" value="2_15" class="mr-1 skalapewsk pews_pernafasank_4_4">51-60</td>
													<td class="center"><input type="radio" name="pernafasanpewsk" id="skalapewsk_4_5" value="3_16" class="mr-1 skalapewsk pews_pernafasank_4_5"> ≥60</td>
												</tr>
												<tr>
													<td><span class="ml-3">7-12 Tahun</span></td>
													<td class="center"><input type="radio" name="pernafasanpewsk" id="skalapewsk_5_1" value="3_17" class="mr-1 skalapewsk pews_pernafasank_5_1">≤10</td>
													<td></td>
													<td></td>
													<td class="center"><input type="radio" name="pernafasanpewsk" id="skalapewsk_5_2" value="0_18" class="mr-1 skalapewsk pews_pernafasank_5_2">10-20</td>
													<td class="center"><input type="radio" name="pernafasanpewsk" id="skalapewsk_5_3" value="1_19" class="mr-1 skalapewsk pews_pernafasank_5_3">21-30</td>
													<td class="center"><input type="radio" name="pernafasanpewsk" id="skalapewsk_5_4" value="2_20" class="mr-1 skalapewsk pews_pernafasank_5_4">31-40</td>
													<td class="center"><input type="radio" name="pernafasanpewsk" id="skalapewsk_5_5" value="3_21" class="mr-1 skalapewsk pews_pernafasank_5_5"> ≥40</td>
												</tr>
												<tr>
													<td><span class="ml-3">13-18 Tahun</span></td>
													<td class="center"><input type="radio" name="pernafasanpewsk" id="skalapewsk_6_1" value="3_22" class="mr-1 skalapewsk pews_pernafasank_6_1"> ≤10</td>
													<td></td>
													<td></td>
													<td class="center"><input type="radio" name="pernafasanpewsk" id="skalapewsk_6_2" value="0_23" class="mr-1 skalapewsk pews_pernafasank_6_2">10-20</td>
													<td class="center"><input type="radio" name="pernafasanpewsk" id="skalapewsk_6_3" value="1_24" class="mr-1 skalapewsk pews_pernafasank_6_3">21-30</td>
													<td class="center"><input type="radio" name="pernafasanpewsk" id="skalapewsk_6_4" value="2_25" class="mr-1 skalapewsk pews_pernafasank_6_4">31-40</td>
													<td class="center"><input type="radio" name="pernafasanpewsk" id="skalapewsk_6_5" value="3_26" class="mr-1 skalapewsk pews_pernafasank_6_5"> ≥40</td>
												</tr>
												<tr>
													<td></td>
													<td></td>
													<td></td>
													<td></td>
													<td class="center"><input type="radio" name="tidakretraksipewsk" id="skalapewsk_7_1" value="0_1" class="mr-1 skalapewsk pews_subpernafasank_7_1">Tidak Retraksi</td>
													<td class="center"><input type="radio" name="tidakretraksipewsk" id="skalapewsk_7_2" value="1_2" class="mr-1 skalapewsk pews_subpernafasank_7_2">Otot Bantu Nafas</td>
													<td class="center"><input type="radio" name="tidakretraksipewsk" id="skalapewsk_7_3" value="2_3" class="mr-1 skalapewsk pews_subpernafasank_7_3">Retraksi</td>
													<td class="center"><input type="radio" name="tidakretraksipewsk" id="skalapewsk_7_4" value="3_4" class="mr-1 skalapewsk pews_subpernafasank_7_4">Merintih</td>
												</tr>
												<tr>
													<td>Alat Bantu O₂</td>
													<td></td>
													<td></td>
													<td></td>
													<td class="center"><input type="radio" name="alatbantupewsk" id="skalapewsk_8_1" value="0_1" class="mr-1 skalapewsk pews_alat_bantuk_8_1">Tidak</td>
													<td class="center"><input type="radio" name="alatbantupewsk" id="skalapewsk_8_2" value="1_2" class="mr-1 skalapewsk pews_alat_bantuk_8_2"> > 3L/Menit</td>
													<td class="center"><input type="radio" name="alatbantupewsk" id="skalapewsk_8_3" value="2_3" class="mr-1 skalapewsk pews_alat_bantuk_8_3"> > 6L/Menit</td>
													<td class="center"><input type="radio" name="alatbantupewsk" id="skalapewsk_8_4" value="3_4" class="mr-1 skalapewsk pews_alat_bantuk_8_4"> > 8L/Menit</td> 
												</tr>
												<tr>
													<td>Saturasi O₂</td>
													<td class="center"><input type="radio" name="saturasipewask" id="skalapewsk_9_1" value="3_1" class="mr-1 skalapewsk pews_saturasik_9_1">≤85</td>
													<td class="center"><input type="radio" name="saturasipewask" id="skalapewsk_9_2" value="2_2" class="mr-1 skalapewsk pews_saturasik_9_2">86-89</td>
													<td class="center"><input type="radio" name="saturasipewask" id="skalapewsk_9_3" value="1_3" class="mr-1 skalapewsk pews_saturasik_9_3">90-93</td>
													<td class="center"><input type="radio" name="saturasipewask" id="skalapewsk_9_4" value="0_4" class="mr-1 skalapewsk pews_saturasik_9_4"> >94</td>
													<td></td>
													<td></td>
													<td></td>
												</tr>
												...
												<tr>
													<td><span class="ml-3">1-12 Bulan</span></td>
													<td class="center"><input type="radio" name="nadipewsk" id="skalapewsk_10_1" value="3_1" class="mr-1 skalapewsk pews_nadik_10_1"> ≤90 </td>
													<td class="center"><input type="radio" name="nadipewsk" id="skalapewsk_10_2" value="2_2" class="mr-1 skalapewsk pews_nadik_10_2">90-99 </td> 
													<td class="center"><input type="radio" name="nadipewsk" id="skalapewsk_10_3" value="1_3" class="mr-1 skalapewsk pews_nadik_10_3">100-109</td>
													<td class="center"><input type="radio" name="nadipewsk" id="skalapewsk_10_4" value="0_4" class="mr-1 skalapewsk pews_nadik_10_4">110-160</td>
													<td class="center"><input type="radio" name="nadipewsk" id="skalapewsk_10_5" value="1_5" class="mr-1 skalapewsk pews_nadik_10_5">161-170</td>
													<td class="center"><input type="radio" name="nadipewsk" id="skalapewsk_10_6" value="2_6" class="mr-1 skalapewsk pews_nadik_10_6">171-190</td>
													<td class="center"><input type="radio" name="nadipewsk" id="skalapewsk_10_7" value="3_7" class="mr-1 skalapewsk pews_nadik_10_7">≥ 190</td>
												</tr>
												<tr>
													<td><span class="ml-3">13-36 Bulan</span></td>
													<td class="center"><input type="radio" name="nadipewsk" id="skalapewsk_11_1" value="3_8" class="mr-1 skalapewsk pews_nadik_11_1">≤ 70</td>
													<td class="center"><input type="radio" name="nadipewsk" id="skalapewsk_11_2" value="2_9" class="mr-1 skalapewsk pews_nadik_11_2">70-79</td>
													<td class="center"><input type="radio" name="nadipewsk" id="skalapewsk_11_3" value="1_10" class="mr-1 skalapewsk pews_nadik_11_3">80-89</td>
													<td class="center"><input type="radio" name="nadipewsk" id="skalapewsk_11_4" value="0_11" class="mr-1 skalapewsk pews_nadik_11_4">90-140</td>
													<td class="center"><input type="radio" name="nadipewsk" id="skalapewsk_11_5" value="1_12" class="mr-1 skalapewsk pews_nadik_11_5">141-160</td>
													<td class="center"><input type="radio" name="nadipewsk" id="skalapewsk_11_6" value="2_13" class="mr-1 skalapewsk pews_nadik_11_6">161-170</td>
													<td class="center"><input type="radio" name="nadipewsk" id="skalapewsk_11_7" value="3_14" class="mr-1 skalapewsk pews_nadik_11_7">≥170</td>
												</tr>
												<tr>
													<td><span class="ml-3">4-6 Tahun</span></td>
													<td class="center"><input type="radio" name="nadipewsk" id="skalapewsk_12_1" value="3_15" class="mr-1 skalapewsk pews_nadik_12_1">≤60</td>
													<td class="center"><input type="radio" name="nadipewsk" id="skalapewsk_12_2" value="2_16" class="mr-1 skalapewsk pews_nadik_12_2">60-79</td>
													<td class="center"><input type="radio" name="nadipewsk" id="skalapewsk_12_3" value="1_17" class="mr-1 skalapewsk pews_nadik_12_3">80-89</td>
													<td class="center"><input type="radio" name="nadipewsk" id="skalapewsk_12_4" value="0_18" class="mr-1 skalapewsk pews_nadik_12_4">90-120</td>
													<td class="center"><input type="radio" name="nadipewsk" id="skalapewsk_12_5" value="1_19" class="mr-1 skalapewsk pews_nadik_12_5">121-140</td>
													<td class="center"><input type="radio" name="nadipewsk" id="skalapewsk_12_6" value="2_20" class="mr-1 skalapewsk pews_nadik_12_6">141-160</td>
													<td class="center"><input type="radio" name="nadipewsk" id="skalapewsk_12_7" value="3_21" class="mr-1 skalapewsk pews_nadik_12_7">≥160</td>
												</tr>
												<tr>
													<td><span class="ml-3">7-12 Tahun</span></td>
													<td class="center"><input type="radio" name="nadipewsk" id="skalapewsk_13_1" value="3_22" class="mr-1 skalapewsk pews_nadik_13_1">≤60</td>
													<td class="center"><input type="radio" name="nadipewsk" id="skalapewsk_13_2" value="2_23" class="mr-1 skalapewsk pews_nadik_13_2">60-69</td>
													<td class="center"><input type="radio" name="nadipewsk" id="skalapewsk_13_3" value="1_24" class="mr-1 skalapewsk pews_nadik_13_3">70-79</td>
													<td class="center"><input type="radio" name="nadipewsk" id="skalapewsk_13_4" value="0_25" class="mr-1 skalapewsk pews_nadik_13_4">80-100</td>
													<td class="center"><input type="radio" name="nadipewsk" id="skalapewsk_13_5" value="1_26" class="mr-1 skalapewsk pews_nadik_13_5">101-120</td>
													<td class="center"><input type="radio" name="nadipewsk" id="skalapewsk_13_6" value="2_27" class="mr-1 skalapewsk pews_nadik_13_6">121-140</td>
													<td class="center"><input type="radio" name="nadipewsk" id="skalapewsk_13_7" value="3_28" class="mr-1 skalapewsk pews_nadik_13_7">≥140</td>
												</tr>
												<tr>
													<td><span class="ml-3">13-18 Tahun</span></td>
													<td class="center"><input type="radio" name="nadipewsk" id="skalapewsk_14_1" value="3_29" class="mr-1 skalapewsk pews_nadik_14_1">≤60</td>
													<td class="center"><input type="radio" name="nadipewsk" id="skalapewsk_14_2" value="2_30" class="mr-1 skalapewsk pews_nadik_14_2">60-69</td>
													<td class="center"><input type="radio" name="nadipewsk" id="skalapewsk_14_3" value="1_31" class="mr-1 skalapewsk pews_nadik_14_3">70-79</td>
													<td class="center"><input type="radio" name="nadipewsk" id="skalapewsk_14_4" value="0_32" class="mr-1 skalapewsk pews_nadik_14_4">80-100</td>
													<td class="center"><input type="radio" name="nadipewsk" id="skalapewsk_14_5" value="1_33" class="mr-1 skalapewsk pews_nadik_14_5">101-120</td>
													<td class="center"><input type="radio" name="nadipewsk" id="skalapewsk_14_6" value="2_34" class="mr-1 skalapewsk pews_nadik_14_6">121-140</td>
													<td class="center"><input type="radio" name="nadipewsk" id="skalapewsk_14_7" value="3_35" class="mr-1 skalapewsk pews_nadik_14_7">≥140</td>
												</tr>
												<tr>
													<td>Warna Kulit</td>
													<td></td>
													<td></td>
													<td></td>
													<td class="center"><input type="radio" name="warnakulitpewsk" id="skalapewsk_15_1" value="0_1" class="mr-1 skalapewsk pews_warna_kulitk_15_1">Tidak Sianosis/CRT < 2 S</td>
													<td></td>
													<td class="center"><input type="radio" name="warnakulitpewsk" id="skalapewsk_15_2" value="2_2" class="mr-1 skalapewsk pews_warna_kulitk_15_2">Tampak Sianotik/CRT > 2 S</td>
													<td class="center"><input type="radio" name="warnakulitpewsk" id="skalapewsk_15_3" value="3_3" class="mr-1 skalapewsk pews_warna_kulitk_15_3">Sianotik dan Motled /CRT > 5 S</td>
												</tr>
												<tr>
													<td>TDS</td>
													<td class="center"><input type="radio" name="tdspewsk" id="skalapewsk_16_1" value="3_1" class="mr-1 skalapewsk pews_tdsk_16_1">≤ 80</td>
													<td></td>
													<td class="center"><input type="radio" name="tdspewsk" id="skalapewsk_16_2" value="1_2" class="mr-1 skalapewsk pews_tdsk_16_2">80-89</td>
													<td class="center"><input type="radio" name="tdspewsk" id="skalapewsk_16_3" value="0_3" class="mr-1 skalapewsk pews_tdsk_16_3">90-119</td>
													<td class="center"><input type="radio" name="tdspewsk" id="skalapewsk_16_4" value="1_4" class="mr-1 skalapewsk pews_tdsk_16_4">120-129</td>
													<td class="center"><input type="radio" name="tdspewsk" id="skalapewsk_16_5" value="2_5" class="mr-1 skalapewsk pews_tdsk_16_5">130-139</td>
													<td class="center"><input type="radio" name="tdspewsk" id="skalapewsk_16_6" value="3_6" class="mr-1 skalapewsk pews_tdsk_16_6">> 140</td>
												</tr>
												<tr>
													<td>Kesadaran</td>
													<td class="center"><input type="radio" name="kesadaranpewsk" id="skalapewsk_17_1" value="3_1" class="mr-1 skalapewsk pews_kesadarank_17_1">P/U</td>
													<td></td>
													<td class="center"><input type="radio" name="kesadaranpewsk" id="skalapewsk_17_2" value="1_2" class="mr-1 skalapewsk pews_kesadarank_17_2">V</td>
													<td class="center"><input type="radio" name="kesadaranpewsk" id="skalapewsk_17_3" value="0_3" class="mr-1 skalapewsk pews_kesadarank_17_3">A</td>
													<td class="center"><input type="radio" name="kesadaranpewsk" id="skalapewsk_17_4" value="1_4" class="mr-1 skalapewsk pews_kesadarank_17_4">V</td>
													<td></td>
													<td class="center"><input type="radio" name="kesadaranpewsk" id="skalapewsk_17_5" value="3_5" class="mr-1 skalapewsk pews_kesadarank_17_5">P/U</td>
												</tr>
												<tr>
													<td></td>
													<td colspan="7">
														<input type="radio" name="sew_total" id="sew_total_1" class="mr-1 ml-3" value="Hijau"><i class="fas fa-fw fa-square" style="color: green"></i><b>Hijau (0-2)</b>
														<input type="radio" name="sew_total" id="sew_total_2" class="mr-1 ml-3" value="Kuning"><i class="fas fa-fw fa-square" style="color: yellow"></i><b>Kuning (3-4)</b>
														<input type="radio" name="sew_total" id="sew_total_3" class="mr-1 ml-3" value="Merah"><i class="fas fa-fw fa-square" style="color: red"></i><b>Merah(≥5/3 Pada salah satu parameter)</b>
													</td>
												</tr>
											</tbody>
										</table>
														...
														<tbody>
															...
															<tr>
																...
																<td colspan="8">
																	...
																	<input type="radio" name="total_skala_sew_anak" id="total_skala_sew_anak_2" class="mr-1 ml-3" value="Hijau"><i class="fas fa-fw fa-square" style="color: green"></i><b>Hijau (0-2)</b>
																	<input type="radio" name="total_skala_sew_anak" id="total_skala_sew_anak_3" class="mr-1 ml-3" value="Kuning"><i class="fas fa-fw fa-square" style="color: yellow"></i><b>Kuning (3-4)</b>
																	<input type="radio" name="total_skala_sew_anak" id="total_skala_sew_anak_4" class="mr-1 ml-3" value="Merah"><i class="fas fa-fw fa-square" style="color: red"></i><b>Merah (≥5 atau skor 3 pada salah satu parameter)</b>
																</td>
															</tr>
														</tbody>
													</table>
								...
								<div class="form-data-pengkajian-dokter">
									<table class="table table-no-border table-sm table-striped">
										...
										<tr>
											...
											<td class="bold">:</td>
											<td>
												<div id="hasil_laboratorium_anak"></div>
											</td>
										</tr>
										<tr>
											...
											<td class="bold">:</td>
											<td>
												<div id="hasil_radiologi_anak"></div>
											</td>
										</tr>
										<tr>
											...
											<td class="bold">:</td>
											<td>
												<div id="hasil_penunjang_lain_anak"></div>
											</td>
										</tr>
										<tr>
										...
										<tr>
											<td colspan="3">
												<div id="diagnosa_awal_medis_anak"></div>
											</td>
										</tr>
										<tr>
