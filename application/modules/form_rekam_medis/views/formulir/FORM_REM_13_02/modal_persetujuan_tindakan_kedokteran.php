<script>
	...
	function simpanPersetujuanTindakanKedokteran() {
		...
		if ($('#tindakan-mptk').val() === '') {
            syams_validation('#tindakan-mptk', 'Tindakan Belum diisi.');
            return false;
        } else {
            syams_validation_remove('#tindakan-mptk');
        }
		...
		$.ajax({
			...
			success: function(data) {
				if (data.status) {
					...
					showListForm($('#id-pendaftaran-form-mptk').val(),$('#id-layanan-pendaftaran-form-mptk').val(), $('#id-pasien-form-mptk').val());
				} else {
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<?= form_open('', 'id=form-persetujuan-tindakan-kedokteran class="form-horizontal"') ?>
					<input type="hidden" name="id_pasien" id="id-pasien-form-mptk">
					<input type="hidden" name="id_pendaftaran" id="id-pendaftaran-form-mptk">
								...
								<div id="wizard_form_ranap">																		
									<div class="form-persetujuan-tindakan-kedokteran">
										<table class="table table-no-border table-sm table-striped">
											<tr>												
												<td class="bold" width="30%">Apakah form ditandatangani oleh pasien sendiri?</td>
											...
											<tr>												
												<td class="bold" width="30%">Nama keluarga / wali</td>
												<td class="bold" width="1%">:</td>
												<td width="48%">
											...
											<tr>												
												<td class="bold" width="30%">Tanggal lahir</td>
												<td class="bold" width="1%">:</td>
												<td width="48%">
											...
											<tr>												
												<td class="bold" width="30%">Jenis kelamin</td>
												<td class="bold" width="1%">:</td>
												<td width="48%">
											...
											<tr>												
												<td class="bold" width="30%">Alamat</td>
												<td class="bold" width="1%">:</td>
												<td width="48%">
											...
											<tr>												
												<td class="bold" width="30%">Hubungan keluarga</td>
												<td class="bold" width="1%">:</td>
												<td width="48%">
											...
											<tr>												
												<td class="bold" width="30%">Tindakan</td>
												<td class="bold" width="1%">:</td>
												<td width="48%">
											...
											<tr>
												<td class="bold" width="30%">Saksi 1</td>
												<td class="bold" width="1%">:</td>
												<td width="48%">
											...
											<tr>
												<td class="bold" width="30%">Saksi 2</td>
												<td class="bold" width="1%">:</td>
												<td width="48%">
													<!-- <input type="text" name="saksi_2" id="saksi-2-mptk" class="select2c-input"> -->
													<input type="text" name="id_keluwarga" id="id-keluwarga" class="custom-form clear-input col-lg-5">
												</td>
											</tr>								
										</table>
									</div>
