    ...
    <div class="modal-dialog modal-dialog-scrollable" style="max-width: 90%;">
        <div class="modal-content">
            <div class="modal-header">
                <div class="title">
                    <h5 class="modal-title bold" id="modal_entri_keperawatan_rm">RESUME KEPERAWATAN</h5>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card-body">
                            ...
                            <!-- Data Resume Keperawatan-->
                            <div class="form-data-resume-perawat">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <!-- <h5 class="center"><b>RESUME KEPERAWATAN</b></h5> -->
                                        <table class="table table-no-border table-sm table-striped">
                                            <tr>
                                                <td colspan="3">
                                                    <button class="btn btn-info btn-xs mr-1 float-left" type="button" id="ek_btn_expand_all"><i class="fas fa-fw fa-expand mr-1"></i>Expand All</button>
                                                    <button class="btn btn-warning btn-xs mr-1 float-left" type="button" id="ek_btn_collapse_all"><i class="fas fa-fw fa-compress mr-1"></i>Collapse
                                                        All</button>
                                                </td>
                                            </tr>
                                        </table>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="box-well shadow">
                                            <div class="widget-body">
                                                <div id="wizard-resume-group">
                                                    <ol>
                                                        <li>ENTRI RESUME</li>
                                                        <li>DATA RESUME</li>
                                                    </ol>
                                                    <div class="form-resume-entri">
                                                        <div class="row">
                                                            <div class="col-lg-12">
                                                                <!-- Row Data Kesehatan -->
                                                                <table class="table table-sm table-striped" style="margin-top: -15px">
                                                                    <tr>
                                                                        <td width="1%"></td>
                                                                        <td width="5%"><b>Ruangan</b></td>
                                                                        <td width="1%">:</td>
                                                                        <td width="33%">
																			<!-- <div class="input-group">
                                                                                <input type="text" name="ruang_resume_keperawatan" id="ruang_resume_keperawatan" class="custom-form clear-input d-inline-block col-lg-6">
                                                                            </div> -->
																			<span id="ruang-resume-keperawatan"></span>
																		</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td width="1%"></td>
                                                                        <td width="5%"><b>Diagnosis Masuk</b></td>
                                                                        <td width="1%">:</td>
                                                                        <td width="33%">
																			<!-- <div class="input-group">
                                                                                <input type="text" name="rk_diagnosa_masuk" id="rk_diagnosa_masuk" class="custom-form clear-input d-inline-block col-lg-6" placeholder="Diagnosis Masuk">
                                                                            </div> -->
																			<span id="rk-diagnosa-masuk"></span>
																		</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td width="1%"></td>
                                                                        <td width="5%"><b>Diagnosis Keluar</b></td>
                                                                        <td width="1%">:</td>
                                                                        <td width="33%">
																			<!-- <div class="input-group">
                                                                                <input type="text" name="rk_diagnosa_keluar" id="rk_diagnosa_keluar" class="custom-form clear-input d-inline-block col-lg-6" placeholder="Diagnosis Keluar">
                                                                            </div> -->
																			<span id="rk-diagnosa-keluar"></span>
																		</td>
                                                                    </tr>
                                                                </table>
                                                                <table class="table table-no-border table-sm table-striped" style="margin-top:-15px">
                                                                    <tr>
                                                                        <td colspan="3" class="center bold td-dark">
                                                                            <button class="btn btn-info btn-xs mr-1 float-left" type="button" data-toggle="collapse" data-target="#data-resume-keperawatan"><i class="fas fa-expand mr-1"></i>Expand</button>KEADAAN
                                                                            UMUM PASIEN
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                                <div class="collapse multi-collapse mt-2" id="data-resume-keperawatan">
                                                                    <input type="hidden" name="id_rk" id="rk-id">
                                                                    <input type="hidden" name="rk_id_layanan_pendaftaran" id="rk-id-layanan-pendaftaran">
                                                                    <table class="table table-no-border table-sm table-striped">
                                                                        <tr>
                                                                            <td width="2%"></td>
                                                                            <td width="15%" class="bold">Keadaan
                                                                                saat Pulang</td>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <div class="input-group">
                                                                                    <input type="text" name="ek_suhu" id="ek_suhu" class="custom-form clear-input d-inline-block col-lg-3" placeholder="Suhu" onkeypress="return hanyaAngka(event)">
                                                                            ...
                                                                            <td>
                                                                                <div class="input-group">
                                                                                    <input type="text" name="ek_nadi" id="ek_nadi" class="custom-form clear-input d-inline-block col-lg-3" placeholder="Nadi" onkeypress="return hanyaAngka(event)">
                                                                                    <div class="input-group-append">
                                                                        ...
                                                                        <tr>
                                                                            <td width="2%"></td>
                                                                            <td width="15%" class="bold">Pernafasan
                                                                            </td>
                                                                            <td width="1%" class="bold">:</td>
                                                                            <td>
                                                                                <div class="input-group">
                                                                                    <input type="text" name="ek_pernafasan" id="ek_pernafasan" class="custom-form clear-input d-inline-block col-lg-3" placeholder="Nafas" onkeypress="return hanyaAngka(event)">
                                                                                    <div class="input-group-append">
                                                                                        <span class="input-group-custom">x/mnt</span>
                                                                                    </div>
                                                                                </div>
                                                                            ...
                                                                            <td>
                                                                                <div class="input-group">
                                                                                    <input type="text" name="ek_tensi_sis" id="ek_tensi_sis" class="custom-form clear-input d-inline-block col-lg-3" placeholder="Sistolik" onkeypress="return hanyaAngka(event)">
                                                                                    <span>/</span>
                                                                                    <input type="text" name="rk_tensi_dis" id="rk-tensi-dis" class="custom-form clear-input d-inline-block col-lg-3" placeholder="Diastolik" onkeypress="return hanyaAngka(event)">
                                                                                    <div class="input-group-append">
                                                                    ...
                                                                    <table class="table table-no-border table-sm table-striped">
                                                                        <tr>
                                                                            <td width="2%"></td>
                                                                            <td width="15%" class="bold">Diet
                                                                                Nutrisi</td>
                                                                            <td width="1%" class="bold">:</td>
                                                                            <td>
                                                                                <div class="input-group">
                                                                                    <input type="checkbox" name="diet_khusus" id="diet_khusus" value="1" class="mr-1">Diet Khusus
                                                                                    <input type="text" name="sm_diet_khusus" id="sm_diet_khusus" class="custom-form clear-input d-inline-block col-lg-3 ml-2 disabled" placeholder=".......................">
                                                                                    <input type="checkbox" name="batasan_cairan" id="batasan_cairan" value="1" class="mr-1 ml-5">Batasan
                                                                                    Cairan
                                                                                    <input type="text" name="sm_batasan_cairan" id="sm_batasan_cairan" class="custom-form clear-input d-inline-block col-lg-3 ml-2 disabled" placeholder=".......................">
                                                                                </div>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <div class="input-group">
                                                                                    <input type="checkbox" name="diet_oral" id="diet_oral" value="1" class="mr-1">Oral
                                                                                    <input type="checkbox" name="diet_ngt" id="diet_ngt" value="1" class="mr-1 ml-2">NGT
                                                                                </div>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td width="2%"></td>
                                                                            <td width="15%" class="bold">BAB</td>
                                                                            <td width="1%" class="bold">:</td>
                                                                            <td>
                                                                                <div class="input-group">
                                                                                    <input type="radio" name="bab" id="bab-normal" value="Normal" class="mr-1">Normal
                                                                                    <input type="radio" name="bab" id="bab-ileostomy" value="Ileostomy" class="mr-1 ml-2">Ileostomy/Colostomy
                                                                                    <input type="radio" name="bab" id="bab-inontinensia" value="Inontinensia Urin" class="mr-1 ml-2">Inontinensia
                                                                                    Urin
                                                                                    <input type="radio" name="bab" id="bab-inkontinensia" value="Inkontinensia alvi" class="mr-1 ml-2">Inkontinensia
                                                                                    alvi
                                                                                </div>
                                                                            </td>
                                                                            <td></td>
                                                                        ...
                                                                        <tr>
                                                                            <td width="2%"></td>
                                                                            <td width="15%" class="bold">BAK</td>
                                                                            <td width="1%" class="bold">:</td>
                                                                            <td>
                                                                                <div class="input-group">
                                                                                    <input type="radio" name="bak" id="bak-normal" value="Normal" class="mr-1">Normal
                                                                                    <input type="radio" name="bak" id="bak_kateter" value="Kateter, tanggal pasang terakhir" class="mr-1 ml-2">Kateter,
                                                                                    tanggal pasang terakhir
                                                                                    <input type="text" name="bak_kateter" id="sm_bak_kateter" class="custom-form clear-input d-inline-block col-lg-3 ml-2 disabled" value="<?= date('d/m/Y H:i') ?>">
                                                                                </div>
                                                                            </td>
                                                                            <td></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td width="2%"></td>
                                                                            <td width="15%" class="bold">Luka/Luka
                                                                                Operasi</td>
                                                                            <td width="1%" class="bold">:</td>
                                                                            <td>
                                                                                <div class="input-group">
                                                                                    <input type="radio" name="luka_operasi" id="luka_bersih" value="Normal" class="mr-1">Bersih
                                                                                    <input type="radio" name="luka_operasi" id="luka_kering" value="Kering" class="mr-1 ml-2">Kering
                                                                                    <input type="radio" name="luka_operasi" id="cairan_luka" value="Ada cairan dari luka" class="mr-1 ml-2">Ada cairan
                                                                                    dari luka, jelaskan
                                                                                    <input type="text" name="sm_cairan_luka" id="sm_cairan_luka" class="custom-form clear-input d-inline-block col-lg-3 ml-2 disabled" placeholder="Jelaskan...">
                                                                                </div>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td width="2%"></td>
                                                                            <td width="15%" class="bold">Transfer &
                                                                                Mobilisasi</td>
                                                                            <td width="1%" class="bold">:</td>
                                                                            <td>
                                                                                <div class="input-group">
                                                                                    <input type="radio" name="mobilisasi" id="mobilisasi_mandiri" value="Mandiri" class="mr-1">Mandiri
                                                                                    <input type="radio" name="mobilisasi" id="mobilisasi_dibantu" value="Dibantu Sebagian" class="mr-1 ml-2">Dibantu
                                                                                    Sebagian
                                                                                    <input type="radio" name="mobilisasi" id="mobilisasi_penuh" value="Dibantu Penuh" class="mr-1 ml-2">Dibantu
                                                                                    Penuh
                                                                                </div>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td width="2%"></td>
                                                                            <td width="15%" class="bold">Alat Bantu
                                                                            </td>
                                                                            <td width="1%" class="bold">:</td>
                                                                            <td>
                                                                                <div class="input-group">
                                                                                    <input type="radio" name="alat_bantu" id="alat_tongkat" value="Tongkat" class="mr-1">Tongkat
                                                                                    <input type="radio" name="alat_bantu" id="alat_kursi_roda" value="Kursi Roda" class="mr-1 ml-2">Kursi Roda
                                                                                    <input type="radio" name="alat_bantu" id="alat_trolley" value="Troley/Kereta Dorong" class="mr-1 ml-2">Troley/Kereta
                                                                                    Dorong
                                                                                    <input type="radio" name="alat_bantu" id="alat_lain" value="Lain - lain" class="mr-1 ml-2">Lain -
                                                                                    lain
                                                                                    <input type="text" name="alat_bantu_lain" id="sm_alat_lain" class="custom-form clear-input d-inline-block col-lg-3 ml-2 disabled" placeholder="Sebutkan Alat Bantu yang digunakan...">
                                                                                </div>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                    ...
                                                                    <table class="table table-no-border table-sm table-striped">
                                                                        <tr>
                                                                            <td colspan="3" class="bold">EDUKASI /
                                                                                PENYULUHAN KESEHATAN YANG SUDAH
                                                                                DIBERIKAN</td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td colspan="3">
                                                                                <input type="checkbox" name="edukasi_penyakit" id="edukasi_penyakit" value="1" class="mr-1">Penyakit dan
                                                                                Pengobatannya
                                                                                <input type="checkbox" name="edukasi_perawatan" id="edukasi_perawatan" value="1" class="mr-1 ml-2">Perawatan Luka
                                                                                <input type="checkbox" name="edukasi_dirumah" id="edukasi_dirumah" value="1" class="mr-1 ml-2">Perawatan di
                                                                                Rumah
                                                                                <input type="checkbox" name="edukasi_ibubayi" id="edukasi_ibubayi" value="1" class="mr-1 ml-2">Perawatan Ibu
                                                                                dan Bayi
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td colspan="3">
                                                                                <input type="checkbox" name="edukasi_nyeri" id="edukasi_nyeri" value="1" class="mr-1">Mengatasi Nyari
                                                                                <input type="checkbox" name="edukasi_lingkungan" id="edukasi_lingkungan" value="1" class="mr-1 ml-2">Persiapan
                                                                                Lingkungan dan Fasilitas untuk
                                                                                Perawatan di Rumah
                                                                                <input type="checkbox" name="edukasi_kb" id="edukasi_kb" value="1" class="mr-1 ml-2">Nasehat
                                                                                Keluarga Berencana
                                                                                <input type="checkbox" name="edukasi_rehabilitas" id="edukasi_rehabilitas" value="1" class="mr-1 ml-2">Rehabilitas
                                                                                Terapi
                                                                                <input type="checkbox" name="edukasi_lain" id="edukasi_lain" value="1" class="mr-1 ml-2">Lainnya
                                                                                <input type="text" name="edukasi_lain_input" id="edukasi_lain_input" class="custom-form clear-input d-inline-block col-lg-3 ml-2 disabled">
                                                                    ...
                                                                    <table class="table table-no-border table-sm table-striped">
                                                                        <tr>
                                                                            <td colspan="3" class="bold">DIAGNOSA
                                                                                KEPERAWATAN SELAMA DIRAWAT</td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td width="2%" class="bold">1.</td>
                                                                            <td width="48%">
                                                                                <div class="form-group tight">
                                                                                    <textarea name="diagnosa_perawat" id="diagnosa_perawat" class="form-control visitasi-input" rows="4"></textarea>
                                                                                </div>
                                                                            </td>
                                                                            <td width="2%" class="bold">2.</td>
                                                                            <td width="48%">
                                                                                <div class="form-group tight">
                                                                                    <textarea name="diagnosa_perawat_satu" id="diagnosa_perawat_satu" class="form-control visitasi-input" rows="4"></textarea>
                                                                                </div>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                    ...
                                                                    <table class="table table-no-border table-sm table-striped">
                                                                        <tr>
                                                                            <td colspan="3" class="bold">
                                                                                ANJURAN/PERAWAT KHUSUS SETELAH
                                                                                PULANG</td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td class="bold">1.</td>
                                                                            <td>
                                                                                <div class="input-group">
                                                                                    <input type="text" name="anjuran_perawat" id="anjuran_perawat" class="custom-form clear-input d-inline-block col-lg-8 ml-2" placeholder="Anjuran Perawat...">
                                                                                </div>
                                                                            </td>
                                                                            <td class="bold">3.</td>
                                                                            <td>
                                                                                <div class="input-group">
                                                                                    <input type="text" name="anjuran_perawat_satu" id="anjuran_perawat_satu" class="custom-form clear-input d-inline-block mr-1 ml-2" placeholder="Anjuran Perawat...">
                                                                                </div>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <div class="input-group">
                                                                                    <input type="text" name="anjuran_perawat_dua" id="anjuran_perawat_dua" class="custom-form clear-input d-inline-block col-lg-8 ml-2" placeholder="Anjuran Perawat...">
                                                                                </div>
                                                                            </td>
                                                                            <td class="bold">4.</td>
                                                                            <td>
                                                                                <div class="input-group">
                                                                                    <input type="text" name="anjuran_perawat_tiga" id="anjuran_perawat_tiga" class="custom-form clear-input d-inline-block mr-1 ml-2" placeholder="Anjuran Perawat...">
                                                                                </div>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                ...
                                                                <table class="table table-no-border table-sm table-striped" style="margin-top:-15px">
                                                                    <tr>
                                                                        <td colspan="3" class="center bold td-dark">
                                                                            <button class="btn btn-info btn-xs mr-1 float-left" type="button" data-toggle="collapse" data-target="#data-resume-bidan"><i class="fas fa-expand mr-1"></i>Expand</button>DIISI
                                                                            OLEH BIDAN (Khusus Pasien Kebidanan)
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                                <div class="collapse multi-collapse mt-2" id="data-resume-bidan">
                                                                    <table class="table table-no-border table-sm table-striped">
                                                                        <tr>
                                                                            <td width="2%"></td>
                                                                            <td width="15%" class="bold">Kontraksi
                                                                                Uterus</td>
                                                                            <td width="1%" class="bold">:</td>
                                                                            <td>
                                                                                <div class="input-group">
                                                                                    <input type="radio" name="kontraksi" id="sm_kontraksi_tidak" value="Tidak" class="mr-1">Tidak
                                                                                    <input type="radio" name="kontraksi" id="sm_kontraksi_baik" value="Baik" class="mr-1 ml-2">Baik
                                                                                </div>
                                                                            </td>
                                                                            <td class="bold">Tinggi Fundus Uteri
                                                                            </td>
                                                                            <td class="bold">:</td>
                                                                            <td>
                                                                                <div class="input-group">
                                                                                    <input type="text" name="fundus_uteri" id="fundus_uteri" class="custom-form clear-input d-inline-block mr-1 ml-2" placeholder="Fundus Uteri" onkeypress="return hanyaAngka(event)">
                                                                                </div>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td></td>
                                                                            <td class="bold">Vulva</td>
                                                                            <td class="bold">:</td>
                                                                            <td>
                                                                                <div class="input-group">
                                                                                    <input type="radio" name="vulva" id="vulva_bersih" value="Bersih" class="mr-1">Bersih
                                                                                    <input type="radio" name="vulva" id="vulva_kotor" value="Kotor" class="mr-1 ml-2">Kotor
                                                                                    <input type="radio" name="vulva" id="vulva_bengkak" value="Bengkak" class="mr-1 ml-2">Bengkak
                                                                                </div>
                                                                            </td>
                                                                            <td class="bold">Luka Perineum</td>
                                                                            <td class="bold">:</td>
                                                                            <td>
                                                                                <div class="input-group">
                                                                                    <input type="radio" name="perineum" id="perineum_kering" value="Kering" class="mr-1">Kering
                                                                                    <input type="radio" name="perineum" id="perineum_basah" value="Basah" class="mr-1 ml-2">Basah
                                                                                </div>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td></td>
                                                                            <td class="bold">Lochaea</td>
                                                                            <td class="bold">:</td>
                                                                            <td>
                                                                                <div class="input-group">
                                                                                    <input type="radio" name="lochaea" id="lochaea_banyak" value="Banyak" class="mr-1">Banyak
                                                                                    <input type="radio" name="lochaea" id="lochaea_sedikit" value="Sedikit" class="mr-1 ml-2">Sedikit
                                                                                </div>
                                                                            </td>
                                                                            ...
                                                                            <td>
                                                                                <div class="input-group">
                                                                                    <input type="text" name="warna_lochaea" id="warna_lochaea" class="custom-form clear-input d-inline-block mr-1 ml-2" placeholder="Warna Lochaea">
                                                                                </div>
                                                                            </td>
                                                                            ...
                                                                            <td>
                                                                                <div class="input-group">
                                                                                    <input type="text" name="bau_lochaea" id="bau_lochaea" class="custom-form clear-input d-inline-block mr-1 ml-2" placeholder="Bau Lochaea">
                                                                                </div>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                ...
                                                                <table class="table table-no-border table-sm table-striped" style="margin-top:-15px">
                                                                    <tr>
                                                                        <td colspan="3" class="center bold td-dark">
                                                                            <button class="btn btn-info btn-xs mr-1 float-left" type="button" data-toggle="collapse" data-target="#data-barang-dan-pemeriksaan"><i class="fas fa-expand mr-1"></i>Expand</button>BARANG
                                                                            DAN HASIL PEMERIKSAAN YANG DISERAHKAN
                                                                            KEPADA KELUARGA
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                                <div class="collapse multi-collapse mt-2" id="data-barang-dan-pemeriksaan">
                                                                    <table class="table table-no-border table-sm table-striped">
                                                                        <tr>
                                                                            <td width="1%" class="bold">1.</td>
                                                                            <td width="15%" class="bold">Hasil Lab
                                                                            </td>
                                                                            <td width="1%" class="bold">:</td>
                                                                            <td>
                                                                                <div class="input-group">
                                                                                    <input type="text" name="hasil_lab" id="hasil_lab" class="custom-form clear-input d-inline-block col-lg-4" placeholder="Hasil Lab" onkeypress="return hanyaAngka(event)">
                                                                                    <div class="input-group-append">
                                                                                        <span class="input-group-custom">Lembar</span>
                                                                                    </div>
                                                                                </div>
                                                                            </td>
                                                                            <td></td>
                                                                            ...
                                                                            <td>
                                                                                <div class="input-group">
                                                                                    <input type="text" name="ekg" id="ekg" class="custom-form clear-input d-inline-block col-lg-4" placeholder="EKG" onkeypress="return hanyaAngka(event)">
                                                                                    <div class="input-group-append">
                                                                                        <span class="input-group-custom">Lembar</span>
                                                                                    </div>
                                                                                </div>
                                                                        ...
                                                                        <tr>
                                                                            <td class="bold">2.</td>
                                                                            <td class="bold">Foto Rontgen</td>
                                                                            <td class="bold">:</td>
                                                                            <td>
                                                                                <div class="input-group">
                                                                                    <input type="text" name="foto_rontgen" id="foto_rontgen" class="custom-form clear-input d-inline-block col-lg-4" placeholder="Foto Rontgen" onkeypress="return hanyaAngka(event)">
                                                                                    <div class="input-group-append">
                                                                                        <span class="input-group-custom">Lembar</span>
                                                                                    </div>
                                                                                </div>
                                                                            ...
                                                                            <td></td>
                                                                            <td class="bold">5.</td>
                                                                            <td class="bold">MRI/MRA</td>
                                                                            <td class="bold">:</td>
                                                                            <td>
                                                                                <div class="input-group">
                                                                                    <input type="text" name="mri" id="mri" class="custom-form clear-input d-inline-block col-lg-4" placeholder="MRI/MRA" onkeypress="return hanyaAngka(event)">
                                                                                    <div class="input-group-append">
                                                                                        <span class="input-group-custom">Lembar</span>
                                                                                    </div>
                                                                                </div>
                                                                        ...
                                                                        <tr border=>
                                                                            ...
                                                                            <td>
                                                                                <div class="input-group">
                                                                                    <input type="text" name="ct_scan" id="ct_scan" class="custom-form clear-input d-inline-block col-lg-4" placeholder="CT. Scan" onkeypress="return hanyaAngka(event)">
                                                                                    <div class="input-group-append">
                                                                                        <span class="input-group-custom">Lembar</span>
                                                                                    </div>
                                                                                </div>
                                                                            ...
                                                                            <td></td>
                                                                            <td class="bold">6.</td>
                                                                            <td class="bold">USG</td>
                                                                            <td class="bold">:</td>
                                                                            <td>
                                                                                <div class="input-group">
                                                                                    <input type="text" name="usg" id="usg" class="custom-form clear-input d-inline-block col-lg-4" placeholder="USG" onkeypress="return hanyaAngka(event)">
                                                                                    <div class="input-group-append">
                                                                                        <span class="input-group-custom">Lembar</span>
                                                                                    </div>
                                                                                </div>
                                                                        ...
                                                                        <tr>
                                                                            <td></td>
                                                                            <td class="bold">Surat Kontrol</td>
                                                                            <td class="bold">:</td>
                                                                            <td>
                                                                                <div class="input-group">
                                                                                    <input type="radio" name="surat_kontrol" id="surat_kontrol_ya" value="1" class="mr-1">Ada
                                                                                    <input type="radio" name="surat_kontrol" id="surat_kontrol_tidak" value="0" class="mr-1 ml-2" checked>Tidak
                                                                                </div>
                                                                            </td>
                                                                            <td></td>
                                                                            <td></td>
                                                                            <td>Hasil Pemeriksaan dari luar RS</td>
                                                                            <td></td>
                                                                            <td></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td></td>
                                                                            <td class="bold">Resume Medis</td>
                                                                            <td class="bold">:</td>
                                                                            <td>
                                                                                <div class="input-group">
                                                                                    <input type="radio" name="resume_medis" id="resume_medis_ya" value="1" class="mr-1">Ada
                                                                                    <input type="radio" name="resume_medis" id="resume_medis_tidak" value="0" class="mr-1 ml-2" checked>Tidak
                                                                                </div>
                                                                            </td>
                                                                            <td></td>
                                                                            <td>1.</td>
                                                                            <td colspan="3">
                                                                                <div class="input-group"><input type="text" name="hasil_satu" id="hasil_satu" class="custom-form clear-input d-inline-block mr-1 ml-2" placeholder="...................">
                                                                                </div>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td></td>
                                                                            <td class="bold">Surat Asuransi</td>
                                                                            <td class="bold">:</td>
                                                                            <td>
                                                                                <div class="input-group">
                                                                                    <input type="radio" name="surat_asuransi" id="surat_asuransi_ya" value="1" class="mr-1">Ada
                                                                                    <input type="radio" name="surat_asuransi" id="surat_asuransi_tidak" value="0" class="mr-1 ml-2" checked>Tidak
                                                                                </div>
                                                                            </td>
                                                                            <td></td>
                                                                            <td>2.</td>
                                                                            <td colspan="3">
                                                                                <div class="input-group"><input type="text" name="hasil_dua" id="hasil_dua" class="custom-form clear-input d-inline-block mr-1 ml-2" placeholder="...................">
                                                                                </div>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td></td>
                                                                            <td class="bold">Summary Pasien Pulang
                                                                            </td>
                                                                            <td class="bold">:</td>
                                                                            <td>
                                                                                <div class="input-group">
                                                                                    <input type="radio" name="summary_pasien" id="summary_pasien_ya" value="1" class="mr-1">Ada
                                                                                    <input type="radio" name="summary_pasien" id="summary_pasien_tidak" value="0" class="mr-1 ml-2" checked>Tidak
                                                                                </div>
                                                                            </td>
                                                                            <td></td>
                                                                            <td>3.</td>
                                                                            <td colspan="3">
                                                                                <div class="input-group"><input type="text" name="hasil_tiga" id="hasil_tiga" class="custom-form clear-input d-inline-block mr-1 ml-2" placeholder="...................">
                                                                                </div>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td></td>
                                                                            <td class="bold">Surat Keterangan Lahir
                                                                            </td>
                                                                            <td class="bold">:</td>
                                                                            <td>
                                                                                <div class="input-group">
                                                                                    <input type="radio" name="suket_lahir" id="suket_lahir_ya" value="1" class="mr-1">Ada
                                                                                    <input type="radio" name="suket_lahir" id="suket_lahir_tidak" value="0" class="mr-1 ml-2" checked>Tidak
                                                                                </div>
                                                                            </td>
                                                                            <td></td>
                                                                            <td>4.</td>
                                                                            <td colspan="3">
                                                                                <div class="input-group">
                                                                                    <input type="text" name="hasil_empat" id="hasil_empat" class="custom-form clear-input d-inline-block mr-1 ml-2" placeholder="...................">
                                                                                </div>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td></td>
                                                                            <td class="bold">Bayi diserahkan oleh
                                                                            </td>
                                                                            <td class="bold">:</td>
                                                                            <td>
                                                                                <div class="input-group">
                                                                                    <input type="text" name="bayi_diserahkan" id="bayi_diserahkan" class="custom-form clear-input d-inline-block mr-1 ml-2" placeholder="...................">
                                                                                </div>
                                                                            </td>
                                                                            <td></td>
                                                                            <td>5.</td>
                                                                            <td colspan="3">
                                                                                <div class="input-group">
                                                                                    <input type="text" name="hasil_lima" id="hasil_lima" class="custom-form clear-input d-inline-block mr-1 ml-2" placeholder="...................">
                                                                                </div>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <div class="input-group">
                                                                                    <input type="text" name="lain_lain" id="lain_lain" class="custom-form clear-input d-inline-block mr-1 ml-2" placeholder="...................">
                                                                                </div>
                                                                            </td>
                                                                            <td></td>
                                                                            <td></td>
                                                                ...
                                                                <table class="table table-no-border table-sm table-striped" style="margin-top:-15px">
                                                                    <tr>
                                                                        <td colspan="3" class="center bold td-dark">
                                                                            <button class="btn btn-info btn-xs mr-1 float-left" type="button" data-toggle="collapse" data-target="#data-terapi-pulang"><i class="fas fa-expand mr-1"></i>Expand</button>TERAPI
                                                                            PULANG
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                                <div class="collapse multi-collapse mt-2" id="data-terapi-pulang">
                                                                    <hr>
                                                                    <table class="table table-sm table-striped table-bordered" id="table-terapi" style="margin-top: -15px">
                                                                        <thead>
                                                                            <tr>
                                                                ...
                                                                <table class="table table-no-border table-sm table-striped" style="margin-top:-15px">
                                                                    <tr>
                                                                        <td colspan="3" class="center bold td-dark">
                                                                            <button class="btn btn-info btn-xs mr-1 float-left" type="button" data-toggle="collapse" data-target="#data-kontrol-kembali"><i class="fas fa-expand mr-1"></i>Expand</button>KONTROL
                                                                            KEMBALI TANGGAL
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                                <div class="collapse multi-collapse mt-2" id="data-kontrol-kembali">
                                                                    <hr>
                                                                    <table class="table table-sm table-striped table-bordered" style="margin-top: -15px" id="table-kontrol">
                                                                        <thead>
                                                                            <tr>
                                                                                <th class="center"><b>No</b></th>
                                                                                <th class="center"><b>Tanggal</b>
                                                                                </th>
                                                                                <th class="center"><b>Hari</b></th>
                                                                                <th class="center"><b>Jam</b></th>
                                                                                <th class="center"><b>Nama
                                                                                        Dokter</b></th>
                                                                                <th class="center"><b>Tempat</b>
                                                                                </th>
                                                                ...
                                                                <table class="table table-no-border table-sm table-striped" style="margin-top:-15px">
                                                                    ...
                                                                    <tr>
                                                                        <td width="33%">
                                                                            Tanggal & Jam <input type="text" name="ek_tanggal_ttd_perawat" id="ek_tanggal_ttd_perawat" class="custom-form clear-input d-inline-block col-lg-5 ml-2" placeholder="dd/mm/yyyy hh:ii">

                                                                        </td>
                                                                        <td width="33%">
                                                                            Tanggal & Jam <input type="text" name="ek_tanggal_verifikasi_dokter" id="ek_tanggal_verifikasi_dokter" class="custom-form clear-input d-inline-block col-lg-5 ml-2" placeholder="dd/mm/yyyy hh:ii">

                                                                        </td>
                                                                        <td width="33%">
                                                                            Tanggal & Jam <input type="text" name="ek_tanggal_verifikasi_penerima" id="ek_tanggal_verifikasi_penerima" class="custom-form clear-input d-inline-block col-lg-5 ml-2" placeholder="dd/mm/yyyy hh:ii">
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>Perawat Yang Menyerahkan</td>
                                                                        <td>Dokter yang merawat/ruangan</td>
                                                                        <td>Yang Menerima</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td><input type="text" name="perawat_medis" id="perawat_medis" class="select2c-input ml-2"></td>
                                                                        <td><input type="text" name="verifikasi_dokter" id="verifikasi_dokter" class="select2c-input ml-2"></td>
                                                                        <td>
                                                                            <div class="input-group">
                                                                                <input type="text" name="verifikasi_penerima" id="verifikasi_penerima" class="custom-form clear-input d-inline-block col-lg-10">
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                    ...
                                                                    <tr>
                                                                        <td class="center">
                                                                            <input type="checkbox" name="ek_ttd_perawat" id="ek_ttd_perawat" value="1" class="custom-form col-lg-1 mx-auto">
                                                                            <?= digitalSignature('ek_ttd_perawat_verified') ?>
                                                                        </td>
                                                                        <td class="center">
                                                                            <input type="checkbox" name="ek_ttd_verifikasi_dokter" id="ek_ttd_verifikasi_dokter_dpjp" value="1" class="custom-form col-lg-1 mx-auto">
                                                                            <?= digitalSignature('ek_ttd_verifikasi_dokter_dpjp_verified') ?>
                                                                        </td>
                                                                        <td class="center">
                                                                            <input type="checkbox" name="ek_ttd_pasien" id="ek_ttd_pasien" value="1" class="custom-form col-lg-1 mx-auto">
                                                                            <?= digitalSignature('ek_ttd_pasien_verified') ?>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </div>
                                                                    ...
                                                                    <div class="col d-flex justify-content-start">
                                                                        <div class="input-group">
                                                                            <div class="input-group-prepend">
                                                                                <span class="input-group-text" id="rs-img-calendar"><i class="fas fa-fw fa-calendar-alt"></i></span>
                                                                            </div>
                                                                            <input type="text" name="waktu_search" id="rs-waktu-search" class="form-control col-lg-4" placeholder="Pencarian Tanggal">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col d-flex justify-content-end">
                                                                        <div class="custom-search">
                                                                            <input type="text" class="search-query-white" onkeyup="getListResumeKeperawatan($('#ek-id-pendaftaran').val(), 1)" id="rs-keyword" placeholder="Pencarian ...">
                                                                            <button type="button"><span class="fas fa-search" aria-hidden="true"></span></button>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <table class="table table-sm table-striped table-bordered color-table info-table" id="table-resume-keperawatan">
                                                                    <thead>
                                                                        <tr>
                                                                            <th class="center v-center" width="1%">
                                                                                No.</th>
                                                                            <th class="center v-center" width="15%">
                                                                                Waktu</th>
                                                                            <th class="center v-center" width="15%">
                                                                                Layanan</th>
                                                                            <th class="center v-center" width="15%">
                                                                            ...
                                                                            <?php else : ?>
                                                                            <?php endif ?>
                                                                            <th class="center v-center" width="16%">
                                                                            </th>
                                                                        </tr>
                                                                    </thead>
                                                                    <tbody></tbody>
                                                                </table>
                                                                <div id="rs-pagination" class="float-left"></div>
                                                                <div id="rs-summary" class="float-right text-sm">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
