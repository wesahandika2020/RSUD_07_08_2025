	...
	<div class="modal-dialog modal-dialog-scrollable" style="max-width: 85%">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<nav>
					<div class="nav nav-tabs" id="nav-tab" role="tablist">
						<a class="nav-item nav-link active" data-toggle="tab" id="tab-1" href="#tab1-hd" role="tab">Pengkajian Keperawatan</a>
						<a class="nav-item nav-link" data-toggle="tab" id="tab-2" href="#tab2-hd" role="tab">Diagnosa dan Intervensi Keperawatan</a>
						<a class="nav-item nav-link" data-toggle="tab" id="tab-3" href="#tab3-hd" role="tab">Tindakan dan Evaluasi Keperawatan</a>
					</div>
				</nav>
				<div class="tab-content" id="nav-tabContent">
					<div class="tab-pane fade show active" id="tab1-hd" role="tabpanel">
									...
									<div class="collapse multi-collapse show mt-2" id="pengkajian-keperawatan">
										...
										<div class="form-group row tight">
											...
											<div class="col-lg-9">
												...
												<input type="radio" name="kebiasaan_merokok" id="kebiasaan-merokok-tidak" class="mr-1" value="0">Tidak
										...
										<div class="form-group row tight">
											...
											<div class="col-lg-9">
												...
												<input type="radio" name="kebiasaan_narkoba" id="kebiasaan-narkoba-tidak" class="mr-1" value="0">Tidak
										...
										<div class="form-group row tight">
											...
											<div class="col-lg-9">
												...
												<input type="radio" name="kebiasaan_alkohol" id="kebiasaan-alkohol-tidak" class="mr-1" value="0">Tidak
										...
										<div class="form-group row tight">
											...
											<div class="col-lg-9">
												...
												<input type="radio" name="alergi" id="alergi-tidak" class="mr-1" value="Tidak">Tidak
									...
									<div class="collapse multi-collapse show mt-2" id="riwayat-psikososial">
										<div class="form-group row tight">
											...
											<div class="col-lg-9">
												...
												<input type="radio" name="hubungan_keluarga" id="hubungan-keluarga-baik" class="mr-1" value="Baik">Baik
									...
									<div class="collapse multi-collapse show mt-2" id="pemeriksaan-fisik">
										...
										<div class="form-group row tight">
											...
											<div class="col-lg-9">
												...
												<input type="radio" name="konjungtiva" id="konjungtiva-tidak" class="mr-1 ml-2" value="0">Tidak Anemis
											</div>
										</div>
										<div class="form-group row tight">
					...
					<div class="tab-pane fade" id="tab2-hd" role="tabpanel">
						<div class="row mt-2" style="font-size: 12px">
							<div class="col-lg-12">
								<div class="box-well" style="overflow-y: auto; height: 400px;">
					...
					<div class="tab-pane fade" id="tab3-hd" role="tabpanel">
						<div class="row mt-2" style="font-size: 12px">
							<div class="col-lg-12">
								<div class="box-well" style="overflow-y: auto; height: 400px;">
													...
													<table class="table table-sm" style="border: 0;" id="table-tindakan-keperawatan">
														<thead class="thead-light">
															<tr>
																...
																<th class="center v-center" rowspan="2" width="15%">Keterangan ↓</th>
														...
														<tbody id="tbody-pre-hd">
															<tr>
																...
																<td class="center v-center" widht="15%">↓</td>
															...
															<tr>
																...
																<td colspan="8">
																	<textarea name="pre_keterangan_lain_subject"id="pre-keterangan-lain-subject" rows="2"class="form-control clear-input"placeholder="Subject"></textarea>
																</td>
																<td colspan="6">
																	<textarea name="pre_keterangan_lain_objective"id="pre-keterangan-lain-objective" rows="2"class="form-control clear-input"placeholder="Objective"></textarea>
																</td>
															</tr>
															<tr>
																<th></th>
																<td colspan="8">
																	<textarea name="pre_keterangan_lain_assessment"id="pre-keterangan-lain-assessment" rows="2"class="form-control clear-input"placeholder="Assessment"></textarea>
																</td>
																<td colspan="6">
																	<textarea name="pre_keterangan_lain_plan"id="pre-keterangan-lain-plan" rows="2"class="form-control clear-input"placeholder="Plan"></textarea>
																</td>
															</tr>
									...
									<button class="btn btn-info btn-xs" type="button" data-toggle="collapse" data-target="#penyakit-selama-hd"><i class="fas fa-expand mr-1"></i>Penyulit Selama HD</button><hr>
			...
			<div class="modal-footer">
				...
				<button type="button" class="btn btn-info" id="btn-simpan" onclick="konfirmasiSimpanAsuhanKeperawatan()"><i class="fas fa-save mr-1"></i>Simpan</button>
			</div>
		</div>
	</div>
</div>