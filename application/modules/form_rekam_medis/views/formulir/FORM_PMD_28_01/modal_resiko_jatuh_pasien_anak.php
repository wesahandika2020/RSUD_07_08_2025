    ...
    <div class="modal-dialog modal-dialog-scrollable" style="max-width: 90%;">
        <div class="modal-content">
            <div class="modal-header">
                <div class="title">
                    <h5 class="modal-title bold" id="modal_entri_keperawatan_rm">PENGKAJIAN ULANG DAN PEMANTAUAN RISIKO JATUH PASIEN ANAK</h5>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card-body">
                            ...
                            <!-- Pengkajian ulang resiko jatuh pasien dewasa-->
                            <div class="form-resiko-jatuh-pasien">
                                <!-- <h5 class="center"><b>PENGKAJIAN ULANG DAN PEMANTAUAN RISIKO JATUH PASIEN</b></h5> -->
                                ...
                                <!-- Star Form Resiko Jatuh -->

                                <!-- PENGKAJIAN ULANG RISIKO JATUH PASIEN ANAK -->
                                <table class="table table-no-border table-sm table-striped" style="margin-top:-15px">
                                    <tr>
                                        <td colspan="3" class="center bold td-dark">
                                            <button class="btn btn-info btn-xs mr-1 float-left" type="button" data-toggle="collapse" data-target="#data-pengkajian-ulang-resiko-pasien-anak"><i class="fas fa-expand mr-1"></i>Expand
                                            </button>
                                            PENGKAJIAN ULANG RISIKO JATUH PASIEN ANAK
                                        </td>
                                    </tr>
                                ...
                                <div class="collapse multi-collapse mt-2" id="data-pengkajian-ulang-resiko-pasien-anak">
                                    <div class="col-xl-12">
                                        <div id="buka-tutup-pengkajian-anak">
                                        </div>
                                        <div class="card">
                                            <table class="table table-no-border table-sm table-striped" id="tabel-pengkajian-ulang-anak">
                                                <thead>
                                                    <tr>
                                            ...
                                            <table class="table table-sm table-bordered">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th width="20%" class="center"><b>Kriteria</b></th>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>Risiko Rendah</td>
                                                        <td>7-11</td>
                                                        <td>Lakukan Pencegahan Risiko Jatuh Rendah</td>
                                                    </tr>
                                                    <tr>
                                                        <td>Risiko Tinggi</td>
                                                        <td>&ge; 12</td>
                                                    ...
                                                    <tr>
                                                        <td colspan="3">
                                                            <ul>
                                                                <li>*Jika Risiko Rendah tidak perlu di skroning tetapi tetap dilakukan pemantauan
                                                                </li>
                                                            </ul>
                                                        </td>
                                                    </tr>
                                ...
                                <!-- END PENGKAJIAN ULANG RISIKO JATUH PASIEN ANAK -->

                                <!--UPAYA PENCEGAHAN RISIKO JATUH PASIEN ANAK-->
                                <table class="table table-no-border table-sm table-striped" style="margin-top:-15px">
                                    <tr>
                                        <td colspan="3" class="center bold td-dark">
                                            <button class="btn btn-info btn-xs mr-1 float-left" type="button" data-toggle="collapse" data-target="#data-upaya-pencegahan-risiko-jatuh-pasien-anak"><i class="fas fa-expand mr-1"></i>Expand
                                            </button>
                                            UPAYA PENCEGAHAN RISIKO JATUH PASIEN ANAK
                                        </td>
                                    </tr>
                                ...
                                <div class="collapse multi-collapse mt-2" id="data-upaya-pencegahan-risiko-jatuh-pasien-anak">
                                    <div class="col-lg">
                                        <div id="buka-tutup-uprjpa">
                                        </div>
                                        <div class="card">
                                            <table class="table table-no-border table-sm table-striped" id="tabel-uprjpa">
                                                <thead>
                                                    <tr>
                                                        <th class="center"><b>No</b></th>
                                                        <th class="center"><b>Tanggal</b></th>
                                            ...
                                            <table class="table table-no-border table-sm table-striped" style="margin-top:15px">
                                                <tr>
                                                    <td>
                                                        <span class="bold"> Catatan : Untuk Resiko Tinggi Jatuh(Skore >12) Lakukan semua pedoman pencegahan untuk resiko rendah</span><br>
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>
                                ...
                                <!-- End Form Resiko Jatuh -->

                            </div>
                            <!-- End Pengkajian ulang resiko jatuh pasien dewasa-->
            ...
            <div class="modal-body">
                ...
                <table class="table table-sm table-striped table-bordered" style="margin-top: -15px" id="form-purjpa">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td rowspan="3"><input type="hidden" id="purjpa-edit-gangguan-kognitif">Gangguan
                                kognitif</td>
                        ...
                        <tr>
                            <td rowspan="3"><input type="hidden" id="purjpa-edit-respon-pembedahan">Respon
                                terhadap pembedahan, sedasi dan anastesi</td>
