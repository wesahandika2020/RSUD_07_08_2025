  ...
  <div class="modal-dialog modal-dialog-scrollable" style="max-width: 90%;">
    <div class="modal-content">
      <div class="modal-header">
        <div class="title">
          <h5 class="modal-title bold" id="modal_entri_keperawatan_rm">ASESMENT PRA BEDAH</h5>
        </div>
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card-body">
              ...
              <!-- Form Asesment Pra Bedah // APBT-->
              <div class="form-asessment-rs">
                <div class="row">
                  <div class="col-lg-12">
                ...
                <div class="form-asesment">
                    ...
                    <div class="col-lg-12">
                      ...
                      <table class="table table-sm table-striped" style="margin-top: -15px">
                        <tr>
                          ...
                          <td>
                            <div class="input-group">
                              <input type="text" name="tanggal_waktu_asessment" id="tanggal-dan-waktu-assesment" class="custom-form clear-input d-inline-block col-lg-6">
                            </div>
                          </td>
                        </tr>
                        <tr>
                          ...
                          <td width="2%">:</td>
                          <td>
                            <input type="radio" name="apb_riwayat_alergi" id="riwayat_alergi_tidak" value="0" class="mr-1" checked>Tidak
                            <input type="radio" name="apb_riwayat_alergi" id="riwayat_alergi_ya" value="1" class="mr-1 ml-2">Ya
                            <input type="text" name="apb_ket_riwayat_alergi" id="jenis_riwayat_alergi" class="custom-form clear-input d-inline-block col-lg-7" placeholder="Alergi" disabled>
                          </td>
                        </tr>
                        <tr>
                          <td width="2%"></td>
                          ...
                          <td>
                            <div class="input-group">
                              <input type="text" name="apb_suhu" id="apb_suhu" class="custom-form clear-input d-inline-block col-lg-3" placeholder="Suhu" onkeypress="return hanyaAngka(event)">
                          ...
                          <td>
                            <div class="input-group">
                              <input type="text" name="apb_nadi" id="apb_nadi" class="custom-form clear-input d-inline-block col-lg-3" placeholder="Nadi" onkeypress="return hanyaAngka(event)">
                              <div class="input-group-append">
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="input-group">
                              <input type="text" name="apb_pernafasan" id="apb_pernafasan" class="custom-form clear-input d-inline-block col-lg-3" placeholder="Nafas" onkeypress="return hanyaAngka(event)">
                              <div class="input-group-append">
                                <span class="input-group-custom">x/mnt</span>
                              </div>
                            </div>
                          ...
                          <td>
                            <div class="input-group">
                              <input type="text" name="apb_tensi_sis" id="apb_tensi_sis" class="custom-form clear-input d-inline-block col-lg-3" placeholder="Sistolik" onkeypress="return hanyaAngka(event)">
                              <span>/</span>
                              <input type="text" name="apb_tensi_dis" id="apb_tensi_dis" class="custom-form clear-input d-inline-block col-lg-3" placeholder="Diastolik" onkeypress="return hanyaAngka(event)">
                              <div class="input-group-append">
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="input-group">
                              <input type="text" name="apb_berat_badan" id="apb_berat_badan" class="custom-form clear-input d-inline-block col-lg-3" placeholder="BB" onkeypress="return hanyaAngka(event)">
                              <div class="input-group-append">
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="input-group">
                              <input type="radio" name="apb_status_nutrisi" id="apb-status-nutrisi-obesitas" value="Obesitas" class="mr-1">Obesitas
                              <input type="radio" name="apb_status_nutrisi" id="apb-status-nutrisi-over" value="Over Weight" class="mr-1 ml-2">Over Weight
                              <input type="radio" name="apb_status_nutrisi" id="apb-status-nutrisi-normo" value="Normo Weight" class="mr-1 ml-2">Normo Weight
                            </div>
                          </td>
                        </tr>
                      </table>
                      ...
                      <table class="table table-no-border table-sm table-striped">
                        ...
                        <tr>
                          ...
                          <td class="bold">:</td>
                          <td>
                            <textarea name="apb_keluhan_utama" id="apb_keluhan_utama" rows="2" class="form-control clear-input" placeholder="Keluhan Utama"></textarea>
                          </td>
                        </tr>
                        <tr>
                          ...
                          <td class="bold">:</td>
                          <td>
                            <textarea name="apb_rps" id="apb_rps" rows="2" class="form-control clear-input" placeholder="Riwayat Penyakit Sekarang"></textarea>
                          </td>
                        </tr>
                        <tr>
                          ...
                          <td class="bold">:</td>
                          <td>
                            <textarea name="apb_rpt" id="apb_rpt" rows="2" class="form-control clear-input" placeholder="Riwayat Penyakit Terdahulu"></textarea>
                          </td>
                        </tr>
                        <tr>
                          ...
                          <td class="bold">:</td>
                          <td>
                            <textarea name="apb_pemeriksaan_fisik" id="apb_pemeriksaan_fisik" rows="2" class="form-control clear-input" placeholder="Pemeriksaan Fisik"></textarea>
                          </td>
                        </tr>
                        <tr>
                          ...
                          <td class="bold">:</td>
                          <td>
                            <textarea name="apb_pemeriksaan_banding" id="apb_pemeriksaan_banding" rows="2" class="form-control clear-input" placeholder="Pemeriksaan Penunjang"></textarea>
                          </td>
                        </tr>
                        <tr>
                          ...
                          <td class="bold">:</td>
                          <td>
                            <textarea name="apb_laboratorium" id="apb_laboratorium" rows="2" class="form-control clear-input" placeholder="Labolatorium"></textarea>
                          </td>
                        </tr>
                        <tr>
                          ...
                          <td class="bold">:</td>
                          <td>
                            <textarea name="apb_diagnosis" id="apb_diagnosis" rows="2" class="form-control clear-input" placeholder="Diagnosis Pra Bedah"></textarea>
                          </td>
                        </tr>
                        <tr>
                          ...
                          <td class="bold">:</td>
                          <td>
                            <textarea name="apb_diagnosis_banding" id="apb_diagnosis_banding" rows="2" class="form-control clear-input" placeholder="Diagnosis Banding"></textarea>
                          </td>
                        </tr>
                        <tr>
                          ...
                          <td class="bold">:</td>
                          <td>
                            <textarea name="apb_permasalahan" id="apb_permasalahan" rows="2" class="form-control clear-input" placeholder="Permasalahan"></textarea>
                          </td>
                        </tr>
                        <tr>
                          ...
                          <td class="bold">:</td>
                          <td>
                            <textarea name="apb_rto" id="apb_rto" rows="2" class="form-control clear-input" placeholder="Rencana Tindak Operasi"></textarea>
                          </td>
                        </tr>
                        <tr>
                          ...
                          <td width="1%" class="bold">:</td>
                          <td>
                            <input type="radio" name="rawat_inap" id="apb_rawat_inap_tidak" value="0" class="mr-1" checked>Tidak
                            <input type="radio" name="rawat_inap" id="apb_rawat_inap_ya" value="1" class="mr-1 ml-2">Ya
                            <input type="text" name="apb_rawat_inap_indikasi" id="apb_rawat_inap_indikasi" class="custom-form clear-input d-inline-block col-lg-4 ml-2 disabled" placeholder="Rawat Inap" disabled>
                          </td>
                        </tr>

                        <tr>
                          <td width="18%" class="bold">Indikasi Rawat Inap</td>
                          <td width="1%" class="bold">:</td>
                          <td>
                            <input type="text" name="apb_indikasi_ranap" id="apb-indikasi-ranap" class="custom-form clear-input d-inline-block col-lg-8 ml-2" placeholder="Indikasi Rawat Inap">
                          </td>
                        </tr>
                      ...
                      <table>
                        ...
                        <tr>
                          <td colspan="5">
                            <input type="checkbox" name="apb_pasien" id="apb_pasien" value="1" class="mr-1">Pasien
                          </td>
                        </tr>
                        <tr>
                          <td colspan="5">
                            <input type="checkbox" name="apb_keluarga" id="apb_keluarga" value="1" class="mr-1">Keluarga, Nama
                            <input type="text" name="apb_keluarga_keterangan" id="apb_keluarga_keterangan" class="custom-form clear-input d-inline-block col-lg-6 disabled" placeholder="Nama Keluarga" disabled>
                          </td>
                        </tr>
                        <tr>
                          <td colspan="5">
                            Hubungan dengan pasien
                            <input type="text" name="apb_riwayat_hk" id="apb_riwayat_hk" class="custom-form clear-input d-inline-block col-lg-6" placeholder="Hubungan Keluarga">
                          </td>
                        </tr>
                        <tr>
                          <td>
                            <input type="checkbox" name="apb_tidak_edukasi" id="apb_tidak_edukasi" value="1" class="mr-1">Tidak
                            dapat memberikan edukasi kepada pasien atau keluarga pasien
                            <input type="text" name="apb_keterangan_edukasi" id="apb_keterangan_edukasi" class="custom-form clear-input d-inline-block col-lg-6 disabled" placeholder="Alasan" disabled>
                          </td>
                        </tr>
                      </table>
                  ...
                  <div class="row">
                    <table class="table table-no-border table-sm table-striped" style="margin-top:-15px">
                      <tr>
                        <td colspan="3" class="center td-dark">YANG MELAKUKAN ASESMEN</td>
                      </tr>
                      <tr>
                        <td width="33%" class="center">
                          Tanggal & Jam <input type="text" name="apb_tanggal_verifiaksi_dokter_dpjp" id="apb_tanggal_verifiaksi_dokter_dpjp" class="custom-form clear-input d-inline-block col-lg-5 ml-2" placeholder="dd/mm/yyyy hh:ii">
                        </td>
                        <td width="33%">
                        </td>
                        <td width="33%" class="center">
                          Tanggal & Jam <input type="text" name="apb_tanggal_verifiaksi_pasien" id="apb_tanggal_verifiaksi_pasien" class="custom-form clear-input d-inline-block col-lg-5 ml-2" placeholder="dd/mm/yyyy hh:ii">
                        </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td class="center"><input type="text" name="apb_dokter_dpjp" id="apb_dokter_dpjp" class="select2c-input ml-2"></td>
                        <td></td>
                        <td class="center"><input type="text" name="apb_pasien_asesment" id="apb_pasien_asesment" class="custom-form clear-input d-inline-block col-lg-10">
                        </td>
                      ...
                      <tr>
                        <td class="center">
                          <input type="checkbox" name="apb_ttd_dokter_dpjp" id="apb_ttd_dokter_dpjp" value="1" class="custom-form col-lg-1 mx-auto">
                        </td>
                        <td class="center">
                        </td>
                        <td class="center">
                          <input type="checkbox" name="apb_ttd_pasien_dpjp" id="apb_ttd_pasien_dpjp" value="1" class="custom-form col-lg-1 mx-auto">
                        </td>
                      </tr>
                    </table>
                  </div>
              ...
              <!-- End Asessment Pra Bedah Rumah Sakit-->
