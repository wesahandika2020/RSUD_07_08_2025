<script>
	function lihatFORM_REM_01_01_ICARE(data) {
		...
		resumeMedis(layanan.id_pendaftaran, layanan.id, details, action)
	}

	function editFORM_REM_01_01_ICARE(data) {
		let pasien = data.pasien;
		let layanan = data.layanan;
		let action = 'edit';
	...
	function tambahFORM_REM_01_01_ICARE(data) {
		let pasien = data.pasien;
		let layanan = data.layanan;
		let action = 'tambah';
	...
	function resumeMedis(id, id_layanan_pendaftaran, details, action) {
	...
	<div class="modal-dialog modal-dialog-scrollable" style="max-width: 90%;">
		<div class="modal-content">
							...
							<div id="wizard_form_ranap">
								<div class="form-modal-resume-medis">
									...
									<table class="table table-no-border table-sm table-striped">
										...
										<tr>
											<td width="25%"><b>Diagnosis Utama</b> <span id="button-edit-diagnosa"></span></td>
											<td width="1%"><b>:</b></td>
											<td>
			...
			<div class="modal-footer">
				...
				<button type="button" class="btn btn-info" onclick="simpanResumeMedisRanap()" id="btn___simpan"></button>
