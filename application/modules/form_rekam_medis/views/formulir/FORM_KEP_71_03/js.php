<script>
    ...
    function lihatFORM_KEP_71_03(data) {
    ...
    function editFORM_KEP_71_03(data) {
        let pasien = data.pasien;
        let layanan = data.layanan;
        let bed = layanan.bangsal + ' kelas ' + layanan.kelas + ' ruang ' + layanan.no_ruang + ' No. Bed ' + layanan.no_bed;
        let action = 'edit';
    ...
    function tambahFORM_KEP_71_03(data) {
        let pasien = data.pasien;
        let layanan = data.layanan;
        let bed = layanan.bangsal + ' kelas ' + layanan.kelas + ' ruang ' + layanan.no_ruang + ' No. Bed ' + layanan.no_bed;
        let action = 'tambah';
    ...
    function simpanEntriOperasi() {
        ...
        $.ajax({
            type: 'POST',
            url: '<?= base_url("form_rekam_medis/api/entri_form_operasi/simpan_entri_rpppp") ?>',
