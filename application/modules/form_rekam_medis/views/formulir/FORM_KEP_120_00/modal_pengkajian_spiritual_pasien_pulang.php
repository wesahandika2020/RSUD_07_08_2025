		...
		$.ajax({
			...
			success: function(data) {
				if (data.status) {
					...
					showListForm($('#id-pendaftaran-spiritual').val(), $('#id-layanan-pendaftaran-spiritual').val(), $('#id-pasien-spiritual').val());    
	...
	<div class="modal-dialog modal-dialog-scrollable" style="max-width: 90%;">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<input type="hidden" name="id_pasien" id="id-pasien-spiritual">
                <input type="hidden" name="id_layanan_pendaftaran" id="id-layanan-pendaftaran-spiritual">
										...
										<tr>
											...
											<td width="48%">
												<div class="input-group">
													...
													<input type="radio" name="edukasi_islam"
