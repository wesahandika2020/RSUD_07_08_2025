<script>
	...
	$(function() {
		...
		$('#waktu-pemeriksaan-skk, #waktu-meninggal').datetimepicker({
	...
	function simpanSuratKeteranganKematianERM() {
		if ($('#dokter-pemeriksa-skk').val() === '') {
            syams_validation('#dokter-pemeriksa-skk', 'Nama Dokter Belum di Pilih.....!');
            return false;
        } else {
            syams_validation_remove('#dokter-pemeriksa-skk');
        }
		
		var id = $('#id-pendaftaran-skk').val();
		var id_layanan = $('#id-layanan-pendaftaran-skk').val();
		var id_pasien = $('#id-pasien-skk').val();
	...
	<div class="modal-dialog modal-dialog-scrollable" style="max-width: 90%;">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<input type="hidden" name="id_pendaftaran" id="id-pendaftaran-skk">
				<input type="hidden" name="id_layanan_pendaftaran" id="id-layanan-pendaftaran-skk">
				<input type="hidden" name="id_pasien" id="id-pasien-skk">
							...
							<div id="wizard_form_ranap">
								<div class="form-modal-surat-keterangan-kematian">
									<table class="table table-no-border table-sm table-striped">
										...
										<tr>
											<td width="25%">Waktu Meninggal</td>
											<td width="1%">:</td>
											<td>
												<input type="text" name="waktu_meninggal" class="custom-form col-lg-2" id="waktu-meninggal" value="<?= date('d/m/Y H:i') ?>">
											</td>
										</tr>
										<tr>
			...
			<div class="modal-footer">
				...
				<button type="button" class="btn btn-info" onclick="simpanSuratKeteranganKematianERM()" id="btn_simpan"><i class="fas fa-fw fa-save mr-1"></i>Cetak</button>
			</div>
		</div>
	</div>
</div>
