  ...
  <div class="modal-dialog modal-dialog-scrollable" style="max-width: 90%;">
    <div class="modal-content">
      <div class="modal-header">
        <div class="title">
          <h5 class="modal-title bold" id="modal_entri_keperawatan_rm">PENGKAJIAN LANJUTAN SPIRITUAL PASIEN</h5>
        </div>
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card-body">
              ...
              <!-- Pengkajian lanjutan spiritual pasien-->
              <div class="form-pengkajian-lanjutan-spiritual-pasien" id="form-spiritual">
                <!-- <h5 class="center"><b>PENGKAJIAN LANJUTAN SPIRITUAL PASIEN</b></h5> -->
                <table class="table table-no-border table-sm table-striped">
                  <tr>
                    <td colspan="3">
                      <button class="btn btn-info btn-xs mr-1 float-left" type="button" id="pls-btn-expand-all"><i class="fas fa-fw fa-expand mr-1"></i>Expand All</button>
                      <button class="btn btn-warning btn-xs mr-1 float-left" type="button" id="pls-btn-collapse-all"><i class="fas fa-fw fa-compress mr-1"></i>Collapse All</button>
                    </td>
                  </tr>
                </table>
                <table class="table table-no-border table-sm table-striped" style="margin-top:-15px">
                  <tr>
                    <td colspan="3" class="center bold td-dark">
                      <button class="btn btn-info btn-xs mr-1 float-left" type="button" data-toggle="collapse" data-target="#data-pengkajian-spiritual"><i class="fas fa-expand mr-1"></i>Expand</button>ANAMNESIS DAN
                      PEMERIKSAAN
                    </td>
                  </tr>
                </table>
                <div class="collapse multi-collapse mt-2" id="data-pengkajian-spiritual">
                  <div class="row">
                    <div class="col-lg-6">
                      <table class="table table-no-border table-sm table-striped" id="tabel-pengkajian-spiritual">
                        <tr>
                          <td width="1%">
                            <b>Pernyataan Pasien</b>
                          </td>
                          <td width="1%">
                          </td>
                        </tr>
                        <tr>
                          <td width="1%">
                            <div class="input-group">
                              <input type="radio" name="pasien_terima" id="plsp-pasien-terima" value="1" class="mr-1">Menerima
                            </div>
                          </td>
                          <td width="1%">
                            <input type="radio" name="pasien_terima" id="plsp-pasien-tidak-terima" value="0" class="mr-1">Tidak Menerima
                          </td>
                        </tr>
                        <tr>
                          <td width="1%">
                            <div class="input-group">
                              <input type="radio" name="pasien_tabah" id="plsp-pasien-tabah" value="1" class="mr-1">Tabah
                            </div>
                          </td>
                          <td width="1%">
                            <input type="radio" name="pasien_tabah" id="plsp-pasien-sedih" value="0" class="mr-1">Sedih
                          </td>
                        </tr>
                        <tr>
                          <td width="1%">
                            <div class="input-group">
                              <input type="radio" name="pasien_sabar" id="plsp-pasien-sabar" value="1" class="mr-1">Sabar
                            </div>
                          </td>
                          <td width="1%">
                            <input type="radio" name="pasien_sabar" id="plsp-pasien-mengeluh" value="0" class="mr-1">Mengeluh
                          </td>
                        </tr>
                        <tr>
                          <td width="1%">
                        ...
                        <tr>
                          <td width="1%">
                            <div class="input-group">
                              <input type="radio" name="keluarga_terima" id="plsp-keluarga-terima" value="1" class="mr-1">Menerima
                            </div>
                          </td>
                          <td width="1%">
                            <input type="radio" name="keluarga_terima" id="plsp-keluarga-tidak-terima" value="0" class="mr-1">Tidak Menerima
                          </td>
                        </tr>
                        <tr>
                          <td width="1%">
                            <div class="input-group">
                              <input type="radio" name="keluarga_tabah" id="plsp-keluarga-tabah" value="1" class="mr-1">Tabah
                            </div>
                          </td>
                          <td width="1%">
                            <input type="radio" name="keluarga_tabah" id="plsp-keluarga-sedih" value="0" class="mr-1">Sedih
                          </td>
                        </tr>
                        <tr>
                          <td width="1%">
                            <div class="input-group">
                              <input type="radio" name="keluarga_sabar" id="plsp-keluarga-sabar" value="1" class="mr-1">Sabar
                            </div>
                          </td>
                          <td width="1%">
                            <input type="radio" name="keluarga_sabar" id="plsp-keluarga-mengeluh" value="0" class="mr-1">Mengeluh
                          </td>
                        </tr>
                        <tr>
                          <td width="1%">
                        ...
                        <tr>
                          <td width="1%">
                            <div class="input-group">
                              <input type="radio" name="ekspresi_senyum" id="plsp-ekspresi-senyum" value="1" class="mr-1">Senyum
                            </div>
                          </td>
                          <td width="1%">
                            <input type="radio" name="ekspresi_senyum" id="plsp-ekspresi-sedih" value="0" class="mr-1">Sedih
                          </td>
                        </tr>
                        <tr>
                          <td width="1%">
                            <div class="input-group">
                              <input type="radio" name="ekspresi_mengikuti" id="plsp-ekspresi-mengikuti" value="1" class="mr-1">Mengikuti
                            </div>
                          </td>
                          <td width="1%">
                            <input type="radio" name="ekspresi_mengikuti" id="plsp-ekspresi-menolak" value="0" class="mr-1">Menolak
                          </td>
                        </tr>
                        <tr>
                          <td width="1%">
                            <div class="input-group">
                              <input type="radio" name="ekspresi_nasihat" id="plsp-ekspresi-nasihat" value="1" class="mr-1">Nasihat
                            </div>
                          </td>
                          <td width="1%">
                            <input type="radio" name="ekspresi_nasihat" id="plsp-ekspresi-marah" value="0" class="mr-1">Nasihat
                          </td>
                        </tr>
                        <tr>
                          <td width="1%">
                            <div class="input-group">
                              <input type="radio" name="ekspresi_semangat" id="plsp-ekspresi-semangat" value="1" class="mr-1">Semangat
                            </div>
                          </td>
                          <td width="1%">
                            <input type="radio" name="ekspresi_semangat" id="plsp-ekspresi-apatis" value="0" class="mr-1">Marah
                          </td>
                        </tr>
                        <tr>
                          <td width="1%">
                            <div class="input-group">
                              <input type="radio" name="ekspresi_pasrah" id="plsp-ekspresi-pasrah" value="1" class="mr-1">Pasrah
                            </div>
                          </td>
                          <td width="1%">
                            <div class="input-group">
                              <input type="radio" name="ekspresi_pasrah" id="plsp-ekspresi-cemas" value="0" class="mr-1">Cemas
                            </div>
                          </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          <td width="1%">
                            <div class="input-group">
                              <input type="radio" name="penilaian_satu_positif" id="plsp-satu-positif" value="1" class="mr-1">Positif
                            </div>
                          </td>
                          <td width="1%">
                            <input type="radio" name="penilaian_satu_positif" id="plsp-satu-negatif" value="0" class="mr-1">Negatif
                          </td>
                        </tr>
                        <tr>
                          <td width="1%">
                        ...
                        <tr>
                          <td class="center" colspan="2">
                            <textarea name="kesimpulan_kiri" id="plsp-kesimpulan-kiri" class="form-control visitasi-input" rows="4"></textarea>
                          </td>
                        </tr>
                      </table>
                    </div>
                    <div class="col-lg-6">
                      <table class="table table-no-border table-sm table-striped">
                        ...
                        <tr>
                          <td width="1%">
                            <input type="radio" name="pasien_belum_disiplin" id="pasien-belum-disiplin" value="1" class="mr-1">Disiplin
                          </td>
                          <td width="1%">
                            <input type="radio" name="pasien_sudah_disiplin" id="pasien-sudah-disiplin" value="1" class="mr-1">Disiplin
                          </td>
                        </tr>
                        <tr>
                          <td width="1%">
                            <input type="radio" name="pasien_belum_disiplin" id="pasien-belum-kadang" value="2" class="mr-1">Kadang-kadang
                          </td>
                          <td width="1%">
                            <input type="radio" name="pasien_sudah_disiplin" id="pasien-sudah-kadang" value="2" class="mr-1">Kadang-kadang
                          </td>
                        </tr>
                        <tr>
                          <td width="1%">
                            <input type="radio" name="pasien_belum_disiplin" id="pasien-belum-tidak" value="3" class="mr-1">Tidak
                          </td>
                          <td width="1%">
                            <input type="radio" name="pasien_sudah_disiplin" id="pasien-sudah-tidak" value="3" class="mr-1">Tidak
                          </td>
                        </tr>
                        <tr>
                          <td width="1%">
                        ...
                        <tr>
                          <td width="1%">
                            <input type="radio" name="keluarga_belum_disiplin" id="keluarga-belum-disiplin" value="1" class="mr-1">Disiplin
                          </td>
                          <td width="1%">
                            <input type="radio" name="keluarga_sudah_disiplin" id="keluarga-sudah-disiplin" value="1" class="mr-1">Disiplin
                          </td>
                        </tr>
                        <tr>
                          <td width="1%">
                            <input type="radio" name="keluarga_belum_disiplin" id="keluarga-belum-kadang" value="2" class="mr-1">Kadang-kadang
                          </td>
                          <td width="1%">
                            <input type="radio" name="keluarga_sudah_disiplin" id="keluarga-sudah-kadang" value="2" class="mr-1">Kadang-kadang
                          </td>
                        </tr>
                        <tr>
                          <td width="1%">
                            <input type="radio" name="keluarga_belum_disiplin" id="keluarga-belum-tidak" value="3" class="mr-1">Tidak
                          </td>
                          <td width="1%">
                            <input type="radio" name="keluarga_sudah_disiplin" id="keluarga-sudah-tidak" value="3" class="mr-1">Tidak
                          </td>
                        </tr>
                        <tr>
                          <td width="1%">
                        ...
                        <tr>
                          <td width="1%">
                            <input type="checkbox" name="keluarga_hafalan_alfatihah" id="keluarga-hafalan-alfatihah" value="1" class="mr-1">Al Fatihah
                          </td>
                          <td width="1%">
                            <input type="radio" name="keluarga_media_wudhu" id="keluarga-media-wudhu" value="1" class="mr-1">Wudhu
                          </td>
                        </tr>
                        <tr>
                          <td width="1%">
                            <input type="checkbox" name="keluarga_hafalan_rukuk" id="keluarga-hafalan-rukuk" value="1" class="mr-1">Rukuk
                          </td>
                          <td width="1%">
                            <input type="radio" name="keluarga_media_wudhu" id="keluarga-media-tayamum" value="2" class="mr-1">Tayamum
                          </td>
                        </tr>
                        <tr>
                          <td width="1%">
                            <input type="checkbox" name="keluarga_hafalan_sujud" id="keluarga-hafalan-sujud" value="1" class="mr-1">Sujud
                          </td>
                          <td width="1%">
                            <input type="radio" name="keluarga_media_wudhu" id="keluarga-tidak-keduanya" value="0" class="mr-1">Tidak Keduanya
                          </td>
                        </tr>
                        <tr>
                          <td width="1%">
                            <input type="checkbox" name="keluarga_hafalan_tasyahud" id="keluarga-hafalan-tasyahud" value="1" class="mr-1">Tasyahud
                          </td>
                          <td width="1%">
                          </td>
                        </tr>
                        ...
                        <tr>
                          <td width="1%">
                            <div class="input-group">
                              <input type="radio" name="penilaian_dua_positif" id="plsp-dua-positif" value="1" class="mr-1">Positif
                            </div>
                          </td>
                          <td width="1%">
                            <input type="radio" name="penilaian_dua_positif" id="plsp-dua-negatif" value="0" class="mr-1">Negatif
                          </td>
                        </tr>
                        <tr>
                          <td width="1%">
                        ...
                        <tr>
                          <td class="center" colspan="2">
                            <textarea name="kesimpulan_kanan" id="plsp-kesimpulan-kanan" class="form-control" rows="4"></textarea>
                          </td>
                        </tr>
                      </table>
                    </div>
                ...
                <table class="table table-no-border table-sm table-striped" style="margin-top:-15px">
                  <tr>
                    <td colspan="3" class="center bold td-dark">
                      <button class="btn btn-info btn-xs mr-1 float-left" type="button" data-toggle="collapse" data-target="#tindak-lanjut-terapi"><i class="fas fa-expand mr-1"></i>Expand</button>TINDAK LANJUT
                      RENCANA TERAPI
                    </td>
                  </tr>
                </table>
                <div class="collapse multi-collapse mt-2" id="tindak-lanjut-terapi">
                  <div class="row">
                    <div class="col-lg-6">
                      <table class="table table-no-border table-sm table-striped" id="tabel-pengkajian-spiritual">
                        <tr>
                          <td width="1%">
                            <div class="input-group">
                              <input type="checkbox" name="rencana_motivasi" id="plsp-rencana-motivasi" value="1" class="mr-1">Motivasi Penerimaan Sakit
                            </div>
                          </td>
                          <td width="1%">
                            <input type="checkbox" name="pendampingan_umum" id="plsp-pendampingan-umum" value="1" class="mr-1">Pendampingan Umum
                          </td>
                        </tr>
                        <tr>
                          <td width="1%">
                            <div class="input-group">
                              <input type="checkbox" name="fiqih_pasien" id="plsp-fiqih-pasien" value="1" class="mr-1">Bimbingan Fiqih Pasien
                            </div>
                          </td>
                          <td width="1%">
                            <input type="checkbox" name="pendampingan_khusus" id="plsp-pendampingan-khusus" value="1" class="mr-1">Pendampingan Khusus
                          </td>
                        </tr>
                        <tr>
                          <td width="1%">
                            <div class="input-group">
                              <input type="checkbox" name="fiqih_wanita" id="plsp-fiqih-wanita" value="1" class="mr-1">Bimbingan Fiqih Wanita
                            </div>
                          </td>
                          <td width="1%">
                            <input type="checkbox" name="ruqyah_syariyah" id="plsp-ruqyah-syariyah" value="1" class="mr-1">Ruqyah
                            Syar'iyah
                          </td>
                        </tr>
                        <tr>
                          <td width="1%">
                            <div class="input-group">
                              <input type="checkbox" name="bimbingan_doa" id="plsp-bimbingan-doa" value="1" class="mr-1">Bimbingan Doa
                            </div>
                          </td>
                          <td width="1%">
                            <input type="checkbox" name="terapi_tahajud" id="plsp-terapi-tahajud" value="1" class="mr-1">Terapi
                            Tahajud
                          </td>
                        </tr>
                        <tr>
                          <td width="1%">
                            <div class="input-group">
                              <input type="checkbox" name="bimbingan_membaca" id="plsp-bimbingan-membaca" value="1" class="mr-1">Bimbingan Membaca/Menghafal Alqur'an
                            </div>
                          </td>
                          <td width="1%">
                            <input type="checkbox" name="terapi_dzikir" id="plsp-terapi-dzikir" value="1" class="mr-1">Terapi
                            Dzikir
                          </td>
                        </tr>
                        <tr>
                          <td width="1%">
                            <div class="input-group">
                              <input type="checkbox" name="motivasi_keluarga" id="plsp-motivasi-keluarga" value="1" class="mr-1">Motivasi Keluarga Pasien
                            </div>
                          </td>
                          <td width="1%">
                            <input type="checkbox" name="manajemen_nyeri" id="plsp-manajemen-nyeri" value="1" class="mr-1">Manajemen Nyeri Syari'ah
                          </td>
                        </tr>
                        <tr>
                          <td width="1%">
                            <div class="input-group">
                              <input type="checkbox" name="anjuran_sedekah" id="plsp-anjuran-sedekah" value="1" class="mr-1">Anjuran Sedekah
                            </div>
                          </td>
                          <td width="1%">
                          </td>
                ...
                <table class="table table-no-border table-sm table-striped" style="margin-top:-15px">
                  <tr>
                    <td colspan="3" class="center bold td-dark">
                      <button class="btn btn-info btn-xs mr-1 float-left" type="button" data-toggle="collapse" data-target="#data-pemantauan-shalat"><i class="fas fa-expand mr-1"></i>Expand</button>PEMANTAUAN SHALAT
                      LIMA WAKTU SELAMA DI RUMAH SAKIT
                    </td>
                  </tr>
                </table>
                <div class="collapse multi-collapse mt-2" id="data-pemantauan-shalat">
                  <div class="row">
                    <div class="col-lg-6">
                      <div id="pengkajian-sholat">
                      </div>
                      <table class="table table-no-border table-sm table-striped" id="tabel-pemantauan-sholat">
                        <thead>
                          <tr>
                            <th class="center" rowspan="3"><b>No</b></th>
                            <?php if ($this->session->userdata('account_group') === 'Admin') : ?>
                              <th class="center" rowspan="3"><b>Waktu</b></th>
                              <th class="center" rowspan="3"><b>Tanggal</b></th>
                            <?php else : ?>
                              <th class="center" rowspan="3"><b>Tanggal</b></th>
                            <?php endif ?>
                            <th class="center" colspan="10"><b>Shalat</b></th>
                            <?php if ($this->session->userdata('account_group') === 'Admin') : ?>
                              <th class="center" rowspan="3"><b>Petugas</b></th>
                            <?php else : ?>
                            <?php endif ?>
                            <th class="center" rowspan="3"></th>
                          </tr>
                          <tr>
                            <th class="center" colspan="2"><b>Shubuh</b></th>
                            <th class="center" colspan="2"><b>Dzuhur</b></th>
                            <th class="center" colspan="2"><b>Ashar</b></th>
                            <th class="center" colspan="2"><b>Maghrib</b></th>
                            <th class="center" colspan="2"><b>Isya</b></th>
                          </tr>
                          <tr>
                            <th class="center"><b>Ya</b></th>
                ...
                <table class="table table-no-border table-sm table-striped" style="margin-top:-15px">
                  ...
                  <tr>
                    ...
                    <td width="33%" class="center">
                      Tanggal & Jam <input type="text" name="plsp_tanggal_ttd_petugas" id="plsp-tanggal-ttd-petugas" class="custom-form clear-input d-inline-block col-lg-5 ml-2" placeholder="dd/mm/yyyy hh:ii">
                    </td>
                  </tr>
                  <tr>
                    <td></td>
                  ...
                  <tr>
                    <td></td>
                    <td></td>
                    <td class="center"><input type="text" name="perawat_terapi" id="perawat-terapi" class="select2c-input ml-2"></td>
                  </tr>
                  <tr>
                    <td class="center">
                    </td>
                  ...
                  <tr>
                    ...
                    <td class="center">
                      <input type="checkbox" name="ttd_petugas" id="plsp-ttd-petugas" value="1" class="custom-form col-lg-1 mx-auto">
                      <?= digitalSignature('plsp_ttd_petugas_verified') ?>
                    </td>
                  </tr>
                </table>
              </div>
              <!-- End Pengkajian lanjutan spiritual pasien-->
