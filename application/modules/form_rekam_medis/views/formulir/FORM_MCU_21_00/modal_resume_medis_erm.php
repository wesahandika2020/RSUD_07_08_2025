<!-- // MRMERM -->
<div class="modal fade" id="modal_resume_medis_erm" data-backdrop="static">
    <div class="modal-dialog modal-dialog-scrollable" style="max-width: 85%;">
        <div class="modal-content">
            <div class="modal-header">
                <div class="title">
                    <h5 id="modal_resume_medis_erm_title"></h5>
                </div>
            ...
            <div class="modal-body">
                <?= form_open('', 'id=resume-medis-erm class="form-horizontal"') ?>
