<script>
    $(function() {
        ...
        $('#kepalaa-9').click(function() {
            ...
            $('#kepalaa-10').prop('readonly', false);
        });

        $('#mataa-6').click(function() {
            $('#mataa-7').prop('readonly', false);
        });
        $('#mataa-8').click(function() {
            $('#mataa-9').prop('readonly', false);
        });
        $('#mataa-10').click(function() {
            $('#mataa-11').prop('readonly', false);
        });
        $('#tht-5').click(function() {
            $('#tht-6').prop('readonly', false);
        });
        $('#mulut-6').click(function() {
            $('#mulut-7').prop('readonly', false);
        });
        $('#gigi-2').click(function() {
            $('#gigi-3').prop('readonly', false);
        });
        $('#leher-2').click(function() {
            $('#leher-3').prop('readonly', false);
        });
        $('#dada-4').click(function() {
            $('#dada-5').prop('readonly', false);
        });
        $('#paru-12').click(function() {
            $('#paru-13').prop('readonly', false);
        });


        $('#paru-14').click(function() {
            $('#paru-15').prop('readonly', false);
        });
        $('#paru-16').click(function() {
            $('#paru-17').prop('readonly', false);
        });
        $('#paru-24').click(function() {
            $('#paru-25').prop('readonly', false);
        });
        $('#jantung-3').click(function() {
            $('#jantung-4').prop('readonly', false);
        });
        $('#extremitas-4').click(function() {
            $('#extremitas-5').prop('readonly', false);
        });
        $('#ardomen-5').click(function() {
            $('#ardomen-6').prop('readonly', false);
        });
        $('#ardomen-7').click(function() {
            $('#ardomen-8').prop('readonly', false);
        });
        $('#genetalia-1').click(function() {
            $('#genetalia-2').prop('readonly', false);
        });
        $('#genetalia-3').click(function() {
            $('#genetalia-4').prop('readonly', false);
        });
        $('#kulit-7').click(function() {
            $('#kulit-8').prop('readonly', false);
        });
        $('#extremitass-4').click(function() {
            $('#extremitass-5').prop('readonly', false);
        });

        $('#masalah-keperawatan-36-neonatus').click(function() {
            $('#masalah-keperawatan-lain-input-neonatus').prop('readonly', false);
        });
        $('#kriteria-discharge-noenatus-9').click(function() {
            $('#kriteria-discharge-noenatus-10').prop('readonly', false);
        });


        // CARA MASUK RS
        $('#cara-masuk-lain-neonatus').click(function() {
            $('#cara-masuk-lain-lain-neonatus').prop('readonly', false);
        });
    ...
    function lihatFORM_KEP_31_02(data) {
        let pasien = data.pasien;
        let layanan = data.layanan;
        let bed = layanan.bangsal + ' kelas ' + layanan.kelas + ' ruang ' + layanan.no_ruang + ' No. Bed ' + layanan.no_bed;
        let action = 'lihat';

        entriPengkajianAwalNeonatus(layanan.id_pendaftaran, layanan.id, bed, action);
    }

    function editFORM_KEP_31_02(data) {
        let pasien = data.pasien;
        let layanan = data.layanan;
        let bed = layanan.bangsal + ' kelas ' + layanan.kelas + ' ruang ' + layanan.no_ruang + ' No. Bed ' + layanan.no_bed;
        let action = 'edit';
    ...
    function tambahFORM_KEP_31_02(data) {
        let pasien = data.pasien;
        let layanan = data.layanan;
        let bed = layanan.bangsal + ' kelas ' + layanan.kelas + ' ruang ' + layanan.no_ruang + ' No. Bed ' + layanan.no_bed;
        let action = 'tambah';
    ...
    function entriPengkajianAwalNeonatus(id_pendaftaran, id_layanan_pendaftaran, bed, action) {
            ...
            success: function(data) {
                ...
                if (data.pasien !== null) {
                    ...
                    if (data.pasien.agama == 'Islam') {
                        ...
                        let inputLain = $('#agama-lain-input-neonatus');
                        if (inputLain.length) {
                            ...
                            syams_validation('#agama-lain-input-neonatus', 'Agama Belum Dipilih, Silahkan Hubungi *Rekam Medis*');
                        } else {
                            // Kalau input untuk agama lain tidak ditemukan di DOM, munculkan error di console
                            console.error("Elemen #agama-lain-input-neonatus tidak ditemukan!");
                        }
                    }
                ...
                if (data.kajian_neonatus !== null) {
                    ...
                    if (data.kajian_medis_neonatus !== null) {
                        showKajianMedisNeonatus(data.kajian_medis_neonatus);
                    }
                    ...
                    // if (data.kajian_neonatus && data.kajian_neonatus.tanggal_jam_pengkajian) {
                    //     $('#waktu-kajian-neonatus').val(datetimefmysql(data.kajian_neonatus.tanggal_jam_pengkajian));
                    // } else {
                    //     $('#waktu-kajian-neonatus').val('<?= date('d/m/Y H:i:s') ?>');
                    // }


                    // MEMBAWA OBAT DARI LUAR AKHIR
                    if (data.kajian_neonatus.membawa_obat === 'tidak') {
                        $('#membawa-obatt-1').prop('checked', true).change()
                    }
                    if (data.kajian_neonatus.membawa_obat === 'ya') {
                        $('#membawa-obatt-2').prop('checked', true).change()
                    }


                    if (data.kajian_neonatus.cara_masuk_irj_neonatus === 'IRJ') {$('#cara-masuk-irj-neonatus').prop('checked', true).change()}
                    if (data.kajian_neonatus.cara_masuk_igd_neonatus === 'IGD') {$('#cara-masuk-igd-neonatus').prop('checked', true).change()}
                    if (data.kajian_neonatus.cara_masuk_lain_neonatus === 'Lain-lain') {$('#cara-masuk-lain-neonatus').prop('checked', true).change()}
                    $('#cara-masuk-lain-lain-neonatus').val(data.kajian_neonatus.cara_masuk_lain_lain_neonatus);


                    // NAMA ORANG TUA AWAL
                    // ayah awal
                    const nama_ayah = JSON.parse(data.kajian_neonatus.nama_ayah);
                    if (nama_ayah.data_ayah_1 !== null) {
                        $('#data-ayah-1').val(nama_ayah.data_ayah_1);
                    }
                    if (nama_ayah.data_ayah_2 !== null) {
                        $('#data-ayah-2').val(nama_ayah.data_ayah_2);
                    }
                    if (nama_ayah.data_ayah_3 !== null) {
                        $('#data-ayah-3').val(nama_ayah.data_ayah_3);
                    }
                    if (nama_ayah.data_ayah_4 !== null) {
                        $('#data-ayah-4').val(nama_ayah.data_ayah_4);
                    }
                    if (nama_ayah.data_ayah_5 !== null) {
                        $('#data-ayah-5').val(nama_ayah.data_ayah_5);
                    }
                    if (nama_ayah.data_ayah_6 !== null) {
                        $('#data-ayah-6').val(nama_ayah.data_ayah_6);
                    }
                    if (nama_ayah.data_ayah_7 !== null) {
                        $('#data-ayah-7').val(nama_ayah.data_ayah_7);
                    }
                    // ayah akhir
                    ...
                    if (apgar_frekuensi_jantung.apgar_frekuensi_1 !== null) {
                        $('#apgar-frekuensi-1').prop('checked', true)
                    }
                    if (apgar_frekuensi_jantung.apgar_frekuensi_2 !== null) {
                        $('#apgar-frekuensi-2').prop('checked', true)
                    }
                    if (apgar_frekuensi_jantung.apgar_frekuensi_3 !== null) {
                        $('#apgar-frekuensi-3').prop('checked', true)
                    }
                    if (apgar_frekuensi_jantung.apgar_frekuensi_4 !== null) {
                        $('#apgar-frekuensi-4').prop('checked', true)
                    }
                    if (apgar_frekuensi_jantung.apgar_frekuensi_6 !== null) {
                        $('#apgar-frekuensi-6').prop('checked', true)
                    }

                    const apgar_usaha_nafas = JSON.parse(data.kajian_neonatus.apgar_usaha_nafas);
                    if (apgar_usaha_nafas.apgar_usaha_1 !== null) {
                        $('#apgar-usaha-1').prop('checked', true)
                    }
                    if (apgar_usaha_nafas.apgar_usaha_2 !== null) {
                        $('#apgar-usaha-2').prop('checked', true)
                    }
                    if (apgar_usaha_nafas.apgar_usaha_3 !== null) {
                        $('#apgar-usaha-3').prop('checked', true)
                    }
                    if (apgar_usaha_nafas.apgar_usaha_4 !== null) {
                        $('#apgar-usaha-4').prop('checked', true)
                    }
                    if (apgar_usaha_nafas.apgar_usaha_6 !== null) {
                        $('#apgar-usaha-6').prop('checked', true)
                    }

                    const apgar_tonus_otot = JSON.parse(data.kajian_neonatus.apgar_tonus_otot);
                    if (apgar_tonus_otot.apgar_tonus_1 !== null) {
                        $('#apgar-tonus-1').prop('checked', true)
                    }
                    if (apgar_tonus_otot.apgar_tonus_2 !== null) {
                        $('#apgar-tonus-2').prop('checked', true)
                    }
                    if (apgar_tonus_otot.apgar_tonus_3 !== null) {
                        $('#apgar-tonus-3').prop('checked', true)
                    }
                    if (apgar_tonus_otot.apgar_tonus_4 !== null) {
                        $('#apgar-tonus-4').prop('checked', true)
                    }
                    if (apgar_tonus_otot.apgar_tonus_6 !== null) {
                        $('#apgar-tonus-6').prop('checked', true)
                    }

                    const apgar_refleksi = JSON.parse(data.kajian_neonatus.apgar_refleksi);
                    if (apgar_refleksi.apgar_refleksi_1 !== null) {
                        $('#apgar-refleksi-1').prop('checked', true)
                    }
                    if (apgar_refleksi.apgar_refleksi_2 !== null) {
                        $('#apgar-refleksi-2').prop('checked', true)
                    }
                    if (apgar_refleksi.apgar_refleksi_3 !== null) {
                        $('#apgar-refleksi-3').prop('checked', true)
                    }
                    if (apgar_refleksi.apgar_refleksi_4 !== null) {
                        $('#apgar-refleksi-4').prop('checked', true)
                    }
                    if (apgar_refleksi.apgar_refleksi_6 !== null) {
                        $('#apgar-refleksi-6').prop('checked', true)
                    }

                    const apgar_warna = JSON.parse(data.kajian_neonatus.apgar_warna);
                    if (apgar_warna.apgar_warna_1 !== null) {
                        $('#apgar-warna-1').prop('checked', true)
                    }
                    if (apgar_warna.apgar_warna_2 !== null) {
                        $('#apgar-warna-2').prop('checked', true)
                    }
                    if (apgar_warna.apgar_warna_3 !== null) {
                        $('#apgar-warna-3').prop('checked', true)
                    }
                    if (apgar_warna.apgar_warna_4 !== null) {
                        $('#apgar-warna-4').prop('checked', true)
                    }
                    if (apgar_warna.apgar_warna_6 !== null) {
                        $('#apgar-warna-6').prop('checked', true)
                    }

                    const apgar_skor_1 = JSON.parse(data.kajian_neonatus.apgar_skor_1);
                    if (apgar_skor_1.total_skor_1 !== null) {
                        $('#total-skor-1').val(apgar_skor_1.total_skor_1);
                    }
                    if (apgar_skor_1.total_skor_1_1 !== null) {
                        $('#total-skor-1-1').val(apgar_skor_1.total_skor_1_1);
                    }
                    if (apgar_skor_1.total_skor_1_1_1 !== null) {
                        $('#total-skor-1-1-1').val(apgar_skor_1.total_skor_1_1_1);
                    }
                    if (apgar_skor_1.total_skor_1_1_1_1 !== null) {
                        $('#total-skor-1-1-1-1').val(apgar_skor_1.total_skor_1_1_1_1);
                    }
                    if (apgar_skor_1.total_skor_1_1_1_1_1 !== null) {
                        $('#total-skor-1-1-1-1-1').val(apgar_skor_1.total_skor_1_1_1_1_1);
                    }


                    const apgar_skor_2 = JSON.parse(data.kajian_neonatus.apgar_skor_2);
                    if (apgar_skor_2.total_skor_2 !== null) {
                        $('#total-skor-2').val(apgar_skor_2.total_skor_2);
                    }
                    if (apgar_skor_2.total_skor_2_2 !== null) {
                        $('#total-skor-2-2').val(apgar_skor_2.total_skor_2_2);
                    }
                    if (apgar_skor_2.total_skor_2_2_2 !== null) {
                        $('#total-skor-2-2-2').val(apgar_skor_2.total_skor_2_2_2);
                    }
                    if (apgar_skor_2.total_skor_2_2_2_2 !== null) {
                        $('#total-skor-2-2-2-2').val(apgar_skor_2.total_skor_2_2_2_2);
                    }
                    if (apgar_skor_2.total_skor_2_2_2_2_2 !== null) {
                        $('#total-skor-2-2-2-2-2').val(apgar_skor_2.total_skor_2_2_2_2_2);
                    }
                    // APGAR SKORE AKHIR 
                    ...
                    if (pengkajian_nyeri_kepala.kepalaa_1 !== null) {
                        $('#kepalaa-1').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_kepala.kepalaa_2 !== null) {
                        $('#kepalaa-2').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_kepala.kepalaa_3 !== null) {
                        $('#kepalaa-3').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_kepala.kepalaa_4 !== null) {
                        $('#kepalaa-4').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_kepala.kepalaa_5 !== null) {
                        $('#kepalaa-5').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_kepala.kepalaa_6 !== null) {
                        $('#kepalaa-6').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_kepala.kepalaa_7 !== null) {
                        $('#kepalaa-7').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_kepala.kepalaa_8 !== null) {
                        $('#kepalaa-8').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_kepala.kepalaa_9 !== null) {
                        $('#kepalaa-9').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_kepala.kepalaa_10 !== null) {
                        $('#kepalaa-10').val(pengkajian_nyeri_kepala.kepalaa_10);
                    }
                    if (pengkajian_nyeri_kepala.kepalaa_11 !== null) {
                        $('#kepalaa-11').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_kepala.kepalaa_12 !== null) {
                        $('#kepalaa-12').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_kepala.kepalaa_13 !== null) {
                        $('#kepalaa-13').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_kepala.kepalaa_14 !== null) {
                        $('#kepalaa-14').prop('checked', true).change()
                    }


                    // MATA
                    const pengkajian_nyeri_mata = JSON.parse(data.kajian_neonatus.pengkajian_nyeri_mata);
                    if (pengkajian_nyeri_mata.mataa_1 !== null) {
                        $('#mataa-1').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_mata.mataa_2 !== null) {
                        $('#mataa-2').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_mata.mataa_3 !== null) {
                        $('#mataa-3').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_mata.mataa_4 !== null) {
                        $('#mataa-4').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_mata.mataa_5 !== null) {
                        $('#mataa-5').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_mata.mataa_6 !== null) {
                        $('#mataa-6').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_mata.mataa_7 !== null) {
                        $('#mataa-7').val(pengkajian_nyeri_mata.mataa_7);
                    }
                    if (pengkajian_nyeri_mata.mataa_8 !== null) {
                        $('#mataa-8').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_mata.mataa_9 !== null) {
                        $('#mataa-9').val(pengkajian_nyeri_mata.mataa_9);
                    }
                    if (pengkajian_nyeri_mata.mataa_10 !== null) {
                        $('#mataa-10').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_mata.mataa_11 !== null) {
                        $('#mataa-11').val(pengkajian_nyeri_mata.mataa_11);
                    }


                    // THT
                    const pengkajian_nyeri_tht = JSON.parse(data.kajian_neonatus.pengkajian_nyeri_tht);
                    if (pengkajian_nyeri_tht.tht_1 !== null) {
                        $('#tht-1').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_tht.tht_2 !== null) {
                        $('#tht-2').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_tht.tht_3 !== null) {
                        $('#tht-3').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_tht.tht_4 !== null) {
                        $('#tht-4').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_tht.tht_5 !== null) {
                        $('#tht-5').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_tht.tht_6 !== null) {
                        $('#tht-6').val(pengkajian_nyeri_tht.tht_6);
                    }


                    // MULUT
                    const pengkajian_nyeri_mulut = JSON.parse(data.kajian_neonatus.pengkajian_nyeri_mulut);
                    if (pengkajian_nyeri_mulut.mulut_1 !== null) {
                        $('#mulut-1').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_mulut.mulut_2 !== null) {
                        $('#mulut-2').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_mulut.mulut_3 !== null) {
                        $('#mulut-3').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_mulut.mulut_4 !== null) {
                        $('#mulut-4').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_mulut.mulut_5 !== null) {
                        $('#mulut-5').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_mulut.mulut_6 !== null) {
                        $('#mulut-6').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_mulut.mulut_7 !== null) {
                        $('#mulut-7').val(pengkajian_nyeri_mulut.mulut_7);
                    }


                    // GIGI
                    const pengkajian_nyeri_gigi = JSON.parse(data.kajian_neonatus.pengkajian_nyeri_gigi);
                    if (pengkajian_nyeri_gigi.gigi_1 !== null) {
                        $('#gigi-1').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_gigi.gigi_2 !== null) {
                        $('#gigi-2').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_gigi.gigi_3 !== null) {
                        $('#gigi-3').val(pengkajian_nyeri_gigi.gigi_3);
                    }


                    // LEHER
                    const pengkajian_nyeri_leher = JSON.parse(data.kajian_neonatus.pengkajian_nyeri_leher);
                    if (pengkajian_nyeri_leher.leher_1 !== null) {
                        $('#leher-1').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_leher.leher_2 !== null) {
                        $('#leher-2').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_leher.leher_3 !== null) {
                        $('#leher-3').val(pengkajian_nyeri_leher.leher_3);
                    }

                    // DADA
                    const pengkajian_nyeri_dada = JSON.parse(data.kajian_neonatus.pengkajian_nyeri_dada);
                    if (pengkajian_nyeri_dada.dada_1 !== null) {
                        $('#dada-1').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_dada.dada_2 !== null) {
                        $('#dada-2').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_dada.dada_3 !== null) {
                        $('#dada-3').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_dada.dada_4 !== null) {
                        $('#dada-4').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_dada.dada_5 !== null) {
                        $('#dada-5').val(pengkajian_nyeri_dada.dada_5);
                    }
                    if (pengkajian_nyeri_dada.dada_6 !== null) {
                        $('#dada-6').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_dada.dada_7 !== null) {
                        $('#dada-7').prop('checked', true).change()
                    }


                    // PARU-PARU
                    const pengkajian_nyeri_paru_paru = JSON.parse(data.kajian_neonatus.pengkajian_nyeri_paru_paru);
                    if (pengkajian_nyeri_paru_paru.paru_1 !== null) {
                        $('#paru-1').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_paru_paru.paru_2 !== null) {
                        $('#paru-2').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_paru_paru.paru_3 !== null) {
                        $('#paru-3').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_paru_paru.paru_4 !== null) {
                        $('#paru-4').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_paru_paru.paru_5 !== null) {
                        $('#paru-5').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_paru_paru.paru_6 !== null) {
                        $('#paru-6').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_paru_paru.paru_7 !== null) {
                        $('#paru-7').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_paru_paru.paru_8 !== null) {
                        $('#paru-8').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_paru_paru.paru_9 !== null) {
                        $('#paru-9').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_paru_paru.paru_10 !== null) {
                        $('#paru-10').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_paru_paru.paru_11 !== null) {
                        $('#paru-11').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_paru_paru.paru_12 !== null) {
                        $('#paru-12').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_paru_paru.paru_13 !== null) {
                        $('#paru-13').val(pengkajian_nyeri_paru_paru.paru_13);
                    }
                    if (pengkajian_nyeri_paru_paru.paru_14 !== null) {
                        $('#paru-14').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_paru_paru.paru_15 !== null) {
                        $('#paru-15').val(pengkajian_nyeri_paru_paru.paru_15);
                    }
                    if (pengkajian_nyeri_paru_paru.paru_16 !== null) {
                        $('#paru-16').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_paru_paru.paru_17 !== null) {
                        $('#paru-17').val(pengkajian_nyeri_paru_paru.paru_17);
                    }
                    if (pengkajian_nyeri_paru_paru.paru_18 !== null) {
                        $('#paru-18').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_paru_paru.paru_19 !== null) {
                        $('#paru-19').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_paru_paru.paru_20 === '0') {
                        $('#paru-20').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_paru_paru.paru_20 === '1') {
                        $('#paru-21').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_paru_paru.paru_22 !== null) {
                        $('#paru-22').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_paru_paru.paru_23 !== null) {
                        $('#paru-23').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_paru_paru.paru_24 !== null) {
                        $('#paru-24').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_paru_paru.paru_25 !== null) {
                        $('#paru-25').val(pengkajian_nyeri_paru_paru.paru_25);
                    }

                    // JANTUNG
                    const pengkajian_nyeri_jantung = JSON.parse(data.kajian_neonatus.pengkajian_nyeri_jantung);
                    if (pengkajian_nyeri_jantung.jantung_1 !== null) {
                        $('#jantung-1').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_jantung.jantung_2 !== null) {
                        $('#jantung-2').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_jantung.jantung_3 !== null) {
                        $('#jantung-3').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_jantung.jantung_4 !== null) {
                        $('#jantung-4').val(pengkajian_nyeri_jantung.jantung_4);
                    }

                    // EXTREMITAS ATAS
                    const pengkajian_nyeri_extremitas_atas = JSON.parse(data.kajian_neonatus.pengkajian_nyeri_extremitas_atas);
                    if (pengkajian_nyeri_extremitas_atas.extremitas_1 !== null) {
                        $('#extremitas-1').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_extremitas_atas.extremitas_2 !== null) {
                        $('#extremitas-2').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_extremitas_atas.extremitas_3 !== null) {
                        $('#extremitas-3').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_extremitas_atas.extremitas_4 !== null) {
                        $('#extremitas-4').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_extremitas_atas.extremitas_5 !== null) {
                        $('#extremitas-5').val(pengkajian_nyeri_extremitas_atas.extremitas_5);
                    }
                    if (pengkajian_nyeri_extremitas_atas.extremitas_6 !== null) {
                        $('#extremitas-6').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_extremitas_atas.extremitas_7 !== null) {
                        $('#extremitas-7').prop('checked', true).change()
                    }

                    // ABDOMEN
                    const pengkajian_nyeri_abdomen = JSON.parse(data.kajian_neonatus.pengkajian_nyeri_abdomen);
                    if (pengkajian_nyeri_abdomen.ardomen_1 !== null) {
                        $('#ardomen-1').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_abdomen.ardomen_2 !== null) {
                        $('#ardomen-2').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_abdomen.ardomen_3 !== null) {
                        $('#ardomen-3').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_abdomen.ardomen_4 !== null) {
                        $('#ardomen-4').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_abdomen.ardomen_5 !== null) {
                        $('#ardomen-5').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_abdomen.ardomen_6 !== null) {
                        $('#ardomen-6').val(pengkajian_nyeri_abdomen.ardomen_6);
                    }
                    if (pengkajian_nyeri_abdomen.ardomen_7 !== null) {
                        $('#ardomen-7').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_abdomen.ardomen_8 !== null) {
                        $('#ardomen-8').val(pengkajian_nyeri_abdomen.ardomen_8);
                    }

                    // UMBILIKAL
                    const pengkajian_nyeri_umbilikal = JSON.parse(data.kajian_neonatus.pengkajian_nyeri_umbilikal);
                    if (pengkajian_nyeri_umbilikal.umbilikal_1 !== null) {
                        $('#umbilikal-1').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_umbilikal.umbilikal_2 !== null) {
                        $('#umbilikal-2').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_umbilikal.umbilikal_3 !== null) {
                        $('#umbilikal-3').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_umbilikal.umbilikal_4 !== null) {
                        $('#umbilikal-4').prop('checked', true).change()
                    }

                    // GENETALIA
                    const pengkajian_nyeri_genetalia = JSON.parse(data.kajian_neonatus.pengkajian_nyeri_genetalia);
                    if (pengkajian_nyeri_genetalia.genetalia_1 !== null) {
                        $('#genetalia-1').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_genetalia.genetalia_2 !== null) {
                        $('#genetalia-2').val(pengkajian_nyeri_genetalia.genetalia_2);
                    }
                    if (pengkajian_nyeri_genetalia.genetalia_3 !== null) {
                        $('#genetalia-3').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_genetalia.genetalia_4 !== null) {
                        $('#genetalia-4').val(pengkajian_nyeri_genetalia.genetalia_4);
                    }

                    // ANUS
                    const pengkajian_nyeri_anus = JSON.parse(data.kajian_neonatus.pengkajian_nyeri_anus);
                    if (pengkajian_nyeri_anus.anus_1 === '1') {
                        $('#anus-1').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_anus.anus_1 === '0') {
                        $('#anus-2').prop('checked', true).change()
                    }

                    // KULIT
                    const pengkajian_nyeri_kulit = JSON.parse(data.kajian_neonatus.pengkajian_nyeri_kulit);
                    if (pengkajian_nyeri_kulit.kulit_1 !== null) {
                        $('#kulit-1').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_kulit.kulit_2 !== null) {
                        $('#kulit-2').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_kulit.kulit_3 !== null) {
                        $('#kulit-3').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_kulit.kulit_4 !== null) {
                        $('#kulit-4').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_kulit.kulit_5 !== null) {
                        $('#kulit-5').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_kulit.kulit_6 !== null) {
                        $('#kulit-6').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_kulit.kulit_7 !== null) {
                        $('#kulit-7').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_kulit.kulit_8 !== null) {
                        $('#kulit-8').val(pengkajian_nyeri_kulit.kulit_8);
                    }

                    // REFLEKS
                    const pengkajian_nyeri_refleks = JSON.parse(data.kajian_neonatus.pengkajian_nyeri_refleks);
                    if (pengkajian_nyeri_refleks.refleks_1 !== null) {
                        $('#refleks-1').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_refleks.refleks_2 !== null) {
                        $('#refleks-2').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_refleks.refleks_3 !== null) {
                        $('#refleks-3').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_refleks.refleks_4 !== null) {
                        $('#refleks-4').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_refleks.refleks_5 !== null) {
                        $('#refleks-5').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_refleks.refleks_6 !== null) {
                        $('#refleks-6').prop('checked', true).change()
                    }

                    // TONUS OTOT
                    const pengkajian_nyeri_otot_tonus = JSON.parse(data.kajian_neonatus.pengkajian_nyeri_otot_tonus);
                    if (pengkajian_nyeri_otot_tonus.tonus_1 !== null) {
                        $('#tonus-1').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_otot_tonus.tonus_2 !== null) {
                        $('#tonus-2').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_otot_tonus.tonus_3 !== null) {
                        $('#tonus-3').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_otot_tonus.tonus_4 !== null) {
                        $('#tonus-4').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_otot_tonus.tonus_5 !== null) {
                        $('#tonus-5').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_otot_tonus.tonus_6 !== null) {
                        $('#tonus-6').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_otot_tonus.tonus_7 !== null) {
                        $('#tonus-7').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_otot_tonus.tonus_8 !== null) {
                        $('#tonus-8').prop('checked', true).change()
                    }

                    // EXTREMITAS BAWAH
                    const pengkajian_nyeri_ektremitas_bawah = JSON.parse(data.kajian_neonatus.pengkajian_nyeri_ektremitas_bawah);
                    if (pengkajian_nyeri_ektremitas_bawah.extremitass_1 !== null) {
                        $('#extremitass-1').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_ektremitas_bawah.extremitass_2 !== null) {
                        $('#extremitass-2').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_ektremitas_bawah.extremitass_3 !== null) {
                        $('#extremitass-3').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_ektremitas_bawah.extremitass_4 !== null) {
                        $('#extremitass-4').prop('checked', true).change()
                    }
                    if (pengkajian_nyeri_ektremitas_bawah.extremitass_5 !== null) {
                        $('#extremitass-5').val(pengkajian_nyeri_ektremitas_bawah.extremitass_5);
                    }
                    ...
                    // Neonatal Early Warning Score  INI YANG ASLI 
                    // for (let a = 1; a <= 6; a++) { 
                    //     for (let b = 1; b <= 5; b++) { 
                    //         if (data.kajian_neonatus.neurobehavirol === $('#calsnews_' + a + '_' + b).val() && 
                    //             data.kajian_neonatus.neurobehavirol === $('.pramet_neurobehavirol_' + a + '_' + b).val()) {
                    //             $('#calsnews_' + a + '_' + b).prop('checked', true).change();
                    //         }
                    //         if (data.kajian_neonatus.nadiqy === $('#calsnews_' + a + '_' + b).val() && 
                    //             data.kajian_neonatus.nadiqy === $('.pramet_nadiqy_' + a + '_' + b).val()) {
                    //             $('#calsnews_' + a + '_' + b).prop('checked', true).change();
                    //         }
                    //         if (data.kajian_neonatus.respirasqy === $('#calsnews_' + a + '_' + b).val() && 
                    //             data.kajian_neonatus.respirasqy === $('.pramet_respirasqy_' + a + '_' + b).val()) {
                    //             $('#calsnews_' + a + '_' + b).prop('checked', true).change();
                    //         }
                    //         if (data.kajian_neonatus.warnaulity === $('#calsnews_' + a + '_' + b).val() && 
                    //             data.kajian_neonatus.warnaulity === $('.pramet_warnaulity_' + a + '_' + b).val()) {
                    //             $('#calsnews_' + a + '_' + b).prop('checked', true).change();
                    //         }
                    //         if (data.kajian_neonatus.suhuqy === $('#calsnews_' + a + '_' + b).val() && 
                    //             data.kajian_neonatus.suhuqy === $('.pramet_suhuqy_' + a + '_' + b).val()) {
                    //             $('#calsnews_' + a + '_' + b).prop('checked', true).change();
                    //         }
                    //         if (data.kajian_neonatus.merintihqy === $('#calsnews_' + a + '_' + b).val() && 
                    //             data.kajian_neonatus.merintihqy === $('.pramet_merintihqy_' + a + '_' + b).val()) {
                    //             $('#calsnews_' + a + '_' + b).prop('checked', true).change();
                    //         }
                    //     }
                    // }
                    ...
                    for (let a = 1; a <= 6; a++) { 
                        for (let b = 1; b <= 5; b++) { 
                            if (data.kajian_neonatus.pews_pernafasan === $('#calsnews_' + a + '_' + b).val() && 
                                data.kajian_neonatus.pews_pernafasan === $('.pramet_neurobehavirol_' + a + '_' + b).val()) {
                                $('#calsnews_' + a + '_' + b).prop('checked', true).change();
                            }
                            if (data.kajian_neonatus.pews_alat_bantu === $('#calsnews_' + a + '_' + b).val() && 
                                data.kajian_neonatus.pews_alat_bantu === $('.pramet_nadiqy_' + a + '_' + b).val()) {
                                $('#calsnews_' + a + '_' + b).prop('checked', true).change();
                            }
                            if (data.kajian_neonatus.pews_saturasi === $('#calsnews_' + a + '_' + b).val() && 
                                data.kajian_neonatus.pews_saturasi === $('.pramet_respirasqy_' + a + '_' + b).val()) {
                                $('#calsnews_' + a + '_' + b).prop('checked', true).change();
                            }
                            if (data.kajian_neonatus.pews_nadi === $('#calsnews_' + a + '_' + b).val() && 
                                data.kajian_neonatus.pews_nadi === $('.pramet_warnaulity_' + a + '_' + b).val()) {
                                $('#calsnews_' + a + '_' + b).prop('checked', true).change();
                            }
                            if (data.kajian_neonatus.pews_warna_kulit === $('#calsnews_' + a + '_' + b).val() && 
                                data.kajian_neonatus.pews_warna_kulit === $('.pramet_suhuqy_' + a + '_' + b).val()) {
                                $('#calsnews_' + a + '_' + b).prop('checked', true).change();
                            }
                            if (data.kajian_neonatus.pews_tds === $('#calsnews_' + a + '_' + b).val() && 
                                data.kajian_neonatus.pews_tds === $('.pramet_merintihqy_' + a + '_' + b).val()) {
                                $('#calsnews_' + a + '_' + b).prop('checked', true).change();
                            }
                        }
                    }
                    ...
                    if (masalah_keperawatann.masalah_keperawatan_36_neonatus !== null) {
                        $('#masalah-keperawatan-36-neonatus').prop('checked', true).change()
                    }
                    if (masalah_keperawatann.masalah_keperawatan_lain_input_neonatus !== null) {
                        $('#masalah-keperawatan-lain-input-neonatus').val(masalah_keperawatann.masalah_keperawatan_lain_input_neonatus);
                    }
                    ...
                    if (perencanaan_pulangg.kriteria_discharge_noenatus_9 !== null) {
                        $('#kriteria-discharge-noenatus-9').prop('checked', true).change()
                    }
                    if (perencanaan_pulangg.kriteria_discharge_noenatus_10 !== null) {
                        $('#kriteria-discharge-noenatus-10').val(perencanaan_pulangg.kriteria_discharge_noenatus_10);
                    }
                    ...
                    if (data.kajian_neonatus.id_perawat !== null) {
                        $('#pilih-perawat-neonatus').select2c('readonly', false)
                    }
                    ...
                    if (data.kajian_neonatus.id_dokter !== null) {
                        $('#pilih-dokter-neonatus').select2c('readonly', false)
                    }
                ...
                $('#modal_pengkajian_awal_keperawatan_neonatus').modal('show');
    ...
    function hitungSkala() {
        ...
        for (let i = 1; i <= 6; i++) {
            ...
            for (let j = 1; j <= 5; j++) { 
                var value = 0; 
                if ($('#calsnews_' + i + '_' + j).is(':checked')) { 
                    var getNilai = $('#calsnews_' + i + '_' + j).val(); 
                    value = parseInt(getNilai.split('-')[0]); // Mengambil elemen pertama dan parseInt
                }
                sub_total += value;
            }
            total += sub_total; 
        ...
        $('#total_calsnews_1, #total_calsnews_2, #total_calsnews_3').prop('checked', false);

        if (total >= 0 && total <= 0) {
            $('#total_calsnews_1').prop('checked', true); // Jika total antara 0 dan 0, centang elemen dengan ID 'total-calsnews-1'
        } else if (total >= 0 && total <= 1) {
            $('#total_calsnews_2').prop('checked', true); // Jika total antara 0 dan 1, centang elemen dengan ID 'total-calsnews-2'
        } else if (total >= 2) {
            $('#total_calsnews_3').prop('checked', true); // Jika total 2 atau lebih, centang elemen dengan ID 'total-calsnews-3'
        }
    }
    ...
    function calcscorefrekuensi() {
        var score = 0;
        $("input[name='apgar_frekuensi_1']:checked").each(function() {
            if ($(this).val() == '0') {
                score = parseInt(0);
                return false;
            }
        });
        $("input[name='apgar_frekuensi_2']:checked").each(function() {
            if ($(this).val() == '1') {
                score = parseInt(1);
                return false;
            }
        });
        $("input[name='apgar_frekuensi_3']:checked").each(function() {
            if ($(this).val() == '2') {
                score = parseInt(2);
                return false;
            }
    ...
    function calcscoreusaha() {
        var score = 0;
        $("input[name='apgar_usaha_1']:checked").each(function() {
            if ($(this).val() == '0') {
                score = parseInt(0);
                return false;
            }
        });
        $("input[name='apgar_usaha_2']:checked").each(function() {
            if ($(this).val() == '1') {
                score = parseInt(1);
                return false;
            }
        });
        $("input[name='apgar_usaha_3']:checked").each(function() {
            if ($(this).val() == '2') {
                score = parseInt(2);
                return false;
            }
    ...
    function calcscoretonus() {
        var score = 0;
        $("input[name='apgar_tonus_1']:checked").each(function() {
            if ($(this).val() == '0') {
                score = parseInt(0);
                return false;
            }
        });
        $("input[name='apgar_tonus_2']:checked").each(function() {
            if ($(this).val() == '1') {
                score = parseInt(1);
                return false;
            }
        });
        $("input[name='apgar_tonus_3']:checked").each(function() {
            if ($(this).val() == '2') {
                score = parseInt(2);
                return false;
            }
    ...
    function calcscorerefleksi() {
        var score = 0;
        $("input[name='apgar_refleksi_1']:checked").each(function() {
            if ($(this).val() == '0') {
                score = parseInt(0);
                return false;
            }
        });
        $("input[name='apgar_refleksi_2']:checked").each(function() {
            if ($(this).val() == '1') {
                score = parseInt(1);
                return false;
            }
        });
        $("input[name='apgar_refleksi_3']:checked").each(function() {
            if ($(this).val() == '2') {
                score = parseInt(2);
                return false;
            }
    ...
    function calcscorewarna() {
        var score = 0;
        $("input[name='apgar_warna_1']:checked").each(function() {
            if ($(this).val() == '0') {
                score = parseInt(0);
                return false;
            }
        });
        $("input[name='apgar_warna_2']:checked").each(function() {
            if ($(this).val() == '1') {
                score = parseInt(1);
                return false;
            }
        });
        $("input[name='apgar_warna_3']:checked").each(function() {
            if ($(this).val() == '2') {
                score = parseInt(2);
                return false;
            }
    ...
    function showKajianMedisNeonatus(data) {
        ...
        if (rp_neonatus.rp_neonatus_1 !== null) {
            $('#rk-neonatus-1').val(rp_neonatus.rp_neonatus_1);
        }
        if (rp_neonatus.rp_neonatus_2 !== null) {
            $('#rk-neonatus-2').prop('checked', true)
        }
        if (rp_neonatus.rp_neonatus_3 !== null) {
            $('#rk-neonatus-3').val(rp_neonatus.rp_neonatus_3);
        }
        if (rp_neonatus.rp_neonatus_4 !== null) {
            $('#rk-neonatus-4').val(rp_neonatus.rp_neonatus_4);
        }
        if (rp_neonatus.rp_neonatus_5 !== null) {
            $('#rk-neonatus-5').val(rp_neonatus.rp_neonatus_5);
        }
        ...
        if (data.id_dokter_dpjp !== null) {
            $('#dokter-dpjp-neonatus').select2c('readonly', true)
        }
        if (data.ttd_dokter_dpjp !== null) {
            $('#ttd-dokter-dpjp-neonatus').hide();
            $('#ttd_dokter_dpjp_verified_neonatus').show();
        }
        ...
        if (data.id_dokter_pengkajian !== null) {
            $('#dokter-pengkajian-neonatus').select2c('readonly', true)
        }
        if (data.ttd_dokter_pengkajian !== null) {
            $('#ttd-dokter-pengkajian-neonatus').hide();
            $('#ttd_dokter_pengkajian_verified_neonatus').show();
        }
    ...
    function SimpanPengkajianAwalNeonatus() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $('#modal_pengkajian_awal_keperawatan_neonatus').modal('hide');
                showListForm($('#id-pendaftaran-neonatus').val(), $('#id-layanan-pendaftaran-neonatus').val(), $('#id-pasien-neonatus').val());
            },
