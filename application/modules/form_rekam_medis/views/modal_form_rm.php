    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group row tight">
                    <label for="test_group" class="col-3 col-form-label">Jenis Unit </label>
                    <div class="col-6">
                        <input type="text" name="jenis_unit_formulir" class="form-control" id="jenis_unit_formulir" placeholder="Unit Formulir">
                    </div>
                </div>
