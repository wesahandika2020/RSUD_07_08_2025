	...
	<div class="col-lg-12">
		<div class="card">
			...
			<div class="card-body lap-01">
				<div></div>
					<h5 style="text-transform: uppercase;" class="center"><b>LAPORAN TINDAKAN HEMODIALISA RAWAT JALAN DAN RAWAT INAP</b></h5>
					<h6 class="center"><b>(Khusus Tindakan : HD REGULER dan HD NON REGULER)</b></h6>
