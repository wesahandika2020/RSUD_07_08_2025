	...
	<div class="modal-dialog" style="max-width:500px">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="form-group row tight">
					<label for="jenis-tindakan" class="col-md-3 col-form-label">Tindakan</label>
					<div class="col-md-9">
						<?= form_dropdown('jenis_tindakan', $jenis_tindakan, array(), 'id=jenis-tindakan class=form-control') ?>
					</div>
				</div>
			...
			<div class="modal-footer">
				...
				<button type="button" class="btn btn-info waves-effect" onclick="getLaporanHd(1)"><i class="fas fa-paper-plane mr-1"></i> Tampilkan</button>
			</div>
		</div>
		<!-- /.modal-content -->
	</div>
