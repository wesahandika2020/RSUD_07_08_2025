	...
	<div class="page page_break">
		...
		<table width="100%" id="table-data">
			...
			<tr>
				...
				<td width="1%" >:</td>
				<td width="69%" class="justify"><?= $pasien->id ?></td>
			</tr>
			<tr>
				<td width="20%">Nama</td>
				<td width="1%">:</td>
				<td width="79%" class="justify"><?= $pasien->nama ?></td>
			</tr>
			<tr>
				<td>Kelamin</td>
				<td>:</td>
				<td class="justify"><?= ($pasien->kelamin == 'L' ? 'Laki-laki' : 'Perempuan') ?></td>
			</tr>
			<tr>
				<td>Umur</td>
				<td>:</td>
			...
			<tr>
				<td>Tanggal</td>
				<td>:</td>
				<td class="justify"><?= tanggal_indo($surat->tanggal, true) ?></td>
			</tr>
			<tr>
				<td>Poli yang dituju</td>
				<td>:</td>
				<td class="justify"><?= $surat->poli ?></td>
			</tr>
			<tr>
