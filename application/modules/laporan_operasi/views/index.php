...
<div class="row">
	<div class="col-lg-12">
		<div class="card">
			...
			<?php $this->load->view('lap_bulanan_ibs/index.php') ?>
			<?php $this->load->view('lap_kegiatan_pembedahan/index.php') ?>
			<?php $this->load->view('lap_anastesi_ok/index.php') ?>
			<?php $this->load->view('lap_rekap_operasi/index.php') ?>
...
<!-- ?php $this->load->view('lap_kegiatan_pembedahan/modal') ?> -->