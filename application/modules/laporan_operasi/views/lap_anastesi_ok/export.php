<html>
<title><?= "Laporan Anastesi Dikamar Operasi" ?></title>
...
<body>
  ...
  <main style="page-break-after: auto;">
    <br>
    <h4 align="center">LAPORAN ANASTESI DIKAMAR OPERASI <br>OPERASI BULAN <?= strtoupper($periode) ?></h4>
    <table style="font-size: 10pt; border-collapse: collapse;" width="100%" class="table-border">
      <thead style="background-color: #a9a9a9;">
        <tr style="top: 0;">
          <th width="5%" align="center" class="center">NO.</th>
          <th width="40%" align="center" class="center">DOKTER ANASTESI</th>
          <th align="center" class="center">GA</th>
          <th align="center" class="center">RA</th>
          <th align="center" class="center">LA</th>
          <th width="20%" align="center" class="center">JUMLAH PASIEN OPERASI</th>
        </tr>
      </thead>
      <tbody>
        <?php
        ...
        ?>
          <tr>
            ...
            <td align="center"><?= $value->general ?></td>
            <td align="center"><?= $value->regional ?></td>
            <td align="center"><?= $value->lokal ?></td>
      ...
      <tfoot style="background-color: #dcdcdc;">
        <tr>
          ...
          <td align="center"><b><?= number_format($sum['general'], 0, ',', '.') ?></b></td>
          <td align="center"><b><?= number_format($sum['regional'], 0, ',', '.') ?></b></td>
          <td align="center"><b><?= number_format($sum['lokal'], 0, ',', '.') ?></b></td>
          <td align="center"><b><?= number_format($sum['total_pasien'], 0, ',', '.') ?></b></td>
        </tr>
      </tfoot>
    </table>
    ...
    <table width="100%">
      ...
      <tr>
        <td style="width: 40%;" align="center">Ka. Instalasi Bedah Sentral ( OK )</td>
        <td style="width: 30%;" align="center"></td>
        <td style="width: 40%;" align="center">Kepala Ruang Bedah Sentral ( OK )</td>
      </tr>
      <tr>
