					...
					<table id="table-data" class="table table-hover table-striped table-sm color-table info-table">
						<thead>
							<tr>
								...
								<th width="8%" class="center">Tanggal</th>
								<th width="5%" class="center">No. RM</th>
								<th width="20%" class="left">Nama Pasien</th>
								<th width="10%" class="center">Jenis</th>
								<th width="20%" class="left">Nama Barang</th>
								<th width="7%" class="center">Qty</th>
								<th width="7%" class="left">Kemasan</th>
								<th width="7%" class="right">Harga Jual</th>
								<th width="7%" class="right">Subtotal</th>
