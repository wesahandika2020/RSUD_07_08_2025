                                        ...
                                        <table class="table table-no-border table-sm table-striped"
                                            ...
                                            <tr>
                                                <td width="90%"><input type="radio" name="sn_penurunan_bb" id="sn-tidak"
                                                        class="mr-1" value="1" onchange="calcscorey()">Tidak</td>
                                                <td>Skor 0</td>
                                            </tr>
                                            <tr>
                                                <td><input type="radio" name="sn_penurunan_bb" id="sn-tidak-yakin"
                                                        class="mr-1" value="2" onchange="calcscorey()">Tidak Yakin</td>
                                                <td>Skor 2</td>
                                            </tr>
                                            <tr>
                                                <td><input type="radio" name="sn_penurunan_bb" id="sn-ya" class="mr-1"
                                                        value="3" onchange="calcscorey()">Ya, ada penurunan BB sebanyak
                                                </td>
                                                <td></td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td><input type="radio" name="sn_asupan_makan"
                                                        ...
                                                        onchange="calcscorey()">Tidak</td>
                                                <td>Skor 0</td>
                                            </tr>
                                            <tr>
                                                <td><input type="radio" name="sn_asupan_makan" id="sn-asupan-makan-ya"
                                                        class="mr-1" value="1" onchange="calcscorey()">Ya</td>
                                                <td>Skor 1</td>
                                            </tr>
...
<?php $this->load->view('pelayanan/pengkajian_kebidanan_form/js') ?>