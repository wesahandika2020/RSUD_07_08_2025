<script>
	...
	function entriEdukasi(id_pendaftaran, id_layanan_pendaftaran) {
		resetFormEdukasi();
		$.ajax({
			type: 'GET',
			url: '<?= base_url("pelayanan/api/pelayanan/get_layanan_pendaftaran_detail") ?>/id/' + id_pendaftaran + '/id_layanan/' + id_layanan_pendaftaran + '/tipe/edukasi',
			cache: false,
			dataType: 'JSON',
			beforeSend: function() {
				showLoader();
			...
			$.each(data, function(i, v) {
				...
				var html = /* html */ `
					<tr>
						...
						<td class="center"><span class="bold">&#10003;</span></td>
						<td class="nowrap center">
	...
	function printEdukasi(id_pendaftaran, id_layanan_pendaftaran) {
		window.open('<?= base_url() ?>rawat_inap/printing_edukasi/' + id_pendaftaran + '/' + id_layanan_pendaftaran, 'Cetak Form Edukasi', 'width=' + dWidth + ', height=' + dHeight + ', left=' + x + ', top=' + y);
	}
</script>
					...
					<div class="row">
						...
						<div class="col-lg-12">
							...
							<table class="table table-sm table-striped table-no-border">
								...
								<tr>
									<td colspan="3">
										<input type="checkbox" name="perencanaan_edukasi[]" value="Administrasi" class="perencanaan_edukasi disabled mr-1">Administrasi 
										<input type="checkbox" name="perencanaan_edukasi[]" value="Penyakit" class="perencanaan_edukasi disabled mr-1 ml-3">Penyakit
										<input type="checkbox" name="perencanaan_edukasi[]" value="Penggunaan Obat" class="perencanaan_edukasi disabled mr-1 ml-3">Penggunaan Obat
										<input type="checkbox" name="perencanaan_edukasi[]" value="Peralatan Medis" class="perencanaan_edukasi disabled mr-1 ml-3">Peralatan Medis
										<input type="checkbox" name="perencanaan_edukasi[]" value="Diet/Gizi" class="perencanaan_edukasi disabled mr-1 ml-3">Diet/Gizi
										<input type="checkbox" name="perencanaan_edukasi[]" value="Rehabilitasi Medik" class="perencanaan_edukasi disabled mr-1 ml-3">Rehabilitasi Medik
										<input type="checkbox" name="perencanaan_edukasi[]" value="Pelayanan Spiritual" class="perencanaan_edukasi disabled mr-1 ml-3">Pelayanan Spiritual
									</td>
								</tr>
								<tr><td colspan="3"></td></tr>
							</table>
							<table class="table table-striped table-sm">
								<tr><td colspan="7" class="td-dark">ENTRI EDUKASI</td></tr>
								<tr>
