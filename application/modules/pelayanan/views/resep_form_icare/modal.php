						...
						<div class="widget-body">
							<ul class="nav nav-tabs" id="resep-tab" role="tablist">
								<li class="nav-item" role="presentation">
									<button class="nav-link active" id="form-resep" data-toggle="tab" data-target="#home" type="button" role="tab" aria-controls="home" aria-selected="true">
										<span class="hidden-sm-up"><i class="fas fa-tablets"></i></span>
										<span class="hidden-xs-down">Form Input Resep</span>
									</button>
								</li>
								<li class="nav-item" role="presentation">
									<button class="nav-link" id="data-resep" data-toggle="tab" data-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false">
							...
							<div class="tab-content">
								<div class="tab-pane active p-20" id="home" role="tabpanel" aria-labelledby="home-tab">
								...
								<div class="tab-pane p-20" id="profile" role="tabpanel" aria-labelledby="profile-tab">
									<h4 class="center"><strong>- HISTORY RESEP PASIEN INTENSIVE CARE -</strong></h4>
									<input type="hidden" id="id-resep-history">
									<table class="table table-hover table-striped table-sm color-table info-table" id="table-data-resep-icare">
										<thead>
											<tr>
