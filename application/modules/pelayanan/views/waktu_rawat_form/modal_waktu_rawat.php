...
<script>
	...
	function updateWaktuRawat() {
		...
		$.ajax({
			type: 'POST',
			url: '<?= base_url("rawat_inap/api/rawat_inap/update_waktu_rawat_inap") ?>',
			...
			success: function(data) {
				if (data.status === false) {
					messageCustom('Gagal mengubah waktu rawat inap','Error');
				} else {
					messageCustom('Berhasil mengubah waktu rawat inap', 'Success');
...
<!-- Dialog Form Waktu Rawat Inap-->
<div id="modal-waktu-rawat" class="modal fade">
	<div class="modal-dialog" style="max-width: 40%">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title">Edit Waktu Rawat Inap</h4>
