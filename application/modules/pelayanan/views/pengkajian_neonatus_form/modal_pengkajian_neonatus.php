<!-- Modal -->
<!-- Intensive Care -->
<div class="modal fade" id="modal_pengkajian_neonatus" data-backdrop="static">
    <div class="modal-dialog modal-dialog-scrollable" style="max-width: 90%;">
        <div class="modal-content">
            <div class="modal-header">
                <div class="title">
                    <h5 class="modal-title bold" id="modal_pengkajian_neonatus">FORM PENGKAJIAN AWAL NEONATUS</h5>
                                ...
                                <div class="form-data-pengkajian-neonatus">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="69%">
                                                            ...
                                                            <input type="text" name="ardomen_8"
                                                                id="ardomen-8"
                                                                class="custom-form clear-input d-inline-block col-lg-2 mx-1"
                                                                placeholder="Sebutkan" disabled>cm
                                    ...
                                    <!-- PENGKAJIAN NYERI AKHIR -->
                                     ...
                                     <table class="table table-no-border table-sm table-striped" style="margin-top:-15px">
										<tr>
											<td colspan="3" class="center bold td-dark">
												<button class="btn btn-info btn-xs mr-1 float-left" type="button" data-toggle="collapse" data-target="#data-skala-early-warning-system-neonatus"><i class="fas fa-expand mr-1"></i>Expand</button>SKALA EARLY WARNING SYSTEM (EWS)
											</td>
										</tr>
									</table>
									<div class="collapse multi-collapse mt-2" id="data-skala-early-warning-system-neonatus">
										<table class="table table-sm" style="margin-top: -15px">
											<tr>
												<td width="75%">
													<table class="table table-sm table-striped table-bordered">
											...
											<table class="table table-sm table-striped" style="margin-top: -15px">
												...
												<tr>
                                                    ...
                                                    <td>
														...
														<input type="text" name="masalah_keperawatan_lain_input_neonatus" id="masalah-keperawatan-lain-input-neonatus" class="custom-form clear-input d-inline-block col-lg-6 disabled" placeholder="Masukkan lain - lain" disabled>
													</td>
													<!-- <td></td> -->
												</tr>
											</table>
...
<?php $this->load->view('pelayanan/pengkajian_neonatus_form/js') ?>