...
<div class="modal fade" id="modal_form_rekam_medis_rajal" role="dialog" data-backdrop="static"
    aria-labelledby="modal-resume-keperawatan-label" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable" style="max-width: 90%;">
        <div class="modal-content">
            <div class="modal-header">
                <div class="title">
                    <h5 class="modal-title bold" id="modal_form_rekam_medis_rajal">FORM ENTRI REKAM MEDIS</h5>
                </div>
            ...
            <div class="modal-body">
                ...
                <input type="hidden" name="id_layanan_pendaftaran" id="efrm-id-layanan-pendaftaran">
                        ...
                        <div class="table-responsive">
                            <table class="table table-sm table-striped">
                                <tr>
                                    ...
                                    <td wdith="80%">: <span id="rm-nama-pasien"></span></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>: <span id="rm-tanggal-lahir"></span></td>
                                </tr>
                                <tr>
                                    <td class="bold">Jenis Kelamin</td>
                                    <td>: <span id="rm-jenis-kelamin"></span></td>
                                </tr>
                            </table>
                        </div>
                    </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-sm table-striped">
                                <tr>
                                    ...
                                    <td wdith="70%">: <span id="rm-poli"></span></td>
                                </tr>
                            </table>
                        </div>
                    </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-info" onclick="konfirmasiSimpanEntriFormRekamMedis()"><i
