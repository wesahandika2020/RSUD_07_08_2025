                    ...
                    <div class="col-lg-12">
                        <div class="widget-body">
                            <div id="wizard-form">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <table class="table table-sm table-detail table-striped">
                                                <tr>
                                                    <td><b>Nama Ibu</b></td>
                                                    <td><span id="ibu-detail"></span></td>
                                                </tr>
                                                <tr>
                                                    <td><b>Nama Ayah</b></td>
                                                    <td><span id="ayah-detail"></span></td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td><b>Riwayat Kontrol Pasien</b></td>
                                                    <td id="skd-btn-riwayat-poli">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td id="label-upload-pasien"></td>
                                                    <td id="btn-upload-pasien"></td>
                                                </tr>
                                                <tr>
                                                    <td></td>
                                                    <td>&nbsp;</td>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-lg-2 logo-pasien-meninggal">
                                                    ...
                                                    <img src="<?= resource_url() ?>images/diagnosa/died.jpg" alt="logo-pasien-meninggal" class="img-thumbnail rounded" title="Meninggal">
                                                </div>
                                                <div class="col-lg-2 logo-pasien-hiv-aids">
                                                    <!-- logo pasien hiv-aids -->
                                                    <img src="<?= resource_url() ?>images/diagnosa/hiv-aids.jpg" alt="logo-pasien-hiv-aids" class="img-thumbnail rounded" title="HIV/AIDS">
                                                </div>
                                                <div class="col-lg-2 logo-pasien-gonorrhea">
                                                    <!-- logo pasien gonorrhea -->
                                                    <img src="<?= resource_url() ?>images/diagnosa/gonorrhea.jpg" alt="logo-pasien-gonorrhea" class="img-thumbnail rounded" title="Gonorrhea">
                                                </div>
                                                <div class="col-lg-2 logo-pasien-hepatitis">
                                                    <!-- logo pasien hepatitis -->
                                                    <img src="<?= resource_url() ?>images/diagnosa/hepatitis.jpg" alt="logo-pasien-hepatitis" class="img-thumbnail rounded" title="Hepatitis">
                                                </div>
                                                <div class="col-lg-2 logo-pasien-kusta-lepra">
                                                    <!-- logo pasien kusta-lepra -->
                                                    <img src="<?= resource_url() ?>images/diagnosa/kusta-lepra.jpg" alt="logo-pasien-kusta-lepra" class="img-thumbnail rounded" title="Kusta/Lepra">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-2 logo-pasien-tbc-kp">
                                                    <!-- logo pasien tbc-kp -->
                                                    <img src="<?= resource_url() ?>images/diagnosa/tbc-kp.jpg" alt="logo-pasien-tbc-kp" class="img-thumbnail rounded" title="TBC Kelenjar Paru">
                                                </div>
                                                <div class="col-lg-2 logo-pasien-pejabat">
                                                    <!-- logo pasien-pejabat -->
                                                    <img src="<?= resource_url() ?>images/diagnosa/pasien-pejabat.jpg" alt="logo-pasien-pejabat" class="img-thumbnail rounded" title="Pejabat">
                                                </div>
                                                <div class="col-lg-2 logo-pasien-pemilik-rs">
                                                    <!-- logo pasien-pemilik-rs -->
                                                    <img src="<?= resource_url() ?>images/diagnosa/pasien-pemilik-rs.jpg" alt="logo-pasien-pemilik-rs" class="img-thumbnail rounded" title="Pemilik RS">
                                                </div>
                                                <div class="col-lg-2 logo-pasien-potensi-komplain">
                                                    <!-- logo pasien-potensi-komplain -->
                                                    <img src="<?= resource_url() ?>images/diagnosa/pasien-potensi-komplain.jpg" alt="logo-pasien-potensi-komplain" class="img-thumbnail rounded" title="Potensi Komplain">
                                                </div>
                                                <div class="col-lg-2 logo-pasien-prb">
                                                    <!-- logo pasien-prb -->
                                                    <img src="<?= resource_url() ?>images/diagnosa/prb.jpg" alt="logo-pasien-prb" class="img-thumbnail rounded" title="PRB">
                                                </div>
                                            </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="form-group row tight">
                                                                ...
                                                                <div class="col-lg-8">
                                                                    <div>
                                                                        <label><input type="radio" name="pilihan_alergi" value="ya"> Ya</label>
                                                                        <label><input type="radio" name="pilihan_alergi" value="tidak" checked> Tidak</label>
                                                                    </div>

                                                                    <!-- Input Text untuk Deskripsi Alergi -->
                                                                    <div id="deskripsi-alergi-container" class="form-group" style="display: none;">
                                                                        <label>Deskripsi Alergi</label>
                                                                        <textarea name="alergi" id="deskripsi-alergi" class="custom-textarea" rows="4"></textarea>
                                                                    </div>

                                                                    <!-- Pilihan Kategori Alergi -->
                                                                    <div id="jenis-alergi-container" class="form-group" style="display: none;">
                                                                        <label>Pilih Jenis Alergi</label>
                                                                        <div class="col-lg-4">
                                                                            <select id="jenis-alergi" class="custom-form">
                                                                    ...
                                                                    <!-- Pilihan Detail Alergi -->
                                                                    <div id="pilihan-alergi-container" class="form-group" style="display: none;">
                                                                        <label>Pilih Alergi</label>
                                                                        <div class="col-lg-4">
                                                                            <input type="text"  id="pilihan-alergi" name="opsi_alergi" class="select2c-input">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                        </div>
                                                    ...
                                                    <div class="col-lg-6">
                                                       ...
                                                       <div class="form-group row tight">
                                                            ...
                                                            <div class="col-lg-4">
                                                                <select name="prognosis" id="prognosis" class="custom-form">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="col-lg-6">
                                                ...
                                                <!-- <input type="hidden" name="diagnosa_manual" id="diagnosa-manual" value="0"> -->
                                                <div class="form-group row tight">
                                                ...
                                                <div class="form-group row tight">
                                                    <label class="col-lg-4 col-form-label-custom"></label>
                                                    <div class="col-lg-8">
                                                        <button type="button" title="tambah diagnosa" onclick="addDiagnosa()" class="btn btn-info"><i class="fas fa-arrow-circle-down mr-2"></i>Tambah Diagnosis</button>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <!-- Radiologi -->
                                <!-- Hemodialisis -->
                                <div class="form-hemodial-rajal">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input type="hidden" name="id_dftr_hemodialisis" id="id-dftr-hemorajal">
                                            <input type="hidden" name="hemodialisis_dokter" id="dokter-hemorajal">
                                            <input type="hidden" name="cara_bayar_hemodialisis" id="rajal-bayar-hemodialisis">
                                            <input type="hidden" name="id_penjamin_hemodialisis" id="id-penjamin-rajal">
                                            <input type="hidden" name="no_polish_hemodialisis" id="no-polish-hemorajal">
                                            <input type="hidden" name="no_sep_hemodialisis" id="no-sep-hemorajal">
                                            <button type="button" title="tambah order hd" class="btn btn-info waves-effect" onclick="addHemodialisisRajal()"><i class="fas fa-plus-circle mr-1"></i>Tambah Order Hemodialisis</button>
                                            <table class="table table-hover table-striped table-sm color-table info-table mt-1" id="table-order-hemorajal">
                                                <thead>
                                                    <tr>
                                ...
                                <!-- Form Rekam Medis -->
                                <!-- <div class="form-rekam-medis">
									<div class="row">
										<div class="col-lg-3">
											<button type="button" class="btn btn-info waves-effect" onclick="cetakChecklistPenerimaanPasienRawatInap()"><i class="fa fa-print mr-1"></i>Checklist Penerimaan Pasien Rawat Inap</button>
										</div>
										
										<div class="col-lg-3">
											<button type="button" class="btn btn-info waves-effect" onclick="cetakPemberianInformasi()"><i class="fa fa-print mr-1"></i>Pemberian Informasi</button> 
										</div>

										<div class="col-lg-3">
											<button type="button" class="btn btn-info waves-effect" onclick="cetakPenolakanTindakanKedokteran()"><i class="fa fa-print mr-1"></i>Penolakan Tindakan Kedokteran</button> 
										</div>

										<div class="col-lg-3">
											<button type="button" class="btn btn-info waves-effect" onclick="cetakPersetujuanTindakanAnestesi()"><i class="fa fa-print mr-1"></i>Persetujuan Tindakan Anestesi</button>
										</div>
									</div>	
									<br>
									<div class="row">
										<div class="col-lg-3">
											<button type="button" class="btn btn-info waves-effect" onclick="cetakPersetujuanTindakanKedokteran()"><i class="fa fa-print mr-1"></i>Persetujuan Tindakan Kedokteran</button> 
										</div>

										<div class="col-lg-3">
											<button type="button" class="btn btn-info waves-effect" onclick="cetakPersetujuanTindakanOperasi()"><i class="fa fa-print mr-1"></i>Persetujuan Tindakan Operasi</button> 
										</div>

										<div class="col-lg-3">
											<button type="button" class="btn btn-info waves-effect" onclick="cetakResumeMedis()"><i class="fa fa-print mr-1"></i>Resume Medis</button>
										</div>

										<div class="col-lg-3">
											<button type="button" class="btn btn-info waves-effect" onclick="cetakSuratPengantarRawat()"><i class="fa fa-print mr-1"></i>Surat Pengantar Rawat</button>
										</div>
									</div>
									<br>
									<div class="row">
										<div class="col-lg-3">
											<button type="button" class="btn btn-info waves-effect" onclick="cetakTataTertibPasien()"><i class="fa fa-print mr-1"></i>Tata Tertib Pasien</button>
										</div>
									</div>
                                </div> -->
                                <!-- Form Rekam Medis -->
                                ...
                                <!--<div class="form-Fisioterapi">
                                    <button type="button" class="btn btn-info waves-effect" onclick="requestFisioterapi()"><i class="fa fa-plus-circle mr-1"></i>Order Pemeriksaan Rehab. Medik</button> 
                                    <br/><br/>
