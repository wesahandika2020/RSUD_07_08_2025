        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group row tight">
                    <label for="awal" class="col-3 col-form-label">Tanggal Masuk</label>
                    <div class="col-4">
                ...
                <div class="form-group row tight">
                    ...
                    <div class="col-4">
                        <input type="text" name="tanggal_awal_layanan" id="tanggal-awal-layanan" class="form-control">
                    </div>
                    <div class="col-1">
                        <h5 class="m-t-10">s/d</h5>
                    </div>
                    <div class="col-4">
                        <input type="text" name="tanggal_akhir_layanan" id="tanggal-akhir-layanan" class="form-control">
                    </div>
                </div>
                <div class="form-group row tight">
