            ...
            <div class="header__container-identity border section">
                <div class="identity__section grid">
                    ...
                    <div class="identity__section-subtitle">
                        <p class="identity">: <b><?= $persetujuan_tindakan_anestesi->nama_pasien; ?></b></p>
                        <p class="identity">: <b><?= $persetujuan_tindakan_anestesi->id_pasien; ?></b></p>
                        <p class="identity">: <b><?= datefmysql($persetujuan_tindakan_anestesi->tanggal_lahir_pasien); ?></b></p>
                        <p class="identity">: <b><?= $persetujuan_tindakan_anestesi->kelamin_pasien = 'P' ? 'Perempuan' : 'Laki-Laki' ?></b></p>
                    </div>
                </div>                
            </div>
        </div>
