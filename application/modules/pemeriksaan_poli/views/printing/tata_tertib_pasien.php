...
<title>Tata Tertib Pasien</title>
				...
				<div class="header__container-identity border section">
					<div class="identity__section grid">
						...
						<div class="identity__section-subtitle">
							<p class="identity">: <b><?= $tata_tertib->nama_pasien; ?></b></p>
							<p class="identity">: <b><?= $tata_tertib->id_pasien; ?></b></p>
							<p class="identity">: <b><?= datefmysql($tata_tertib->tanggal_lahir_pasien); ?></b></p>
							<p class="identity">: <b><?= $tata_tertib->kelamin_pasien; ?></b></p>
						</div>
					</div>
				</div>
			</div>
							...
							<table class="no__border justify small__font">
								<tbody>
									...
									<tr>
										...
										<td class="no__border" colspan="3">DILARANG mengambil dokumentasi dalam bentuk apapun (foto, rekaman dan lain-lain) di lingkungan RSUD Kota Tangerang tanpa seijin manajemen Rumah Sakit. Dan apabila melakukan/melanggar maka akan dilakukan tindak lanjut sesuai peraturan yang berlaku.</td>
									</tr>
									<tr>
				...
				<div class="tata__tertib__container grid__two-column-samesize container">
					...
					<div>
						<div class="section">
							...
							<br><br><br>
							<div class=" border no__radius">
								<div>
									<center><b>Tangerang, <?= get_date_format($tata_tertib->updated_on); ?></b></center>
									<center><?= $ttd_pasien_title; ?></center> <br> <br> <br> <br> <br>
									<center>(<b> <?= $ttd_pasien_name; ?> </b>) <br>Nama jelas dan tanda tangan</center>
								</div>
								<!-- <td class="ttd" colspan="3"><br>
									<center>Perawat / Bidan</center> <br> <br> <br> <br> <br>
									<center>( <b><?= $this->session->userdata('nama'); ?> </b> ) <br> Nama jelas dan tanda tangan</center>
								</td> -->
								<!-- <div>(<b><?= $tata_tertib->nama_pasien; ?></b>)</div> -->
