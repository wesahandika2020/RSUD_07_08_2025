            ...
            <div class="header__container-identity border section">
                <div class="identity__section grid">
                    ...
                    <div class="identity__section-subtitle">
                        ...
                        <p class="identity">: <b><?=  $ttd_pasien_kelamin = 'P' ? 'Perempuan' : 'Laki-Laki' ?></b></p>
                    </div>
                </div>                
            </div>
        </div>
            ...
            <div class="surat__persetujuan__rawat__inap__container container border no__radius">
                <table class="no__border small__font">
                    <tbody>
                        ...
                        <tr>
                            <td class="no__border" colspan="4">Demikian Surat ini saya buat dengan penuh kesadaran, tanpa paksaan serta menerima semua resiko dan tidak akan menuntut kepada pihak siapapun / manapun</td>
                        </tr>
                    </tbody>
                </table>     
                <br>           
                <table class="no__border small__font">
                    <tbody>
                        ...
                        <tr>
                            <td class="no__border" width="10%"></td>
                            <td class="no__border" width="30%" align="center">
                                1. (<?= $this->session->userdata('nama') ?>) <br> Nama Jelas & Tandatangan
                            </td>
                            <td class="no__border" width="30%" align="center">
