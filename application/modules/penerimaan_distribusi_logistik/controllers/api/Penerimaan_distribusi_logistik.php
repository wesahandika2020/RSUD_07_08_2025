 ...
 */
class Penerimaan_distribusi_logistik extends REST_Controller
{
	...
	function __construct()
	{
		...
		$this->load->model('Penerimaan_distribusi_logistik_model', 'penerimaan');
	...
	{	
		$check = $this->db->get_where('sm_penerimaan_distribusi_logistik', ['id_distribusi' => safe_post('no_distribusi')])->row();
		if (isset($check->id)) :
