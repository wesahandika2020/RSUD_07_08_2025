 ...
 */
class Resep_icare extends REST_Controller
{
    ...
    function get_list_resep_icare_get()
    {
        if (!$this->get('page')) :
        ...
        $search         = [
            ...
            'bangsal'       => $this->get('bangsal', true),
            'keyword'       => $this->get('keyword', true)
        ];

        $data           = $this->resep_icare->getListDataResepIcare($this->limit, $this->start($this->get('page')), $search);
