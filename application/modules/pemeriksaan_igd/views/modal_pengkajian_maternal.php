...
$(function() {
    ...
    // $('[name="pm_hamil_muda"]').change(function() {
    //     if ($(this).val() == '4') {
    //         $('#pm-hamil-muda-sebutkan').prop('disabled', false)
    //     } else {
    //         $('#pm-hamil-muda-sebutkan').val('').prop('disabled', true)
    //     }
    // })
    ...
    // $('[name="pm_hamil_tua"]').change(function() {
    //     if ($(this).val() == '4') {
    //         $('#pm-hamil-tua-sebutkan').prop('disabled', false)
    //     } else {
    //         $('#pm-hamil-tua-sebutkan').val('').prop('disabled', true)
    //     }
    // })
    ...
    // $('[name="pm_leopold_1"]').change(function() {
    //     if ($(this).val() == '3') {
    //         $('#pm-leopold-1-sebutkan').prop('disabled', false)
    //     } else {
    //         $('#pm-leopold-1-sebutkan').val('').prop('disabled', true)
    //     }
    // })
    ...
    // $('[name="pm_leopold_2"]').change(function() {
    //     if ($(this).val() == '3') {
    //         $('#pm-leopold-2-sebutkan').prop('disabled', false)
    //     } else {
    //         $('#pm-leopold-2-sebutkan').val('').prop('disabled', true)
    //     }
    // })
    ...
    // $('[name="pm_leopold_3"]').change(function() {
    //     if ($(this).val() == '3') {
    //         $('#pm-leopold-3-sebutkan').prop('disabled', false)
    //     } else {
    //         $('#pm-leopold-3-sebutkan').val('').prop('disabled', true)
    //     }
    // })
    ...
    //         $('#pm-berat-badan-sebutkan').prop('disabled', false)
    //     } else {
    //         $('#pm-berat-badan-sebutkan').val('').prop('disabled', true)
    //     }
    // })
    ...
    // $('[name="pm_bayar_t"]').change(function() {
    //     if ($(this).val() == '4') {
    //         $('#pm-bayar-sebutkan').prop('disabled', false)
    //     } else {
    //         $('#pm-bayar-sebutkan').val('').prop('disabled', true)
    //     }
    // })
    ...
    // let total = 0;
    // $('#pm-cgs-e, #pm-cgs-m, #pm-cgs-v').on('keyup', function(e) {
    //     if (e.target.getAttribute('id') === 'pm-cgs-e') {
    //         total += parseInt($(this).val());
    //     }
    //     if (e.target.getAttribute('id') === 'pm-cgs-m') {
    //         total += parseInt($(this).val());
    //     }
    //     if (e.target.getAttribute('id') === 'pm-cgs-v') {
    //         total += parseInt($(this).val());
    //     }
    //     $('#pm-cgs-total').val(total);
    // })
...
function entriPengkajianMaternal(id_pendaftaran, id_layanan_pendaftaran) {
    $('#wizard-maternal').bwizard('show', '0')
    $.ajax({
        type: 'GET',
        url: '<?= base_url("pemeriksaan_igd/api/pemeriksaan_igd/get_data_pengkajian_maternal") ?>/id/' +
        ...
        success: function(data) {
            ...
            if (data.pasien !== null) {
                $('#pm-id-pasien').val(data.pasien.id_pasien)
                $('#pm-pasien-nama').text(data.pasien.nama)
                $('#pm-pasien-no-rm').text(data.pasien.no_rm)
                $('#pm-pasien-tanggal-lahir').text((data.pasien.tanggal_lahir !== null ? datefmysql(data
                    .pasien.tanggal_lahir) : '-') + (' (' + hitungUmur(data.pasien.tanggal_lahir) +
                    ')'))
                $('#pm-pasien-jenis-kelamin').text((data.pasien.kelamin === 'L' ? 'Laki - laki' :
                    'Perempuan'))
            }
            ...
            $('#modal-pengkajian-maternal').modal('show')
        },
        complete: function() {
            hideLoader()
        },
...
function konfirmasiPengkajianMaternal() {
    ...
    var id_pengkajian_maternal = $('#id-pengkajian-maternal').val()
...
function simpanPengkajianMaternal() {
    $.ajax({
        ...
        data: $('#form-pengkajian-maternal').serialize() + '&id_layanan_pendaftaran=' +  $('#id-layanan-pendaftaran').val(),
        cache: false,
        dataType: 'JSON',
        beforeSend: function() {
            showLoader()
        ...
        success: function(data) {
            ...
            $('#modal-pengkajian-maternal').modal('hide')
        },
...
function showKajianMaternal(data) {
    $('#id-pengkajian-maternal').val(data.id)
    ...
    // if (data.pm_hamil_muda === '1') {
    //     $('#pm-hamil-muda-mual').prop('checked', true).change()
    // }
    // if (data.pm_hamil_muda === '2') {
    //     $('#pm-hamil-muda-muntah').prop('checked', true).change()
    // }
    // if (data.pm_hamil_muda === '3') {
    //     $('#pm-hamil-muda-pendarahan').prop('checked', true).change()
    // }
    // if (data.pm_hamil_muda === '4') {
    //     $('#pm-hamil-muda-lain').prop('checked', true).change()
    //     $('#pm-hamil-muda-sebutkan').prop('disabled', false).change()
    // }
    ...
    // if (data.pm_hamil_tua === '1') {
    //     $('#pm-hamil-tua-pusing').prop('checked', true).change()
    // }
    // if (data.pm_hamil_tua === '2') {
    //     $('#pm-hamil-tua-sakit-kepala').prop('checked', true).change()
    // }
    // if (data.pm_hamil_tua === '3') {
    //     $('#pm-hamil-tua-pendarahan').prop('checked', true).change()
    // }
    // if (data.pm_hamil_tua === '4') {
    //     $('#pm-hamil-tua-lain').prop('checked', true).change()
    //     $('#pm-hamil-tua-sebutkan').prop('disabled', false).change()
    // }
    ...
    // if (data.pm_anc === '1') {
    //     $('#pm-anc-teratur').prop('checked', true).change()
    // }
    // if (data.pm_anc === '2') {
    //     $('#pm-anc-tidak-teratur').prop('checked', true).change()
    // }
    // if (data.pm_anc === '3') {
    //     $('#pm-anc-imunisasi').prop('checked', true).change()
    // }
    ...
    // if (data.pm_leopold_1 === '1') {
    //     $('#pm-leopold-1-kepala').prop('checked', true).change()
    // }
    // if (data.pm_leopold_1 === '2') {
    //     $('#pm-leopold-1-bokong').prop('checked', true).change()
    // }
    // if (data.pm_leopold_1 === '3') {
    //     $('#pm-leopold-1-lain').prop('checked', true).change()
    //     $('#pm-leopold-1-sebutkan').prop('disabled', false).change()
    // }
    ...
    // if (data.pm_leopold_2 === '1') {
    //     $('#pm-leopold-2-punggung-kanan').prop('checked', true).change()
    // }
    // if (data.pm_leopold_2 === '2') {
    //     $('#pm-leopold-2-punggung-kiri').prop('checked', true).change()
    // }
    // if (data.pm_leopold_2 === '3') {
    //     $('#pm-leopold-2-lain').prop('checked', true).change()
    //     $('#pm-leopold-2-sebutkan').prop('disabled', false).change()
    // }
    ...
    // if (data.pm_leopold_3 === '1') {
    //     $('#pm-leopold-3-kepala').prop('checked', true).change()
    // }
    // if (data.pm_leopold_3 === '2') {
    //     $('#pm-leopold-3-bokong').prop('checked', true).change()
    // }
    // if (data.pm_leopold_3 === '3') {
    //     $('#pm-leopold-3-lain').prop('checked', true).change()
    //     $('#pm-leopold-3-sebutkan').prop('disabled', false).change()
    // }
    ...
    // if (data.pm_leopold_4 === '1') {
    //     $('#pm-leopold-4-kepala').prop('checked', true).change()
    // }
    // if (data.pm_leopold_4 === '2') {
    //     $('#pm-leopold-4-bokong').prop('checked', true).change()
    // }
    ...
    // if (data.pm_berat_badan_t === '3') {
    //     $('#pm-berat-badan-lain').prop('checked', true).change()
    // }
    ...
    // if (data.pm_bayar === '4') {
    //     $('#pm-bayar-lain').prop('checked', true).change()
    // }
    ...
    if (data.sews_respirasit == '3_1') {$('#skalameowst-1-1').prop('checked', true).change()}
    if (data.sews_respirasit == '0_2') {$('#skalameowst-1-2').prop('checked', true).change()}
    if (data.sews_respirasit == '2_3') {$('#skalameowst-1-3').prop('checked', true).change()}
    if (data.sews_respirasit == '3_4') {$('#skalameowst-1-4').prop('checked', true).change()}
    if (data.sews_saturasit == '3_1') {$('#skalameowst-2-1').prop('checked', true).change()}
    if (data.sews_saturasit == '2_2') {$('#skalameowst-2-2').prop('checked', true).change()}
    if (data.sews_saturasit == '0_3') {$('#skalameowst-2-3').prop('checked', true).change()}
    if (data.sews_o2t == '2_1') {$('#skalameowst-3-1').prop('checked', true).change()}
    if (data.sews_o2t == '0_2') {$('#skalameowst-3-2').prop('checked', true).change()}
    if (data.sews_suhut == '3_1') {$('#skalameowst-4-1').prop('checked', true).change()}
    if (data.sews_suhut == '0_2') {$('#skalameowst-4-2').prop('checked', true).change()}
    if (data.sews_suhut == '2_3') {$('#skalameowst-4-3').prop('checked', true).change()}
    if (data.sews_suhut == '3_4') {$('#skalameowst-4-4').prop('checked', true).change()}
    if (data.sews_td_sintolikt == '3_1') {$('#skalameowst-5-1').prop('checked', true).change()}
    if (data.sews_td_sintolikt == '0_2') {$('#skalameowst-5-2').prop('checked', true).change()}
    if (data.sews_td_sintolikt == '1_3') {$('#skalameowst-5-3').prop('checked', true).change()}
    if (data.sews_td_sintolikt == '2_4') {$('#skalameowst-5-4').prop('checked', true).change()}
    if (data.sews_td_sintolikt == '3_5') {$('#skalameowst-5-5').prop('checked', true).change()}
    if (data.sews_td_diastolikt == '0_1') {$('#skalameowst-6-1').prop('checked', true).change()}
    if (data.sews_td_diastolikt == '1_2') {$('#skalameowst-6-2').prop('checked', true).change()}
    if (data.sews_td_diastolikt == '2_3') {$('#skalameowst-6-3').prop('checked', true).change()}
    if (data.sews_td_diastolikt == '3_4') {$('#skalameowst-6-4').prop('checked', true).change()}
    if (data.sews_nadit == '3_1') {$('#skalameowst-7-1').prop('checked', true).change()}
    if (data.sews_nadit == '2_2') {$('#skalameowst-7-2').prop('checked', true).change()}
    if (data.sews_nadit == '0_3') {$('#skalameowst-7-3').prop('checked', true).change()}
    if (data.sews_nadit == '1_4') {$('#skalameowst-7-4').prop('checked', true).change()}
    if (data.sews_nadit == '2_5') {$('#skalameowst-7-5').prop('checked', true).change()}
    if (data.sews_nadit == '3_6') {$('#skalameowst-7-6').prop('checked', true).change()}
    if (data.sews_kesadarant == '0_1') {$('#skalameowst-8-1').prop('checked', true).change()}
    if (data.sews_kesadarant == '3_2') {$('#skalameowst-8-2').prop('checked', true).change()}
    if (data.sews_nyerit == '0_1') {}
    if (data.sews_nyerit == '3_2') {$('#skalameowst-9-2').prop('checked', true).change()}
    if (data.sews_pengeluwarant == '0_1') {$('#skalameowst-10-1').prop('checked', true).change()}
    if (data.sews_pengeluwarant == '3_2') {$('#skalameowst-10-2').prop('checked', true).change()}
    if (data.sews_proteint == '2_1') {$('#skalameowst-11-1').prop('checked', true).change()}
    if (data.sews_proteint == '3_2') {$('#skalameowst-11-2').prop('checked', true).change()}
    if (data.pm_meows === 'Putih') {$('#total-skalameowst-1').prop('checked', true).change()}
    if (data.pm_meows === 'Hijau') {$('#total-skalameowst-2').prop('checked', true).change()}
    if (data.pm_meows === 'Kuning') {$('#total-skalameowst-3').prop('checked', true).change()}
    if (data.pm_meows === 'Merah') {$('#total-skalameowst-4').prop('checked', true).change()}
    ...
    // NEWS
    if (data.sews_laju_respirasio == '3_1') {$('#skalanewso-1-1').prop('checked', true).change()}
    if (data.sews_laju_respirasio == '1_2') {$('#skalanewso-1-2').prop('checked', true).change()}
    if (data.sews_laju_respirasio == '0_3') {$('#skalanewso-1-3').prop('checked', true).change()}
    if (data.sews_laju_respirasio == '2_4') {$('#skalanewso-1-4').prop('checked', true).change()}
    if (data.sews_laju_respirasio == '3_5') {$('#skalanewso-1-5').prop('checked', true).change()}
    if (data.sews_laju_respirasio == 'bk_6') {$('#skalanewso-1-6').prop('checked', true).change()}
    if (data.sews_saturasio == '3_1') {$('#skalanewso-2-1').prop('checked', true).change()}
    if (data.sews_saturasio == '2_2') {$('#skalanewso-2-2').prop('checked', true).change()}
    if (data.sews_saturasio == '1_3') {$('#skalanewso-2-3').prop('checked', true).change()}
    if (data.sews_saturasio == '0_4') {$('#skalanewso-2-4').prop('checked', true).change()}
    if (data.sews_suplemeno == '2_1') {$('#skalanewso-3-1').prop('checked', true).change()}
    if (data.sews_suplemeno == '0_2') {$('#skalanewso-3-2').prop('checked', true).change()}
    if (data.sews_temperaturo == '3_1') {$('#skalanewso-4-1').prop('checked', true).change()}
    if (data.sews_temperaturo == '1_2') {$('#skalanewso-4-2').prop('checked', true).change()}
    if (data.sews_temperaturo == '0_3') { $('#skalanewso-4-3').prop('checked', true).change()}
    if (data.sews_temperaturo == '1_4') {$('#skalanewso-4-4').prop('checked', true).change()}
    if (data.sews_temperaturo == '2_5') {$('#skalanewso-4-5').prop('checked', true).change()}
    if (data.sews_tdso == '3_1') {$('#skalanewso-5-1').prop('checked', true).change()}
    if (data.sews_tdso == '1_2') {$('#skalanewso-5-2').prop('checked', true).change()}
    if (data.sews_tdso == '0_3') {$('#skalanewso-5-3').prop('checked', true).change()}
    if (data.sews_tdso == '1_4') {$('#skalanewso-5-4').prop('checked', true).change()}
    if (data.sews_tdso == '2_5') {$('#skalanewso-5-5').prop('checked', true).change()}
    if (data.sews_tdso == '3_6') {$('#skalanewso-5-6').prop('checked', true).change()}
    if (data.sews_tdso == 'bk_7') {$('#skalanewso-5-7').prop('checked', true).change()}
    if (data.sews_laju_jantungo == '3_1') {$('#skalanewso-6-1').prop('checked', true).change()}
    if (data.sews_laju_jantungo == '0_2') {$('#skalanewso-6-2').prop('checked', true).change()}
    if (data.sews_laju_jantungo == '1_3') {$('#skalanewso-6-3').prop('checked', true).change()}
    if (data.sews_laju_jantungo == '2_4') {$('#skalanewso-6-4').prop('checked', true).change()}
    if (data.sews_laju_jantungo == '3_5') {$('#skalanewso-6-5').prop('checked', true).change()}
    if (data.sews_laju_jantungo == 'bk_6') {$('#skalanewso-6-6').prop('checked', true).change()}
    if (data.sews_kesadarano == '0_1') {$('#skalanewso-7-1').prop('checked', true).change()}
    if (data.sews_kesadarano == '3_2') {$('#skalanewso-7-2').prop('checked', true).change()}
    if (data.sews_kesadarano == 'bk_3') {$('#skalanewso-7-3').prop('checked', true).change()}
    if (data.pm_news === 'Putih') {$('#total-skalanewso-1').prop('checked', true).change()}
    if (data.pm_news === 'Hijau') {$('#total-skalanewso-2').prop('checked', true).change()}
    if (data.pm_news === 'Kuning') {$('#total-skalanewso-3').prop('checked', true).change()}
    if (data.pm_news === 'Merah') {$('#total-skalanewso-4').prop('checked', true).change()}
    ...
    if (data.pm_bidan !== null) { $('#pm-bidan').select2c('readonly', true)}
    $('#pm-bidan').val(data.pm_bidan)
    $('#s2id_pm-bidan a .select2c-chosen').html(data.nama_bidan)
    ...
    // DPJP maternal
    // if (data.pm_dpjp !== null) { $('#pm-dpjp').select2c('readonly', true)}       
...
<!-- Modal -->
<!-- IGD -->
<div class="modal fade" id="modal-pengkajian-maternal" data-backdrop="static">
    <div class="modal-dialog modal-dialog-scrollable" style="max-width: 90%;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <input type="hidden" name="pm_id_pasien" id="pm-id-pasien">
                <input type="hidden" name="id" id="id-pengkajian-maternal">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <table class="table table-no-border table-sm table-striped"
                                                ...
                                                <tr>
                                                    <td colspan="3" class="center bold td-dark">
                                                        <button class="btn btn-info btn-xs mr-1 float-left" type="button" data-toggle="collapse" data-target="#keluhan-utama"><iclass="fas fa-expand mr-1"></iclass=>Expand</button>KELUHAN UTAMA
                                                    </td>
                                                </tr>
                                            </table>
                                            <div class="collapse multi-collapse mt-2" id="keluhan-utama">
                                                <div class="card p-2" style="margin-top:-15px">
                                                    <table class="table table-no-border table-sm table-striped">
                                                        <tr>
                                                            <td colspan="2">
                                                                <textarea name="pm_keluhan_utama" id="pm-keluhan-utama"
                                                                    rows="3" class="form-control clear-input"
                                            ...
                                            <table class="table table-no-border table-sm table-striped"
                                                ...
                                                <tr>
                                                    <td colspan="3" class="center bold td-dark">
                                                        <button class="btn btn-info btn-xs mr-1 float-left" type="button" data-toggle="collapse" data-target="#penyakit-sekarang"><iclass="fas fa-expand mr-1"></iclass=>Expand</button>RIWAYAT PENYAKIT SEKARANG
                                                    </td>
                                                </tr>
                                            </table>
                                            ...
                                            <table class="table table-no-border table-sm table-striped"
                                                ...
                                                <tr>
                                                    <td colspan="3" class="center bold td-dark">
                                                        <button class="btn btn-info btn-xs mr-1 float-left" type="button" data-toggle="collapse" data-target="#riwayat-kehamilan"><iclass="fas fa-expand mr-1"></iclass=>Expand</button>RIWAYAT KEHAMILAN PERSALINAN DAN NIFAS YANG LALU
                                                    </td>
                                                </tr>
                                            </table>
                                            ...
                                            <table class="table table-no-border table-sm table-striped"
                                                ...
                                                <tr>
                                                    <td colspan="3" class="center bold td-dark">
                                                        <button class="btn btn-info btn-xs mr-1 float-left" type="button" data-toggle="collapse" data-target="#riwayat-menstruasi"><iclass="fas fa-expand mr-1"></iclass=>Expand</button>RIWAYAT MENSTRUASI
                                                    </td>
                                                </tr>
                                            </table>
                                            ...
                                            <table class="table table-no-border table-sm table-striped"
                                                ...
                                                <tr>
                                                    <td colspan="3" class="center bold td-dark">
                                                        <button class="btn btn-info btn-xs mr-1 float-left" type="button" data-toggle="collapse" data-target="#riwayat-penyakit-keluarga"><iclass="fas fa-expand mr-1"></iclass=>Expand</button>RIWAYAT PENYAKIT KELUARGA
                                                    </td>
                                                </tr>
                                            </table>
                                            ...
                                            <table class="table table-no-border table-sm table-striped"
                                                ...
                                                <tr>
                                                    <td colspan="3" class="center bold td-dark">
                                                        <button class="btn btn-info btn-xs mr-1 float-left" type="button" data-toggle="collapse" data-target="#tanda-vital"><iclass="fas fa-expand mr-1"></iclass=>Expand</button>PEMERIKSAAN FISIK DAN TANDA-TANDA VITAL
                                                    </td>
                                                </tr>
                                            </table>
                                            ...
                                            <table class="table table-no-border table-sm table-striped"
                                                ...
                                                <tr>
                                                    <td colspan="3" class="center bold td-dark">
                                                        <button class="btn btn-info btn-xs mr-1 float-left" type="button" data-toggle="collapse" data-target="#pemeriksaan-kandungan"><iclass="fas fa-expand mr-1"></iclass=>Expand</button>PEMERIKSAAN KEBIDANAN DAN KANDUNGAN
                                                    </td>
                                                </tr>
                                            </table>
                                            ...
                                            <table class="table table-no-border table-sm table-striped"
                                                ...
                                                <tr>
                                                    <td colspan="3" class="center bold td-dark">
                                                        <button class="btn btn-info btn-xs mr-1 float-left" type="button" data-toggle="collapse" data-target="#pm-resiko-jatuh"><iclass="fas fa-expand mr-1"></iclass=>Expand</button>PENILAIAN RESIKO JATUH
                                                    </td>
                                                </tr>
                                            </table>
                                            ...
                                            <table class="table table-no-border table-sm table-striped"
                                                ...
                                                <tr>
                                                    <td colspan="3" class="center bold td-dark">
                                                        <button class="btn btn-info btn-xs mr-1 float-left" type="button" data-toggle="collapse" data-target="#pm-tingkat-nyeri"><iclass="fas fa-expand mr-1"></iclass=>Expand</button>PENILAIAN TINGKAT NYERI
                                                    </td>
                                                </tr>
                                            </table>
                                            ...
                                            <table class="table table-no-border table-sm table-striped"
                                                ...
                                                <tr>
                                                    <td colspan="3" class="center bold td-dark">
                                                        <button class="btn btn-info btn-xs mr-1 float-left" type="button" data-toggle="collapse" data-target="#pm-riwayat-alergi"><iclass="fas fa-expand mr-1"></iclass=>Expand</button>RIWAYAT ALERGI
                                                    </td>
                                                </tr>
                                            </table>
                                            ...
                                            <table class="table table-no-border table-sm table-striped"
                                                ...
                                                <tr>
                                                    <td colspan="3" class="center bold td-dark">
                                                        <button class="btn btn-info btn-xs mr-1 float-left" type="button" data-toggle="collapse" data-target="#pm-status-nutrisi"><iclass="fas fa-expand mr-1"></iclass=>Expand</button>STATUS NUTRISI
                                                    </td>
                                                </tr>
                                            </table>
                                            ...
                                            <table class="table table-no-border table-sm table-striped"
                                                ...
                                                <tr>
                                                    <td colspan="3" class="center bold td-dark">
                                                        <button class="btn btn-info btn-xs mr-1 float-left" type="button" data-toggle="collapse" data-target="#pm-status-fungsional"><iclass="fas fa-expand mr-1"></iclass=>Expand</button>STATUS FUNGSIONAL
                                                    </td>
                                                </tr>
                                            </table>
                                            ...
                                            <table class="table table-no-border table-sm table-striped"
                                                ...
                                                <tr>
                                                    <td colspan="3" class="center bold td-dark">
                                                        <button class="btn btn-info btn-xs mr-1 float-left" type="button" data-toggle="collapse" data-target="#pm-psikososial"><iclass="fas fa-expand mr-1"></iclass=>Expand</button>PSIKOSOSIAL EKONOMI
                                                    </td>
                                                </tr>
                                            </table>
                                            ...
                                            <table class="table table-no-border table-sm table-striped"
                                                ...
                                                <tr>
                                                    <td colspan="3" class="center bold td-dark">
                                                        <button class="btn btn-info btn-xs mr-1 float-left" type="button" data-toggle="collapse" data-target="#pm-spiritual"><iclass="fas fa-expand mr-1"></iclass=>Expand</button>PENGKAJIAN SPIRITUAL
                                                    </td>
                                                </tr>
                                            </table>
                                            ...
                                            <table class="table table-no-border table-sm table-striped"
                                                ...
                                                <tr>
                                                    <td colspan="3" class="center bold td-dark">
                                                        <button class="btn btn-info btn-xs mr-1 float-left" type="button" data-toggle="collapse" data-target="#pm-biologis"><iclass="fas fa-expand mr-1"></iclass=>Expand</button>KEBUTUHAN BIOLOGIS
                                                    </td>
                                                </tr>
                                            </table>
                                            ...
                                            <table class="table table-no-border table-sm table-striped"
                                                ...
                                                <tr>
                                                    <td colspan="3" class="center bold td-dark">
                                                        <button class="btn btn-info btn-xs mr-1 float-left" type="button" data-toggle="collapse" data-target="#pm-skala-early"><iclass="fas fa-expand mr-1"></iclass=>Expand</button>SKALA EARLY WARNING SYSTEM (EWS)
                                                    </td>
                                                </tr>
                                            </table>
                                                            ...
                                                            <table class="table table-bordered table-sm">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="center"></td>
                                                                        <td class="center">
                                                                            <input type="radio" name="sews_o2t" id="skalameowst-3-2"value="0_2" class="mr-1 skalameowst ">Tidak</td>
                                                                        <td class="center"></td>
                                                                        <td class="center"></td>
                                                                        <td class="center"></td>
                                                                    </tr>
                                                            ...
                                                            <table class="table table-bordered table-sm">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="center">
                                                                            <input type="radio" name="sews_laju_respirasio"id="skalanewso-1-6" value="bk_6"class="mr-1 skalanewso ">&#8804;5/&#8805;35</td>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="center">2.</td>
                                            ...
                                            <table class="table table-no-border table-sm table-striped"
                                                ...
                                                <tr>
                                                    <td colspan="3" class="center bold td-dark">
                                                        <button class="btn btn-info btn-xs mr-1 float-left" type="button" data-toggle="collapse" data-target="#pm-data-penunjang"><iclass="fas fa-expand mr-1"></iclass=>Expand</button>DATA PENUNJANG
                                                    </td>
                                                </tr>
                                            </table>
                                            ...
                                            <table class="table table-no-border table-sm table-striped"
                                                ...
                                                <tr>
                                                    <td colspan="3" class="center bold td-dark">
                                                        <button class="btn btn-info btn-xs mr-1 float-left" type="button" data-toggle="collapse" data-target="#pm-assesmen-kebidanan"><iclass="fas fa-expand mr-1"></iclass=>Expand</button>ASSESMEN KEBIDANAN
                                                    </td>
                                                </tr>
                                            </table>
                                            ...
                                            <table class="table table-no-border table-sm table-striped"
                                                ...
                                                <tr>
                                                    <td colspan="3" class="center bold td-dark">
                                                        <button class="btn btn-info btn-xs mr-1 float-left" type="button" data-toggle="collapse" data-target="#pm-asuhan-kebidanan"><iclass="fas fa-expand mr-1"></iclass=>Expand</button>RENCANA ASUHAN KEBIDANAN
                                                    </td>
                                                </tr>
                                            </table>
                                            ...
                                            <!--YANG MELAKUKAN PENGKAJIAN MATERNAL AKHIR -->
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-info" onclick="konfirmasiPengkajianMaternal()" id="btn_simpan"><i
